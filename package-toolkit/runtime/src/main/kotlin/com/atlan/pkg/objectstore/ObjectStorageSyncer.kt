...
interface ObjectStorageSyncer {
     ...
     */
    fun copyFrom(prefix: String, localDirectory: String): List<String>
     ...
     */
    fun copyLatestFrom(prefix: String, extension: String, localDirectory: String): String
     ...
     */
    fun downloadFrom(remoteKey: String, localFile: String)
     ...
     */
    fun copyTo(localDirectory: String, prefix: String): Boolean
     ...
     */
    fun uploadTo(localFile: String, remoteKey: String)
}
