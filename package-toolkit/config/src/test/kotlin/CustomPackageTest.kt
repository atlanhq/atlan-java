...
object CustomPackageTest {
    ...
    fun testModelBasics() {
        ...
        assertEquals("ghcr.io/atlanhq/atlan-kotlin-samples:0.3.0", config.containerImage)
    ...
    fun testConnectionUsage() {
        ...
        assertEquals(2, connectionUsage.possibleValues.size)
        assertTrue(connectionUsage.possibleValues.containsKey("CREATE"))
        assertTrue(connectionUsage.possibleValues.containsKey("REUSE"))
        assertEquals("Create", connectionUsage.possibleValues["CREATE"])
        assertEquals("Reuse", connectionUsage.possibleValues["REUSE"])
