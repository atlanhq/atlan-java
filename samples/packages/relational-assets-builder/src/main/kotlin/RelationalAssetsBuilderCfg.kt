...
data class RelationalAssetsBuilderCfg(
    ...
    @JsonProperty("assets_gcs_project") val assetsGcsProject: String? = null,
    @JsonProperty("assets_gcs_bucket") val assetsGcsBucket: String? = null,
    @JsonProperty("assets_gcs_object_key") val assetsGcsObjectKey: String? = null,
    @JsonProperty("assets_gcs_credential_json") val assetsGcsCredentialJson: String? = null,
    @JsonProperty("assets_adls_account") val assetsAdlsAccount: String? = null,
    @JsonProperty("assets_adls_container") val assetsAdlsContainer: String? = null,
    @JsonProperty("assets_adls_object_key") val assetsAdlsObjectKey: String? = null,
    @JsonProperty("assets_adls_sas_token") val assetsAdlsSasToken: String? = null,
