...
public class KafkaClusterTest {
    ...
    private final KafkaCluster full = KafkaCluster._internal()
            .guid("guid")
            ...
            .kafkaTopicCount(123456789L)
            .kafkaPartitionCount(123456789L)
            .kafkaBrokerCount(123456789L)
            .kafkaBootstrapServer("String0")
            .kafkaBootstrapServer("String1")
            .kafkaClusterType("String0")
            .kafkaSchemaRegistryUrl("String0")
            .kafkaAuthenticationType("String0")
            .kafkaEnvironment("String0")
    ...
    @Test
    void serdeCycleKafkaCluster() throws IOException {
        assertNotNull(full, "Unable to build sample instance of KafkaCluster,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting KafkaCluster via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of KafkaCluster,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final KafkaCluster frodo = MockAtlanTenant.client.readValue(serialized, KafkaCluster.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of KafkaCluster,");
