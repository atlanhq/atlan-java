...
public class PowerBIDataflowTest {
    ...
    private final PowerBIDataflow full = PowerBIDataflow._internal()
            .guid("guid")
            ...
            .webUrl("String0")
            .powerBIDataflowRefreshScheduleFrequency("String0")
            ...
            .powerBIDataflowParent(PowerBIDataflow.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .powerBIDataflowEntityColumn(PowerBIDataflowEntityColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCyclePowerBIDataflow() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PowerBIDataflow,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PowerBIDataflow via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PowerBIDataflow,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PowerBIDataflow frodo = MockAtlanTenant.client.readValue(serialized, PowerBIDataflow.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PowerBIDataflow,");
