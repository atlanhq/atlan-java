...
public class SnowflakeShareTest {

    private final SnowflakeShare full = SnowflakeShare._internal()
            .guid("guid")
            ...
            .snowflakeShareKind(SnowflakeShareKind.INBOUND)
            .snowflakeShareOwnerAccount("String0")
            .snowflakeShareTargetAccount("String0")
            .snowflakeShareTargetAccount("String1")
            .snowflakeShareListingGlobalName("String0")
            .snowflakeShareSecureObject(true)
            ...
            .snowflakeListing(SnowflakeListing.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleSnowflakeShare() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeShare,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeShare via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeShare,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeShare frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeShare.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeShare,");
