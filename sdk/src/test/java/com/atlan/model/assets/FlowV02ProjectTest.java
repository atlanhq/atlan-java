...
public class FlowV02ProjectTest {

    private static final FlowV02Project full = FlowV02Project._internal()
            .guid("guid")
    ...
    private static FlowV02Project frodo;
    private static String serialized;

    @Test(groups = {"FlowV02Project.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowV02Project.serialize"},
            dependsOnGroups = {"FlowV02Project.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowV02Project.deserialize"},
            dependsOnGroups = {"FlowV02Project.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowV02Project.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowV02Project.equivalency"},
            dependsOnGroups = {"FlowV02Project.serialize", "FlowV02Project.deserialize"})
