...
public class SageMakerUnifiedStudioPublishedAssetTest {

    private final SageMakerUnifiedStudioPublishedAsset full = SageMakerUnifiedStudioPublishedAsset._internal()
            .guid("guid")
            ...
            .smusSubscribedAsset(SageMakerUnifiedStudioSubscribedAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .smusSubscribedAsset(SageMakerUnifiedStudioSubscribedAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSageMakerUnifiedStudioPublishedAsset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SageMakerUnifiedStudioPublishedAsset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SageMakerUnifiedStudioPublishedAsset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SageMakerUnifiedStudioPublishedAsset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SageMakerUnifiedStudioPublishedAsset frodo = MockAtlanTenant.client.readValue(serialized, SageMakerUnifiedStudioPublishedAsset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerUnifiedStudioPublishedAsset,");
