...
public class DbtEntityTest {

    private final DbtEntity full = DbtEntity._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDbtEntity() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtEntity,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtEntity via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtEntity,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtEntity frodo = MockAtlanTenant.client.readValue(serialized, DbtEntity.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtEntity,");
