...
public class IcebergCatalogTest {
    ...
    private final IcebergCatalog full = IcebergCatalog._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .build())
            .schemaCount(123)
            .icebergCatalogType("String0")
            .icebergUri("String0")
            .icebergWarehouse("String0")
            .icebergScope("String0")
            .icebergCatalogProperty("String0", "String0")
            .icebergCatalogProperty("String1", "String1")
    ...
    @Test
    void serdeCycleIcebergCatalog() throws IOException {
        assertNotNull(full, "Unable to build sample instance of IcebergCatalog,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting IcebergCatalog via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of IcebergCatalog,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final IcebergCatalog frodo = MockAtlanTenant.client.readValue(serialized, IcebergCatalog.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of IcebergCatalog,");
