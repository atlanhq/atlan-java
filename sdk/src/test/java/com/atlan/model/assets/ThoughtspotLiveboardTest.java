...
public class ThoughtspotLiveboardTest {
    ...
    private final ThoughtspotLiveboard full = ThoughtspotLiveboard._internal()
            .guid("guid")
            ...
            .thoughtspotDashlet(ThoughtspotDashlet.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleThoughtspotLiveboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ThoughtspotLiveboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ThoughtspotLiveboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ThoughtspotLiveboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ThoughtspotLiveboard frodo = MockAtlanTenant.client.readValue(serialized, ThoughtspotLiveboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ThoughtspotLiveboard,");
