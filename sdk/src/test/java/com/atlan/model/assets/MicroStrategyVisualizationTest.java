...
public class MicroStrategyVisualizationTest {
    ...
    private static final MicroStrategyVisualization full = MicroStrategyVisualization._internal()
            ...
            .microStrategyDossierName("String0")
            .microStrategyDossierQualifiedName("String0")
            .microStrategyProject(MicroStrategyProject.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .microStrategyVisualizationType("String0")
            .build();

    private static final int hash = full.hashCode();
    private static MicroStrategyVisualization frodo;
    private static String serialized;

    @Test(groups = {"MicroStrategyVisualization.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"MicroStrategyVisualization.serialize"},
            dependsOnGroups = {"MicroStrategyVisualization.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"MicroStrategyVisualization.deserialize"},
            dependsOnGroups = {"MicroStrategyVisualization.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyVisualization.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"MicroStrategyVisualization.equivalency"},
            dependsOnGroups = {"MicroStrategyVisualization.serialize", "MicroStrategyVisualization.deserialize"})
