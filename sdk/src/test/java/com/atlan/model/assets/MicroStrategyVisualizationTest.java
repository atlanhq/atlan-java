...
public class MicroStrategyVisualizationTest {
    ...
    private final MicroStrategyVisualization full = MicroStrategyVisualization._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleMicroStrategyVisualization() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MicroStrategyVisualization,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MicroStrategyVisualization via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MicroStrategyVisualization,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MicroStrategyVisualization frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyVisualization.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MicroStrategyVisualization,");
