...
public class DocumentDBCollectionTest {
    ...
    private final DocumentDBCollection full = DocumentDBCollection._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDocumentDBCollection() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DocumentDBCollection,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DocumentDBCollection via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DocumentDBCollection,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DocumentDBCollection frodo = MockAtlanTenant.client.readValue(serialized, DocumentDBCollection.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DocumentDBCollection,");
