...
public class SapAnalyticsCloudStoryTest {

    private final SapAnalyticsCloudStory full = SapAnalyticsCloudStory._internal()
            .guid("guid")
            ...
            .sapAnalyticsCloudStoryKind("String0")
            .sapAnalyticsCloudIsSample(true)
    ...
    @Test
    void serdeCycleSapAnalyticsCloudStory() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapAnalyticsCloudStory,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapAnalyticsCloudStory via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapAnalyticsCloudStory,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapAnalyticsCloudStory frodo = MockAtlanTenant.client.readValue(serialized, SapAnalyticsCloudStory.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of SapAnalyticsCloudStory,");
