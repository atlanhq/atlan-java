...
public class SourceTagAttachedAssetTest {
    ...
    private static final Table full = Table._internal()
            ...
            .atlanTag(AtlanTag.builder()
                    .typeName("String1")
                    .propagate(false)
                    .sourceTagAttachment(SourceTagAttachment.builder()
                            .sourceTagGuid("sourceTagGuid1")
                            .sourceTagConnectorName("sourceTagConnectorName1")
                            .sourceTagName("sourceTagName1")
                            .sourceTagSyncTimestamp(0L)
                            .sourceTagQualifiedName("sourceTagQualifiedName1")
                            .isSourceTagSynced(false)
                            .sourceTagSyncError("sourceTagSyncError1")
                            .sourceTagValue(List.of(
                                    SourceTagAttachmentValue.builder()
                                            .tagAttachmentKey("tagAttachmentKey1.1")
                                            .tagAttachmentValue("tagAttachmentValue1.1")
                                            .build(),
                                    SourceTagAttachmentValue.builder()
                                            .tagAttachmentKey("tagAttachmentKey1.2")
                                            .tagAttachmentValue("tagAttachmentValue1.2")
                                            .build()))
                            .build())
                    .sourceTagAttachment(SourceTagAttachment.builder()
                            .sourceTagGuid("sourceTagGuid2")
                            .sourceTagConnectorName("sourceTagConnectorName2")
                            .sourceTagName("sourceTagName2")
                            .sourceTagSyncTimestamp(2L)
                            .sourceTagQualifiedName("sourceTagQualifiedName2")
                            .isSourceTagSynced(true)
                            .sourceTagSyncError("sourceTagSyncError2")
                            .sourceTagValue(List.of(
                                    SourceTagAttachmentValue.builder()
                                            .tagAttachmentKey("tagAttachmentKey2.1")
                                            .tagAttachmentValue("tagAttachmentValue2.1")
                                            .build(),
                                    SourceTagAttachmentValue.builder()
                                            .tagAttachmentKey("tagAttachmentKey2.2")
                                            .tagAttachmentValue("tagAttachmentValue2.2")
                                            .build()))
                            .build())
                    .build())
            .customMetadata(
