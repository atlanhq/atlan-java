...
public class ConnectionProcessTest {
    ...
    private static final ConnectionProcess full = ConnectionProcess._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .input(Connection.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .input(Connection.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .output(Connection.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
