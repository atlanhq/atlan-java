...
public class SupersetChartTest {
    ...
    private final SupersetChart full = SupersetChart._internal()
            .guid("guid")
            ...
            .putSupersetChartFormData("String0", "String0")
            .putSupersetChartFormData("String1", "String1")
    ...
    @Test
    void serdeCycleSupersetChart() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SupersetChart,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SupersetChart via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SupersetChart,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SupersetChart frodo = MockAtlanTenant.client.readValue(serialized, SupersetChart.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SupersetChart,");
