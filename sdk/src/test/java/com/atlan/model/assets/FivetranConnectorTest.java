...
public class FivetranConnectorTest {
    ...
    private final FivetranConnector full = FivetranConnector._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleFivetranConnector() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FivetranConnector,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FivetranConnector via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FivetranConnector,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FivetranConnector frodo = MockAtlanTenant.client.readValue(serialized, FivetranConnector.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of FivetranConnector,");
