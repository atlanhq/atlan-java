...
public class DetectiDataDossierElementTest {

    private static final DetectiDataDossierElement full = DetectiDataDossierElement._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .detectiDataComponentScore(123456789L)
            .detectiDataDossier(DetectiDataDossier.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();

    private static final int hash = full.hashCode();
    private static DetectiDataDossierElement frodo;
    private static String serialized;

    @Test(groups = {"DetectiDataDossierElement.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DetectiDataDossierElement.serialize"},
            dependsOnGroups = {"DetectiDataDossierElement.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DetectiDataDossierElement.deserialize"},
            dependsOnGroups = {"DetectiDataDossierElement.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = Atlan.getDefaultClient().readValue(serialized, DetectiDataDossierElement.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DetectiDataDossierElement.equivalency"},
            dependsOnGroups = {"DetectiDataDossierElement.serialize", "DetectiDataDossierElement.deserialize"})
