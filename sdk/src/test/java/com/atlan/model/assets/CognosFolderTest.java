...
public class CognosFolderTest {
    ...
    private static final CognosFolder full = CognosFolder._internal()
            ...
            .cognosFile(CognosFile.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cognosFolder(CognosFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cognosFolderChildObjectsCount(123)
            .cognosFolderSubFolderCount(123)
            .cognosModule(CognosModule.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cognosModule(CognosModule.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cognosPackage(CognosPackage.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cognosPackage(CognosPackage.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cognosReport(CognosReport.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cognosReport(CognosReport.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cognosSubFolder(CognosFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
