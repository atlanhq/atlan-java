...
public class ThoughtspotWorksheetTest {
    ...
    private final ThoughtspotWorksheet full = ThoughtspotWorksheet._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleThoughtspotWorksheet() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ThoughtspotWorksheet,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ThoughtspotWorksheet via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ThoughtspotWorksheet,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ThoughtspotWorksheet frodo = MockAtlanTenant.client.readValue(serialized, ThoughtspotWorksheet.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ThoughtspotWorksheet,");
