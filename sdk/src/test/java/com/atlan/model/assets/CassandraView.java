...
public class CassandraView extends Asset implements ICassandraView, ICassandra, INoSQL, ICatalog, IAsset, IReferenceable {
    ...
    public static CassandraView updateCertificate(
            ...
            throws AtlanException {
        return (CassandraView) Asset.updateCertificate(client, _internal(), TYPE_NAME, qualifiedName, certificate, message);
    }
    ...
    public static CassandraView updateAnnouncement(
            ...
            throws AtlanException {
        return (CassandraView) Asset.updateAnnouncement(client, _internal(), TYPE_NAME, qualifiedName, type, title, message);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static CassandraView replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
