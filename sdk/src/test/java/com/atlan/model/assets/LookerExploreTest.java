...
public class LookerExploreTest {
    ...
    private final LookerExplore full = LookerExplore._internal()
            .guid("guid")
            ...
            .projectName("String0")
            .modelName("String0")
            .sourceConnectionName("String0")
            .viewName("String0")
            .sqlTableName("String0")
    ...
    @Test
    void serdeCycleLookerExplore() throws IOException {
        assertNotNull(full, "Unable to build sample instance of LookerExplore,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting LookerExplore via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of LookerExplore,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final LookerExplore frodo = MockAtlanTenant.client.readValue(serialized, LookerExplore.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of LookerExplore,");
