...
public class SAPBWQueryTest {

    private final SAPBWQuery full = SAPBWQuery._internal()
            .guid("guid")
            ...
            .sapBwQueryUid("String0")
            .sapBwInfoArea(SAPBWInfoArea.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwQueryElement(SAPBWQueryElement.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwQueryElement(SAPBWQueryElement.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSAPBWQuery() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWQuery,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWQuery via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWQuery,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWQuery frodo = MockAtlanTenant.client.readValue(serialized, SAPBWQuery.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWQuery,");
