...
public class CustomDatasetTest {
    ...
    private static final CustomDataset full = CustomDataset._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .customTable(CustomTable.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .customTable(CustomTable.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static CustomDataset frodo;
    private static String serialized;

    @Test(groups = {"CustomDataset.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CustomDataset.serialize"},
            dependsOnGroups = {"CustomDataset.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CustomDataset.deserialize"},
            dependsOnGroups = {"CustomDataset.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = Atlan.getDefaultClient().readValue(serialized, CustomDataset.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CustomDataset.equivalency"},
            dependsOnGroups = {"CustomDataset.serialize", "CustomDataset.deserialize"})
