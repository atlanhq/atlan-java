...
public class FlowControlOperationTest {
    ...
    private final FlowControlOperation full = FlowControlOperation._internal()
            .guid("guid")
            ...
            .flowControlledOperation(FlowControlOperation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleFlowControlOperation() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FlowControlOperation,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FlowControlOperation via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FlowControlOperation,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FlowControlOperation frodo = MockAtlanTenant.client.readValue(serialized, FlowControlOperation.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of FlowControlOperation,");
