...
public class ApplicationFieldTest {
    ...
    private static final ApplicationField full = ApplicationField._internal()
            .guid("guid")
    ...
    private static ApplicationField frodo;
    private static String serialized;

    @Test(groups = {"ApplicationField.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"ApplicationField.serialize"},
            dependsOnGroups = {"ApplicationField.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"ApplicationField.deserialize"},
            dependsOnGroups = {"ApplicationField.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, ApplicationField.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"ApplicationField.equivalency"},
            dependsOnGroups = {"ApplicationField.serialize", "ApplicationField.deserialize"})
