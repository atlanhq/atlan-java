...
public class ApplicationFieldTest {
    ...
    private final ApplicationField full = ApplicationField._internal()
            .guid("guid")
            ...
            .applicationFieldOwnedAsset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleApplicationField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ApplicationField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ApplicationField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ApplicationField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ApplicationField frodo = MockAtlanTenant.client.readValue(serialized, ApplicationField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ApplicationField,");
