...
public class SapErpFunctionModuleTest {
    ...
    private final SapErpFunctionModule full = SapErpFunctionModule._internal()
            .guid("guid")
            ...
            .sapErpFunctionModuleImportParam("String0", "String0")
            .sapErpFunctionModuleImportParam("String1", "String1")
            .sapErpFunctionModuleImportParamsCount(123456789L)
            .sapErpFunctionModuleExportParam("String0", "String0")
            .sapErpFunctionModuleExportParam("String1", "String1")
            .sapErpFunctionModuleExportParamsCount(123456789L)
            .sapErpFunctionException("String0", "String0")
            .sapErpFunctionException("String1", "String1")
    ...
    @Test
    void serdeCycleSapErpFunctionModule() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapErpFunctionModule,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapErpFunctionModule via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapErpFunctionModule,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapErpFunctionModule frodo = MockAtlanTenant.client.readValue(serialized, SapErpFunctionModule.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SapErpFunctionModule,");
