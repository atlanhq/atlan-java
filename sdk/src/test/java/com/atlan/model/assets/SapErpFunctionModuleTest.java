...
public class SapErpFunctionModuleTest {

    private static final SapErpFunctionModule full = SapErpFunctionModule._internal()
            .guid("guid")
            ...
            .sapErpFunctionException(Map.of("key1", "value1"))
            .sapErpFunctionException(Map.of("key2", "value2"))
            .sapErpFunctionExceptionListCount(123456789L)
            .sapErpFunctionModuleExportParam(Map.of("key1", "value1"))
            .sapErpFunctionModuleExportParam(Map.of("key2", "value2"))
            .sapErpFunctionModuleExportParamsCount(123456789L)
            .sapErpFunctionModuleGroup("String0")
            .sapErpFunctionModuleImportParam(Map.of("key1", "value1"))
            .sapErpFunctionModuleImportParam(Map.of("key2", "value2"))
            .sapErpFunctionModuleImportParamsCount(123456789L)
            .build();

    private static final int hash = full.hashCode();
    private static SapErpFunctionModule frodo;
    private static String serialized;

    @Test(groups = {"SapErpFunctionModule.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SapErpFunctionModule.serialize"},
            dependsOnGroups = {"SapErpFunctionModule.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SapErpFunctionModule.deserialize"},
            dependsOnGroups = {"SapErpFunctionModule.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SapErpFunctionModule.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SapErpFunctionModule.equivalency"},
            dependsOnGroups = {"SapErpFunctionModule.serialize", "SapErpFunctionModule.deserialize"})
