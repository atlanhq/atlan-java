...
public class SAPBWCompositeProviderTest {

    private final SAPBWCompositeProvider full = SAPBWCompositeProvider._internal()
            .guid("guid")
            ...
            .sapBwIsHanaModel(true)
            .sapBwInfoArea(SAPBWInfoArea.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwCompositeProviderField(SAPBWCompositeProviderField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleSAPBWCompositeProvider() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWCompositeProvider,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWCompositeProvider via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWCompositeProvider,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWCompositeProvider frodo = MockAtlanTenant.client.readValue(serialized, SAPBWCompositeProvider.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of SAPBWCompositeProvider,");
