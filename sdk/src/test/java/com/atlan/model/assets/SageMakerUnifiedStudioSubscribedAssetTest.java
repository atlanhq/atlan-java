...
public class SageMakerUnifiedStudioSubscribedAssetTest {

    private final SageMakerUnifiedStudioSubscribedAsset full = SageMakerUnifiedStudioSubscribedAsset._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .smusAssetSummary("String0")
            .smusAssetTechnicalName("String0")
            .smusAssetType("String0")
            .smusAssetRevision("String0")
            .smusAssetSourceIdentifier("String0")
            .smusSubscribedAssetProjectName("String0")
            .smusSubscribedAssetRequestorName("String0")
            .smusSubscribedAssetRequestReason("String0")
            .smusSubscribedAssetRequestDate(123456789L)
            .smusSubscribedAssetApproverName("String0")
            .smusSubscribedAssetApprovedReason("String0")
            .smusSubscribedAssetApprovalDate(123456789L)
            .smusSubscribedAssetColumnAccessInfo("String0")
            ...
            .smusAssetSchema(SageMakerUnifiedStudioAssetSchema.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSageMakerUnifiedStudioSubscribedAsset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SageMakerUnifiedStudioSubscribedAsset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SageMakerUnifiedStudioSubscribedAsset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SageMakerUnifiedStudioSubscribedAsset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SageMakerUnifiedStudioSubscribedAsset frodo = MockAtlanTenant.client.readValue(serialized, SageMakerUnifiedStudioSubscribedAsset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerUnifiedStudioSubscribedAsset,");
