...
public class AIModelVersionTest {

    private final AIModelVersion full = AIModelVersion._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAIModelVersion() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AIModelVersion,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AIModelVersion via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AIModelVersion,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AIModelVersion frodo = MockAtlanTenant.client.readValue(serialized, AIModelVersion.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AIModelVersion,");
