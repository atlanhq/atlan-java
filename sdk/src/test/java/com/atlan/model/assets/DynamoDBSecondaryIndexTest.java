...
public class DynamoDBSecondaryIndexTest {

    private final DynamoDBSecondaryIndex full = DynamoDBSecondaryIndex._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDynamoDBSecondaryIndex() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DynamoDBSecondaryIndex,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DynamoDBSecondaryIndex via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DynamoDBSecondaryIndex,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DynamoDBSecondaryIndex frodo = MockAtlanTenant.client.readValue(serialized, DynamoDBSecondaryIndex.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DynamoDBSecondaryIndex,");
