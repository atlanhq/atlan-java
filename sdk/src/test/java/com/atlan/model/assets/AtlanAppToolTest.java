...
public class AtlanAppToolTest {

    private final AtlanAppTool full = AtlanAppTool._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .atlanAppToolInputSchema("String0")
            .atlanAppToolOutputSchema("String0")
            .atlanAppToolTaskQueue("String0")
    ...
    @Test
    void serdeCycleAtlanAppTool() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AtlanAppTool,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AtlanAppTool via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AtlanAppTool,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AtlanAppTool frodo = MockAtlanTenant.client.readValue(serialized, AtlanAppTool.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AtlanAppTool,");
