...
public class DbtMetricTest {
    ...
    private final DbtMetric full = DbtMetric._internal()
            .guid("guid")
            ...
            .dbtMetricFilter(DbtMetricFilter.builder()
                    .dbtMetricFilterColumnQualifiedName("String0")
                    .dbtMetricFilterField("String0")
                    .dbtMetricFilterOperator("String0")
                    .dbtMetricFilterValue("String0")
                    .build())
            .dbtMetricFilter(DbtMetricFilter.builder()
                    .dbtMetricFilterColumnQualifiedName("String1")
                    .dbtMetricFilterField("String1")
                    .dbtMetricFilterOperator("String1")
                    .dbtMetricFilterValue("String1")
                    .build())
            .dbtMetricFilter("String0")
            .dbtMetricWindow("String0")
            .dbtMetricCumulativePeriodAgg("String0")
            .dbtMetricConversionCalculation("String0")
            ...
            .dbtMetricFilterColumn(Column.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dbtMetricFilterColumn(Column.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDbtMetric() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtMetric,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtMetric via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtMetric,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtMetric frodo = MockAtlanTenant.client.readValue(serialized, DbtMetric.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtMetric,");
