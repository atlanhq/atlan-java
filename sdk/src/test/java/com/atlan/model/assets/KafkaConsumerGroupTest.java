...
public class KafkaConsumerGroupTest {
    ...
    private final KafkaConsumerGroup full = KafkaConsumerGroup._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleKafkaConsumerGroup() throws IOException {
        assertNotNull(full, "Unable to build sample instance of KafkaConsumerGroup,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting KafkaConsumerGroup via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of KafkaConsumerGroup,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final KafkaConsumerGroup frodo = MockAtlanTenant.client.readValue(serialized, KafkaConsumerGroup.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of KafkaConsumerGroup,");
