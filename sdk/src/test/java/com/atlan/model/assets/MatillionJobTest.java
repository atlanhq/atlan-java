...
public class MatillionJobTest {
    ...
    private final MatillionJob full = MatillionJob._internal()
            .guid("guid")
            ...
            .matillionComponent(MatillionComponent.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleMatillionJob() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MatillionJob,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MatillionJob via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MatillionJob,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MatillionJob frodo = MockAtlanTenant.client.readValue(serialized, MatillionJob.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MatillionJob,");
