...
public class SAPBWDTPTest {

    private final SAPBWDTP full = SAPBWDTP._internal()
            .guid("guid")
            ...
            .sapBwProcess(SAPProcess.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwProcess(SAPProcess.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSAPBWDTP() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWDTP,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWDTP via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWDTP,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWDTP frodo = MockAtlanTenant.client.readValue(serialized, SAPBWDTP.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWDTP,");
