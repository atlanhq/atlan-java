...
public class APISpecTest {
    ...
    private final APISpec full = APISpec._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAPISpec() throws IOException {
        assertNotNull(full, "Unable to build sample instance of APISpec,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting APISpec via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of APISpec,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final APISpec frodo = MockAtlanTenant.client.readValue(serialized, APISpec.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of APISpec,");
