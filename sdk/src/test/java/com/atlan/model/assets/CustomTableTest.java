...
public class CustomTableTest {
    ...
    private static final CustomTable full = CustomTable._internal()
            .guid("guid")
            ...
            .customDatasetName("String0")
            .customDatasetQualifiedName("String0")
            .customSourceId("String0")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .customDataset(CustomDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .customField(CustomField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .customField(CustomField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .customRating(CustomRatings.builder()
                    .customRatingFrom("String0")
                    .customRatingOf(123456789L)
                    .build())
            .customRating(CustomRatings.builder()
                    .customRatingFrom("String1")
                    .customRatingOf(987654321L)
                    .build())
            .build();

    private static final int hash = full.hashCode();
    private static CustomTable frodo;
    private static String serialized;

    @Test(groups = {"CustomTable.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CustomTable.serialize"},
            dependsOnGroups = {"CustomTable.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CustomTable.deserialize"},
            dependsOnGroups = {"CustomTable.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = Atlan.getDefaultClient().readValue(serialized, CustomTable.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CustomTable.equivalency"},
            dependsOnGroups = {"CustomTable.serialize", "CustomTable.deserialize"})
