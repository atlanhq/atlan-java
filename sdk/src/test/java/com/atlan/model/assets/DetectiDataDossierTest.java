...
public class DetectiDataDossierTest {

    private static final DetectiDataDossier full = DetectiDataDossier._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .detectiDataDossierName("String0")
            .detectiDataDossierQualifiedName("String0")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .detectiDataDossierElement(DetectiDataDossierElement.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .detectiDataDossierElement(
                    DetectiDataDossierElement.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .detectiDataPrivacyClassification("String0")
            .detectiDataTrustScore(123456789L)
            .build();

    private static final int hash = full.hashCode();
    private static DetectiDataDossier frodo;
    private static String serialized;

    @Test(groups = {"DetectiDataDossier.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DetectiDataDossier.serialize"},
            dependsOnGroups = {"DetectiDataDossier.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DetectiDataDossier.deserialize"},
            dependsOnGroups = {"DetectiDataDossier.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = Atlan.getDefaultClient().readValue(serialized, DetectiDataDossier.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DetectiDataDossier.equivalency"},
            dependsOnGroups = {"DetectiDataDossier.serialize", "DetectiDataDossier.deserialize"})
