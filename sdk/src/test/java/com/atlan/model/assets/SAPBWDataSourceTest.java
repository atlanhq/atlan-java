...
public class SAPBWDataSourceTest {

    private final SAPBWDataSource full = SAPBWDataSource._internal()
            .guid("guid")
            ...
            .sapBwLogicalSystem("String0")
            .sapBwSourceType("String0")
            .sapBwDeltaMethod("String0")
            .sapBwDataSourceField(SAPBWDataSourceField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleSAPBWDataSource() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWDataSource,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWDataSource via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWDataSource,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWDataSource frodo = MockAtlanTenant.client.readValue(serialized, SAPBWDataSource.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWDataSource,");
