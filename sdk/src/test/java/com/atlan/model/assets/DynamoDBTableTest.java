...
public class DynamoDBTableTest {
    ...
    private final DynamoDBTable full = DynamoDBTable._internal()
            ...
            .dynamoDBGlobalSecondaryIndex(DynamoDBGlobalSecondaryIndex.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dynamoDBGlobalSecondaryIndex(DynamoDBGlobalSecondaryIndex.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dynamoDBLocalSecondaryIndex(DynamoDBLocalSecondaryIndex.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dynamoDBLocalSecondaryIndex(DynamoDBLocalSecondaryIndex.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dynamoDBColumn(DynamoDBAttribute.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dynamoDBColumn(DynamoDBAttribute.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
