...
public class TypeRegistryAttributeTest {
    ...
    private static final TypeRegistryAttribute full = TypeRegistryAttribute._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .typeRegistryDefinedBy(TypeRegistryWorkspaceStruct.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryEntity(TypeRegistryWorkspaceEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
