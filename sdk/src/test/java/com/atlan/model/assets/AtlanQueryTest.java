...
public class AtlanQueryTest {
    ...
    private final AtlanQuery full = AtlanQuery._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .build())
            .rawQuery("String0")
            .longRawQuery("String0")
            .rawQueryText("String0")
            .defaultSchemaQualifiedName("String0")
            .defaultDatabaseQualifiedName("String0")
            .variablesSchemaBase64("String0")
            .isPrivate(true)
            .isSqlSnippet(true)
            .parentQualifiedName("String0")
            .collectionQualifiedName("String0")
            .isVisualQuery(true)
            .visualBuilderSchemaBase64("String0")
    ...
    @Test
    void serdeCycleAtlanQuery() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AtlanQuery,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AtlanQuery via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AtlanQuery,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AtlanQuery frodo = MockAtlanTenant.client.readValue(serialized, AtlanQuery.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AtlanQuery,");
