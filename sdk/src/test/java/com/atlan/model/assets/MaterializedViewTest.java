...
public class MaterializedViewTest {
    ...
    private final MaterializedView full = MaterializedView._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .build())
            .refreshMode("String0")
            .refreshMethod("String0")
            .staleness("String0")
            .staleSinceDate(123456789L)
    ...
    @Test
    void serdeCycleMaterializedView() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MaterializedView,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MaterializedView via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MaterializedView,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MaterializedView frodo = MockAtlanTenant.client.readValue(serialized, MaterializedView.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MaterializedView,");
