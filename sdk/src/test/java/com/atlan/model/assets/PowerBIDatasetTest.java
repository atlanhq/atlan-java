...
public class PowerBIDatasetTest {
    ...
    private final PowerBIDataset full = PowerBIDataset._internal()
            .guid("guid")
            ...
            .datasource(PowerBIDatasource.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .datasource(PowerBIDatasource.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .table(PowerBITable.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCyclePowerBIDataset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PowerBIDataset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PowerBIDataset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PowerBIDataset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PowerBIDataset frodo = MockAtlanTenant.client.readValue(serialized, PowerBIDataset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PowerBIDataset,");
