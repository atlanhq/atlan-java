...
public class CassandraViewTest {
    ...
    private final CassandraView full = CassandraView._internal()
            .guid("guid")
            ...
            .putCassandraViewCaching("String0", "String0")
            .putCassandraViewCaching("String1", "String1")
            .cassandraViewComment("String0")
            .putCassandraViewCompaction("String0", "String0")
            .putCassandraViewCompaction("String1", "String1")
    ...
    @Test
    void serdeCycleCassandraView() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CassandraView,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CassandraView via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CassandraView,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CassandraView frodo = MockAtlanTenant.client.readValue(serialized, CassandraView.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CassandraView,");
