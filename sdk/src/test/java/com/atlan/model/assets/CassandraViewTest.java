...
public class CassandraViewTest {
    ...
    private static final CassandraView full = CassandraView._internal()
            .guid("guid")
            ...
            .cassandraViewBloomFilterFPChance(123.456)
            .cassandraViewCRCCheckChance(123.456)
            .putCassandraViewCaching("key1", "value1")
            .putCassandraViewCaching("key2", "value2")
            .cassandraViewComment("String0")
            .putCassandraViewCompaction("key1", "value1")
            .putCassandraViewCompaction("key2", "value2")
            .cassandraViewDCLocalReadRepairChance(123.456)
            .cassandraViewDefaultTTL(123456789L)
            .cassandraViewGCGraceSeconds(123456789L)
            .cassandraViewIncludeAllColumns(true)
            .cassandraViewMaxIndexInterval(123456789L)
            .cassandraViewMembtableFlushPeriodInMS(123456789L)
            .cassandraViewMinIndexInterval(123456789L)
            .cassandraViewQuery("String0")
            .cassandraViewReadRepairInterval(123456789L)
            .cassandraViewSpeculativeRetry("String0")
            .cassandraViewTableId("String0")
            .cassandraViewWhereClause("String0")
            .build();

    private static final int hash = full.hashCode();
    private static CassandraView frodo;
    private static String serialized;

    @Test(groups = {"CassandraView.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CassandraView.serialize"},
            dependsOnGroups = {"CassandraView.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CassandraView.deserialize"},
            dependsOnGroups = {"CassandraView.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CassandraView.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CassandraView.equivalency"},
            dependsOnGroups = {"CassandraView.serialize", "CassandraView.deserialize"})
