...
public class SnowflakeAIModelContextTest {
    ...
    private final SnowflakeAIModelContext full = SnowflakeAIModelContext._internal()
            .guid("guid")
            ...
            .modelVersion(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelVersion(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .snowflakeAIModelVersion(SnowflakeAIModelVersion.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSnowflakeAIModelContext() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeAIModelContext,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeAIModelContext via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeAIModelContext,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeAIModelContext frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeAIModelContext.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeAIModelContext,");
