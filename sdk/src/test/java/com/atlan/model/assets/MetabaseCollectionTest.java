...
public class MetabaseCollectionTest {
    ...
    private final MetabaseCollection full = MetabaseCollection._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .metabaseSlug("String0")
            .metabaseColor("String0")
            .metabaseNamespace("String0")
            ...
            .metabaseDashboard(MetabaseDashboard.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .metabaseDashboard(MetabaseDashboard.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleMetabaseCollection() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MetabaseCollection,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MetabaseCollection via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MetabaseCollection,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MetabaseCollection frodo = MockAtlanTenant.client.readValue(serialized, MetabaseCollection.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MetabaseCollection,");
