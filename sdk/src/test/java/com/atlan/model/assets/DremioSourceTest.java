...
public class DremioSourceTest {

    private final DremioSource full = DremioSource._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .dremioSourceType("String0")
            .dremioSourceConnectionConfig("String0", "String0")
            .dremioSourceConnectionConfig("String1", "String1")
            .dremioSourceAccelerationSetting("String0", "String0")
            .dremioSourceAccelerationSetting("String1", "String1")
            .dremioSourceMetadataPolicy("String0", "String0")
            .dremioSourceMetadataPolicy("String1", "String1")
            .dremioSourceHealthStatus("String0")
            .dremioSourceHealthStatusMessage("String0")
            .dremioFolder(DremioFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dremioFolder(DremioFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDremioSource() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DremioSource,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DremioSource via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DremioSource,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DremioSource frodo = MockAtlanTenant.client.readValue(serialized, DremioSource.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DremioSource,");
