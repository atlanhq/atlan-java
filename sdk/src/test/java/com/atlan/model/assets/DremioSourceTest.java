...
public class DremioSourceTest {
    ...
    private final DremioSource full = DremioSource._internal()
            ...
            .dremioSourceAccelerationSetting("key1", "value1")
            .dremioSourceAccelerationSetting("key2", "value2")
            .dremioSourceConnectionConfig("key1", "value1")
            .dremioSourceConnectionConfig("key2", "value2")
            .dremioSourceHealthStatus("String0")
            .dremioSourceHealthStatusMessage("String0")
            .dremioSourceMetadataPolicy("key1", "value1")
            .dremioSourceMetadataPolicy("key2", "value2")
