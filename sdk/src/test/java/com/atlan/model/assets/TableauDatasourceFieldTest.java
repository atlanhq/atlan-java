...
public class TableauDatasourceFieldTest {
    ...
    private final TableauDatasourceField full = TableauDatasourceField._internal()
            .guid("guid")
            ...
            .fullyQualifiedName("String0")
            .tableauDatasourceFieldDataCategory("String0")
            .tableauDatasourceFieldRole("String0")
            .tableauDatasourceFieldDataType("String0")
            .upstreamTable("String0", "String0")
            .upstreamTable("String1", "String1")
            .tableauDatasourceFieldFormula("String0")
            .tableauDatasourceFieldBinSize("String0")
            .upstreamColumn("String0", "String0")
            .upstreamColumn("String1", "String1")
            .upstreamField("String0", "String0")
            .upstreamField("String1", "String1")
            .datasourceFieldType("String0")
    ...
    @Test
    void serdeCycleTableauDatasourceField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of TableauDatasourceField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting TableauDatasourceField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of TableauDatasourceField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final TableauDatasourceField frodo = MockAtlanTenant.client.readValue(serialized, TableauDatasourceField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of TableauDatasourceField,");
