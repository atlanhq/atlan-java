...
public class SAPBWInfoObjectTest {

    private final SAPBWInfoObject full = SAPBWInfoObject._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .sapBwObjectStatus("String0")
            .sapBwParentName("String0")
            .sapBwParentQualifiedName("String0")
            .sapBwInfoObjectName("String0")
            .sapBwInfoObjectQualifiedName("String0")
            .sapBwLength(123456789L)
            ...
            .sapBwFieldName("String0")
            .sapBwInfoArea(SAPBWInfoArea.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwMappedInfoSourceField(SAPBWInfoSourceField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwMappedInfoSourceField(
                    SAPBWInfoSourceField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwMappedDataSourceField(SAPBWDataSourceField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwMappedDataSourceField(
                    SAPBWDataSourceField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwMappedAdsoField(SAPBWADSOField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwMappedAdsoField(SAPBWADSOField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwMappedCompositeProviderField(
                    SAPBWCompositeProviderField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwMappedCompositeProviderField(
                    SAPBWCompositeProviderField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwMappedQueryElement(SAPBWQueryElement.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwMappedQueryElement(
                    SAPBWQueryElement.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwRelatedInfoObject(SAPBWInfoObject.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwRelatedInfoObject(
                    SAPBWInfoObject.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwInfoObject(SAPBWInfoObject.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwInfoObject(SAPBWInfoObject.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSAPBWInfoObject() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWInfoObject,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWInfoObject via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWInfoObject,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWInfoObject frodo = MockAtlanTenant.client.readValue(serialized, SAPBWInfoObject.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWInfoObject,");
