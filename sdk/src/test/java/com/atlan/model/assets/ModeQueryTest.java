...
public class ModeQueryTest {
    ...
    private final ModeQuery full = ModeQuery._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .modeRawQuery("String0")
            .modeReportImportCount(123456789L)
            ...
            .modeChart(ModeChart.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modeChart(ModeChart.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleModeQuery() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ModeQuery,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ModeQuery via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ModeQuery,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ModeQuery frodo = MockAtlanTenant.client.readValue(serialized, ModeQuery.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ModeQuery,");
