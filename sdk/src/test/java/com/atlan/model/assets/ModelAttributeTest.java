...
public class ModelAttributeTest {
    ...
    private final ModelAttribute full = ModelAttribute._internal()
            .guid("guid")
            ...
            .modelAttributePrecision(123456789L)
            .modelAttributeScale(123456789L)
            .modelAttributeDataType("String0")
            ...
            .modelAttributeMappedToAttribute(ModelAttribute.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelAttributeMappedToAttribute(ModelAttribute.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelAttributeMappedFromAttribute(ModelAttribute.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelAttributeMappedFromAttribute(ModelAttribute.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelAttributeImplementedByAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelAttributeImplementedByAsset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelAttributeRelatedFromAttribute(ModelAttributeAssociation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelAttributeRelatedFromAttribute(ModelAttributeAssociation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelAttributeRelatedToAttribute(ModelAttributeAssociation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelAttributeRelatedToAttribute(ModelAttributeAssociation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleModelAttribute() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ModelAttribute,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ModelAttribute via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ModelAttribute,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ModelAttribute frodo = MockAtlanTenant.client.readValue(serialized, ModelAttribute.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ModelAttribute,");
