...
public class TypeRegistryAssociationRelationshipTest {

    private static final TypeRegistryAssociationRelationship full = TypeRegistryAssociationRelationship._internal()
            .guid("guid")
            ...
            .typeRegistryEnd1(TypeRegistryEndDef.builder()
                    .typeRegistryType("String0")
                    .typeRegistryReferredToAs("String0")
                    .typeRegistryDescription("String0")
                    .build())
            .typeRegistryEnd2(TypeRegistryEndDef.builder()
                    .typeRegistryType("String0")
                    .typeRegistryReferredToAs("String0")
                    .typeRegistryDescription("String0")
                    .build())
            .typeRegistryManyToMany(true)
            .build();

    private static final int hash = full.hashCode();
    private static TypeRegistryAssociationRelationship frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryAssociationRelationship.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryAssociationRelationship.serialize"},
            dependsOnGroups = {"TypeRegistryAssociationRelationship.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryAssociationRelationship.deserialize"},
            dependsOnGroups = {"TypeRegistryAssociationRelationship.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryAssociationRelationship.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryAssociationRelationship.equivalency"},
            dependsOnGroups = {
                "TypeRegistryAssociationRelationship.serialize",
                "TypeRegistryAssociationRelationship.deserialize"
            })
