...
public class SalesforceDashboard extends Asset implements ISalesforceDashboard, ISalesforce, ISaaS, ICatalog, IAsset, IReferenceable {
     ...
     */
    @JsonIgnore
    public static SalesforceDashboard get(AtlanClient client, String id, boolean includeAllRelationships) throws AtlanException {
        if (id == null) {
     ...
     */
    @JsonIgnore
    public static SalesforceDashboard get(AtlanClient client, String id, Collection<AtlanField> attributes) throws AtlanException {
...
/**
    ...
    public abstract static class SalesforceDashboardBuilder<C extends SalesforceDashboard, B extends SalesforceDashboardBuilder<C, B>>
     ...
     * @throws AtlanException on any API problems
     */
    public static SalesforceDashboard removeDescription(AtlanClient client, String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SalesforceDashboard removeOwners(AtlanClient client, String qualifiedName, String name) throws AtlanException {
    ...
    public static SalesforceDashboard updateCertificate(
            ...
            throws AtlanException {
        return (SalesforceDashboard) Asset.updateCertificate(client, _internal(), TYPE_NAME, qualifiedName, certificate, message);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static SalesforceDashboard removeCertificate(AtlanClient client, String qualifiedName, String name) throws AtlanException {
    ...
    public static SalesforceDashboard updateAnnouncement(
            ...
            throws AtlanException {
        return (SalesforceDashboard) Asset.updateAnnouncement(client, _internal(), TYPE_NAME, qualifiedName, type, title, message);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static SalesforceDashboard replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    @Deprecated
    public static SalesforceDashboard appendAtlanTags(AtlanClient client, String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
