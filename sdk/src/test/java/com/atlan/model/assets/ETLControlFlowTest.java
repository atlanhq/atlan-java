...
public class ETLControlFlowTest {

    private static final ETLControlFlow full = ETLControlFlow._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .etlContainsOperation(ETLControlFlowOperation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .etlContainsOperation(
    ...
    private static ETLControlFlow frodo;
    private static String serialized;

    @Test(groups = {"ETLControlFlow.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"ETLControlFlow.serialize"},
            dependsOnGroups = {"ETLControlFlow.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"ETLControlFlow.deserialize"},
            dependsOnGroups = {"ETLControlFlow.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, ETLControlFlow.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"ETLControlFlow.equivalency"},
            dependsOnGroups = {"ETLControlFlow.serialize", "ETLControlFlow.deserialize"})
