...
public class FlowV02DataOperationTest {

    private static final FlowV02DataOperation full = FlowV02DataOperation._internal()
            .guid("guid")
    ...
    private static FlowV02DataOperation frodo;
    private static String serialized;

    @Test(groups = {"FlowV02DataOperation.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowV02DataOperation.serialize"},
            dependsOnGroups = {"FlowV02DataOperation.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowV02DataOperation.deserialize"},
            dependsOnGroups = {"FlowV02DataOperation.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowV02DataOperation.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowV02DataOperation.equivalency"},
            dependsOnGroups = {"FlowV02DataOperation.serialize", "FlowV02DataOperation.deserialize"})
