...
public class SnowflakeSemanticMetricTest {

    private final SnowflakeSemanticMetric full = SnowflakeSemanticMetric._internal()
            .guid("guid")
            ...
            .metricType("String0")
            .metricSQL("String0")
            .metricFilters("String0")
            .metricTimeGrain("String0")
            .metricTimeGrain("String1")
            .dqIsPartOfContract(true)
            .snowflakeSemanticViewQualifiedName("String0")
            .snowflakeSemanticViewName("String0")
            .snowflakeSemanticTableQualifiedName("String0")
            .snowflakeSemanticTableName("String0")
            .snowflakeMetricAdditiveDimension("String0")
            .snowflakeMetricAdditiveDimension("String1")
            .snowflakeMetricNonAdditiveDimension("String0")
            .snowflakeMetricNonAdditiveDimension("String1")
            .snowflakeMetricUsingRelationship("String0")
            .snowflakeMetricUsingRelationship("String1")
            ...
            .metricTimestampColumn(Column.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .metricDimensionColumn(Column.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .metricDimensionColumn(Column.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSnowflakeSemanticMetric() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeSemanticMetric,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeSemanticMetric via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeSemanticMetric,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeSemanticMetric frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeSemanticMetric.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeSemanticMetric,");
