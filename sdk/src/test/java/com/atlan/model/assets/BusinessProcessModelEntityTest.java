...
public class BusinessProcessModelEntityTest {

    private static final BusinessProcessModelEntity full = BusinessProcessModelEntity._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .businessProcessModelType("String0")
    ...
    private static BusinessProcessModelEntity frodo;
    private static String serialized;

    @Test(groups = {"BusinessProcessModelEntity.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"BusinessProcessModelEntity.serialize"},
            dependsOnGroups = {"BusinessProcessModelEntity.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"BusinessProcessModelEntity.deserialize"},
            dependsOnGroups = {"BusinessProcessModelEntity.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, BusinessProcessModelEntity.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"BusinessProcessModelEntity.equivalency"},
            dependsOnGroups = {"BusinessProcessModelEntity.serialize", "BusinessProcessModelEntity.deserialize"})
