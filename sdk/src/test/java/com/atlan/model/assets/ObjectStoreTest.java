...
public class ObjectStoreTest {
    ...
    private final ObjectStore full = ObjectStore._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleObjectStore() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ObjectStore,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ObjectStore via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ObjectStore,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ObjectStore frodo = MockAtlanTenant.client.readValue(serialized, ObjectStore.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ObjectStore,");
