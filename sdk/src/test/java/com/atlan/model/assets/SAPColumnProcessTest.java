...
public class SAPColumnProcessTest {

    private final SAPColumnProcess full = SAPColumnProcess._internal()
            .guid("guid")
            ...
            .sapBwTransformation(SAPBWTransformation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwTransformation(
                    SAPBWTransformation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSAPColumnProcess() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPColumnProcess,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPColumnProcess via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPColumnProcess,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPColumnProcess frodo = MockAtlanTenant.client.readValue(serialized, SAPColumnProcess.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPColumnProcess,");
