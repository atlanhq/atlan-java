...
public class StakeholderTest {
    ...
    private final Stakeholder full = Stakeholder._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .stakeholderDataDomain(DataDomain.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .stakeholderDomainQualifiedName("String0")
            .stakeholderTitle(StakeholderTitle.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .stakeholderTitleGuid("String0")
            .build();
    ...
    @Test
    void serdeCycleStakeholder() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Stakeholder,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Stakeholder via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Stakeholder,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Stakeholder frodo = MockAtlanTenant.client.readValue(serialized, Stakeholder.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Stakeholder,");
