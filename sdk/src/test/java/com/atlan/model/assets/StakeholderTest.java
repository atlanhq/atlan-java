...
public class StakeholderTest {
    ...
    private static final Stakeholder full = Stakeholder._internal()
            .guid("guid")
    ...
    private static Stakeholder frodo;
    private static String serialized;

    @Test(groups = {"Stakeholder.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"Stakeholder.serialize"},
            dependsOnGroups = {"Stakeholder.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"Stakeholder.deserialize"},
            dependsOnGroups = {"Stakeholder.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, Stakeholder.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"Stakeholder.equivalency"},
            dependsOnGroups = {"Stakeholder.serialize", "Stakeholder.deserialize"})
