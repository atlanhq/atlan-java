...
public class SqlInsightJoinTest {

    private final SqlInsightJoin full = SqlInsightJoin._internal()
            .guid("guid")
            ...
            .sqlInsightJoinSourceDatasetQualifiedName("String0")
            .sqlInsightJoinJoinedDatasetQualifiedName("String0")
            .sqlInsightJoinType(SqlInsightJoinType.INNER)
            .sqlInsightJoinCardinality(SqlInsightJoinCardinality.ONE_TO_ONE)
            .sqlInsightJoinWhenToUse("String0")
            .sqlInsightJoinColumnPair(SqlInsightJoinColumnPair.builder()
                    .sqlInsightJoinColumnPairSourceColumnQualifiedName("String0")
                    .sqlInsightJoinColumnPairJoinedColumnQualifiedName("String0")
                    .build())
            .sqlInsightJoinColumnPair(SqlInsightJoinColumnPair.builder()
                    .sqlInsightJoinColumnPairSourceColumnQualifiedName("String1")
                    .sqlInsightJoinColumnPairJoinedColumnQualifiedName("String1")
                    .build())
            .sqlInsightJoinQueryCount(123)
            .sqlInsightJoinUniqueUsers(123)
            .sqlInsightJoinLastSeenAt(123456789L)
            .sqlInsightJoinExampleQuery(PopularityInsights.builder()
                    .recordUser("String0")
                    .recordQuery("String0")
                    .recordQueryDuration(123456789L)
                    .recordQueryCount(123456789L)
            ...
            .sqlInsightJoinExampleQuery(PopularityInsights.builder()
                    ...
                    .recordWarehouse("String1")
                    .build())
            .sqlInsightSourceDataset(Table.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sqlInsightJoinedDataset(Table.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleSqlInsightJoin() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SqlInsightJoin,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SqlInsightJoin via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SqlInsightJoin,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SqlInsightJoin frodo = MockAtlanTenant.client.readValue(serialized, SqlInsightJoin.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SqlInsightJoin,");
