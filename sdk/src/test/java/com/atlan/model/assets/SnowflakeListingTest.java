...
public class SnowflakeListingTest {

    private final SnowflakeListing full = SnowflakeListing._internal()
            .guid("guid")
            ...
            .snowflakeListingTitle("String0")
            .snowflakeListingSubtitle("String0")
            .snowflakeListingUniformListingLocator("String0")
            .snowflakeListingState(SnowflakeListingState.PUBLISHED)
            .snowflakeListingDistribution(SnowflakeListingDistribution.ORGANIZATION)
            .snowflakeListingIsShare(true)
            .snowflakeListingIsApplication(true)
            .snowflakeListingApplicationPackage("String0")
            .snowflakeListingCategory("String0")
            .snowflakeListingCategory("String1")
            .snowflakeListingDataAttributes("String0")
            .snowflakeListingTerms("String0")
            .snowflakeListingProfile("String0")
            .snowflakeListingSupportContact("String0")
            .snowflakeListingResharing("String0")
            .snowflakeListingAutoFulfillment("String0")
            .snowflakeListingTargets("String0")
            ...
            .snowflakeShare(SnowflakeShare.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .snowflakeShare(SnowflakeShare.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSnowflakeListing() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeListing,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeListing via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeListing,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeListing frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeListing.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeListing,");
