...
public class MicroStrategyCubeTest {
    ...
    private static MicroStrategyCube frodo;
    private static String serialized;

    @Test(groups = {"MicroStrategyCube.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"MicroStrategyCube.serialize"},
            dependsOnGroups = {"MicroStrategyCube.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"MicroStrategyCube.deserialize"},
            dependsOnGroups = {"MicroStrategyCube.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyCube.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"MicroStrategyCube.equivalency"},
            dependsOnGroups = {"MicroStrategyCube.serialize", "MicroStrategyCube.deserialize"})
