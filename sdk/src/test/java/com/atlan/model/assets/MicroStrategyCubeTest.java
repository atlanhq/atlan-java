...
public class MicroStrategyCubeTest {
    ...
    private final MicroStrategyCube full = MicroStrategyCube._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleMicroStrategyCube() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MicroStrategyCube,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MicroStrategyCube via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MicroStrategyCube,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MicroStrategyCube frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyCube.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MicroStrategyCube,");
