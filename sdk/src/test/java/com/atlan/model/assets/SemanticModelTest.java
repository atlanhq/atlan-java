...
public class SemanticModelTest {
    ...
    private final SemanticModel full = SemanticModel._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSemanticModel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SemanticModel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SemanticModel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SemanticModel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SemanticModel frodo = MockAtlanTenant.client.readValue(serialized, SemanticModel.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SemanticModel,");
