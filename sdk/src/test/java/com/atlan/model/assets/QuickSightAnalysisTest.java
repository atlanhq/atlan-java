...
public class QuickSightAnalysisTest {
    ...
    private final QuickSightAnalysis full = QuickSightAnalysis._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .quickSightAnalysisStatus(QuickSightAnalysisStatus.CREATION_IN_PROGRESS)
            .quickSightAnalysisCalculatedField("String0")
            .quickSightAnalysisCalculatedField("String1")
            .quickSightAnalysisParameterDeclaration("String0")
            .quickSightAnalysisParameterDeclaration("String1")
            .quickSightAnalysisFilterGroup("String0")
            .quickSightAnalysisFilterGroup("String1")
            ...
            .quickSightAnalysisFolder(QuickSightFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .quickSightAnalysisFolder(QuickSightFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .quickSightAnalysisVisual(QuickSightAnalysisVisual.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .quickSightAnalysisVisual(QuickSightAnalysisVisual.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleQuickSightAnalysis() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QuickSightAnalysis,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QuickSightAnalysis via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QuickSightAnalysis,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QuickSightAnalysis frodo = MockAtlanTenant.client.readValue(serialized, QuickSightAnalysis.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QuickSightAnalysis,");
