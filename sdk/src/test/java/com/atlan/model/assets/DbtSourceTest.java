...
public class DbtSourceTest {
    ...
    private final DbtSource full = DbtSource._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDbtSource() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtSource,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtSource via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtSource,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtSource frodo = MockAtlanTenant.client.readValue(serialized, DbtSource.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtSource,");
