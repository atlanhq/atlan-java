...
public class DatabricksVolumeTest {

    private final DatabricksVolume full = DatabricksVolume._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .databricksVolumeOwner("String0")
            .databricksVolumeExternalLocation("String0")
            .databricksVolumeType(DatabricksVolumeType.MANAGED)
            ...
            .databricksVolumeSchema(Schema.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .databricksVolumePath(DatabricksVolumePath.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .databricksVolumePath(DatabricksVolumePath.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDatabricksVolume() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DatabricksVolume,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DatabricksVolume via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DatabricksVolume,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DatabricksVolume frodo = MockAtlanTenant.client.readValue(serialized, DatabricksVolume.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DatabricksVolume,");
