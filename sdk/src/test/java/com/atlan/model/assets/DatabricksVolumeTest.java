...
public class DatabricksVolumeTest {
    ...
    private static final DatabricksVolume full = DatabricksVolume._internal()
            .guid("guid")
    ...
    private static DatabricksVolume frodo;
    ...
    @Test(groups = {"DatabricksVolume.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DatabricksVolume.serialize"},
            dependsOnGroups = {"DatabricksVolume.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DatabricksVolume.deserialize"},
            dependsOnGroups = {"DatabricksVolume.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DatabricksVolume.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DatabricksVolume.equivalency"},
            dependsOnGroups = {"DatabricksVolume.serialize", "DatabricksVolume.deserialize"})
