...
public class ETLControlFlowOperationTest {

    private static final ETLControlFlowOperation full = ETLControlFlowOperation._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .etlFinishedAt(123456789L)
            .etlSchedule("String0")
            .etlStartedAt(123456789L)
            .etlStatus("String0")
            ...
            .etlExpression("String0")
            .etlPredecessor(ETLControlFlowOperation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .etlPredecessor(
                    ETLControlFlowOperation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .etlSuccessor(ETLControlFlowOperation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .etlSuccessor(ETLControlFlowOperation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static ETLControlFlowOperation frodo;
    private static String serialized;

    @Test(groups = {"ETLControlFlowOperation.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"ETLControlFlowOperation.serialize"},
            dependsOnGroups = {"ETLControlFlowOperation.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"ETLControlFlowOperation.deserialize"},
            dependsOnGroups = {"ETLControlFlowOperation.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, ETLControlFlowOperation.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"ETLControlFlowOperation.equivalency"},
            dependsOnGroups = {"ETLControlFlowOperation.serialize", "ETLControlFlowOperation.deserialize"})
