...
public class SalesforceField extends Asset implements ISalesforceField, ISalesforce, ISaaS, ICatalog, IAsset, IReferenceable {
     ...
     */
    @JsonIgnore
    public static SalesforceField get(AtlanClient client, String id, boolean includeAllRelationships) throws AtlanException {
        if (id == null) {
     ...
     */
    @JsonIgnore
    public static SalesforceField get(AtlanClient client, String id, Collection<AtlanField> attributes) throws AtlanException {
...
/**
    ...
    public abstract static class SalesforceFieldBuilder<C extends SalesforceField, B extends SalesforceFieldBuilder<C, B>>
     ...
     * @throws AtlanException on any API problems
     */
    public static SalesforceField replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
