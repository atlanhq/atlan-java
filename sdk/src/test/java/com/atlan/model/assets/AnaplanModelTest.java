...
public class AnaplanModelTest {
    ...
    private final AnaplanModel full = AnaplanModel._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAnaplanModel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AnaplanModel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AnaplanModel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AnaplanModel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AnaplanModel frodo = MockAtlanTenant.client.readValue(serialized, AnaplanModel.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AnaplanModel,");
