...
public class AnaplanModelTest {

    private static final AnaplanModel full = AnaplanModel._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .anaplanModelName("String0")
            .anaplanModelQualifiedName("String0")
            .anaplanModuleName("String0")
            .anaplanModuleQualifiedName("String0")
            .anaplanSourceId("String0")
            .anaplanWorkspaceName("String0")
            .anaplanWorkspaceQualifiedName("String0")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .anaplanDimension(AnaplanDimension.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanDimension(AnaplanDimension.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanList(AnaplanList.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanList(AnaplanList.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanModule(AnaplanModule.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanModule(AnaplanModule.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanPage(AnaplanPage.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanPage(AnaplanPage.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanWorkspace(AnaplanWorkspace.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();

    private static final int hash = full.hashCode();
    private static AnaplanModel frodo;
    private static String serialized;

    @Test(groups = {"AnaplanModel.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AnaplanModel.serialize"},
            dependsOnGroups = {"AnaplanModel.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AnaplanModel.deserialize"},
            dependsOnGroups = {"AnaplanModel.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AnaplanModel.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AnaplanModel.equivalency"},
            dependsOnGroups = {"AnaplanModel.serialize", "AnaplanModel.deserialize"})
