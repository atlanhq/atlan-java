...
public class ThoughtspotColumnTest {
    ...
    private final ThoughtspotColumn full = ThoughtspotColumn._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleThoughtspotColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ThoughtspotColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ThoughtspotColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ThoughtspotColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ThoughtspotColumn frodo = MockAtlanTenant.client.readValue(serialized, ThoughtspotColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ThoughtspotColumn,");
