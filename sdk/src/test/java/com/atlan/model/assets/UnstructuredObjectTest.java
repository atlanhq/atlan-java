...
public class UnstructuredObjectTest {

    private final UnstructuredObject full = UnstructuredObject._internal()
            .guid("guid")
            ...
            .unstructuredObjectKey("String0")
            .unstructuredObjectSize(123456789L)
            .unstructuredObjectExtension("String0")
            .unstructuredObjectMimeType("String0")
            .unstructuredObjectContentLanguage("String0")
    ...
    @Test
    void serdeCycleUnstructuredObject() throws IOException {
        assertNotNull(full, "Unable to build sample instance of UnstructuredObject,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting UnstructuredObject via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of UnstructuredObject,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final UnstructuredObject frodo = MockAtlanTenant.client.readValue(serialized, UnstructuredObject.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of UnstructuredObject,");
