...
public class CognosColumnTest {
    ...
    private final CognosColumn full = CognosColumn._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCognosColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CognosColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CognosColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CognosColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CognosColumn frodo = MockAtlanTenant.client.readValue(serialized, CognosColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CognosColumn,");
