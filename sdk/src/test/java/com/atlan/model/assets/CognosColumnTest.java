...
public class CognosColumnTest {

    private static final CognosColumn full = CognosColumn._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .cognosColumnDatatype("String0")
            .cognosColumnNullable("String0")
            .cognosColumnRegularAggregate("String0")
    ...
    private static CognosColumn frodo;
    private static String serialized;

    @Test(groups = {"CognosColumn.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CognosColumn.serialize"},
            dependsOnGroups = {"CognosColumn.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CognosColumn.deserialize"},
            dependsOnGroups = {"CognosColumn.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CognosColumn.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CognosColumn.equivalency"},
            dependsOnGroups = {"CognosColumn.serialize", "CognosColumn.deserialize"})
