...
public class UnstructuredFolderTest {

    private final UnstructuredFolder full = UnstructuredFolder._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .unstructuredContainerName("String0")
            .unstructuredContainerQualifiedName("String0")
            .unstructuredParentFolderQualifiedName("String0")
            .addUnstructuredFolderHierarchy(Map.of("key1", "value1"))
            .addUnstructuredFolderHierarchy(Map.of("key2", "value2"))
            ...
            .unstructuredFolderCount(123456789L)
            .unstructuredObjectCount(123456789L)
            .unstructuredContainer(UnstructuredContainer.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .unstructuredChildFolder(UnstructuredFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .unstructuredChildFolder(
                    UnstructuredFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .unstructuredParentFolder(UnstructuredFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .unstructuredObject(UnstructuredObject.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .unstructuredObject(
                    UnstructuredObject.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleUnstructuredFolder() throws IOException {
        assertNotNull(full, "Unable to build sample instance of UnstructuredFolder,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting UnstructuredFolder via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of UnstructuredFolder,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final UnstructuredFolder frodo = MockAtlanTenant.client.readValue(serialized, UnstructuredFolder.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of UnstructuredFolder,");
