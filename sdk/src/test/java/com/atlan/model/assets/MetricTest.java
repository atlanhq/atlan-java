...
public class MetricTest {
    ...
    private final Metric full = Metric._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleMetric() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Metric,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Metric via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Metric,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Metric frodo = MockAtlanTenant.client.readValue(serialized, Metric.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Metric,");
