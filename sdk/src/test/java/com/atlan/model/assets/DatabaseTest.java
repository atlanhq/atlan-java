...
public class DatabaseTest {
    ...
    private final Database full = Database._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDatabase() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Database,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Database via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Database,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Database frodo = MockAtlanTenant.client.readValue(serialized, Database.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Database,");
