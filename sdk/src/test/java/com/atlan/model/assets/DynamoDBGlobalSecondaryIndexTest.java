...
public class DynamoDBGlobalSecondaryIndexTest {
    ...
    private final DynamoDBGlobalSecondaryIndex full = DynamoDBGlobalSecondaryIndex._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDynamoDBGlobalSecondaryIndex() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DynamoDBGlobalSecondaryIndex,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DynamoDBGlobalSecondaryIndex via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DynamoDBGlobalSecondaryIndex,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DynamoDBGlobalSecondaryIndex frodo =
                MockAtlanTenant.client.readValue(serialized, DynamoDBGlobalSecondaryIndex.class);
        assertNotNull(
                frodo,
                "Unable to reverse-read serialized value back into an instance of DynamoDBGlobalSecondaryIndex,");
