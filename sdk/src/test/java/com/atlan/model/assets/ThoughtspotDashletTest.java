...
public class ThoughtspotDashletTest {
    ...
    private final ThoughtspotDashlet full = ThoughtspotDashlet._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleThoughtspotDashlet() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ThoughtspotDashlet,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ThoughtspotDashlet via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ThoughtspotDashlet,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ThoughtspotDashlet frodo = MockAtlanTenant.client.readValue(serialized, ThoughtspotDashlet.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ThoughtspotDashlet,");
