...
public class GlossaryTest {
    ...
    private final Glossary full = Glossary._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleGlossary() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Glossary,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Glossary via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Glossary,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Glossary frodo = MockAtlanTenant.client.readValue(serialized, Glossary.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Glossary,");
