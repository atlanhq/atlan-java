...
public class SnowflakeSemanticViewTest {

    private final SnowflakeSemanticView full = SnowflakeSemanticView._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .snowflakeDefinition("String0")
            .semanticDimension(SemanticDimension.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .semanticDimension(SemanticDimension.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .semanticMeasure(SemanticMeasure.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .semanticMeasure(SemanticMeasure.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .semanticEntity(SemanticEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .semanticEntity(SemanticEntity.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .snowflakeSemanticViewSchema(Schema.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleSnowflakeSemanticView() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeSemanticView,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeSemanticView via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeSemanticView,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeSemanticView frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeSemanticView.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeSemanticView,");
