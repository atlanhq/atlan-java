...
public class SchemaRegistryVersionTest {

    private final SchemaRegistryVersion full = SchemaRegistryVersion._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .schemaRegistrySchemaType(SchemaRegistrySchemaType.AVRO)
            .schemaRegistrySchemaId("String0")
            ...
            .schemaRegistryVersionNumber("String0")
            .schemaRegistryVersionSchemaDefinition("String0")
            .schemaRegistryVersionSchemaType(SchemaRegistrySchemaType.AVRO)
            .schemaRegistrySubjectQualifiedName("String0")
    ...
    @Test
    void serdeCycleSchemaRegistryVersion() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SchemaRegistryVersion,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SchemaRegistryVersion via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SchemaRegistryVersion,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SchemaRegistryVersion frodo = MockAtlanTenant.client.readValue(serialized, SchemaRegistryVersion.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SchemaRegistryVersion,");
