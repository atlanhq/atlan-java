...
public class PowerBIAppTest {
    ...
    private final PowerBIApp full = PowerBIApp._internal()
            .guid("guid")
            ...
            .powerBIAppUser("String0", "String0")
            .powerBIAppUser("String1", "String1")
            .powerBIAppGroup("String0", "String0")
            .powerBIAppGroup("String1", "String1")
    ...
    @Test
    void serdeCyclePowerBIApp() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PowerBIApp,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PowerBIApp via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PowerBIApp,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PowerBIApp frodo = MockAtlanTenant.client.readValue(serialized, PowerBIApp.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PowerBIApp,");
