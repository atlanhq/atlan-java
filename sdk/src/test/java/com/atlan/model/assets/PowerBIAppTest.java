...
public class PowerBIAppTest {

    private static final PowerBIApp full = PowerBIApp._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .powerBIAppGroup(Map.of("key1", "value1"))
            .powerBIAppGroup(Map.of("key2", "value2"))
            .powerBIAppId("String0")
            .powerBIAppUser(Map.of("key1", "value1"))
            .powerBIAppUser(Map.of("key2", "value2"))
            .powerBIDashboard(PowerBIDashboard.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .powerBIDashboard(PowerBIDashboard.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .powerBIReport(PowerBIReport.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .powerBIReport(PowerBIReport.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static PowerBIApp frodo;
    private static String serialized;

    @Test(groups = {"PowerBIApp.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"PowerBIApp.serialize"},
            dependsOnGroups = {"PowerBIApp.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"PowerBIApp.deserialize"},
            dependsOnGroups = {"PowerBIApp.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, PowerBIApp.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"PowerBIApp.equivalency"},
            dependsOnGroups = {"PowerBIApp.serialize", "PowerBIApp.deserialize"})
