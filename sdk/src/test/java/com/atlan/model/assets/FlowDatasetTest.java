...
public class FlowDatasetTest {
    ...
    private final FlowDataset full = FlowDataset._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleFlowDataset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FlowDataset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FlowDataset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FlowDataset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FlowDataset frodo = MockAtlanTenant.client.readValue(serialized, FlowDataset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of FlowDataset,");
