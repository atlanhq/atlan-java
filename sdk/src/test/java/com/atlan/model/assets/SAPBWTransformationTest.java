...
public class SAPBWTransformationTest {

    private final SAPBWTransformation full = SAPBWTransformation._internal()
            .guid("guid")
            ...
            .sapBwRule(Map.of("key1", "value1"))
            .sapBwRule(Map.of("key2", "value2"))
            ...
            .sapBwColumnProcess(SAPColumnProcess.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwColumnProcess(SAPColumnProcess.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSAPBWTransformation() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWTransformation,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWTransformation via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWTransformation,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWTransformation frodo = MockAtlanTenant.client.readValue(serialized, SAPBWTransformation.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWTransformation,");
