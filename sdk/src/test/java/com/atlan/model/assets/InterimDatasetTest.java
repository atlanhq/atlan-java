...
public class InterimDatasetTest {

    private static final InterimDataset full = InterimDataset._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .interimDatasetQualifiedName("String0")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .interimField(InterimField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .interimField(InterimField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static InterimDataset frodo;
    private static String serialized;

    @Test(groups = {"InterimDataset.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"InterimDataset.serialize"},
            dependsOnGroups = {"InterimDataset.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"InterimDataset.deserialize"},
            dependsOnGroups = {"InterimDataset.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, InterimDataset.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"InterimDataset.equivalency"},
            dependsOnGroups = {"InterimDataset.serialize", "InterimDataset.deserialize"})
