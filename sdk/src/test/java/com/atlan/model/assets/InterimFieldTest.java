...
public class InterimFieldTest {

    private static final InterimField full = InterimField._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .interimDataset(InterimDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();

    private static final int hash = full.hashCode();
    private static InterimField frodo;
    private static String serialized;

    @Test(groups = {"InterimField.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"InterimField.serialize"},
            dependsOnGroups = {"InterimField.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"InterimField.deserialize"},
            dependsOnGroups = {"InterimField.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, InterimField.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"InterimField.equivalency"},
            dependsOnGroups = {"InterimField.serialize", "InterimField.deserialize"})
