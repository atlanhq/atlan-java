...
public class BigqueryTagTest {

    private static final BigqueryTag full = BigqueryTag._internal()
            .guid("guid")
            ...
            .tagAttribute(SourceTagAttribute.builder()
                    .tagAttributeKey("String0")
                    .tagAttributeValue("String0")
                    .tagAttributeProperties(Map.of("key1", "value1", "key2", "value2"))
                    .build())
            .tagAttribute(SourceTagAttribute.builder()
                    .tagAttributeKey("String1")
                    .tagAttributeValue("String1")
                    .tagAttributeProperties(Map.of("key1", "value1", "key2", "value2"))
                    .build())
            .tagId("String0")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .putBigqueryTagHierarchy(Map.of("key1", "value1"))
            .putBigqueryTagHierarchy(Map.of("key2", "value2"))
            .bigqueryTagTaxonomyProperty("key1", "value1")
            .bigqueryTagTaxonomyProperty("key2", "value2")
            .bigqueryTagType("String0")
            .build();

    private static final int hash = full.hashCode();
    private static BigqueryTag frodo;
    private static String serialized;

    @Test(groups = {"BigqueryTag.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"BigqueryTag.serialize"},
            dependsOnGroups = {"BigqueryTag.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"BigqueryTag.deserialize"},
            dependsOnGroups = {"BigqueryTag.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, BigqueryTag.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"BigqueryTag.equivalency"},
            dependsOnGroups = {"BigqueryTag.serialize", "BigqueryTag.deserialize"})
