...
public class DbtProcessTest {
    ...
    private final DbtProcess full = DbtProcess._internal()
            .guid("guid")
            ...
            .dbtUpstreamContext(DbtInputContext.builder()
                    ...
                    .dbtInputContextQualifiedName("String0")
                    .dbtInputContextType("String0")
                    .dbtInputContextAlias("String0")
                    .dbtInputContextFilter("String0")
                    .dbtInputContextOffsetWindow("String0")
                    .dbtInputContextOffsetToGrain("String0")
                    .build())
            .dbtUpstreamContext(DbtInputContext.builder()
                    .dbtInputContextName("String1")
                    .dbtInputContextQualifiedName("String1")
                    .dbtInputContextType("String1")
                    .dbtInputContextAlias("String1")
                    .dbtInputContextFilter("String1")
                    .dbtInputContextOffsetWindow("String1")
                    .dbtInputContextOffsetToGrain("String1")
                    .build())
            ...
            .input(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .input(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .output(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .output(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .sqlProcedure(Procedure.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sqlProcedure(Procedure.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sqlFunction(Function.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sqlFunction(Function.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDbtProcess() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtProcess,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtProcess via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtProcess,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtProcess frodo = MockAtlanTenant.client.readValue(serialized, DbtProcess.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtProcess,");
