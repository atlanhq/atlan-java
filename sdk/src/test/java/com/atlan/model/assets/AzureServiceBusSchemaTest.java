...
public class AzureServiceBusSchemaTest {
    ...
    private final AzureServiceBusSchema full = AzureServiceBusSchema._internal()
            .guid("guid")
            ...
            .azureServiceBusTopic(AzureServiceBusTopic.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleAzureServiceBusSchema() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AzureServiceBusSchema,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AzureServiceBusSchema via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AzureServiceBusSchema,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AzureServiceBusSchema frodo = MockAtlanTenant.client.readValue(serialized, AzureServiceBusSchema.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AzureServiceBusSchema,");
