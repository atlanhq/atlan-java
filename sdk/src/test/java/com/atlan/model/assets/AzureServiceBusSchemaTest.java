...
public class AzureServiceBusSchemaTest {

    private static final AzureServiceBusSchema full = AzureServiceBusSchema._internal()
            .guid("guid")
    ...
    @Test(
            groups = {"AzureServiceBusSchema.serialize"},
            dependsOnGroups = {"AzureServiceBusSchema.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AzureServiceBusSchema.deserialize"},
            dependsOnGroups = {"AzureServiceBusSchema.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AzureServiceBusSchema.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AzureServiceBusSchema.equivalency"},
            dependsOnGroups = {"AzureServiceBusSchema.serialize", "AzureServiceBusSchema.deserialize"})
