...
public class DbtModelTest {
    ...
    private final DbtModel full = DbtModel._internal()
            .guid("guid")
            ...
            .dbtCompiledSQL("String0")
            .dbtStats("String0")
            .dbtMaterializationType("String0")
            .dbtModelCompileStartedAt(123456789L)
            .dbtModelCompileCompletedAt(123456789L)
            .dbtModelExecuteStartedAt(123456789L)
            .dbtModelExecuteCompletedAt(123456789L)
            ...
            .primarySqlAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dbtModelSqlAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dbtModelSqlAsset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDbtModel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtModel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtModel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtModel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtModel frodo = MockAtlanTenant.client.readValue(serialized, DbtModel.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtModel,");
