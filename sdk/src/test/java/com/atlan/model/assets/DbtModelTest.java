...
public class DbtModelTest {
    ...
    private static final DbtModel full = DbtModel._internal()
            ...
            .dbtModelSqlAsset(SapErpColumn.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dbtModelSqlAsset(SapErpColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dbtRawSQL("String0")
            .dbtStats("String0")
            .dbtStatus("String0")
            ...
            .primarySqlAsset(SapErpColumn.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DbtModel.class);
        assertNotNull(frodo);
    }
