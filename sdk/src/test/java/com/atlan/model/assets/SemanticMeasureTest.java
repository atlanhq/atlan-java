...
public class SemanticMeasureTest {

    private final SemanticMeasure full = SemanticMeasure._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSemanticMeasure() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SemanticMeasure,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SemanticMeasure via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SemanticMeasure,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SemanticMeasure frodo = MockAtlanTenant.client.readValue(serialized, SemanticMeasure.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SemanticMeasure,");
