...
public class ADLSContainerTest {
    ...
    private final ADLSContainer full = ADLSContainer._internal()
            .guid("guid")
            ...
            .adlsContainerUrl("String0")
            .adlsContainerLeaseState(ADLSLeaseState.AVAILABLE)
            .adlsContainerLeaseStatus(ADLSLeaseStatus.LOCKED)
            .adlsContainerEncryptionScope("String0")
            .adlsContainerVersionLevelImmutabilitySupport(true)
            .adlsObjectCount(123)
            .adlsAccount(ADLSAccount.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .adlsObject(ADLSObject.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .adlsObject(ADLSObject.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleADLSContainer() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ADLSContainer,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ADLSContainer via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ADLSContainer,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ADLSContainer frodo = MockAtlanTenant.client.readValue(serialized, ADLSContainer.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ADLSContainer,");
