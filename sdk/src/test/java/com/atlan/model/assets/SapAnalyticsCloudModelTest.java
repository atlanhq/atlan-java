...
public class SapAnalyticsCloudModelTest {

    private final SapAnalyticsCloudModel full = SapAnalyticsCloudModel._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .sapAnalyticsCloudResourceId("String0")
            .sapAnalyticsCloudObjectId("String0")
            .sapAnalyticsCloudRepositoryPartition("String0")
            .sapAnalyticsCloudWorkspaceId("String0")
            .sapAnalyticsCloudWorkspaceName("String0")
            .sapAnalyticsCloudParentFolderQualifiedName("String0")
            .sapAnalyticsCloudParentFolderName("String0")
            ...
            .sapAnalyticsCloudModelKind("String0")
            .sapAnalyticsCloudDataAccessMode("String0")
            .sapAnalyticsCloudProviderId("String0")
            .sapAnalyticsCloudModelId("String0")
            .sapAnalyticsCloudStoryCount(123456789L)
            .sapAnalyticsCloudLiveConnectionId("String0")
            .sapAnalyticsCloudLiveConnectionName("String0")
            .sapAnalyticsCloudLiveConnectionType("String0")
            .sapAnalyticsCloudLiveConnectionSystemType("String0")
            .sapAnalyticsCloudLiveConnectionHost("String0")
            .sapAnalyticsCloudLiveConnectionPort(123)
            .sapAnalyticsCloudLiveConnectionProtocol("String0")
            .sapAnalyticsCloudFolder(SapAnalyticsCloudFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapAnalyticsCloudColumn(SapAnalyticsCloudColumn.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapAnalyticsCloudColumn(
                    SapAnalyticsCloudColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSapAnalyticsCloudModel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapAnalyticsCloudModel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapAnalyticsCloudModel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapAnalyticsCloudModel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapAnalyticsCloudModel frodo = MockAtlanTenant.client.readValue(serialized, SapAnalyticsCloudModel.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of SapAnalyticsCloudModel,");
