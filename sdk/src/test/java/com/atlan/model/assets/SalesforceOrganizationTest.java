...
public class SalesforceOrganizationTest {
    ...
    private final SalesforceOrganization full = SalesforceOrganization._internal()
            .guid("guid")
            ...
            .dashboard(SalesforceDashboard.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dashboard(SalesforceDashboard.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .object(SalesforceObject.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .object(SalesforceObject.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSalesforceOrganization() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SalesforceOrganization,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SalesforceOrganization via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SalesforceOrganization,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SalesforceOrganization frodo = MockAtlanTenant.client.readValue(serialized, SalesforceOrganization.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SalesforceOrganization,");
