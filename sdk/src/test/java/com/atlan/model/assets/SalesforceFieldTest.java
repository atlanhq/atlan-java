...
public class SalesforceFieldTest {
    ...
    private final SalesforceField full = SalesforceField._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .build())
            .dataType("String0")
            .objectQualifiedName("String0")
            .order(123)
            .inlineHelpText("String0")
            .isCalculated(true)
            .formula("String0")
            ...
            .isUnique(true)
            .picklistValue("String0")
            .picklistValue("String1")
            .isPolymorphicForeignKey(true)
            .defaultValueFormula("String0")
            ...
            .lookupObject(SalesforceObject.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .lookupObject(SalesforceObject.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSalesforceField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SalesforceField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SalesforceField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SalesforceField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SalesforceField frodo = MockAtlanTenant.client.readValue(serialized, SalesforceField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SalesforceField,");
