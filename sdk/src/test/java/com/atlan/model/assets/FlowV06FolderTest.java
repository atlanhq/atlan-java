...
public class FlowV06FolderTest {

    private static final FlowV06Folder full = FlowV06Folder._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .flowV06ParentFolder(FlowV06Folder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV06SubFolder(FlowV06Folder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV06SubFolder(FlowV06Folder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static FlowV06Folder frodo;
    private static String serialized;

    @Test(groups = {"FlowV06Folder.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowV06Folder.serialize"},
            dependsOnGroups = {"FlowV06Folder.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowV06Folder.deserialize"},
            dependsOnGroups = {"FlowV06Folder.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowV06Folder.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowV06Folder.equivalency"},
            dependsOnGroups = {"FlowV06Folder.serialize", "FlowV06Folder.deserialize"})
