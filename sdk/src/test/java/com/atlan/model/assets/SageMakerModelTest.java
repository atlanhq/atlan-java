...
public class SageMakerModelTest {

    private final SageMakerModel full = SageMakerModel._internal()
            .guid("guid")
            ...
            .sageMakerModelContainerImage("String0")
            .sageMakerModelExecutionRoleArn("String0")
            .sageMakerModelModelGroupName("String0")
            .sageMakerModelModelGroupQualifiedName("String0")
            .sageMakerModelVersion("String0")
            .sageMakerModelStatus("String0")
            ...
            .sageMakerModelGroup(SageMakerModelGroup.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sageMakerModelDeployment(SageMakerModelDeployment.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sageMakerModelDeployment(SageMakerModelDeployment.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSageMakerModel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SageMakerModel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SageMakerModel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SageMakerModel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SageMakerModel frodo = MockAtlanTenant.client.readValue(serialized, SageMakerModel.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerModel,");
