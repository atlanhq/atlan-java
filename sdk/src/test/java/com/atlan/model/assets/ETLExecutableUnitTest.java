...
public class ETLExecutableUnitTest {

    private static final ETLExecutableUnit full = ETLExecutableUnit._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .etlControlFlowOperation(ETLControlFlowOperation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .etlControlFlowOperation(
                    ETLControlFlowOperation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .etlDataFlow(LineageProcess.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .etlDataFlow(LineageProcess.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static ETLExecutableUnit frodo;
    private static String serialized;

    @Test(groups = {"ETLExecutableUnit.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"ETLExecutableUnit.serialize"},
            dependsOnGroups = {"ETLExecutableUnit.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"ETLExecutableUnit.deserialize"},
            dependsOnGroups = {"ETLExecutableUnit.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, ETLExecutableUnit.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"ETLExecutableUnit.equivalency"},
            dependsOnGroups = {"ETLExecutableUnit.serialize", "ETLExecutableUnit.deserialize"})
