...
public class QlikDatasetTest {
    ...
    private final QlikDataset full = QlikDataset._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleQlikDataset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QlikDataset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QlikDataset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QlikDataset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QlikDataset frodo = MockAtlanTenant.client.readValue(serialized, QlikDataset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QlikDataset,");
