...
public class TypeRegistryEntityTest {

    private static final TypeRegistryEntity full = TypeRegistryEntity._internal()
            .guid("guid")
            ...
            .typeRegistrySubType(TypeRegistryEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistrySubType(
                    TypeRegistryEntity.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .typeRegistrySuperType(TypeRegistryEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistrySuperType(
                    TypeRegistryEntity.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .typeRegistryVersion("String0")
            .build();

    private static final int hash = full.hashCode();
    private static TypeRegistryEntity frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryEntity.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryEntity.serialize"},
            dependsOnGroups = {"TypeRegistryEntity.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryEntity.deserialize"},
            dependsOnGroups = {"TypeRegistryEntity.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryEntity.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryEntity.equivalency"},
            dependsOnGroups = {"TypeRegistryEntity.serialize", "TypeRegistryEntity.deserialize"})
