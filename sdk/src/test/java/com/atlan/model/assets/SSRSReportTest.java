...
public class SSRSReportTest {

    private final SSRSReport full = SSRSReport._internal()
            .guid("guid")
            ...
            .ssrsReportSize(123456789L)
            .ssrsReportParameters("String0")
            .ssrsReportDataSetCount(123456789L)
            .ssrsReportDataSourceCount(123456789L)
            .ssrsFolder(SSRSFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .ssrsLinkedFromReport(SSRSReport.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .ssrsLinkedFromReport(SSRSReport.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .ssrsLinkedReport(SSRSReport.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .ssrsLinkedReport(SSRSReport.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .ssrsDataSet(SSRSDataSet.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .ssrsDataSet(SSRSDataSet.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSSRSReport() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SSRSReport,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SSRSReport via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SSRSReport,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SSRSReport frodo = MockAtlanTenant.client.readValue(serialized, SSRSReport.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SSRSReport,");
