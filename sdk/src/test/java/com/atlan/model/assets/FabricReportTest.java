...
public class FabricReportTest {

    private final FabricReport full = FabricReport._internal()
            .guid("guid")
            ...
            .fabricPage(FabricPage.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .fabricPage(FabricPage.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleFabricReport() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FabricReport,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FabricReport via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FabricReport,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FabricReport frodo = MockAtlanTenant.client.readValue(serialized, FabricReport.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of FabricReport,");
