...
public class FabricReportTest {
    ...
    private static final FabricReport full = FabricReport._internal()
            .guid("guid")
    ...
    private static FabricReport frodo;
    ...
    @Test(groups = {"FabricReport.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FabricReport.serialize"},
            dependsOnGroups = {"FabricReport.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FabricReport.deserialize"},
            dependsOnGroups = {"FabricReport.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FabricReport.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FabricReport.equivalency"},
            dependsOnGroups = {"FabricReport.serialize", "FabricReport.deserialize"})
