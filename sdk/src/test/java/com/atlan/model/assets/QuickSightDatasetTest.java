...
public class QuickSightDatasetTest {
    ...
    private final QuickSightDataset full = QuickSightDataset._internal()
            .guid("guid")
            ...
            .quickSightDatasetColumnCount(123456789L)
            .quickSightDatasetFolder(QuickSightFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .quickSightDatasetFolder(QuickSightFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .quickSightDatasetField(QuickSightDatasetField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .quickSightDatasetField(QuickSightDatasetField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleQuickSightDataset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QuickSightDataset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QuickSightDataset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QuickSightDataset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QuickSightDataset frodo = MockAtlanTenant.client.readValue(serialized, QuickSightDataset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QuickSightDataset,");
