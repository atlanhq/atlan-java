...
public class S3ObjectTest {
    ...
    private final S3Object full = S3Object._internal()
            .guid("guid")
            ...
            .putS3PrefixHierarchy("String0", "String0")
            .putS3PrefixHierarchy("String1", "String1")
            .name("String0")
            .displayName("String0")
            .description("String0")
            ...
            .s3ObjectKey("String0")
            .s3ObjectContentType("String0")
            .s3ObjectContentDisposition("String0")
            .s3ObjectVersionId("String0")
            .s3ObjectLockRetainUntil(123456789L)
            .s3ObjectLockMode(S3ObjectLockMode.GOVERNANCE)
            .s3ObjectLockLegalHoldEnabled(true)
            .bucket(S3Bucket.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleS3Object() throws IOException {
        assertNotNull(full, "Unable to build sample instance of S3Object,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting S3Object via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of S3Object,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final S3Object frodo = MockAtlanTenant.client.readValue(serialized, S3Object.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of S3Object,");
