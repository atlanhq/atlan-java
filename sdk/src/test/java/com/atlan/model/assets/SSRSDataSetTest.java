...
public class SSRSDataSetTest {

    private final SSRSDataSet full = SSRSDataSet._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .ssrsPath("String0")
            .ssrsUsedInReports(true)
            .ssrsHidden(true)
            .ssrsTableName("String0")
            .ssrsSchemaName("String0")
            .ssrsCatalogName("String0")
            .ssrsReferenceRepositoryId("String0")
            .ssrsParentFolderQualifiedName("String0")
            .ssrsFolderHierarchy(Map.of("key1", "value1"))
            .ssrsFolderHierarchy(Map.of("key2", "value2"))
            .ssrsReportQualifiedName("String0")
            .ssrsReportName("String0")
            .ssrsDataSetQualifiedName("String0")
            .ssrsDataSetName("String0")
            ...
            .ssrsDataSetSqlQuery("String0")
            .ssrsDataSetIsSharedDataSet(true)
            .ssrsDataSetQueryParameters("String0")
            .ssrsDataSetDataSourceConnectionString("String0")
            .ssrsDataSetDataSourceReference("String0")
            .ssrsDataSetExtension("String0")
            .ssrsDataSetReferenceTableName("String0")
            .ssrsDataSetReferenceTableName("String1")
            .ssrsDataSetCubeName("String0")
            .ssrsDataSetStoredProcedureName("String0")
            .ssrsDataSetProcessedSql("String0")
            .ssrsDataSetLogMessages("String0")
            .ssrsDataSetErrorCode("String0")
            .ssrsDataSetConnected(true)
            .ssrsDataSetFieldCount(123456789L)
            .ssrsReport(SSRSReport.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .ssrsField(SSRSField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .ssrsField(SSRSField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSSRSDataSet() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SSRSDataSet,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SSRSDataSet via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SSRSDataSet,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SSRSDataSet frodo = MockAtlanTenant.client.readValue(serialized, SSRSDataSet.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SSRSDataSet,");
