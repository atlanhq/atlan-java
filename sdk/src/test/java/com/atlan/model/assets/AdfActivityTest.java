...
public class AdfActivityTest {
    ...
    private final AdfActivity full = AdfActivity._internal()
            .guid("guid")
            ...
            .adfActivityRun("String0", "String0")
            .adfActivityRun("String1", "String1")
    ...
    @Test
    void serdeCycleAdfActivity() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AdfActivity,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AdfActivity via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AdfActivity,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AdfActivity frodo = MockAtlanTenant.client.readValue(serialized, AdfActivity.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AdfActivity,");
