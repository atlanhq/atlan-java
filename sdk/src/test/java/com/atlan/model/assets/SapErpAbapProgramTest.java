...
public class SapErpAbapProgramTest {
    ...
    private final SapErpAbapProgram full = SapErpAbapProgram._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSapErpAbapProgram() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapErpAbapProgram,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapErpAbapProgram via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapErpAbapProgram,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapErpAbapProgram frodo = MockAtlanTenant.client.readValue(serialized, SapErpAbapProgram.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SapErpAbapProgram,");
