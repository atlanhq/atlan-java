...
public class SapErpAbapProgramTest {

    private static final SapErpAbapProgram full = SapErpAbapProgram._internal()
            .guid("guid")
    ...
    private static SapErpAbapProgram frodo;
    private static String serialized;

    @Test(groups = {"SapErpAbapProgram.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SapErpAbapProgram.serialize"},
            dependsOnGroups = {"SapErpAbapProgram.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SapErpAbapProgram.deserialize"},
            dependsOnGroups = {"SapErpAbapProgram.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SapErpAbapProgram.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SapErpAbapProgram.equivalency"},
            dependsOnGroups = {"SapErpAbapProgram.serialize", "SapErpAbapProgram.deserialize"})
