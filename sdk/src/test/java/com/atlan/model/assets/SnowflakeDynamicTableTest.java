...
public class SnowflakeDynamicTableTest {
    ...
    private final SnowflakeDynamicTable full = SnowflakeDynamicTable._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSnowflakeDynamicTable() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeDynamicTable,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeDynamicTable via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeDynamicTable,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeDynamicTable frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeDynamicTable.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeDynamicTable,");
