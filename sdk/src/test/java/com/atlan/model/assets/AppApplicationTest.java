...
public class AppApplicationTest {
    ...
    private static final AppApplication full = AppApplication._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .appComponentCount(123456789L)
            .appComponent(AppComponent.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .appComponent(AppComponent.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .appImplementedByAsset(AirflowDag.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .appImplementedByAsset(AirflowDag.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static AppApplication frodo;
    private static String serialized;

    @Test(groups = {"AppApplication.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AppApplication.serialize"},
            dependsOnGroups = {"AppApplication.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AppApplication.deserialize"},
            dependsOnGroups = {"AppApplication.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = Atlan.getDefaultClient().readValue(serialized, AppApplication.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AppApplication.equivalency"},
            dependsOnGroups = {"AppApplication.serialize", "AppApplication.deserialize"})
