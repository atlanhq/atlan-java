...
public class SapErpCdsViewTest {

    private static final SapErpCdsView full = SapErpCdsView._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .sapErpCdsViewSourceName("String0")
            .sapErpCdsViewSourceType("String0")
            .sapErpCdsViewTechnicalName("String0")
            .sapErpColumn(SapErpColumn.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapErpColumn(SapErpColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapErpComponent(SapErpComponent.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();

    private static final int hash = full.hashCode();
    private static SapErpCdsView frodo;
    private static String serialized;

    @Test(groups = {"SapErpCdsView.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SapErpCdsView.serialize"},
            dependsOnGroups = {"SapErpCdsView.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SapErpCdsView.deserialize"},
            dependsOnGroups = {"SapErpCdsView.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SapErpCdsView.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SapErpCdsView.equivalency"},
            dependsOnGroups = {"SapErpCdsView.serialize", "SapErpCdsView.deserialize"})
