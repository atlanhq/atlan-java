...
public class SapErpCdsViewTest {
    ...
    private final SapErpCdsView full = SapErpCdsView._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSapErpCdsView() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapErpCdsView,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapErpCdsView via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapErpCdsView,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapErpCdsView frodo = MockAtlanTenant.client.readValue(serialized, SapErpCdsView.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SapErpCdsView,");
