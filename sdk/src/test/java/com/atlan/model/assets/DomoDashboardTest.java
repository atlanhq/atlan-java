...
public class DomoDashboardTest {
    ...
    private final DomoDashboard full = DomoDashboard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDomoDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DomoDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DomoDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DomoDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DomoDashboard frodo = MockAtlanTenant.client.readValue(serialized, DomoDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DomoDashboard,");
