...
public class DremioPhysicalDatasetTest {
    ...
    private static final DremioPhysicalDataset full = DremioPhysicalDataset._internal()
            .guid("guid")
    ...
    private static DremioPhysicalDataset frodo;
    ...
    @Test(groups = {"DremioPhysicalDataset.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DremioPhysicalDataset.serialize"},
            dependsOnGroups = {"DremioPhysicalDataset.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DremioPhysicalDataset.deserialize"},
            dependsOnGroups = {"DremioPhysicalDataset.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DremioPhysicalDataset.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DremioPhysicalDataset.equivalency"},
            dependsOnGroups = {"DremioPhysicalDataset.serialize", "DremioPhysicalDataset.deserialize"})
