...
public class DremioPhysicalDatasetTest {

    private final DremioPhysicalDataset full = DremioPhysicalDataset._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDremioPhysicalDataset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DremioPhysicalDataset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DremioPhysicalDataset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DremioPhysicalDataset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DremioPhysicalDataset frodo = MockAtlanTenant.client.readValue(serialized, DremioPhysicalDataset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DremioPhysicalDataset,");
