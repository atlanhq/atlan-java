...
public class DocumentDBDatabaseTest {
    ...
    private final DocumentDBDatabase full = DocumentDBDatabase._internal()
            .guid("guid")
            ...
            .documentDBCollection(DocumentDBCollection.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDocumentDBDatabase() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DocumentDBDatabase,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DocumentDBDatabase via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DocumentDBDatabase,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DocumentDBDatabase frodo = MockAtlanTenant.client.readValue(serialized, DocumentDBDatabase.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DocumentDBDatabase,");
