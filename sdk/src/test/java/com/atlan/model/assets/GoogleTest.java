...
public class GoogleTest {
    ...
    private final Google full = Google._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleGoogle() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Google,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Google via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Google,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Google frodo = MockAtlanTenant.client.readValue(serialized, Google.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Google,");
