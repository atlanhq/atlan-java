...
public class SAPBWInfoSourceTest {

    private final SAPBWInfoSource full = SAPBWInfoSource._internal()
            .guid("guid")
            ...
            .sapBwInfoSourceField(SAPBWInfoSourceField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleSAPBWInfoSource() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWInfoSource,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWInfoSource via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWInfoSource,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWInfoSource frodo = MockAtlanTenant.client.readValue(serialized, SAPBWInfoSource.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWInfoSource,");
