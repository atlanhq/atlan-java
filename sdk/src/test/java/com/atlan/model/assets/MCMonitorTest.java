...
public class MCMonitorTest {
    ...
    private static final MCMonitor full = MCMonitor._internal()
            ...
            .mcMonitorAsset(Task.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .mcMonitorAsset(Task.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MCMonitor.class);
        assertNotNull(frodo);
    }
