...
public class PowerBIDashboardTest {
    ...
    private final PowerBIDashboard full = PowerBIDashboard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCyclePowerBIDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PowerBIDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PowerBIDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PowerBIDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PowerBIDashboard frodo = MockAtlanTenant.client.readValue(serialized, PowerBIDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PowerBIDashboard,");
