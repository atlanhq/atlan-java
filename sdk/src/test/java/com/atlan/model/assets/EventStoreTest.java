...
public class EventStoreTest {
    ...
    private final EventStore full = EventStore._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleEventStore() throws IOException {
        assertNotNull(full, "Unable to build sample instance of EventStore,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting EventStore via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of EventStore,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final EventStore frodo = MockAtlanTenant.client.readValue(serialized, EventStore.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of EventStore,");
