...
public class SisenseDashboardTest {
    ...
    private final SisenseDashboard full = SisenseDashboard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSisenseDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SisenseDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SisenseDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SisenseDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SisenseDashboard frodo = MockAtlanTenant.client.readValue(serialized, SisenseDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SisenseDashboard,");
