...
public class ReadmeTemplateTest {
    ...
    private final ReadmeTemplate full = ReadmeTemplate._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleReadmeTemplate() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ReadmeTemplate,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ReadmeTemplate via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ReadmeTemplate,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ReadmeTemplate frodo = MockAtlanTenant.client.readValue(serialized, ReadmeTemplate.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ReadmeTemplate,");
