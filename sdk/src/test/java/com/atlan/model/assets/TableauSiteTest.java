...
public class TableauSiteTest {
    ...
    private final TableauSite full = TableauSite._internal()
            .guid("guid")
            ...
            .project(TableauProject.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleTableauSite() throws IOException {
        assertNotNull(full, "Unable to build sample instance of TableauSite,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting TableauSite via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of TableauSite,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final TableauSite frodo = MockAtlanTenant.client.readValue(serialized, TableauSite.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of TableauSite,");
