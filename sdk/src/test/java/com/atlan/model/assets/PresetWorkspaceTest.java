...
public class PresetWorkspaceTest {
    ...
    private final PresetWorkspace full = PresetWorkspace._internal()
            .guid("guid")
            ...
            .presetWorkspaceClusterId(123456789L)
            .presetWorkspaceDeploymentId(123456789L)
            .presetWorkspaceHostname("String0")
            .presetWorkspaceIsInMaintenanceMode(true)
            .presetWorkspaceRegion("String0")
            .presetWorkspaceStatus("String0")
            .presetWorkspaceDashboardCount(123456789L)
            .presetWorkspaceDatasetCount(123456789L)
            .presetDashboard(PresetDashboard.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .presetDashboard(PresetDashboard.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCyclePresetWorkspace() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PresetWorkspace,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PresetWorkspace via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PresetWorkspace,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PresetWorkspace frodo = MockAtlanTenant.client.readValue(serialized, PresetWorkspace.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PresetWorkspace,");
