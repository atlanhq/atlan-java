...
public class CognosDashboardTest {

    private static final CognosDashboard full = CognosDashboard._internal()
            .guid("guid")
    ...
    private static CognosDashboard frodo;
    private static String serialized;

    @Test(groups = {"CognosDashboard.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CognosDashboard.serialize"},
            dependsOnGroups = {"CognosDashboard.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CognosDashboard.deserialize"},
            dependsOnGroups = {"CognosDashboard.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CognosDashboard.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CognosDashboard.equivalency"},
            dependsOnGroups = {"CognosDashboard.serialize", "CognosDashboard.deserialize"})
