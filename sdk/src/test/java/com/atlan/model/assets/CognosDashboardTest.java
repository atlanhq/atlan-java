...
public class CognosDashboardTest {
    ...
    private final CognosDashboard full = CognosDashboard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCognosDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CognosDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CognosDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CognosDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CognosDashboard frodo = MockAtlanTenant.client.readValue(serialized, CognosDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CognosDashboard,");
