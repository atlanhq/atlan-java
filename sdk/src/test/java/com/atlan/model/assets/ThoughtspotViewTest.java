...
public class ThoughtspotViewTest {
    ...
    private final ThoughtspotView full = ThoughtspotView._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleThoughtspotView() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ThoughtspotView,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ThoughtspotView via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ThoughtspotView,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ThoughtspotView frodo = MockAtlanTenant.client.readValue(serialized, ThoughtspotView.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ThoughtspotView,");
