...
public class FlowV02FieldOperationTest {

    private static final FlowV02FieldOperation full = FlowV02FieldOperation._internal()
            .guid("guid")
    ...
    private static FlowV02FieldOperation frodo;
    private static String serialized;

    @Test(groups = {"FlowV02FieldOperation.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowV02FieldOperation.serialize"},
            dependsOnGroups = {"FlowV02FieldOperation.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowV02FieldOperation.deserialize"},
            dependsOnGroups = {"FlowV02FieldOperation.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowV02FieldOperation.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowV02FieldOperation.equivalency"},
            dependsOnGroups = {"FlowV02FieldOperation.serialize", "FlowV02FieldOperation.deserialize"})
