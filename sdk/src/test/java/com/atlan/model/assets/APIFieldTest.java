...
public class APIFieldTest {
    ...
    private final APIField full = APIField._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAPIField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of APIField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting APIField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of APIField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final APIField frodo = MockAtlanTenant.client.readValue(serialized, APIField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of APIField,");
