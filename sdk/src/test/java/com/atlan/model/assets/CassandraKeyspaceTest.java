...
public class CassandraKeyspaceTest {
    ...
    private final CassandraKeyspace full = CassandraKeyspace._internal()
            .guid("guid")
            ...
            .putCassandraKeyspaceReplication("String0", "String0")
            .putCassandraKeyspaceReplication("String1", "String1")
    ...
    @Test
    void serdeCycleCassandraKeyspace() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CassandraKeyspace,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CassandraKeyspace via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CassandraKeyspace,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CassandraKeyspace frodo = MockAtlanTenant.client.readValue(serialized, CassandraKeyspace.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CassandraKeyspace,");
