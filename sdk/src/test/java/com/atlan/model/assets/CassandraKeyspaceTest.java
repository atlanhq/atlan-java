...
public class CassandraKeyspaceTest {
    ...
    private static final CassandraKeyspace full = CassandraKeyspace._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .cassandraKeyspaceDurableWrites(true)
            .cassandraKeyspaceQuery("String0")
            .putCassandraKeyspaceReplication("key1", "value1")
            .putCassandraKeyspaceReplication("key2", "value2")
            .cassandraKeyspaceVirtual(true)
            .cassandraTable(CassandraTable.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cassandraTable(CassandraTable.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cassandraView(CassandraView.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cassandraView(CassandraView.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static CassandraKeyspace frodo;
    private static String serialized;

    @Test(groups = {"CassandraKeyspace.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CassandraKeyspace.serialize"},
            dependsOnGroups = {"CassandraKeyspace.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CassandraKeyspace.deserialize"},
            dependsOnGroups = {"CassandraKeyspace.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CassandraKeyspace.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CassandraKeyspace.equivalency"},
            dependsOnGroups = {"CassandraKeyspace.serialize", "CassandraKeyspace.deserialize"})
