...
public class DatabricksExternalLocationPathTest {
    ...
    private static final DatabricksExternalLocationPath full = DatabricksExternalLocationPath._internal()
            .guid("guid")
    ...
    private static DatabricksExternalLocationPath frodo;
    ...
    @Test(groups = {"DatabricksExternalLocationPath.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DatabricksExternalLocationPath.serialize"},
            dependsOnGroups = {"DatabricksExternalLocationPath.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DatabricksExternalLocationPath.deserialize"},
            dependsOnGroups = {"DatabricksExternalLocationPath.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DatabricksExternalLocationPath.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DatabricksExternalLocationPath.equivalency"},
            dependsOnGroups = {"DatabricksExternalLocationPath.serialize", "DatabricksExternalLocationPath.deserialize"
            })
