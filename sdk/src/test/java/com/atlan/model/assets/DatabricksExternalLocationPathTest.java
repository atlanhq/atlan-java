...
public class DatabricksExternalLocationPathTest {

    private final DatabricksExternalLocationPath full = DatabricksExternalLocationPath._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .databricksPath("String0")
            .databricksParentQualifiedName("String0")
            .databricksParentName("String0")
            .databricksExternalLocation(DatabricksExternalLocation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleDatabricksExternalLocationPath() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DatabricksExternalLocationPath,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DatabricksExternalLocationPath via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DatabricksExternalLocationPath,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DatabricksExternalLocationPath frodo = MockAtlanTenant.client.readValue(serialized, DatabricksExternalLocationPath.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DatabricksExternalLocationPath,");
