...
public class DatabricksExternalLocationPathTest {
    ...
    void serdeCycleDatabricksExternalLocationPath() throws IOException {
        ...
        // Deserialization
        final DatabricksExternalLocationPath frodo =
                MockAtlanTenant.client.readValue(serialized, DatabricksExternalLocationPath.class);
        assertNotNull(
                frodo,
                "Unable to reverse-read serialized value back into an instance of DatabricksExternalLocationPath,");
