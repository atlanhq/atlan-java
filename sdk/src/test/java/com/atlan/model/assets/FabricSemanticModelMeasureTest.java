...
public class FabricSemanticModelMeasureTest {

    private final FabricSemanticModelMeasure full = FabricSemanticModelMeasure._internal()
            .guid("guid")
            ...
            .fabricMeasureExpression("String0")
            .fabricFormatString("String0")
            .fabricDisplayFolder("String0")
            .fabricIsHidden(true)
            .fabricIsExternalMeasure(true)
    ...
    @Test
    void serdeCycleFabricSemanticModelMeasure() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FabricSemanticModelMeasure,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FabricSemanticModelMeasure via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FabricSemanticModelMeasure,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FabricSemanticModelMeasure frodo =
                MockAtlanTenant.client.readValue(serialized, FabricSemanticModelMeasure.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of FabricSemanticModelMeasure,");
