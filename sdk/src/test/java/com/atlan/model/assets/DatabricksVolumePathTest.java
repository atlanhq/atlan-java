...
public class DatabricksVolumePathTest {

    private final DatabricksVolumePath full = DatabricksVolumePath._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .databricksVolumePathPath("String0")
            .databricksVolumePathVolumeQualifiedName("String0")
            .databricksVolumePathVolumeName("String0")
    ...
    @Test
    void serdeCycleDatabricksVolumePath() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DatabricksVolumePath,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DatabricksVolumePath via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DatabricksVolumePath,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DatabricksVolumePath frodo = MockAtlanTenant.client.readValue(serialized, DatabricksVolumePath.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DatabricksVolumePath,");
