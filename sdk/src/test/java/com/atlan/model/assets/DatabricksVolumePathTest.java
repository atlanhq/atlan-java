...
public class DatabricksVolumePathTest {
    ...
    private static final DatabricksVolumePath full = DatabricksVolumePath._internal()
            .guid("guid")
    ...
    private static DatabricksVolumePath frodo;
    ...
    @Test(groups = {"DatabricksVolumePath.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DatabricksVolumePath.serialize"},
            dependsOnGroups = {"DatabricksVolumePath.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DatabricksVolumePath.deserialize"},
            dependsOnGroups = {"DatabricksVolumePath.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DatabricksVolumePath.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DatabricksVolumePath.equivalency"},
            dependsOnGroups = {"DatabricksVolumePath.serialize", "DatabricksVolumePath.deserialize"})
