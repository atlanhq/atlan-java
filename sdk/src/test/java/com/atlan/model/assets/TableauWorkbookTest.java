...
public class TableauWorkbookTest {
    ...
    private final TableauWorkbook full = TableauWorkbook._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleTableauWorkbook() throws IOException {
        assertNotNull(full, "Unable to build sample instance of TableauWorkbook,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting TableauWorkbook via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of TableauWorkbook,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final TableauWorkbook frodo = MockAtlanTenant.client.readValue(serialized, TableauWorkbook.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of TableauWorkbook,");
