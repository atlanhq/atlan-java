...
public class ModeChartTest {
    ...
    private final ModeChart full = ModeChart._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleModeChart() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ModeChart,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ModeChart via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ModeChart,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ModeChart frodo = MockAtlanTenant.client.readValue(serialized, ModeChart.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ModeChart,");
