...
public class SageMakerFeatureTest {

    private final SageMakerFeature full = SageMakerFeature._internal()
            .guid("guid")
            ...
            .sageMakerFeatureGroupName("String0")
            .sageMakerFeatureGroupQualifiedName("String0")
            .sageMakerFeatureDataType("String0")
            .sageMakerFeatureIsRecordIdentifier(true)
            ...
            .sageMakerFeatureGroup(SageMakerFeatureGroup.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleSageMakerFeature() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SageMakerFeature,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SageMakerFeature via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SageMakerFeature,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SageMakerFeature frodo = MockAtlanTenant.client.readValue(serialized, SageMakerFeature.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerFeature,");
