...
public class DremioFolderTest {

    private final DremioFolder full = DremioFolder._internal()
            .guid("guid")
            ...
            .addDremioFolderHierarchy("String0", "String0")
            .addDremioFolderHierarchy("String1", "String1")
            .dremioLabel("String0")
            .dremioLabel("String1")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .dremioParentAssetType(DremioParentAssetType.SPACE)
            ...
            .dremioSource(DremioSource.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dremioSpace(DremioSpace.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dremioSubFolder(DremioFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dremioSubFolder(DremioFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dremioParentFolder(DremioFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dremioPhysicalDataset(DremioPhysicalDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dremioPhysicalDataset(DremioPhysicalDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dremioVirtualDataset(DremioVirtualDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dremioVirtualDataset(DremioVirtualDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDremioFolder() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DremioFolder,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DremioFolder via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DremioFolder,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DremioFolder frodo = MockAtlanTenant.client.readValue(serialized, DremioFolder.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DremioFolder,");
