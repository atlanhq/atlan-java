...
public class DremioFolderTest {
    ...
    private static final DremioFolder full = DremioFolder._internal()
            .guid("guid")
    ...
    private static DremioFolder frodo;
    ...
    @Test(groups = {"DremioFolder.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DremioFolder.serialize"},
            dependsOnGroups = {"DremioFolder.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DremioFolder.deserialize"},
            dependsOnGroups = {"DremioFolder.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DremioFolder.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DremioFolder.equivalency"},
            dependsOnGroups = {"DremioFolder.serialize", "DremioFolder.deserialize"})
