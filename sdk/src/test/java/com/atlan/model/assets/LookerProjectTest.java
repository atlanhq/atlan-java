...
public class LookerProjectTest {
    ...
    private final LookerProject full = LookerProject._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleLookerProject() throws IOException {
        assertNotNull(full, "Unable to build sample instance of LookerProject,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting LookerProject via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of LookerProject,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final LookerProject frodo = MockAtlanTenant.client.readValue(serialized, LookerProject.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of LookerProject,");
