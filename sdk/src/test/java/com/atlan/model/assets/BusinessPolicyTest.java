...
public class BusinessPolicyTest {
    ...
    private final BusinessPolicy full = BusinessPolicy._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleBusinessPolicy() throws IOException {
        assertNotNull(full, "Unable to build sample instance of BusinessPolicy,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting BusinessPolicy via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of BusinessPolicy,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final BusinessPolicy frodo = MockAtlanTenant.client.readValue(serialized, BusinessPolicy.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of BusinessPolicy,");
