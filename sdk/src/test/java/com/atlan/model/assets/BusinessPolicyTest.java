...
public class BusinessPolicyTest {

    private static final BusinessPolicy full = BusinessPolicy._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .businessPolicyBaseParentGuid("String0")
            .businessPolicyFilterDSL("String0")
            .businessPolicyLongDescription("String0")
            .businessPolicyReviewPeriod("String0")
            .businessPolicyRule(BusinessPolicyRule.builder()
                    .bprId("String0")
                    .bprName("String0")
                    .bprSequence("String0")
                    .bprOperand("String0")
                    .bprOperator("String0")
                    .bprValues(List.of("String0", "String1"))
                    .bprQuery("String0")
                    .build())
            .businessPolicyRule(BusinessPolicyRule.builder()
                    .bprId("String1")
                    ...
                    .bprQuery("String1")
                    .build())
            .businessPolicySelectedApprovalWF("String0")
            .businessPolicyType("String0")
            .businessPolicyValidFrom(123456789L)
            .businessPolicyValidTill(123456789L)
            .businessPolicyVersion(123)
            .exceptionForBusinessPolicy(BusinessPolicyException.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .exceptionForBusinessPolicy(
                    BusinessPolicyException.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .relatedBusinessPolicy(BusinessPolicy.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .relatedBusinessPolicy(BusinessPolicy.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static BusinessPolicy frodo;
    private static String serialized;

    @Test(groups = {"BusinessPolicy.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"BusinessPolicy.serialize"},
            dependsOnGroups = {"BusinessPolicy.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"BusinessPolicy.deserialize"},
            dependsOnGroups = {"BusinessPolicy.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, BusinessPolicy.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"BusinessPolicy.equivalency"},
            dependsOnGroups = {"BusinessPolicy.serialize", "BusinessPolicy.deserialize"})
