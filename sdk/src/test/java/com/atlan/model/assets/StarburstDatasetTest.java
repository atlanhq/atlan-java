...
public class StarburstDatasetTest {

    private final StarburstDataset full = StarburstDataset._internal()
            .guid("guid")
            ...
            .isTemporary(true)
            .isQueryPreview(true)
            .putQueryPreviewConfig("String0", "String0")
            .putQueryPreviewConfig("String1", "String1")
            ...
            .tableImpalaParameter("String0", "String0")
            .tableImpalaParameter("String1", "String1")
            ...
            .starburstIsMaterialized(true)
            .starburstSqlQualifiedName("String0")
            .starburstViewDefinition("String0")
            ...
            .starburstDataProduct(DataProduct.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .starburstDatasetColumn(StarburstDatasetColumn.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .starburstDatasetColumn(StarburstDatasetColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
    ...
    @Test
    void serdeCycleStarburstDataset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of StarburstDataset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting StarburstDataset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of StarburstDataset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final StarburstDataset frodo = MockAtlanTenant.client.readValue(serialized, StarburstDataset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of StarburstDataset,");
