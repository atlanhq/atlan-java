...
public class AppWorkflowRunTest {

    private static final AppWorkflowRun full = AppWorkflowRun._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .appWorkflowRunCompletedAt(123456789L)
            .appWorkflowRunLabel("String0")
            .appWorkflowRunOutput("key1", "value1")
            .appWorkflowRunOutput("key2", "value2")
            .appWorkflowRunStartedAt(123456789L)
            .appWorkflowRunStatus(AppWorkflowRunStatus.SKIPPED)
            .appWorkflowRunStep(AppWorkflowRunStep.builder()
                    .appWorkflowRunLabel("String0")
                    .appWorkflowRunStatus(AppWorkflowRunStatus.SKIPPED)
                    .appWorkflowRunStartedAt(123456789L)
                    .appWorkflowRunCompletedAt(123456789L)
                    .appWorkflowRunOutputs(Map.of("key1", "value1", "key2", "value2"))
                    .build())
            .appWorkflowRunStep(AppWorkflowRunStep.builder()
                    .appWorkflowRunLabel("String1")
                    .appWorkflowRunStatus(AppWorkflowRunStatus.PENDING)
                    .appWorkflowRunStartedAt(987654321L)
                    .appWorkflowRunCompletedAt(987654321L)
                    .appWorkflowRunOutputs(Map.of("key1", "value1", "key2", "value2"))
                    .build())
            .build();

    private static final int hash = full.hashCode();
    private static AppWorkflowRun frodo;
    private static String serialized;

    @Test(groups = {"AppWorkflowRun.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AppWorkflowRun.serialize"},
            dependsOnGroups = {"AppWorkflowRun.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AppWorkflowRun.deserialize"},
            dependsOnGroups = {"AppWorkflowRun.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AppWorkflowRun.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AppWorkflowRun.equivalency"},
            dependsOnGroups = {"AppWorkflowRun.serialize", "AppWorkflowRun.deserialize"})
