...
public class AppWorkflowRunTest {
    ...
    private final AppWorkflowRun full = AppWorkflowRun._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAppWorkflowRun() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AppWorkflowRun,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AppWorkflowRun via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AppWorkflowRun,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AppWorkflowRun frodo = MockAtlanTenant.client.readValue(serialized, AppWorkflowRun.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AppWorkflowRun,");
