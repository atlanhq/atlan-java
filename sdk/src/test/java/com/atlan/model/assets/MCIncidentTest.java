...
public class MCIncidentTest {
    ...
    private static final MCIncident full = MCIncident._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .mcIncidentAsset(Task.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .mcIncidentAsset(Task.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MCIncident.class);
        assertNotNull(frodo);
    }
