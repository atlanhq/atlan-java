...
public class MCIncidentTest {
    ...
    private final MCIncident full = MCIncident._internal()
            .guid("guid")
            ...
            .mcIncidentPriority("String0")
            .mcIncidentState("String0")
            .mcIncidentWarehouse("String0")
            .mcMonitor(MCMonitor.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .mcIncidentAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .mcIncidentAsset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleMCIncident() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MCIncident,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MCIncident via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MCIncident,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MCIncident frodo = MockAtlanTenant.client.readValue(serialized, MCIncident.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MCIncident,");
