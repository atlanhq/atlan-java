...
public class FlowReusableUnitTest {
    ...
    private final FlowReusableUnit full = FlowReusableUnit._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleFlowReusableUnit() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FlowReusableUnit,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FlowReusableUnit via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FlowReusableUnit,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FlowReusableUnit frodo = MockAtlanTenant.client.readValue(serialized, FlowReusableUnit.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of FlowReusableUnit,");
