...
public class DomoCardTest {
    ...
    private final DomoCard full = DomoCard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDomoCard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DomoCard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DomoCard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DomoCard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DomoCard frodo = MockAtlanTenant.client.readValue(serialized, DomoCard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DomoCard,");
