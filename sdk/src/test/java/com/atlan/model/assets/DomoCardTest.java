...
public class DomoCardTest {

    private static final DomoCard full = DomoCard._internal()
            .guid("guid")
    ...
    private static DomoCard frodo;
    private static String serialized;

    @Test(groups = {"DomoCard.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DomoCard.serialize"},
            dependsOnGroups = {"DomoCard.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DomoCard.deserialize"},
            dependsOnGroups = {"DomoCard.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DomoCard.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DomoCard.equivalency"},
            dependsOnGroups = {"DomoCard.serialize", "DomoCard.deserialize"})
