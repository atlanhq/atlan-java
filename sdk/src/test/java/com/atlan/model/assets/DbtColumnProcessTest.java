...
public class DbtColumnProcessTest {
    ...
    private final DbtColumnProcess full = DbtColumnProcess._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDbtColumnProcess() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtColumnProcess,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtColumnProcess via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtColumnProcess,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtColumnProcess frodo = MockAtlanTenant.client.readValue(serialized, DbtColumnProcess.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtColumnProcess,");
