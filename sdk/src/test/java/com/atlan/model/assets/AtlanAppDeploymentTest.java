...
public class AtlanAppDeploymentTest {

    private final AtlanAppDeployment full = AtlanAppDeployment._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .atlanAppVersionId(123)
            .atlanAppVersionUUID("String0")
            .atlanAppStatus(AtlanAppDeploymentStatus.PENDING)
            .atlanAppOperation(AtlanAppDeploymentOperation.INSTALL)
            .atlanAppErrorDetails("String0")
            .atlanAppDeploymentName("String0")
    ...
    @Test
    void serdeCycleAtlanAppDeployment() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AtlanAppDeployment,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AtlanAppDeployment via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AtlanAppDeployment,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AtlanAppDeployment frodo = MockAtlanTenant.client.readValue(serialized, AtlanAppDeployment.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AtlanAppDeployment,");
