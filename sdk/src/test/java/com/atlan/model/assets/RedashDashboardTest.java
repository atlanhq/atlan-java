...
public class RedashDashboardTest {

    private static final RedashDashboard full = RedashDashboard._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .redashDashboardWidgetCount(123456789L)
            .build();

    private static final int hash = full.hashCode();
    private static RedashDashboard frodo;
    private static String serialized;

    @Test(groups = {"RedashDashboard.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"RedashDashboard.serialize"},
            dependsOnGroups = {"RedashDashboard.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"RedashDashboard.deserialize"},
            dependsOnGroups = {"RedashDashboard.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, RedashDashboard.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"RedashDashboard.equivalency"},
            dependsOnGroups = {"RedashDashboard.serialize", "RedashDashboard.deserialize"})
