...
public class RedashDashboardTest {
    ...
    private final RedashDashboard full = RedashDashboard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleRedashDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of RedashDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting RedashDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of RedashDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final RedashDashboard frodo = MockAtlanTenant.client.readValue(serialized, RedashDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of RedashDashboard,");
