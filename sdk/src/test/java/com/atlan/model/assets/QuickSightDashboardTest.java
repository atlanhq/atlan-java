...
public class QuickSightDashboardTest {
    ...
    private final QuickSightDashboard full = QuickSightDashboard._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .quickSightDashboardPublishedVersionNumber(123456789L)
            .quickSightDashboardLastPublishedTime(123456789L)
            ...
            .quickSightDashboardVisual(QuickSightDashboardVisual.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .quickSightDashboardVisual(QuickSightDashboardVisual.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .quickSightDashboardFolder(QuickSightFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .quickSightDashboardFolder(QuickSightFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleQuickSightDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QuickSightDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QuickSightDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QuickSightDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QuickSightDashboard frodo = MockAtlanTenant.client.readValue(serialized, QuickSightDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QuickSightDashboard,");
