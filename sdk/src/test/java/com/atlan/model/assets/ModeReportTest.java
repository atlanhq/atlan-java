...
public class ModeReportTest {
    ...
    private final ModeReport full = ModeReport._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .modeCollectionToken("String0")
            .modeReportPublishedAt(123456789L)
            .modeQueryCount(123456789L)
            .modeChartCount(123456789L)
            .modeQueryPreview("String0")
            .modeIsPublic(true)
            .modeIsShared(true)
            .modeIsArchived(true)
            ...
            .modeQuery(ModeQuery.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modeQuery(ModeQuery.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modeCollection(ModeCollection.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modeCollection(ModeCollection.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleModeReport() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ModeReport,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ModeReport via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ModeReport,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ModeReport frodo = MockAtlanTenant.client.readValue(serialized, ModeReport.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ModeReport,");
