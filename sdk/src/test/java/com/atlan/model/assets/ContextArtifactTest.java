...
public class ContextArtifactTest {

    private final ContextArtifact full = ContextArtifact._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleContextArtifact() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ContextArtifact,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ContextArtifact via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ContextArtifact,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ContextArtifact frodo = MockAtlanTenant.client.readValue(serialized, ContextArtifact.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ContextArtifact,");
