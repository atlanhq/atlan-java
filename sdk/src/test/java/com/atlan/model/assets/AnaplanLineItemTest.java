...
public class AnaplanLineItemTest {

    private static final AnaplanLineItem full = AnaplanLineItem._internal()
            .guid("guid")
            ...
            .anaplanLineItemFormula("String0")
    ...
    private static AnaplanLineItem frodo;
    private static String serialized;

    @Test(groups = {"AnaplanLineItem.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AnaplanLineItem.serialize"},
            dependsOnGroups = {"AnaplanLineItem.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AnaplanLineItem.deserialize"},
            dependsOnGroups = {"AnaplanLineItem.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AnaplanLineItem.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AnaplanLineItem.equivalency"},
            dependsOnGroups = {"AnaplanLineItem.serialize", "AnaplanLineItem.deserialize"})
