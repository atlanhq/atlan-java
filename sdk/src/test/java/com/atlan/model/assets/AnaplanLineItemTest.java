...
public class AnaplanLineItemTest {
    ...
    private final AnaplanLineItem full = AnaplanLineItem._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAnaplanLineItem() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AnaplanLineItem,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AnaplanLineItem via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AnaplanLineItem,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AnaplanLineItem frodo = MockAtlanTenant.client.readValue(serialized, AnaplanLineItem.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AnaplanLineItem,");
