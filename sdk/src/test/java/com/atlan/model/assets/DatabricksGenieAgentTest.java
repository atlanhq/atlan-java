...
public class DatabricksGenieAgentTest {

    private final DatabricksGenieAgent full = DatabricksGenieAgent._internal()
            .guid("guid")
            ...
            .agentStatus(AgenticLifecycleStatus.DRAFT)
            .agentSystemPrompt("String0")
            .agentLlmConfig("String0")
            .agentMcpServers("String0")
            .agentSchedules("String0")
            .agentSkillName("String0")
            .agentSkillName("String1")
            .agentSkillQualifiedName("String0")
            .agentSkillQualifiedName("String1")
            .agenticVersion(123456789L)
            .agenticSource(AgenticSource.CONTEXT_STUDIO)
            .databricksGenieAgentWorkspaceId("String0")
            .databricksGenieAgentWarehouseId("String0")
            .databricksGenieAgentParentPath("String0")
            .databricksGenieAgentEtag("String0")
            .agentSkill(Skill.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .agentSkill(Skill.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .contextSourceRepository(ContextRepository.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleDatabricksGenieAgent() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DatabricksGenieAgent,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DatabricksGenieAgent via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DatabricksGenieAgent,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DatabricksGenieAgent frodo = MockAtlanTenant.client.readValue(serialized, DatabricksGenieAgent.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DatabricksGenieAgent,");
