...
public class TypeRegistryStructTest {

    private static final TypeRegistryStruct full = TypeRegistryStruct._internal()
            .guid("guid")
    ...
    private static TypeRegistryStruct frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryStruct.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryStruct.serialize"},
            dependsOnGroups = {"TypeRegistryStruct.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryStruct.deserialize"},
            dependsOnGroups = {"TypeRegistryStruct.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryStruct.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryStruct.equivalency"},
            dependsOnGroups = {"TypeRegistryStruct.serialize", "TypeRegistryStruct.deserialize"})
