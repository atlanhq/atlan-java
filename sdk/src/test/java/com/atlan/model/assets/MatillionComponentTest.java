...
public class MatillionComponentTest {
    ...
    private static final MatillionComponent full = MatillionComponent._internal()
            .guid("guid")
            ...
            .putMatillionComponentLinkedJob("key1", "value1")
            .putMatillionComponentLinkedJob("key2", "value2")
    ...
    private static MatillionComponent frodo;
    private static String serialized;

    @Test(groups = {"MatillionComponent.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"MatillionComponent.serialize"},
            dependsOnGroups = {"MatillionComponent.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"MatillionComponent.deserialize"},
            dependsOnGroups = {"MatillionComponent.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MatillionComponent.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"MatillionComponent.equivalency"},
            dependsOnGroups = {"MatillionComponent.serialize", "MatillionComponent.deserialize"})
