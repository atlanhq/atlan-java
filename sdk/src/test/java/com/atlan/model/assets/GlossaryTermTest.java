...
public class GlossaryTermTest {
    ...
    private final GlossaryTerm full = GlossaryTerm._internal()
            .guid("guid")
            ...
            .assignedEntity(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .assignedEntity(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleGlossaryTerm() throws IOException {
        assertNotNull(full, "Unable to build sample instance of GlossaryTerm,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting GlossaryTerm via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of GlossaryTerm,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final GlossaryTerm frodo = MockAtlanTenant.client.readValue(serialized, GlossaryTerm.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of GlossaryTerm,");
