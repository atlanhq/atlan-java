...
public class GCSObjectTest {
    ...
    private final GCSObject full = GCSObject._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .gcsStorageClass("String0")
            .gcsEncryptionType("String0")
            .gcsETag("String0")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .googleService("String0")
            .googleProjectName("String0")
            .googleProjectId("String0")
            .googleProjectNumber(123456789L)
            .googleLocation("String0")
            .googleLocationType("String0")
            .googleLabel(GoogleLabel.builder()
                    .googleLabelKey("String0")
                    .googleLabelValue("String0")
                    .build())
            .googleLabel(GoogleLabel.builder()
                    .googleLabelKey("String1")
                    .googleLabelValue("String1")
                    .build())
            .googleTag(GoogleTag.builder()
                    .googleTagKey("String0")
                    .googleTagValue("String0")
                    .build())
            .googleTag(GoogleTag.builder()
                    .googleTagKey("String1")
                    .googleTagValue("String1")
                    .build())
            .cloudUniformResourceName("String0")
            .gcsBucketName("String0")
            .gcsBucketQualifiedName("String0")
            .gcsObjectSize(123456789L)
            .gcsObjectKey("String0")
            .gcsObjectMediaLink("String0")
            .gcsObjectHoldType("String0")
            .gcsObjectGenerationId(123456789L)
            .gcsObjectCRC32CHash("String0")
            .gcsObjectMD5Hash("String0")
            .gcsObjectDataLastModifiedTime(123456789L)
            .gcsObjectContentType("String0")
            .gcsObjectContentEncoding("String0")
            .gcsObjectContentDisposition("String0")
            .gcsObjectContentLanguage("String0")
            .gcsObjectRetentionExpirationDate(123456789L)
            ...
            .gcsBucket(GCSBucket.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleGCSObject() throws IOException {
        assertNotNull(full, "Unable to build sample instance of GCSObject,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting GCSObject via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of GCSObject,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final GCSObject frodo = MockAtlanTenant.client.readValue(serialized, GCSObject.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of GCSObject,");
