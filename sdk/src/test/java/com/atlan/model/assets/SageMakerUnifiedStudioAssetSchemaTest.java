...
public class SageMakerUnifiedStudioAssetSchemaTest {

    private final SageMakerUnifiedStudioAssetSchema full = SageMakerUnifiedStudioAssetSchema._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSageMakerUnifiedStudioAssetSchema() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SageMakerUnifiedStudioAssetSchema,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SageMakerUnifiedStudioAssetSchema via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SageMakerUnifiedStudioAssetSchema,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SageMakerUnifiedStudioAssetSchema frodo = MockAtlanTenant.client.readValue(serialized, SageMakerUnifiedStudioAssetSchema.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerUnifiedStudioAssetSchema,");
