...
public class SapAnalyticsCloudColumnTest {

    private final SapAnalyticsCloudColumn full = SapAnalyticsCloudColumn._internal()
            .guid("guid")
            ...
            .sapAnalyticsCloudModelQualifiedName("String0")
            .sapAnalyticsCloudModelName("String0")
            ...
            .dataQualityMetricDimension(Metric.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dataQualityMetricDimension(Metric.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSapAnalyticsCloudColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapAnalyticsCloudColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapAnalyticsCloudColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapAnalyticsCloudColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapAnalyticsCloudColumn frodo =
                MockAtlanTenant.client.readValue(serialized, SapAnalyticsCloudColumn.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of SapAnalyticsCloudColumn,");
