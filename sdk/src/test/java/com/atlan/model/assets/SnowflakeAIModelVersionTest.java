...
public class SnowflakeAIModelVersionTest {
    ...
    private final SnowflakeAIModelVersion full = SnowflakeAIModelVersion._internal()
            ...
            .snowflakeAIModelVersionMetric("String0", "String0")
            .snowflakeAIModelVersionMetric("String1", "String1")
    ...
    void serdeCycleSnowflakeAIModelVersion() throws IOException {
        ...
        // Deserialization
        final SnowflakeAIModelVersion frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeAIModelVersion.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeAIModelVersion,");
