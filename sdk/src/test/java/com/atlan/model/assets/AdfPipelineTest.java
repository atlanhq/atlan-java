...
public class AdfPipelineTest {
    ...
    private final AdfPipeline full = AdfPipeline._internal()
            .guid("guid")
            ...
            .adfPipelineRun("String0", "String0")
            .adfPipelineRun("String1", "String1")
    ...
    @Test
    void serdeCycleAdfPipeline() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AdfPipeline,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AdfPipeline via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AdfPipeline,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AdfPipeline frodo = MockAtlanTenant.client.readValue(serialized, AdfPipeline.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AdfPipeline,");
