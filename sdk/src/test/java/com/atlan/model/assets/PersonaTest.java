...
public class PersonaTest {
    ...
    private final Persona full = Persona._internal()
            .guid("guid")
            ...
            .denyAssetFilter(AssetFilterGroup.VALUE0)
            .denyAssetFilter(AssetFilterGroup.VALUE1)
            .denyAssetMetadataType("String0")
            .denyAssetMetadataType("String1")
            .denyAssetTab(AssetSidebarTab.VALUE0)
            .denyAssetTab(AssetSidebarTab.VALUE1)
    ...
    @Test
    void serdeCyclePersona() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Persona,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Persona via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Persona,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Persona frodo = MockAtlanTenant.client.readValue(serialized, Persona.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Persona,");
