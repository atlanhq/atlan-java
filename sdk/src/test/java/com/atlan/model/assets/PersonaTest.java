...
public class PersonaTest {
    ...
    private static final Persona full = Persona._internal()
            .guid("guid")
    ...
    @Test(groups = {"Persona.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"Persona.serialize"},
            dependsOnGroups = {"Persona.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, Persona.class);
        assertNotNull(frodo);
    }
