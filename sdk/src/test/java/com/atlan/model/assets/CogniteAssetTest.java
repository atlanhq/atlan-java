...
public class CogniteAssetTest {
    ...
    private static final CogniteAsset full = CogniteAsset._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .cognite3dmodel(Cognite3DModel.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cognite3dmodel(Cognite3DModel.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cogniteEvent(CogniteEvent.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cogniteEvent(CogniteEvent.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cogniteFile(CogniteFile.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cogniteFile(CogniteFile.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cogniteSequence(CogniteSequence.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cogniteSequence(CogniteSequence.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .addCogniteTimeseries(CogniteTimeSeries.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .addCogniteTimeseries(
