...
public class GCPDataplexAspectTypeTest {

    private final GCPDataplexAspectType full = GCPDataplexAspectType._internal()
            .guid("guid")
            ...
            .gcpDataplexAspectTypeResourceName("String0")
            .gcpDataplexAspectTypeProject("String0")
            .gcpDataplexAspectTypeLocation("String0")
            .gcpDataplexAspectTypeMetadataTemplate("String0")
            .gcpDataplexAspectTypeLabel("String0", "String0")
            .gcpDataplexAspectTypeLabel("String1", "String1")
            .gcpDataplexAspectTypeEntry(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleGCPDataplexAspectType() throws IOException {
        assertNotNull(full, "Unable to build sample instance of GCPDataplexAspectType,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting GCPDataplexAspectType via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of GCPDataplexAspectType,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final GCPDataplexAspectType frodo = MockAtlanTenant.client.readValue(serialized, GCPDataplexAspectType.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of GCPDataplexAspectType,");
