...
public class InsightTest {
    ...
    private final Insight full = Insight._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleInsight() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Insight,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Insight via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Insight,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Insight frodo = MockAtlanTenant.client.readValue(serialized, Insight.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Insight,");
