...
public class DynamoDBAttributeTest {

    private final DynamoDBAttribute full = DynamoDBAttribute._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDynamoDBAttribute() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DynamoDBAttribute,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DynamoDBAttribute via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DynamoDBAttribute,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DynamoDBAttribute frodo = MockAtlanTenant.client.readValue(serialized, DynamoDBAttribute.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DynamoDBAttribute,");
