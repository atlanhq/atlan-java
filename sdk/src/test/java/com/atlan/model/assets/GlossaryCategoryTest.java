...
public class GlossaryCategoryTest {
    ...
    private final GlossaryCategory full = GlossaryCategory._internal()
            .guid("guid")
            ...
            .categoryType(AtlasGlossaryCategoryType.DOCUMENT_FOLDER)
            ...
            .term(GlossaryTerm.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .term(GlossaryTerm.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleGlossaryCategory() throws IOException {
        assertNotNull(full, "Unable to build sample instance of GlossaryCategory,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting GlossaryCategory via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of GlossaryCategory,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final GlossaryCategory frodo = MockAtlanTenant.client.readValue(serialized, GlossaryCategory.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of GlossaryCategory,");
