...
public class LookerFolderTest {
    ...
    private final LookerFolder full = LookerFolder._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .sourceContentMetadataId(123)
            .sourceCreatorId(123)
            .sourceChildCount(123)
            .sourceParentID(123)
            ...
            .dashboard(LookerDashboard.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .look(LookerLook.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .look(LookerLook.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .lookerSubFolder(LookerFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .lookerSubFolder(LookerFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .lookerParentFolder(LookerFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleLookerFolder() throws IOException {
        assertNotNull(full, "Unable to build sample instance of LookerFolder,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting LookerFolder via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of LookerFolder,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final LookerFolder frodo = MockAtlanTenant.client.readValue(serialized, LookerFolder.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of LookerFolder,");
