...
public class QlikSpaceTest {
    ...
    private final QlikSpace full = QlikSpace._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleQlikSpace() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QlikSpace,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QlikSpace via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QlikSpace,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QlikSpace frodo = MockAtlanTenant.client.readValue(serialized, QlikSpace.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QlikSpace,");
