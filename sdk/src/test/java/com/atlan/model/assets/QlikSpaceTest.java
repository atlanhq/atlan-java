...
public class QlikSpaceTest {
    ...
    private static final QlikSpace full = QlikSpace._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .qlikApp(QlikApp.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .qlikApp(QlikApp.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .qlikDataset(QlikDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .qlikDataset(QlikDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .qlikSpaceType("String0")
            .build();
    ...
    @Test(groups = {"QlikSpace.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"QlikSpace.serialize"},
            dependsOnGroups = {"QlikSpace.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"QlikSpace.deserialize"},
            dependsOnGroups = {"QlikSpace.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, QlikSpace.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"QlikSpace.equivalency"},
            dependsOnGroups = {"QlikSpace.serialize", "QlikSpace.deserialize"})
