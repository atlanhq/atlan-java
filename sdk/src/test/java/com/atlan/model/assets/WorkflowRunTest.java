...
public class WorkflowRunTest {
    ...
    private static final WorkflowRun full = WorkflowRun._internal()
            ...
            .workflowRunDeletedAt(123456789L)
            .workflowRunExpiresAt(123456789L)
            .workflowRunOnAssetGuid("String0")
            .workflowRunStatus(WorkflowRunStatus.PENDING)
            .workflowRunType(WorkflowRunType.DATA_ACCESS)
            .workflowRunUpdatedBy("String0")
