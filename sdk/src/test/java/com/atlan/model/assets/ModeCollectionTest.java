...
public class ModeCollectionTest {
    ...
    private static final ModeCollection full = ModeCollection._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .modeCollectionState("String0")
            .modeCollectionType("String0")
            .modeReport(ModeReport.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modeReport(ModeReport.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modeWorkspace(ModeWorkspace.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, ModeCollection.class);
        assertNotNull(frodo);
    }
