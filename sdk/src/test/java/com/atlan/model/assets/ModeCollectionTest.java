...
public class ModeCollectionTest {
    ...
    private final ModeCollection full = ModeCollection._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleModeCollection() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ModeCollection,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ModeCollection via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ModeCollection,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ModeCollection frodo = MockAtlanTenant.client.readValue(serialized, ModeCollection.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ModeCollection,");
