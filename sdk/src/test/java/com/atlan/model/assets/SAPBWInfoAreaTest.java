...
public class SAPBWInfoAreaTest {

    private final SAPBWInfoArea full = SAPBWInfoArea._internal()
            .guid("guid")
            ...
            .sapBwChildInfoArea(SAPBWInfoArea.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwChildInfoArea(SAPBWInfoArea.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwParentInfoArea(SAPBWInfoArea.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            ...
            .sapBwInfoSource(SAPBWInfoSource.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwInfoSource(SAPBWInfoSource.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwAdso(SAPBWADSO.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwAdso(SAPBWADSO.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwCompositeProvider(SAPBWCompositeProvider.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwCompositeProvider(
                    SAPBWCompositeProvider.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwQuery(SAPBWQuery.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwQuery(SAPBWQuery.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSAPBWInfoArea() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWInfoArea,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWInfoArea via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWInfoArea,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWInfoArea frodo = MockAtlanTenant.client.readValue(serialized, SAPBWInfoArea.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWInfoArea,");
