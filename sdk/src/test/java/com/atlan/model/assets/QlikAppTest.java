...
public class QlikAppTest {
    ...
    private final QlikApp full = QlikApp._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .qlikHasSectionAccess(true)
            .qlikOriginAppId("String0")
            .qlikIsEncrypted(true)
            .qlikIsDirectQueryMode(true)
            .qlikAppStaticByteSize(123456789L)
            .qlikSheet(QlikSheet.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .qlikSheet(QlikSheet.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .qlikSpace(QlikSpace.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleQlikApp() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QlikApp,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QlikApp via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QlikApp,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QlikApp frodo = MockAtlanTenant.client.readValue(serialized, QlikApp.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QlikApp,");
