...
public class StakeholderTitleTest {

    private final StakeholderTitle full = StakeholderTitle._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .stakeholderTitleDomainQualifiedName("String0")
            .stakeholderTitleDomainQualifiedName("String1")
    ...
    @Test
    void serdeCycleStakeholderTitle() throws IOException {
        assertNotNull(full, "Unable to build sample instance of StakeholderTitle,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting StakeholderTitle via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of StakeholderTitle,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final StakeholderTitle frodo = MockAtlanTenant.client.readValue(serialized, StakeholderTitle.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of StakeholderTitle,");
