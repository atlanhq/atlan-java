...
public class StakeholderTitleTest {
    ...
    private static final StakeholderTitle full = StakeholderTitle._internal()
            .guid("guid")
    ...
    private static StakeholderTitle frodo;
    ...
    @Test(groups = {"StakeholderTitle.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"StakeholderTitle.serialize"},
            dependsOnGroups = {"StakeholderTitle.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"StakeholderTitle.deserialize"},
            dependsOnGroups = {"StakeholderTitle.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, StakeholderTitle.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"StakeholderTitle.equivalency"},
            dependsOnGroups = {"StakeholderTitle.serialize", "StakeholderTitle.deserialize"})
