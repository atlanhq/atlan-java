...
public class PowerBIMeasureTest {
    ...
    private static final PowerBIMeasure full = PowerBIMeasure._internal()
            .guid("guid")
            ...
            .powerBIColumn(PowerBIColumn.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .powerBIColumn(PowerBIColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .powerBIIsExternalMeasure(true)
            .powerBIMeasureExpression("String0")
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, PowerBIMeasure.class);
        assertNotNull(frodo);
    }
