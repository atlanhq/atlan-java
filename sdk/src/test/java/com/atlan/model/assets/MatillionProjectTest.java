...
public class MatillionProjectTest {
    ...
    private static final MatillionProject full = MatillionProject._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .matillionEnvironment("String0")
            .matillionEnvironment("String1")
            .matillionGroup(MatillionGroup.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .matillionGroupName("String0")
            .matillionGroupQualifiedName("String0")
            .matillionJob(MatillionJob.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .matillionJob(MatillionJob.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .matillionProjectJobCount(123456789L)
            .addMatillionVersion("String0")
