...
public class DataQualityRuleTemplateTest {
    ...
    private static final DataQualityRuleTemplate full = DataQualityRuleTemplate._internal()
            .guid("guid")
    ...
    private static DataQualityRuleTemplate frodo;
    ...
    @Test(groups = {"DataQualityRuleTemplate.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DataQualityRuleTemplate.serialize"},
            dependsOnGroups = {"DataQualityRuleTemplate.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DataQualityRuleTemplate.deserialize"},
            dependsOnGroups = {"DataQualityRuleTemplate.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DataQualityRuleTemplate.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DataQualityRuleTemplate.equivalency"},
            dependsOnGroups = {"DataQualityRuleTemplate.serialize", "DataQualityRuleTemplate.deserialize"})
