...
public class DataQualityRuleTemplateTest {

    private final DataQualityRuleTemplate full = DataQualityRuleTemplate._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .dqRuleTemplateDimension(DataQualityDimension.COMPLETENESS)
            .dqRuleTemplateConfig(DataQualityRuleTemplateConfig.builder()
                    .dqRuleTemplateConfigBaseDatasetQualifiedName("String0")
                    .dqRuleTemplateConfigBaseColumnQualifiedName("String0")
                    .dqRuleTemplateConfigReferenceDatasetQualifiedNames("String0")
                    .dqRuleTemplateConfigReferenceColumnQualifiedNames("String0")
                    .dqRuleTemplateConfigThresholdObject("String0")
                    .dqRuleTemplateConfigDisplayName("String0")
                    .dqRuleTemplateConfigCustomSQL("String0")
                    .dqRuleTemplateConfigDimension("String0")
                    .dqRuleTemplateConfigUserDescription("String0")
                    .dqRuleTemplateConfigAdvancedSettings("String0")
                    .dqRuleTemplateConfigRuleConditions("String0")
                    .dqRuleTemplateConfigPreflightCheck("String0")
                    .build())
            .dqRuleTemplateMetricValueType(DataQualityRuleTemplateMetricValueType.ABSOLUTE)
            ...
            .dqRule(DataQualityRule.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dqRule(DataQualityRule.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDataQualityRuleTemplate() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DataQualityRuleTemplate,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DataQualityRuleTemplate via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DataQualityRuleTemplate,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DataQualityRuleTemplate frodo = MockAtlanTenant.client.readValue(serialized, DataQualityRuleTemplate.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DataQualityRuleTemplate,");
