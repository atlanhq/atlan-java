...
public class FlowProcessGroupingTest {

    private static final FlowProcessGrouping full = FlowProcessGrouping._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .flowAbstract(FlowInterimDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowAbstract(FlowInterimDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .flowDataFlow(LineageProcess.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowDataFlow(LineageProcess.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static FlowProcessGrouping frodo;
    private static String serialized;

    @Test(groups = {"FlowProcessGrouping.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowProcessGrouping.serialize"},
            dependsOnGroups = {"FlowProcessGrouping.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowProcessGrouping.deserialize"},
            dependsOnGroups = {"FlowProcessGrouping.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowProcessGrouping.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowProcessGrouping.equivalency"},
            dependsOnGroups = {"FlowProcessGrouping.serialize", "FlowProcessGrouping.deserialize"})
