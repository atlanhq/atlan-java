...
public class FlowProjectTest {
    ...
    private static final FlowProject full = FlowProject._internal()
            ...
            .flowFolder(FlowFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .flowGrouping(FlowProcessGrouping.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowGrouping(FlowProcessGrouping.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
