...
public class SAPBWCompositeProviderFieldTest {

    private final SAPBWCompositeProviderField full = SAPBWCompositeProviderField._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSAPBWCompositeProviderField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWCompositeProviderField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWCompositeProviderField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWCompositeProviderField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWCompositeProviderField frodo =
                MockAtlanTenant.client.readValue(serialized, SAPBWCompositeProviderField.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of SAPBWCompositeProviderField,");
