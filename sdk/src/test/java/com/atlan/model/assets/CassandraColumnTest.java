...
public class CassandraColumnTest {

    private static final CassandraColumn full = CassandraColumn._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .cassandraColumnClusteringOrder("String0")
            .cassandraColumnIsClusteringKey(true)
            .cassandraColumnIsPartitionKey(true)
            .cassandraColumnIsStatic(true)
            .cassandraColumnKind("String0")
            .cassandraColumnPosition(123456789L)
            .cassandraColumnType("String0")
    ...
    private static CassandraColumn frodo;
    private static String serialized;

    @Test(groups = {"CassandraColumn.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CassandraColumn.serialize"},
            dependsOnGroups = {"CassandraColumn.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CassandraColumn.deserialize"},
            dependsOnGroups = {"CassandraColumn.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CassandraColumn.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CassandraColumn.equivalency"},
            dependsOnGroups = {"CassandraColumn.serialize", "CassandraColumn.deserialize"})
