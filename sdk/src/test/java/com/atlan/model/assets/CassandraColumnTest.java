...
public class CassandraColumnTest {
    ...
    private final CassandraColumn full = CassandraColumn._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCassandraColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CassandraColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CassandraColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CassandraColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CassandraColumn frodo = MockAtlanTenant.client.readValue(serialized, CassandraColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CassandraColumn,");
