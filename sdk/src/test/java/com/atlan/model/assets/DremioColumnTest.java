...
public class DremioColumnTest {
    ...
    private final DremioColumn full = DremioColumn._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDremioColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DremioColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DremioColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DremioColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DremioColumn frodo = MockAtlanTenant.client.readValue(serialized, DremioColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DremioColumn,");
