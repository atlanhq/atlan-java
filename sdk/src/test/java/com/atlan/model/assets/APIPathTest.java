...
public class APIPathTest {
    ...
    private static final APIPath full = APIPath._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .apiPathAvailableOperation("String0")
            .apiPathAvailableOperation("String1")
            .apiPathAvailableResponseCode("key1", "value1")
            .apiPathAvailableResponseCode("key2", "value2")
            .apiPathIsIngressExposed(true)
            .apiPathIsTemplated(true)
            .apiPathRawURI("String0")
            .apiPathSummary("String0")
