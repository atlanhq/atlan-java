...
public class APIPathTest {
    ...
    private final APIPath full = APIPath._internal()
            ...
            .apiPathAvailableResponseCode("String0", "String0")
            .apiPathAvailableResponseCode("String1", "String1")
    ...
    void serdeCycleAPIPath() throws IOException {
        ...
        assertEquals(
                ...
                full,
                "Unable to converting APIPath via builder back to its original state,");
        // Serialization
