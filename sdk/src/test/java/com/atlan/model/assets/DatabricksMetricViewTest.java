...
public class DatabricksMetricViewTest {

    private final DatabricksMetricView full = DatabricksMetricView._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDatabricksMetricView() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DatabricksMetricView,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DatabricksMetricView via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DatabricksMetricView,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DatabricksMetricView frodo = MockAtlanTenant.client.readValue(serialized, DatabricksMetricView.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DatabricksMetricView,");
