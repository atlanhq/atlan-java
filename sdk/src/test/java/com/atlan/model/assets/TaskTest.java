...
public class TaskTest {
    ...
    private static final Task full = Task._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .taskAction(Action.builder()
                    .taskActionFulfillmentUrl("String0")
                    .taskActionFulfillmentMethod("String0")
                    .taskActionFulfillmentPayload("String0")
                    .taskActionDisplayText("String0")
                    .build())
            .taskAction(Action.builder()
                    .taskActionFulfillmentUrl("String1")
                    .taskActionFulfillmentMethod("String1")
    ...
    private static Task frodo;
    private static String serialized;

    @Test(groups = {"Task.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"Task.serialize"},
            dependsOnGroups = {"Task.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"Task.deserialize"},
            dependsOnGroups = {"Task.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, Task.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"Task.equivalency"},
            dependsOnGroups = {"Task.serialize", "Task.deserialize"})
