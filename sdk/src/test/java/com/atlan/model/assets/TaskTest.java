...
public class TaskTest {
    ...
    private final Task full = Task._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleTask() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Task,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(), full, "Unable to converting Task via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Task,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Task frodo = MockAtlanTenant.client.readValue(serialized, Task.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Task,");
