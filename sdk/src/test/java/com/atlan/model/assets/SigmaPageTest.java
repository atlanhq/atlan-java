...
public class SigmaPageTest {
    ...
    private static final SigmaPage full = SigmaPage._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .sigmaDataElementCount(123456789L)
            .sigmaDataElement(SigmaDataElement.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sigmaDataElement(SigmaDataElement.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sigmaWorkbook(SigmaWorkbook.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();
