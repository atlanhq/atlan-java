...
public class SigmaPageTest {
    ...
    private final SigmaPage full = SigmaPage._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSigmaPage() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SigmaPage,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SigmaPage via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SigmaPage,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SigmaPage frodo = MockAtlanTenant.client.readValue(serialized, SigmaPage.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SigmaPage,");
