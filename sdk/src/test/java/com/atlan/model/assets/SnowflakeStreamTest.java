...
public class SnowflakeStreamTest {
    ...
    private final SnowflakeStream full = SnowflakeStream._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSnowflakeStream() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeStream,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeStream via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeStream,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeStream frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeStream.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeStream,");
