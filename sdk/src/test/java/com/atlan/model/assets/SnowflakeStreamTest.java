...
public class SnowflakeStreamTest {
    ...
    private static final SnowflakeStream full = SnowflakeStream._internal()
            ...
            .snowflakeStreamMode("String0")
            .snowflakeStreamSourceType("String0")
            .snowflakeStreamStaleAfter(123456789L)
            .snowflakeStreamType("String0")
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeStream.class);
        assertNotNull(frodo);
    }
