...
public class AirflowTaskTest {

    private final AirflowTask full = AirflowTask._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .airflowTaskOperatorClass("String0")
            .airflowDagName("String0")
            .airflowDagQualifiedName("String0")
            .airflowTaskConnectionId("String0")
            .airflowTaskSql("String0")
            .airflowTaskRetryNumber(123456789L)
            .airflowTaskPool("String0")
            .airflowTaskPoolSlots(123456789L)
            .airflowTaskQueue("String0")
            .airflowTaskPriorityWeight(123456789L)
            .airflowTaskTriggerRule("String0")
            .airflowTaskGroupName("String0")
            .airflowDag(AirflowDag.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            ...
            .sparkOrchestratedAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sparkOrchestratedAsset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
    ...
    @Test
    void serdeCycleAirflowTask() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AirflowTask,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AirflowTask via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AirflowTask,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AirflowTask frodo = MockAtlanTenant.client.readValue(serialized, AirflowTask.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AirflowTask,");
