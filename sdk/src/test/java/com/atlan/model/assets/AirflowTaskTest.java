...
public class AirflowTaskTest {
    ...
    private final AirflowTask full = AirflowTask._internal()
            ...
            .sparkOrchestratedAsset(Spark.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sparkOrchestratedAsset(Spark.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
