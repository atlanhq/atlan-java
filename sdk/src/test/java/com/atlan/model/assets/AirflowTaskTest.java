...
public class AirflowTaskTest {
    ...
    private static final AirflowTask full = AirflowTask._internal()
            .guid("guid")
    ...
    private static AirflowTask frodo;
    private static String serialized;

    @Test(groups = {"AirflowTask.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AirflowTask.serialize"},
            dependsOnGroups = {"AirflowTask.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AirflowTask.deserialize"},
            dependsOnGroups = {"AirflowTask.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AirflowTask.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AirflowTask.equivalency"},
            dependsOnGroups = {"AirflowTask.serialize", "AirflowTask.deserialize"})
