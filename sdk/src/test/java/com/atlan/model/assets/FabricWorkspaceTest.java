...
public class FabricWorkspaceTest {
    ...
    private final FabricWorkspace full = FabricWorkspace._internal()
            ...
            .fabricDatabase(Database.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .fabricDatabase(Database.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .fabricDashboard(FabricDashboard.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .fabricDashboard(FabricDashboard.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .fabricDataflow(FabricDataflow.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .fabricDataflow(FabricDataflow.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .fabricDataPipeline(FabricDataPipeline.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .fabricDataPipeline(FabricDataPipeline.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .fabricReport(FabricReport.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .fabricReport(FabricReport.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .fabricSemanticModel(FabricSemanticModel.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .fabricSemanticModel(FabricSemanticModel.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
