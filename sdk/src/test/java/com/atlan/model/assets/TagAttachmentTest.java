...
public class TagAttachmentTest {
    ...
    private final TagAttachment full = TagAttachment._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleTagAttachment() throws IOException {
        assertNotNull(full, "Unable to build sample instance of TagAttachment,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting TagAttachment via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of TagAttachment,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final TagAttachment frodo = MockAtlanTenant.client.readValue(serialized, TagAttachment.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of TagAttachment,");
