...
public class TagAttachmentTest {

    private static final TagAttachment full = TagAttachment._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .tagAttachmentStringValue("String0")
            .tagQualifiedName("String0")
            .build();

    private static final int hash = full.hashCode();
    private static TagAttachment frodo;
    private static String serialized;

    @Test(groups = {"TagAttachment.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TagAttachment.serialize"},
            dependsOnGroups = {"TagAttachment.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TagAttachment.deserialize"},
            dependsOnGroups = {"TagAttachment.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TagAttachment.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TagAttachment.equivalency"},
            dependsOnGroups = {"TagAttachment.serialize", "TagAttachment.deserialize"})
