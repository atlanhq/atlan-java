...
public class ConnectionTest {
    ...
    private final Connection full = Connection._internal()
            .guid("guid")
            ...
            .connectionDQCredentialGuid("String0")
            .connectionDQEnvironmentSetupErrorMessage("String0")
            .connectionDQEnvironmentSetupStatus(ConnectionDQEnvironmentSetupStatus.NOT_STARTED)
            .connectionDQEnvironmentSetupStatusUpdatedAt(123456789L)
            .connectionDQEnvironmentSourceDatabaseName("String0")
    ...
    @Test
    void serdeCycleConnection() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Connection,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Connection via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Connection,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Connection frodo = MockAtlanTenant.client.readValue(serialized, Connection.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Connection,");
