...
public class ConnectionTest {
    ...
    private static final Connection full = Connection._internal()
            .guid("guid")
            ...
            .category(AtlanConnectionCategory.WAREHOUSE)
            .connectionDbtEnvironment("String0")
            ...
            .queryTimeout(123456789L)
            .queryUsernameStrategy(QueryUsernameStrategy.CONNECTION_USERNAME)
            .rowLimit(123456789L)
            .sourceLogo("String0")
            .subCategory("String0")
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, Connection.class);
        assertNotNull(frodo);
    }
