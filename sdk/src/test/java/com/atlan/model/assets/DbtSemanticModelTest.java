...
public class DbtSemanticModelTest {

    private final DbtSemanticModel full = DbtSemanticModel._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDbtSemanticModel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtSemanticModel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtSemanticModel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtSemanticModel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtSemanticModel frodo = MockAtlanTenant.client.readValue(serialized, DbtSemanticModel.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtSemanticModel,");
