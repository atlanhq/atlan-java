...
public class MicroStrategyColumnTest {
    ...
    private final MicroStrategyColumn full = MicroStrategyColumn._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleMicroStrategyColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MicroStrategyColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MicroStrategyColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MicroStrategyColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MicroStrategyColumn frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MicroStrategyColumn,");
