...
public class SapErpColumnTest {

    private static final SapErpColumn full = SapErpColumn._internal()
            .guid("guid")
            ...
            .sapErpCdsViewName("String0")
            .sapErpCdsViewQualifiedName("String0")
            .sapErpColumnDataElement("String0")
            .sapErpColumnDecimals("String0")
            .sapErpColumnIsForeign(true)
            .sapErpColumnIsMandatory(true)
            .sapErpColumnIsPrimary(true)
            ...
            .sapErpTableName("String0")
            .sapErpTableQualifiedName("String0")
            .sapErpView(SapErpView.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapErpViewName("String0")
            .sapErpViewQualifiedName("String0")
            .build();

    private static final int hash = full.hashCode();
    private static SapErpColumn frodo;
    private static String serialized;

    @Test(groups = {"SapErpColumn.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SapErpColumn.serialize"},
            dependsOnGroups = {"SapErpColumn.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SapErpColumn.deserialize"},
            dependsOnGroups = {"SapErpColumn.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SapErpColumn.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SapErpColumn.equivalency"},
            dependsOnGroups = {"SapErpColumn.serialize", "SapErpColumn.deserialize"})
