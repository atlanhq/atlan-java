...
public class SapErpColumnTest {
    ...
    private final SapErpColumn full = SapErpColumn._internal()
            .guid("guid")
            ...
            .sapErpColumnCheckTableName("String0")
            .sapErpColumnCheckTableQualifiedName("String0")
    ...
    @Test
    void serdeCycleSapErpColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapErpColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapErpColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapErpColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapErpColumn frodo = MockAtlanTenant.client.readValue(serialized, SapErpColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SapErpColumn,");
