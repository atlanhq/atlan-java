...
public class PowerBIColumnTest {
    ...
    private final PowerBIColumn full = PowerBIColumn._internal()
            .guid("guid")
            ...
            .powerBIColumnDataCategory("String0")
            .powerBIColumnDataType("String0")
            .powerBISortByColumn("String0")
            .powerBIColumnSummarizeBy("String0")
            ...
            .powerBIMeasure(PowerBIMeasure.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .powerBIMeasure(PowerBIMeasure.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCyclePowerBIColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PowerBIColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PowerBIColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PowerBIColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PowerBIColumn frodo = MockAtlanTenant.client.readValue(serialized, PowerBIColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PowerBIColumn,");
