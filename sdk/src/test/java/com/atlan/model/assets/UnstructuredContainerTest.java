...
public class UnstructuredContainerTest {
    ...
    private final UnstructuredContainer full = UnstructuredContainer._internal()
            .guid("guid")
            ...
            .unstructuredFolder(UnstructuredFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .unstructuredFolder(
    ...
    @Test
    void serdeCycleUnstructuredContainer() throws IOException {
        assertNotNull(full, "Unable to build sample instance of UnstructuredContainer,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting UnstructuredContainer via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of UnstructuredContainer,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final UnstructuredContainer frodo = MockAtlanTenant.client.readValue(serialized, UnstructuredContainer.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of UnstructuredContainer,");
