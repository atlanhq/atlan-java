...
public class ModelEntityAssociationTest {
    ...
    private static final ModelEntityAssociation full = ModelEntityAssociation._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .modelEntityAssociationCardinality(ModelCardinalityType.ONE_TO_ONE)
            .modelEntityAssociationFrom(ModelEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelEntityAssociationFromLabel("String0")
            .modelEntityAssociationFromMaxCardinality(123456789L)
            .modelEntityAssociationFromMinCardinality(123456789L)
            .modelEntityAssociationFromQualifiedName("String0")
            .modelEntityAssociationLabel("String0")
            .modelEntityAssociationTo(ModelEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelEntityAssociationToLabel("String0")
            .modelEntityAssociationToMaxCardinality(123456789L)
            .modelEntityAssociationToMinCardinality(123456789L)
