...
public class SapErpComponentTest {
    ...
    private final SapErpComponent full = SapErpComponent._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSapErpComponent() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapErpComponent,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapErpComponent via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapErpComponent,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapErpComponent frodo = MockAtlanTenant.client.readValue(serialized, SapErpComponent.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SapErpComponent,");
