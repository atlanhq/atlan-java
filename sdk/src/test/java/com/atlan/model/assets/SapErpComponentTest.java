...
public class SapErpComponentTest {

    private static final SapErpComponent full = SapErpComponent._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .childComponent(SapErpComponent.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    private static SapErpComponent frodo;
    private static String serialized;

    @Test(groups = {"SapErpComponent.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SapErpComponent.serialize"},
            dependsOnGroups = {"SapErpComponent.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SapErpComponent.deserialize"},
            dependsOnGroups = {"SapErpComponent.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SapErpComponent.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SapErpComponent.equivalency"},
            dependsOnGroups = {"SapErpComponent.serialize", "SapErpComponent.deserialize"})
