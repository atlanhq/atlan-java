...
public class DataContractTest {
    ...
    private final DataContract full = DataContract._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDataContract() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DataContract,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DataContract via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DataContract,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DataContract frodo = MockAtlanTenant.client.readValue(serialized, DataContract.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DataContract,");
