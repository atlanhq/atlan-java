...
public class DataContractTest {
    ...
    private static final DataContract full = DataContract._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .dataContractAssetCertified(TagAttachment.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dataContractAssetGuid("String0")
            .dataContractAssetLatest(TagAttachment.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
