...
public class SapErpTableTest {

    private static final SapErpTable full = SapErpTable._internal()
            .guid("guid")
            ...
            .sapErpTableDeliveryClass("String0")
            .sapErpTableType("String0")
            .build();

    private static final int hash = full.hashCode();
    private static SapErpTable frodo;
    private static String serialized;

    @Test(groups = {"SapErpTable.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SapErpTable.serialize"},
            dependsOnGroups = {"SapErpTable.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SapErpTable.deserialize"},
            dependsOnGroups = {"SapErpTable.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SapErpTable.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SapErpTable.equivalency"},
            dependsOnGroups = {"SapErpTable.serialize", "SapErpTable.deserialize"})
