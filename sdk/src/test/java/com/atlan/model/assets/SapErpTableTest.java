...
public class SapErpTableTest {
    ...
    private final SapErpTable full = SapErpTable._internal()
            .guid("guid")
            ...
            .sapErpRelatedTable(SapErpTable.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapErpRelatedTable(SapErpTable.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSapErpTable() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapErpTable,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapErpTable via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapErpTable,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapErpTable frodo = MockAtlanTenant.client.readValue(serialized, SapErpTable.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SapErpTable,");
