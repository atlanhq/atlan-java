...
public class SigmaDataModelColumnTest {

    private final SigmaDataModelColumn full = SigmaDataModelColumn._internal()
            .guid("guid")
            ...
            .sigmaDataModelQualifiedName("String0")
            .sigmaDataModelName("String0")
            .sigmaDataModelColumnFormula("String0")
            .sigmaDataModelColumnDataType("String0")
            .sigmaDataModel(SigmaDataModel.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleSigmaDataModelColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SigmaDataModelColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SigmaDataModelColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SigmaDataModelColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SigmaDataModelColumn frodo = MockAtlanTenant.client.readValue(serialized, SigmaDataModelColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SigmaDataModelColumn,");
