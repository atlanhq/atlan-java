...
public class SigmaDataElementTest {
    ...
    private final SigmaDataElement full = SigmaDataElement._internal()
            .guid("guid")
            ...
            .sigmaDataElementField(SigmaDataElementField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSigmaDataElement() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SigmaDataElement,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SigmaDataElement via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SigmaDataElement,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SigmaDataElement frodo = MockAtlanTenant.client.readValue(serialized, SigmaDataElement.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SigmaDataElement,");
