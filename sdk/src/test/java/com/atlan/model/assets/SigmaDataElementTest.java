...
public class SigmaDataElementTest {
    ...
    private static final SigmaDataElement full = SigmaDataElement._internal()
            ...
            .sigmaPageQualifiedName("String0")
            .sigmaWorkbookName("String0")
            .sigmaWorkbookQualifiedName("String0")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .sigmaDataElementFieldCount(123456789L)
            .sigmaDataElementField(SigmaDataElementField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sigmaDataElementField(
                    SigmaDataElementField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sigmaDataElementQuery("String0")
            .sigmaDataElementType("String0")
            .sigmaPage(SigmaPage.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SigmaDataElement.class);
        assertNotNull(frodo);
    }
