...
public class PartialFieldTest {
    ...
    private final PartialField full = PartialField._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .partialStructureJSON("String0")
            .partialResolvedTypeName("String0")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .partialDataType("String0")
            .partialParentAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCyclePartialField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PartialField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PartialField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PartialField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PartialField frodo = MockAtlanTenant.client.readValue(serialized, PartialField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PartialField,");
