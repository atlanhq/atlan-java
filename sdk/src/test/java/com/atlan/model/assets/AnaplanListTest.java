...
public class AnaplanListTest {

    private static final AnaplanList full = AnaplanList._internal()
            .guid("guid")
    ...
    private static AnaplanList frodo;
    private static String serialized;

    @Test(groups = {"AnaplanList.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AnaplanList.serialize"},
            dependsOnGroups = {"AnaplanList.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AnaplanList.deserialize"},
            dependsOnGroups = {"AnaplanList.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AnaplanList.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AnaplanList.equivalency"},
            dependsOnGroups = {"AnaplanList.serialize", "AnaplanList.deserialize"})
