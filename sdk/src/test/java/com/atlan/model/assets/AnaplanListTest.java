...
public class AnaplanListTest {
    ...
    private final AnaplanList full = AnaplanList._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAnaplanList() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AnaplanList,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AnaplanList via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AnaplanList,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AnaplanList frodo = MockAtlanTenant.client.readValue(serialized, AnaplanList.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AnaplanList,");
