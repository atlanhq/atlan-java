...
public class QuickSightDashboardVisual extends Asset implements IQuickSightDashboardVisual, IQuickSight, IBI, ICatalog, IAsset, IReferenceable {
    ...
    public static QuickSightDashboardVisual refByQualifiedName(String qualifiedName, Reference.SaveSemantic semantic) {
        return QuickSightDashboardVisual._internal()
                .uniqueAttributes(
     ...
     */
    @JsonIgnore
    public static QuickSightDashboardVisual get(AtlanClient client, String id, boolean includeAllRelationships) throws AtlanException {
        if (id == null) {
    ...
    /**
     * Retrieves a QuickSightDashboardVisual by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the QuickSightDashboardVisual to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the QuickSightDashboardVisual, including any relationships
     * @return the requested QuickSightDashboardVisual, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the QuickSightDashboardVisual does not exist or the provided GUID is not a QuickSightDashboardVisual
     */
    @JsonIgnore
    public static QuickSightDashboardVisual get(AtlanClient client, String id, Collection<AtlanField> attributes) throws AtlanException {
     ...
     * @param id of the QuickSightDashboardVisual to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the QuickSightDashboardVisual, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the QuickSightDashboardVisual
     * @return the requested QuickSightDashboardVisual, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the QuickSightDashboardVisual does not exist or the provided GUID is not a QuickSightDashboardVisual
     */
    @JsonIgnore
    public static QuickSightDashboardVisual get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = QuickSightDashboardVisual.select(client)
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof QuickSightDashboardVisual) {
                return (QuickSightDashboardVisual) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
    ...
    /**
     * Builds the minimal object necessary to apply an update to a QuickSightDashboardVisual,
     * from a potentially more-complete QuickSightDashboardVisual object.
     *
     * @return the minimal object necessary to update the QuickSightDashboardVisual, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a QuickSightDashboardVisual are not present in the initial object
     */
    @Override
    ...
    public abstract static class QuickSightDashboardVisualBuilder<C extends QuickSightDashboardVisual, B extends QuickSightDashboardVisualBuilder<C, B>>
     ...
     * @throws AtlanException on any API problems
     */
    public static QuickSightDashboardVisual replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    @Deprecated
    public static QuickSightDashboardVisual appendTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    @Deprecated
    public static QuickSightDashboardVisual removeTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    @Deprecated
    public static QuickSightDashboardVisual appendAtlanTags(AtlanClient client, String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
