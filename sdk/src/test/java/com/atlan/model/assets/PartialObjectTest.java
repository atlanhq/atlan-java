...
public class PartialObjectTest {
    ...
    private final PartialObject full = PartialObject._internal()
            .guid("guid")
    ...
    @Test
    void serdeCyclePartialObject() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PartialObject,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PartialObject via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PartialObject,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PartialObject frodo = MockAtlanTenant.client.readValue(serialized, PartialObject.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PartialObject,");
