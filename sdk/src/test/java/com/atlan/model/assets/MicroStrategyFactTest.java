...
public class MicroStrategyFactTest {

    private static final MicroStrategyFact full = MicroStrategyFact._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .microStrategyFactExpression("String0")
            .microStrategyFactExpression("String1")
    ...
    private static MicroStrategyFact frodo;
    private static String serialized;

    @Test(groups = {"MicroStrategyFact.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"MicroStrategyFact.serialize"},
            dependsOnGroups = {"MicroStrategyFact.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"MicroStrategyFact.deserialize"},
            dependsOnGroups = {"MicroStrategyFact.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyFact.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"MicroStrategyFact.equivalency"},
            dependsOnGroups = {"MicroStrategyFact.serialize", "MicroStrategyFact.deserialize"})
