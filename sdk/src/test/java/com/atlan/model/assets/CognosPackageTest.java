...
public class CognosPackageTest {
    ...
    private final CognosPackage full = CognosPackage._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCognosPackage() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CognosPackage,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CognosPackage via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CognosPackage,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CognosPackage frodo = MockAtlanTenant.client.readValue(serialized, CognosPackage.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CognosPackage,");
