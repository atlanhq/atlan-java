...
public class CognosPackageTest {

    private static final CognosPackage full = CognosPackage._internal()
            .guid("guid")
    ...
    private static CognosPackage frodo;
    private static String serialized;

    @Test(groups = {"CognosPackage.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CognosPackage.serialize"},
            dependsOnGroups = {"CognosPackage.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CognosPackage.deserialize"},
            dependsOnGroups = {"CognosPackage.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CognosPackage.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CognosPackage.equivalency"},
            dependsOnGroups = {"CognosPackage.serialize", "CognosPackage.deserialize"})
