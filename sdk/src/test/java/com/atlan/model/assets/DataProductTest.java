...
public class DataProductTest {
    ...
    private final DataProduct full = DataProduct._internal()
            .guid("guid")
            ...
            .daapCriticality(DataProductCriticality.LOW)
            .dataProductSensitivity(DataProductSensitivity.PUBLIC)
            .daapSensitivity(DataProductSensitivity.PUBLIC)
            .dataProductVisibility(DataProductVisibility.PRIVATE)
            .daapVisibility(DataProductVisibility.PRIVATE)
            .dataProductAssetsDSL("String0")
            .dataProductAssetsPlaybookFilter("String0")
            .dataProductScoreValue(123.456)
            .dataProductScoreUpdatedAt(123456789L)
            .daapVisibilityUser("String0")
            .daapVisibilityUser("String1")
            .daapVisibilityGroup("String0")
            .daapVisibilityGroup("String1")
            .daapOutputPortGuid("String0")
            .daapOutputPortGuid("String1")
            .daapInputPortGuid("String0")
            .daapInputPortGuid("String1")
            .daapLineageStatus(DataProductLineageStatus.COMPLETED)
            .dataDomain(DataDomain.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dataMeshDataset(DataMeshDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dataMeshDataset(DataMeshDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .outputPort(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .outputPort(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .inputPort(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .inputPort(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .starburstDataset(StarburstDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .starburstDataset(StarburstDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDataProduct() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DataProduct,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DataProduct via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DataProduct,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DataProduct frodo = MockAtlanTenant.client.readValue(serialized, DataProduct.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DataProduct,");
