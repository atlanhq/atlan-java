...
public class DataProductTest {
    ...
    private static final DataProduct full = DataProduct._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .dataContract(DataContract.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dataContract(DataContract.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
