...
public class AuthPolicyTest {
    ...
    private final AuthPolicy full = AuthPolicy._internal()
            ...
            .policyAction(AtlanPolicyAction.ENTITY_READ)
            .policyAction(AtlanPolicyAction.ENTITY_CREATE)
            .policyCategory(AuthPolicyCategory.BOOTSTRAP)
            .policyCondition(AuthPolicyCondition.builder()
                    .accessControlPolicyConditionType("String0")
                    .policyConditionValues(List.of("String0", "String1"))
                    .build())
            .policyCondition(AuthPolicyCondition.builder()
                    .accessControlPolicyConditionType("String1")
                    .policyConditionValues(List.of("String0", "String1"))
                    .build())
            ...
            .policyGroup("String0")
            .policyGroup("String1")
            .policyMaskType(DataMaskingType.VALUE0)
            .policyPriority(123)
            ...
            .addPolicyValiditySchedule(AuthPolicyValiditySchedule.builder()
                    .accessControlPolicyValidityScheduleStartTime("String0")
                    .accessControlPolicyValidityScheduleEndTime("String0")
                    .accessControlPolicyValidityScheduleTimezone("String0")
                    .build())
            .addPolicyValiditySchedule(AuthPolicyValiditySchedule.builder()
                    .accessControlPolicyValidityScheduleStartTime("String1")
                    .accessControlPolicyValidityScheduleEndTime("String1")
                    .accessControlPolicyValidityScheduleTimezone("String1")
                    .build())
            .accessControl(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
