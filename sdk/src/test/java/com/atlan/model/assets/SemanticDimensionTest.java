...
public class SemanticDimensionTest {

    private final SemanticDimension full = SemanticDimension._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSemanticDimension() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SemanticDimension,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SemanticDimension via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SemanticDimension,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SemanticDimension frodo = MockAtlanTenant.client.readValue(serialized, SemanticDimension.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SemanticDimension,");
