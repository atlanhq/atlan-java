...
public class SAPBWADSOTest {

    private final SAPBWADSO full = SAPBWADSO
            ._internal()
            .guid("guid")
            ...
            .sapBwPlanningMode("String0")
            .sapBwDirectUpdate("String0")
            .sapBwInfoArea(SAPBWInfoArea.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwAdsoField(SAPBWADSOField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwAdsoField(SAPBWADSOField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapBwMemberOfCompositeProvider(SAPBWCompositeProvider.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwMemberOfCompositeProvider(
    ...
    @Test
    void serdeCycleSAPBWADSO() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWADSO,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWADSO via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWADSO,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWADSO frodo = MockAtlanTenant.client.readValue(serialized, SAPBWADSO.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWADSO,");
