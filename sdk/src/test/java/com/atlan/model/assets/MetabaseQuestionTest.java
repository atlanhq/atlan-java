...
public class MetabaseQuestionTest {
    ...
    private final MetabaseQuestion full = MetabaseQuestion._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .metabaseDashboardCount(123456789L)
            .metabaseQueryType("String0")
            .metabaseQuery("String0")
    ...
    @Test
    void serdeCycleMetabaseQuestion() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MetabaseQuestion,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MetabaseQuestion via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MetabaseQuestion,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MetabaseQuestion frodo = MockAtlanTenant.client.readValue(serialized, MetabaseQuestion.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MetabaseQuestion,");
