...
public class AdfDataflowTest {
    ...
    private final AdfDataflow full = AdfDataflow._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAdfDataflow() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AdfDataflow,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AdfDataflow via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AdfDataflow,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AdfDataflow frodo = MockAtlanTenant.client.readValue(serialized, AdfDataflow.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AdfDataflow,");
