...
public class DataDomainTest {
    ...
    private static final DataDomain full = DataDomain._internal()
            .guid("guid")
    ...
    private static DataDomain frodo;
    private static String serialized;

    @Test(groups = {"DataDomain.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DataDomain.serialize"},
            dependsOnGroups = {"DataDomain.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DataDomain.deserialize"},
            dependsOnGroups = {"DataDomain.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DataDomain.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DataDomain.equivalency"},
            dependsOnGroups = {"DataDomain.serialize", "DataDomain.deserialize"})
