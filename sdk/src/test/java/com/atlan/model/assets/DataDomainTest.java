...
public class DataDomainTest {
    ...
    private final DataDomain full = DataDomain._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDataDomain() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DataDomain,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DataDomain via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DataDomain,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DataDomain frodo = MockAtlanTenant.client.readValue(serialized, DataDomain.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DataDomain,");
