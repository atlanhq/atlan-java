...
public class SodaCheckTest {
    ...
    private static final SodaCheck full = SodaCheck._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .sodaCheckAsset(TagAttachment.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sodaCheckAsset(TagAttachment.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = Atlan.getDefaultClient().readValue(serialized, SodaCheck.class);
        assertNotNull(frodo);
    }
