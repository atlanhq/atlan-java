...
public class SodaCheckTest {

    private static final SodaCheck full = SodaCheck._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .sodaCheckAsset(Task.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sodaCheckAsset(Task.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sodaCheckColumn(Column.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sodaCheckColumn(Column.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sodaCheckDefinition("String0")
            .sodaCheckEvaluationStatus("String0")
            .sodaCheckId("String0")
            .sodaCheckIncidentCount(123456789L)
            .sodaCheckLastScanAt(123456789L)
            .build();

    private static final int hash = full.hashCode();
    private static SodaCheck frodo;
    private static String serialized;

    @Test(groups = {"SodaCheck.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SodaCheck.serialize"},
            dependsOnGroups = {"SodaCheck.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SodaCheck.deserialize"},
            dependsOnGroups = {"SodaCheck.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SodaCheck.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SodaCheck.equivalency"},
            dependsOnGroups = {"SodaCheck.serialize", "SodaCheck.deserialize"})
