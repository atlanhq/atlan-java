...
public class AnaplanSystemDimensionTest {
    ...
    private final AnaplanSystemDimension full = AnaplanSystemDimension._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAnaplanSystemDimension() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AnaplanSystemDimension,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AnaplanSystemDimension via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AnaplanSystemDimension,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AnaplanSystemDimension frodo = MockAtlanTenant.client.readValue(serialized, AnaplanSystemDimension.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AnaplanSystemDimension,");
