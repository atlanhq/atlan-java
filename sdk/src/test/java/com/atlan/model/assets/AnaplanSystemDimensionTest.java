...
public class AnaplanSystemDimensionTest {

    private static final AnaplanSystemDimension full = AnaplanSystemDimension._internal()
            .guid("guid")
    ...
    private static AnaplanSystemDimension frodo;
    private static String serialized;

    @Test(groups = {"AnaplanSystemDimension.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AnaplanSystemDimension.serialize"},
            dependsOnGroups = {"AnaplanSystemDimension.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AnaplanSystemDimension.deserialize"},
            dependsOnGroups = {"AnaplanSystemDimension.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AnaplanSystemDimension.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AnaplanSystemDimension.equivalency"},
            dependsOnGroups = {"AnaplanSystemDimension.serialize", "AnaplanSystemDimension.deserialize"})
