...
public class APIQueryTest {
    ...
    private final APIQuery full = APIQuery._internal()
            .guid("guid")
            ...
            .apiExternalDoc("String0", "String0")
            .apiExternalDoc("String1", "String1")
    ...
    @Test
    void serdeCycleAPIQuery() throws IOException {
        assertNotNull(full, "Unable to build sample instance of APIQuery,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting APIQuery via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of APIQuery,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final APIQuery frodo = MockAtlanTenant.client.readValue(serialized, APIQuery.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of APIQuery,");
