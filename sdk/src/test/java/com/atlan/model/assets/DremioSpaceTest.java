...
public class DremioSpaceTest {

    private final DremioSpace full = DremioSpace._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDremioSpace() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DremioSpace,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DremioSpace via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DremioSpace,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DremioSpace frodo = MockAtlanTenant.client.readValue(serialized, DremioSpace.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DremioSpace,");
