...
public class DremioSpaceTest {
    ...
    private static final DremioSpace full = DremioSpace._internal()
            .guid("guid")
    ...
    private static DremioSpace frodo;
    ...
    @Test(groups = {"DremioSpace.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DremioSpace.serialize"},
            dependsOnGroups = {"DremioSpace.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DremioSpace.deserialize"},
            dependsOnGroups = {"DremioSpace.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DremioSpace.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DremioSpace.equivalency"},
            dependsOnGroups = {"DremioSpace.serialize", "DremioSpace.deserialize"})
