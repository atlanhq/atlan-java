...
public class TableauWorksheetTest {
    ...
    private final TableauWorksheet full = TableauWorksheet._internal()
            .guid("guid")
            ...
            .addProjectHierarchy("String0", "String0")
            .addProjectHierarchy("String1", "String1")
            ...
            .datasourceField(TableauDatasourceField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .datasourceField(TableauDatasourceField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .tableauWorksheetField(TableauWorksheetField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .tableauWorksheetField(TableauWorksheetField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .calculatedField(TableauCalculatedField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .calculatedField(TableauCalculatedField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleTableauWorksheet() throws IOException {
        assertNotNull(full, "Unable to build sample instance of TableauWorksheet,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting TableauWorksheet via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of TableauWorksheet,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final TableauWorksheet frodo = MockAtlanTenant.client.readValue(serialized, TableauWorksheet.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of TableauWorksheet,");
