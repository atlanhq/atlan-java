...
public class TableauWorksheetTest {
    ...
    private final TableauWorksheet full = TableauWorksheet._internal()
            ...
            .tableauSourceReadCount(TableauReadCountWindow.builder()
                    .tableauReadCountWindowDays(123456789L)
                    .tableauReadCountWindowCount(123456789L)
                    .tableauReadCountWindowAsOfDate(123456789L)
                    .build())
            .tableauSourceReadCount(TableauReadCountWindow.builder()
                    .tableauReadCountWindowDays(987654321L)
                    .tableauReadCountWindowCount(987654321L)
                    .tableauReadCountWindowAsOfDate(987654321L)
                    .build())
            ...
            .datasourceField(
                    TableauDatasourceField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .calculatedField(
                    TableauCalculatedField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
