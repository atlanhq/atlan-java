...
public class SAPBWInfoSourceFieldTest {

    private final SAPBWInfoSourceField full = SAPBWInfoSourceField._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSAPBWInfoSourceField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWInfoSourceField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWInfoSourceField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWInfoSourceField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWInfoSourceField frodo = MockAtlanTenant.client.readValue(serialized, SAPBWInfoSourceField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWInfoSourceField,");
