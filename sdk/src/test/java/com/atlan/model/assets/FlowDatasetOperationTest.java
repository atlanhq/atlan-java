...
public class FlowDatasetOperationTest {

    private final FlowDatasetOperation full = FlowDatasetOperation._internal()
            .guid("guid")
            ...
            .flowReusableUnit(FlowReusableUnit.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleFlowDatasetOperation() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FlowDatasetOperation,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FlowDatasetOperation via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FlowDatasetOperation,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FlowDatasetOperation frodo = MockAtlanTenant.client.readValue(serialized, FlowDatasetOperation.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of FlowDatasetOperation,");
