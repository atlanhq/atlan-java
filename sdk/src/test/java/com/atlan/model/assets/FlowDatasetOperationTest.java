...
public class FlowDatasetOperationTest {
    ...
    private static final FlowDatasetOperation full = FlowDatasetOperation._internal()
            .guid("guid")
    ...
    private static FlowDatasetOperation frodo;
    private static String serialized;

    @Test(groups = {"FlowDatasetOperation.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowDatasetOperation.serialize"},
            dependsOnGroups = {"FlowDatasetOperation.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowDatasetOperation.deserialize"},
            dependsOnGroups = {"FlowDatasetOperation.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowDatasetOperation.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowDatasetOperation.equivalency"},
            dependsOnGroups = {"FlowDatasetOperation.serialize", "FlowDatasetOperation.deserialize"})
