...
public class RedashVisualizationTest {

    private static final RedashVisualization full = RedashVisualization._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .redashQuery(RedashQuery.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .redashQueryName("String0")
            .redashQueryQualifiedName("String0")
            .redashVisualizationType("String0")
            .build();

    private static final int hash = full.hashCode();
    private static RedashVisualization frodo;
    private static String serialized;

    @Test(groups = {"RedashVisualization.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"RedashVisualization.serialize"},
            dependsOnGroups = {"RedashVisualization.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"RedashVisualization.deserialize"},
            dependsOnGroups = {"RedashVisualization.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, RedashVisualization.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"RedashVisualization.equivalency"},
            dependsOnGroups = {"RedashVisualization.serialize", "RedashVisualization.deserialize"})
