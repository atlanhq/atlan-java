...
public class RedashVisualizationTest {
    ...
    private final RedashVisualization full = RedashVisualization._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleRedashVisualization() throws IOException {
        assertNotNull(full, "Unable to build sample instance of RedashVisualization,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting RedashVisualization via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of RedashVisualization,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final RedashVisualization frodo = MockAtlanTenant.client.readValue(serialized, RedashVisualization.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of RedashVisualization,");
