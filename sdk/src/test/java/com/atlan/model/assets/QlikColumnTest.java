...
public class QlikColumnTest {
    ...
    private final QlikColumn full = QlikColumn._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleQlikColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QlikColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QlikColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QlikColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QlikColumn frodo = MockAtlanTenant.client.readValue(serialized, QlikColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QlikColumn,");
