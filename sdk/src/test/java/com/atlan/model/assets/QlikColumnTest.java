...
public class QlikColumnTest {

    private static final QlikColumn full = QlikColumn._internal()
            .guid("guid")
            ...
            .qlikQRI("String0")
            .qlikSpaceId("String0")
            .qlikSpaceQualifiedName("String0")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .qlikChart(QlikChart.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .qlikColumnName("String0")
            .qlikColumnType("String0")
            .qlikDataType("String0")
            .qlikDataset(QlikDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .qlikParentQualifiedName("String0")
            .qlikSheet(QlikSheet.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();

    private static final int hash = full.hashCode();
    private static QlikColumn frodo;
    private static String serialized;

    @Test(groups = {"QlikColumn.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"QlikColumn.serialize"},
            dependsOnGroups = {"QlikColumn.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"QlikColumn.deserialize"},
            dependsOnGroups = {"QlikColumn.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, QlikColumn.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"QlikColumn.equivalency"},
            dependsOnGroups = {"QlikColumn.serialize", "QlikColumn.deserialize"})
