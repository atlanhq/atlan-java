...
public class ResponseTest {
    ...
    private final Response full = Response._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleResponse() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Response,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Response via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Response,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Response frodo = MockAtlanTenant.client.readValue(serialized, Response.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Response,");
