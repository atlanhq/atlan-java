...
public class ResponseTest {
    ...
    private static final Response full = Response._internal()
            .guid("guid")
            ...
            .viewerUser("String1")
            .formGuid("String0")
            .responseOption("key1", "value1")
            .responseOption("key2", "value2")
            .responseValue(ResponseValue.builder()
                    .responseFieldId("String0")
                    .responseValueString("String0")
                    .responseValueInt(123)
                    .responseValueBoolean(true)
                    .responseValueJson("String0")
                    .responseValueLong(123456789L)
                    .responseValueDate(123456789L)
                    .responseValueArrString(List.of("String0", "String1"))
                    .responseValueArrInt(List.of(123, 456))
                    .responseValueArrBoolean(List.of(true, false))
                    .responseValueArrJson(List.of("String0", "String1"))
                    .responseValueArrLong(List.of(123456789L, 987654321L))
                    .responseValueArrDate(List.of(123456789L, 987654321L))
                    .responseValueOptions(Map.of("key1", "value1", "key2", "value2"))
                    .build())
            .responseValue(ResponseValue.builder()
                    .responseFieldId("String1")
                    .responseValueString("String1")
                    .responseValueInt(456)
                    .responseValueBoolean(false)
                    .responseValueJson("String1")
                    .responseValueLong(987654321L)
                    .responseValueDate(987654321L)
                    .responseValueArrString(List.of("String0", "String1"))
                    .responseValueArrInt(List.of(123, 456))
                    .responseValueArrBoolean(List.of(true, false))
                    .responseValueArrJson(List.of("String0", "String1"))
    ...
    private static Response frodo;
    private static String serialized;

    @Test(groups = {"Response.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"Response.serialize"},
            dependsOnGroups = {"Response.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"Response.deserialize"},
            dependsOnGroups = {"Response.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, Response.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"Response.equivalency"},
            dependsOnGroups = {"Response.serialize", "Response.deserialize"})
