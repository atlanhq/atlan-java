...
public class IcebergColumnTest {

    private final IcebergColumn full = IcebergColumn._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleIcebergColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of IcebergColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting IcebergColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of IcebergColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final IcebergColumn frodo = MockAtlanTenant.client.readValue(serialized, IcebergColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of IcebergColumn,");
