...
public class LookerLookTest {
    ...
    private final LookerLook full = LookerLook._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleLookerLook() throws IOException {
        assertNotNull(full, "Unable to build sample instance of LookerLook,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting LookerLook via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of LookerLook,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final LookerLook frodo = MockAtlanTenant.client.readValue(serialized, LookerLook.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of LookerLook,");
