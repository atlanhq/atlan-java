...
public class AWSTest {
    ...
    private final AWS full = AWS._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAWS() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AWS,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AWS via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AWS,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AWS frodo = MockAtlanTenant.client.readValue(serialized, AWS.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AWS,");
