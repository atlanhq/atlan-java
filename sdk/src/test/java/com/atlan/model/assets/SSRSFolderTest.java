...
public class SSRSFolderTest {

    private final SSRSFolder full = SSRSFolder._internal()
            .guid("guid")
            ...
            .ssrsSubFolder(SSRSFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .ssrsSubFolder(SSRSFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .ssrsParentFolder(SSRSFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .ssrsReport(SSRSReport.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .ssrsReport(SSRSReport.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSSRSFolder() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SSRSFolder,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SSRSFolder via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SSRSFolder,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SSRSFolder frodo = MockAtlanTenant.client.readValue(serialized, SSRSFolder.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SSRSFolder,");
