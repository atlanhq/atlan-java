...
public class PresetDashboardTest {
    ...
    private final PresetDashboard full = PresetDashboard._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .presetDashboardChangedByName("String0")
            .presetDashboardChangedByURL("String0")
            .presetDashboardIsManagedExternally(true)
            .presetDashboardIsPublished(true)
            .presetDashboardThumbnailURL("String0")
            .presetDashboardChartCount(123456789L)
            .presetChart(PresetChart.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .presetChart(PresetChart.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .presetWorkspace(PresetWorkspace.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .presetDataset(PresetDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .presetDataset(PresetDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCyclePresetDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PresetDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PresetDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PresetDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PresetDashboard frodo = MockAtlanTenant.client.readValue(serialized, PresetDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PresetDashboard,");
