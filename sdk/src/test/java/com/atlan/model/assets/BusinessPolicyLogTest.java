...
public class BusinessPolicyLogTest {
    ...
    private static final BusinessPolicyLog full = BusinessPolicyLog._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .businessPolicyId("String0")
            .businessPolicyLogPolicyType("String0")
            .compliantAssetsCount(123456789L)
            .governedAssetsCount(123456789L)
            .nonCompliantAssetsCount(123456789L)
