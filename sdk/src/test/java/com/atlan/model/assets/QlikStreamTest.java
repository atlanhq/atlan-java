...
public class QlikStreamTest {
    ...
    private final QlikStream full = QlikStream._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleQlikStream() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QlikStream,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QlikStream via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QlikStream,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QlikStream frodo = MockAtlanTenant.client.readValue(serialized, QlikStream.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QlikStream,");
