...
public class PowerBIWorkspaceTest {
    ...
    private final PowerBIWorkspace full = PowerBIWorkspace._internal()
            .guid("guid")
            ...
            .dashboardCount(123456789L)
            .datasetCount(123456789L)
            .dataflowCount(123456789L)
            ...
            .report(PowerBIReport.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dashboard(PowerBIDashboard.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dashboard(PowerBIDashboard.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCyclePowerBIWorkspace() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PowerBIWorkspace,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PowerBIWorkspace via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PowerBIWorkspace,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PowerBIWorkspace frodo = MockAtlanTenant.client.readValue(serialized, PowerBIWorkspace.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PowerBIWorkspace,");
