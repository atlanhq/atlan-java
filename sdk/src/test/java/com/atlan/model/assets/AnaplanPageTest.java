...
public class AnaplanPageTest {
    ...
    private final AnaplanPage full = AnaplanPage._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAnaplanPage() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AnaplanPage,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AnaplanPage via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AnaplanPage,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AnaplanPage frodo = MockAtlanTenant.client.readValue(serialized, AnaplanPage.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AnaplanPage,");
