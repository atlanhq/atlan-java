...
public class AnaplanPageTest {

    private static final AnaplanPage full = AnaplanPage._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .anaplanApp(AnaplanApp.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanAppQualifiedName("String0")
            .anaplanModel(AnaplanModel.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanModel(AnaplanModel.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanPageCategoryName("String0")
            .anaplanPageType("String0")
            .build();

    private static final int hash = full.hashCode();
    private static AnaplanPage frodo;
    private static String serialized;

    @Test(groups = {"AnaplanPage.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AnaplanPage.serialize"},
            dependsOnGroups = {"AnaplanPage.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AnaplanPage.deserialize"},
            dependsOnGroups = {"AnaplanPage.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AnaplanPage.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AnaplanPage.equivalency"},
            dependsOnGroups = {"AnaplanPage.serialize", "AnaplanPage.deserialize"})
