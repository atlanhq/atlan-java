...
public class PowerBIDataflowEntityColumnTest {
    ...
    void serdeCyclePowerBIDataflowEntityColumn() throws IOException {
        ...
        // Deserialization
        final PowerBIDataflowEntityColumn frodo =
                MockAtlanTenant.client.readValue(serialized, PowerBIDataflowEntityColumn.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of PowerBIDataflowEntityColumn,");
