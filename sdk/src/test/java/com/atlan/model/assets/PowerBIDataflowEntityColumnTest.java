...
public class PowerBIDataflowEntityColumnTest {
    ...
    private final PowerBIDataflowEntityColumn full = PowerBIDataflowEntityColumn._internal()
            .guid("guid")
    ...
    @Test
    void serdeCyclePowerBIDataflowEntityColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PowerBIDataflowEntityColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PowerBIDataflowEntityColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PowerBIDataflowEntityColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PowerBIDataflowEntityColumn frodo = MockAtlanTenant.client.readValue(serialized, PowerBIDataflowEntityColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PowerBIDataflowEntityColumn,");
