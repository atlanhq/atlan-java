...
public class MetabaseDashboardTest {
    ...
    private static final MetabaseDashboard full = MetabaseDashboard._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .metabaseCollection(MetabaseCollection.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .metabaseQuestionCount(123456789L)
            .metabaseQuestion(MetabaseQuestion.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .metabaseQuestion(MetabaseQuestion.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MetabaseDashboard.class);
        assertNotNull(frodo);
    }
