...
public class MetabaseDashboardTest {
    ...
    private final MetabaseDashboard full = MetabaseDashboard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleMetabaseDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MetabaseDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MetabaseDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MetabaseDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MetabaseDashboard frodo = MockAtlanTenant.client.readValue(serialized, MetabaseDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MetabaseDashboard,");
