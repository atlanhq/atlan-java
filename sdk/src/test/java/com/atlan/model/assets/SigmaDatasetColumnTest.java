...
public class SigmaDatasetColumnTest {
    ...
    private static final SigmaDatasetColumn full = SigmaDatasetColumn._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .sigmaDataset(SigmaDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sigmaDatasetName("String0")
            .sigmaDatasetQualifiedName("String0")
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SigmaDatasetColumn.class);
        assertNotNull(frodo);
    }
