...
public class SigmaDatasetColumnTest {
    ...
    private final SigmaDatasetColumn full = SigmaDatasetColumn._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSigmaDatasetColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SigmaDatasetColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SigmaDatasetColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SigmaDatasetColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SigmaDatasetColumn frodo = MockAtlanTenant.client.readValue(serialized, SigmaDatasetColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SigmaDatasetColumn,");
