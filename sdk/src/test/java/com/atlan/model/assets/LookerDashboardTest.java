...
public class LookerDashboardTest {
    ...
    private static final LookerDashboard full = LookerDashboard._internal()
            ...
            .sourceLastAccessedAt(123456789L)
            .sourceLastViewedAt(123456789L)
            .sourceMetadataId(123)
            .sourceUserId(123)
            .sourceViewCount(123)
            .sourcelastUpdaterId(123)
            .tile(LookerTile.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .tile(LookerTile.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, LookerDashboard.class);
        assertNotNull(frodo);
    }
