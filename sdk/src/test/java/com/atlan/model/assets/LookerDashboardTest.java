...
public class LookerDashboardTest {
    ...
    private final LookerDashboard full = LookerDashboard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleLookerDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of LookerDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting LookerDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of LookerDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final LookerDashboard frodo = MockAtlanTenant.client.readValue(serialized, LookerDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of LookerDashboard,");
