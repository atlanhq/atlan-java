...
public class AzureEventHubTest {
    ...
    private final AzureEventHub full = AzureEventHub._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAzureEventHub() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AzureEventHub,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AzureEventHub via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AzureEventHub,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AzureEventHub frodo = MockAtlanTenant.client.readValue(serialized, AzureEventHub.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AzureEventHub,");
