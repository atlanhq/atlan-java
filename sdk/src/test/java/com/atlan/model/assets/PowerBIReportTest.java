...
public class PowerBIReportTest {
    ...
    private final PowerBIReport full = PowerBIReport._internal()
            .guid("guid")
    ...
    @Test
    void serdeCyclePowerBIReport() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PowerBIReport,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PowerBIReport via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PowerBIReport,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PowerBIReport frodo = MockAtlanTenant.client.readValue(serialized, PowerBIReport.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PowerBIReport,");
