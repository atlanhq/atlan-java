...
public class SupersetDashboardTest {
    ...
    private final SupersetDashboard full = SupersetDashboard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSupersetDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SupersetDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SupersetDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SupersetDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SupersetDashboard frodo = MockAtlanTenant.client.readValue(serialized, SupersetDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SupersetDashboard,");
