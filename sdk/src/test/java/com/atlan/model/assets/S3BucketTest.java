...
public class S3BucketTest {
    ...
    private final S3Bucket full = S3Bucket._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleS3Bucket() throws IOException {
        assertNotNull(full, "Unable to build sample instance of S3Bucket,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting S3Bucket via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of S3Bucket,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final S3Bucket frodo = MockAtlanTenant.client.readValue(serialized, S3Bucket.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of S3Bucket,");
