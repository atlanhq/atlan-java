...
public class TypeRegistryPublishedRelationshipTest {

    private static final TypeRegistryPublishedRelationship full = TypeRegistryPublishedRelationship._internal()
            .guid("guid")
    ...
    private static TypeRegistryPublishedRelationship frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryPublishedRelationship.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryPublishedRelationship.serialize"},
            dependsOnGroups = {"TypeRegistryPublishedRelationship.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryPublishedRelationship.deserialize"},
            dependsOnGroups = {"TypeRegistryPublishedRelationship.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryPublishedRelationship.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryPublishedRelationship.equivalency"},
            dependsOnGroups = {
                "TypeRegistryPublishedRelationship.serialize",
                "TypeRegistryPublishedRelationship.deserialize"
            })
