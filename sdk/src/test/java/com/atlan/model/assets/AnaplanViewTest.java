...
public class AnaplanViewTest {
    ...
    private final AnaplanView full = AnaplanView._internal()
            .guid("guid")
            ...
            .anaplanColumnDimension(AnaplanDimension.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanPageDimension(AnaplanDimension.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanPageDimension(AnaplanDimension.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleAnaplanView() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AnaplanView,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AnaplanView via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AnaplanView,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AnaplanView frodo = MockAtlanTenant.client.readValue(serialized, AnaplanView.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AnaplanView,");
