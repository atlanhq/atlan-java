...
public class AnaplanViewTest {

    private static final AnaplanView full = AnaplanView._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .anaplanColumnDimension(AnaplanDimension.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanColumnDimension(
                    AnaplanDimension.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanModule(AnaplanModule.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanPageDimension(AnaplanDimension.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanPageDimension(
                    AnaplanDimension.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanRowDimension(AnaplanDimension.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanRowDimension(AnaplanDimension.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static AnaplanView frodo;
    private static String serialized;

    @Test(groups = {"AnaplanView.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AnaplanView.serialize"},
            dependsOnGroups = {"AnaplanView.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AnaplanView.deserialize"},
            dependsOnGroups = {"AnaplanView.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AnaplanView.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AnaplanView.equivalency"},
            dependsOnGroups = {"AnaplanView.serialize", "AnaplanView.deserialize"})
