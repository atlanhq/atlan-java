...
public class RedashQueryTest {
    ...
    private static RedashQuery frodo;
    private static String serialized;

    @Test(groups = {"RedashQuery.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"RedashQuery.serialize"},
            dependsOnGroups = {"RedashQuery.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"RedashQuery.deserialize"},
            dependsOnGroups = {"RedashQuery.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, RedashQuery.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"RedashQuery.equivalency"},
            dependsOnGroups = {"RedashQuery.serialize", "RedashQuery.deserialize"})
