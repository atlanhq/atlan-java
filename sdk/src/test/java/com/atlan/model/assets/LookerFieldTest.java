...
public class LookerFieldTest {
    ...
    private final LookerField full = LookerField._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleLookerField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of LookerField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting LookerField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of LookerField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final LookerField frodo = MockAtlanTenant.client.readValue(serialized, LookerField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of LookerField,");
