...
public class LookerFieldTest {
    ...
    private static final LookerField full = LookerField._internal()
            .guid("guid")
            ...
            .lookerFieldIsRefined(true)
            .lookerFieldRefinementFilePath("String0")
            .lookerFieldRefinementLineNumber("String0")
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, LookerField.class);
        assertNotNull(frodo);
    }
