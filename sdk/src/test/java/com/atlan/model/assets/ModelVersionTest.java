...
public class ModelVersionTest {
    ...
    private static final ModelVersion full = ModelVersion._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .modelDataModel(ModelDataModel.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelVersionEntity(ModelEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelVersionEntity(ModelEntity.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelVersionEntityCount(123456789L)
            .build();

    private static final int hash = full.hashCode();
    private static ModelVersion frodo;
    private static String serialized;

    @Test(groups = {"ModelVersion.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"ModelVersion.serialize"},
            dependsOnGroups = {"ModelVersion.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"ModelVersion.deserialize"},
            dependsOnGroups = {"ModelVersion.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, ModelVersion.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"ModelVersion.equivalency"},
            dependsOnGroups = {"ModelVersion.serialize", "ModelVersion.deserialize"})
