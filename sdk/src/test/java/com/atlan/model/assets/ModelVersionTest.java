...
public class ModelVersionTest {
    ...
    private final ModelVersion full = ModelVersion._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleModelVersion() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ModelVersion,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ModelVersion via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ModelVersion,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ModelVersion frodo = MockAtlanTenant.client.readValue(serialized, ModelVersion.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ModelVersion,");
