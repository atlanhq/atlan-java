...
public class SageMakerModelGroupTest {

    private final SageMakerModelGroup full = SageMakerModelGroup._internal()
            .guid("guid")
            ...
            .sageMakerModelGroupStatus("String0")
            ...
            .sageMakerModel(SageMakerModel.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sageMakerModel(SageMakerModel.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSageMakerModelGroup() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SageMakerModelGroup,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SageMakerModelGroup via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SageMakerModelGroup,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SageMakerModelGroup frodo = MockAtlanTenant.client.readValue(serialized, SageMakerModelGroup.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerModelGroup,");
