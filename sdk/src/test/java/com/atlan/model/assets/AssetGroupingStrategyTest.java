...
public class AssetGroupingStrategyTest {

    private final AssetGroupingStrategy full = AssetGroupingStrategy._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .assetGroupingStrategyType(AssetGroupingStrategyType.DSL)
            .assetGroupingStrategyConfig("String0")
            .assetGroupingStrategyLastEvaluatedAssetCount(123456789L)
            .assetGroupingStrategyLastEvaluatedTimestamp(123456789L)
            .assetGroupingStrategySource(AssetGroupingStrategySource.SYSTEM)
            ...
            .assetGroupingCollection(AssetGroupingCollection.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .assetGroupingCollection(AssetGroupingCollection.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleAssetGroupingStrategy() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AssetGroupingStrategy,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AssetGroupingStrategy via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AssetGroupingStrategy,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AssetGroupingStrategy frodo = MockAtlanTenant.client.readValue(serialized, AssetGroupingStrategy.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AssetGroupingStrategy,");
