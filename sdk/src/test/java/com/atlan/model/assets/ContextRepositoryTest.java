...
public class ContextRepositoryTest {
    ...
    private final ContextRepository full = ContextRepository._internal()
            .guid("guid")
            ...
            .contextRepositoryLifecycleStatus(ContextLifecycleStatus.DRAFT)
            .contextRepositoryAgentInstructions("String0")
            .contextRepositoryTargetConnectionQualifiedName("String0")
            .contextArtifact(ContextArtifact.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .contextArtifact(ContextArtifact.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .contextOutputSkill(Skill.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .contextOutputAgent(Agent.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .contextOutputAgent(Agent.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .contextInputAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .contextInputAsset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleContextRepository() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ContextRepository,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ContextRepository via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ContextRepository,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ContextRepository frodo = MockAtlanTenant.client.readValue(serialized, ContextRepository.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ContextRepository,");
