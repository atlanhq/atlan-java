...
public class TypeRegistryPublishedEnumTest {

    private static final TypeRegistryPublishedEnum full = TypeRegistryPublishedEnum._internal()
            .guid("guid")
    ...
    private static TypeRegistryPublishedEnum frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryPublishedEnum.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryPublishedEnum.serialize"},
            dependsOnGroups = {"TypeRegistryPublishedEnum.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryPublishedEnum.deserialize"},
            dependsOnGroups = {"TypeRegistryPublishedEnum.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryPublishedEnum.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryPublishedEnum.equivalency"},
            dependsOnGroups = {"TypeRegistryPublishedEnum.serialize", "TypeRegistryPublishedEnum.deserialize"})
