...
public class SigmaWorkbookTest {
    ...
    private final SigmaWorkbook full = SigmaWorkbook._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .sigmaPageCount(123456789L)
            .sigmaPage(SigmaPage.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sigmaPage(SigmaPage.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSigmaWorkbook() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SigmaWorkbook,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SigmaWorkbook via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SigmaWorkbook,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SigmaWorkbook frodo = MockAtlanTenant.client.readValue(serialized, SigmaWorkbook.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SigmaWorkbook,");
