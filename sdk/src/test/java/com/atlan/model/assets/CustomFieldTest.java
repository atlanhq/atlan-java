...
public class CustomFieldTest {
    ...
    private static final CustomField full = CustomField._internal()
            .guid("guid")
            ...
            .customTemperature(CustomTemperatureType.COLD)
            .build();

    private static final int hash = full.hashCode();
    private static CustomField frodo;
    private static String serialized;

    @Test(groups = {"CustomField.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CustomField.serialize"},
            dependsOnGroups = {"CustomField.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CustomField.deserialize"},
            dependsOnGroups = {"CustomField.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = Atlan.getDefaultClient().readValue(serialized, CustomField.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CustomField.equivalency"},
            dependsOnGroups = {"CustomField.serialize", "CustomField.deserialize"})
