...
public class FabricDataflowEntityColumnTest {
    ...
    void serdeCycleFabricDataflowEntityColumn() throws IOException {
        ...
        // Deserialization
        final FabricDataflowEntityColumn frodo =
                MockAtlanTenant.client.readValue(serialized, FabricDataflowEntityColumn.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of FabricDataflowEntityColumn,");
