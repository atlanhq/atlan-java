...
public class FabricDataflowEntityColumnTest {
    ...
    private static final FabricDataflowEntityColumn full = FabricDataflowEntityColumn._internal()
            .guid("guid")
    ...
    private static FabricDataflowEntityColumn frodo;
    ...
    @Test(groups = {"FabricDataflowEntityColumn.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FabricDataflowEntityColumn.serialize"},
            dependsOnGroups = {"FabricDataflowEntityColumn.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FabricDataflowEntityColumn.deserialize"},
            dependsOnGroups = {"FabricDataflowEntityColumn.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FabricDataflowEntityColumn.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FabricDataflowEntityColumn.equivalency"},
            dependsOnGroups = {"FabricDataflowEntityColumn.serialize", "FabricDataflowEntityColumn.deserialize"})
