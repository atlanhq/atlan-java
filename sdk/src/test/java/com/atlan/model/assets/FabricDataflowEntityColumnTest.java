...
public class FabricDataflowEntityColumnTest {

    private final FabricDataflowEntityColumn full = FabricDataflowEntityColumn._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .fabricDataflowQualifiedName("String0")
            .fabricDataflowName("String0")
    ...
    @Test
    void serdeCycleFabricDataflowEntityColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FabricDataflowEntityColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FabricDataflowEntityColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FabricDataflowEntityColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FabricDataflowEntityColumn frodo = MockAtlanTenant.client.readValue(serialized, FabricDataflowEntityColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of FabricDataflowEntityColumn,");
