...
public class DremioVirtualDatasetTest {

    private final DremioVirtualDataset full = DremioVirtualDataset._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDremioVirtualDataset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DremioVirtualDataset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DremioVirtualDataset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DremioVirtualDataset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DremioVirtualDataset frodo = MockAtlanTenant.client.readValue(serialized, DremioVirtualDataset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DremioVirtualDataset,");
