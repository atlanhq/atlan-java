...
public class DremioVirtualDatasetTest {
    ...
    private static final DremioVirtualDataset full = DremioVirtualDataset._internal()
            .guid("guid")
    ...
    private static DremioVirtualDataset frodo;
    ...
    @Test(groups = {"DremioVirtualDataset.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DremioVirtualDataset.serialize"},
            dependsOnGroups = {"DremioVirtualDataset.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DremioVirtualDataset.deserialize"},
            dependsOnGroups = {"DremioVirtualDataset.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DremioVirtualDataset.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DremioVirtualDataset.equivalency"},
            dependsOnGroups = {"DremioVirtualDataset.serialize", "DremioVirtualDataset.deserialize"})
