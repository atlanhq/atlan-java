...
public class SnowflakeSemanticFactTest {

    private final SnowflakeSemanticFact full = SnowflakeSemanticFact._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSnowflakeSemanticFact() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeSemanticFact,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeSemanticFact via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeSemanticFact,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeSemanticFact frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeSemanticFact.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeSemanticFact,");
