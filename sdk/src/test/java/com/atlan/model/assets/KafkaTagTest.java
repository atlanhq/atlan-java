...
public class KafkaTagTest {

    private final KafkaTag full = KafkaTag._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleKafkaTag() throws IOException {
        assertNotNull(full, "Unable to build sample instance of KafkaTag,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting KafkaTag via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of KafkaTag,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final KafkaTag frodo = MockAtlanTenant.client.readValue(serialized, KafkaTag.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of KafkaTag,");
