...
public class SnowflakeSemanticLogicalTableTest {

    private final SnowflakeSemanticLogicalTable full = SnowflakeSemanticLogicalTable._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .semanticExpression("String0")
            .semanticType("String0")
            .semanticSynonym("String0")
            .semanticSynonym("String1")
            .semanticSampleValue("String0")
            .semanticSampleValue("String1")
            .semanticAccessModifier("String0")
            .semanticDataType("String0")
            .semanticLabel("String0")
            .semanticLabel("String1")
            .snowflakeSemanticViewQualifiedName("String0")
            .snowflakeSemanticViewName("String0")
            .snowflakeSemanticTablePrimaryKey("String0")
            .snowflakeSemanticTablePrimaryKey("String1")
            .snowflakeSemanticTableUniqueKey("String0")
            .snowflakeSemanticTableUniqueKey("String1")
            .snowflakeSemanticTableDistinctRange("String0")
            .snowflakeSemanticTableDistinctRange("String1")
            .semanticModel(SemanticModel.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .snowflakeSemanticView(SnowflakeSemanticView.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .snowflakeSemanticFact(SnowflakeSemanticFact.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .snowflakeSemanticFact(SnowflakeSemanticFact.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .snowflakeSemanticDimension(SnowflakeSemanticDimension.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .snowflakeSemanticDimension(SnowflakeSemanticDimension.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .snowflakeSemanticMetric(SnowflakeSemanticMetric.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .snowflakeSemanticMetric(SnowflakeSemanticMetric.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .snowflakeBaseTable(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .snowflakeSemanticLogicalTableJoin(SnowflakeSemanticLogicalTable.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .snowflakeSemanticLogicalTableJoin(SnowflakeSemanticLogicalTable.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .metric(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .metric(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSnowflakeSemanticLogicalTable() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeSemanticLogicalTable,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeSemanticLogicalTable via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeSemanticLogicalTable,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeSemanticLogicalTable frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeSemanticLogicalTable.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeSemanticLogicalTable,");
