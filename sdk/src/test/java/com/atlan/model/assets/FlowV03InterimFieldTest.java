...
public class FlowV03InterimFieldTest {

    private static final FlowV03InterimField full = FlowV03InterimField._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .flowV03Dataset(FlowV03InterimDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();

    private static final int hash = full.hashCode();
    private static FlowV03InterimField frodo;
    private static String serialized;

    @Test(groups = {"FlowV03InterimField.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowV03InterimField.serialize"},
            dependsOnGroups = {"FlowV03InterimField.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowV03InterimField.deserialize"},
            dependsOnGroups = {"FlowV03InterimField.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowV03InterimField.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowV03InterimField.equivalency"},
            dependsOnGroups = {"FlowV03InterimField.serialize", "FlowV03InterimField.deserialize"})
