...
public class CognosDatasetTest {
    ...
    private final CognosDataset full = CognosDataset._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCognosDataset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CognosDataset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CognosDataset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CognosDataset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CognosDataset frodo = MockAtlanTenant.client.readValue(serialized, CognosDataset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CognosDataset,");
