...
public class DataverseEntityTest {
    ...
    private static final DataverseEntity full = DataverseEntity._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .dataverseAttribute(DataverseAttribute.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dataverseAttribute(DataverseAttribute.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dataverseEntitySchemaName("String0")
