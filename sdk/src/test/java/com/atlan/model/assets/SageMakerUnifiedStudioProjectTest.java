...
public class SageMakerUnifiedStudioProjectTest {
    ...
    private final SageMakerUnifiedStudioProject full = SageMakerUnifiedStudioProject._internal()
            ...
            .smusPublishedAsset(SageMakerUnifiedStudioPublishedAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    void serdeCycleSageMakerUnifiedStudioProject() throws IOException {
        ...
        // Deserialization
        final SageMakerUnifiedStudioProject frodo = MockAtlanTenant.client.readValue(serialized, SageMakerUnifiedStudioProject.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerUnifiedStudioProject,");
