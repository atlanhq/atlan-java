...
public class SageMakerUnifiedStudioProjectTest {
    ...
    private final SageMakerUnifiedStudioProject full = SageMakerUnifiedStudioProject._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .smusDataProduct(DataProduct.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .smusDataProduct(DataProduct.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
