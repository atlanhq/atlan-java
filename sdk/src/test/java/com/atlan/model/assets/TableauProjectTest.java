...
public class TableauProjectTest {
    ...
    private static final TableauProject full = TableauProject._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .childProject(TableauProject.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .childProject(TableauProject.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .flow(TableauFlow.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flow(TableauFlow.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .isTopLevelProject(true)
            .parentProject(TableauProject.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .addProjectHierarchy(Map.of("key1", "value1"))
            .addProjectHierarchy(Map.of("key2", "value2"))
            .site(TableauSite.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
