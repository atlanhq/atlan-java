...
public class SigmaDataElementFieldTest {
    ...
    private final SigmaDataElementField full = SigmaDataElementField._internal()
            .guid("guid")
            ...
            .sigmaDataElementFieldFormula("String0")
    ...
    @Test
    void serdeCycleSigmaDataElementField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SigmaDataElementField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SigmaDataElementField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SigmaDataElementField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SigmaDataElementField frodo = MockAtlanTenant.client.readValue(serialized, SigmaDataElementField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SigmaDataElementField,");
