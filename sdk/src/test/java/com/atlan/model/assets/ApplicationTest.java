...
public class ApplicationTest {
    ...
    private final Application full = Application._internal()
            .guid("guid")
            ...
            .applicationOwnedAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .applicationOwnedAsset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .applicationChildField(ApplicationField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleApplication() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Application,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Application via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Application,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Application frodo = MockAtlanTenant.client.readValue(serialized, Application.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Application,");
