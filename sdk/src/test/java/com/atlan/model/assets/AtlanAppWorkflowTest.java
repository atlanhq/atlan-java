...
public class AtlanAppWorkflowTest {

    private final AtlanAppWorkflow full = AtlanAppWorkflow._internal()
            .guid("guid")
            ...
            .atlanAppWorkflowVersion("String0")
            .atlanAppWorkflowSlug("String0")
            .atlanAppWorkflowDag("String0")
            .atlanAppWorkflowStatus(AtlanAppWorkflowStatus.DRAFT)
            .atlanAppWorkflowErrorHandling(AtlanAppErrorHandling.builder()
                    .atlanAppErrorHandlingInitialInterval("String0")
                    .atlanAppErrorHandlingBackoffCoefficient(123.456)
                    .atlanAppErrorHandlingMaximumInterval("String0")
                    .atlanAppErrorHandlingMaximumAttempts(123)
            ...
            .atlanAppWorkflowAgentName("String0")
            .atlanAppWorkflowDeploymentName("String0")
            .atlanAppWorkflowRuntimeMode(AtlanAppWorkflowRuntimeMode.SDR)
            ...
            .atlanAppWorkflowRun(AppWorkflowRun.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .atlanAppWorkflowRun(AppWorkflowRun.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleAtlanAppWorkflow() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AtlanAppWorkflow,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AtlanAppWorkflow via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AtlanAppWorkflow,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AtlanAppWorkflow frodo = MockAtlanTenant.client.readValue(serialized, AtlanAppWorkflow.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AtlanAppWorkflow,");
