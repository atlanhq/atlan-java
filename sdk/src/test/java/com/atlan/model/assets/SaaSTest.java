...
public class SaaSTest {
    ...
    private final SaaS full = SaaS._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSaaS() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SaaS,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SaaS via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SaaS,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SaaS frodo = MockAtlanTenant.client.readValue(serialized, SaaS.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SaaS,");
