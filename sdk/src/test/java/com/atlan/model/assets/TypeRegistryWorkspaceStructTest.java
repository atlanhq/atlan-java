...
public class TypeRegistryWorkspaceStructTest {

    private static final TypeRegistryWorkspaceStruct full = TypeRegistryWorkspaceStruct._internal()
            .guid("guid")
    ...
    private static TypeRegistryWorkspaceStruct frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryWorkspaceStruct.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryWorkspaceStruct.serialize"},
            dependsOnGroups = {"TypeRegistryWorkspaceStruct.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryWorkspaceStruct.deserialize"},
            dependsOnGroups = {"TypeRegistryWorkspaceStruct.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryWorkspaceStruct.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryWorkspaceStruct.equivalency"},
            dependsOnGroups = {"TypeRegistryWorkspaceStruct.serialize", "TypeRegistryWorkspaceStruct.deserialize"})
