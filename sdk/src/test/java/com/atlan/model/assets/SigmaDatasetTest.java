...
public class SigmaDatasetTest {
    ...
    private static final SigmaDataset full = SigmaDataset._internal()
            .guid("guid")
            ...
            .sigmaDatasetColumn(
                    SigmaDatasetColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SigmaDataset.class);
        assertNotNull(frodo);
    }
