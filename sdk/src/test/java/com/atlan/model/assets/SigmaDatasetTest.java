...
public class SigmaDatasetTest {
    ...
    private final SigmaDataset full = SigmaDataset._internal()
            .guid("guid")
            ...
            .sigmaDatasetColumn(SigmaDatasetColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSigmaDataset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SigmaDataset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SigmaDataset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SigmaDataset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SigmaDataset frodo = MockAtlanTenant.client.readValue(serialized, SigmaDataset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SigmaDataset,");
