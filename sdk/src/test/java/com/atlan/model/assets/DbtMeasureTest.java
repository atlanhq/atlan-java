...
public class DbtMeasureTest {

    private final DbtMeasure full = DbtMeasure._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDbtMeasure() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtMeasure,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtMeasure via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtMeasure,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtMeasure frodo = MockAtlanTenant.client.readValue(serialized, DbtMeasure.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtMeasure,");
