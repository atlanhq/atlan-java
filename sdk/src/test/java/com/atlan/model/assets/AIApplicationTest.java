...
public class AIApplicationTest {
    ...
    private static final AIApplication full = AIApplication._internal()
            .guid("guid")
    ...
    private static AIApplication frodo;
    private static String serialized;

    @Test(groups = {"AIApplication.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AIApplication.serialize"},
            dependsOnGroups = {"AIApplication.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AIApplication.deserialize"},
            dependsOnGroups = {"AIApplication.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AIApplication.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AIApplication.equivalency"},
            dependsOnGroups = {"AIApplication.serialize", "AIApplication.deserialize"})
