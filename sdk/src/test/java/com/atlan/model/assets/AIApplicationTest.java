...
public class AIApplicationTest {
    ...
    private final AIApplication full = AIApplication._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAIApplication() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AIApplication,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AIApplication via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AIApplication,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AIApplication frodo = MockAtlanTenant.client.readValue(serialized, AIApplication.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AIApplication,");
