...
public class SAPBWADSOFieldTest {

    private final SAPBWADSOField full = SAPBWADSOField._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSAPBWADSOField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWADSOField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWADSOField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWADSOField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWADSOField frodo = MockAtlanTenant.client.readValue(serialized, SAPBWADSOField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWADSOField,");
