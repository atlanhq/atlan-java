...
public class CassandraTable extends Asset implements ICassandraTable, ICassandra, INoSQL, ICatalog, IAsset, IReferenceable {
    ...
    public static CassandraTable updateCertificate(
            ...
            throws AtlanException {
        return (CassandraTable) Asset.updateCertificate(client, _internal(), TYPE_NAME, qualifiedName, certificate, message);
    }
    ...
    public static CassandraTable updateAnnouncement(
            ...
            throws AtlanException {
        return (CassandraTable) Asset.updateAnnouncement(client, _internal(), TYPE_NAME, qualifiedName, type, title, message);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static CassandraTable replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
