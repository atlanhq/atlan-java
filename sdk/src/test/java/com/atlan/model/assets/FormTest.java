...
public class FormTest {
    ...
    private final Form full = Form._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleForm() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Form,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(), full, "Unable to converting Form via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Form,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Form frodo = MockAtlanTenant.client.readValue(serialized, Form.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Form,");
