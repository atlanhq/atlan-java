...
public class FormTest {
    ...
    private static final Form full = Form._internal()
            .guid("guid")
            ...
            .formField(FormField.builder()
                    .formFieldId("String0")
                    .formFieldName("String0")
                    .formFieldType(FormFieldType.INT)
                    .formFieldDimension(FormFieldDimension.SINGLE)
                    .formFieldOptions(Map.of("key1", "value1", "key2", "value2"))
                    .build())
            .formField(FormField.builder()
                    .formFieldId("String1")
                    .formFieldName("String1")
                    .formFieldType(FormFieldType.STRING)
                    .formFieldDimension(FormFieldDimension.MULTI)
                    .formFieldOptions(Map.of("key1", "value1", "key2", "value2"))
                    .build())
            .formOption("key1", "value1")
            .formOption("key2", "value2")
            .build();

    private static final int hash = full.hashCode();
    private static Form frodo;
    private static String serialized;

    @Test(groups = {"Form.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"Form.serialize"},
            dependsOnGroups = {"Form.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"Form.deserialize"},
            dependsOnGroups = {"Form.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, Form.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"Form.equivalency"},
            dependsOnGroups = {"Form.serialize", "Form.deserialize"})
