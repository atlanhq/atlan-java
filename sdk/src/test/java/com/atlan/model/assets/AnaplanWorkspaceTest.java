...
public class AnaplanWorkspaceTest {
    ...
    private final AnaplanWorkspace full = AnaplanWorkspace._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAnaplanWorkspace() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AnaplanWorkspace,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AnaplanWorkspace via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AnaplanWorkspace,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AnaplanWorkspace frodo = MockAtlanTenant.client.readValue(serialized, AnaplanWorkspace.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AnaplanWorkspace,");
