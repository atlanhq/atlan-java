...
public class AnaplanWorkspaceTest {

    private static final AnaplanWorkspace full = AnaplanWorkspace._internal()
            .guid("guid")
            ...
            .anaplanWorkspaceAllowanceSize(123456789L)
            .anaplanWorkspaceCurrentSize(123456789L)
            .build();

    private static final int hash = full.hashCode();
    private static AnaplanWorkspace frodo;
    private static String serialized;

    @Test(groups = {"AnaplanWorkspace.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AnaplanWorkspace.serialize"},
            dependsOnGroups = {"AnaplanWorkspace.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AnaplanWorkspace.deserialize"},
            dependsOnGroups = {"AnaplanWorkspace.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AnaplanWorkspace.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AnaplanWorkspace.equivalency"},
            dependsOnGroups = {"AnaplanWorkspace.serialize", "AnaplanWorkspace.deserialize"})
