...
public class ModelDataModelTest {
    ...
    private final ModelDataModel full = ModelDataModel._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleModelDataModel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ModelDataModel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ModelDataModel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ModelDataModel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ModelDataModel frodo = MockAtlanTenant.client.readValue(serialized, ModelDataModel.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ModelDataModel,");
