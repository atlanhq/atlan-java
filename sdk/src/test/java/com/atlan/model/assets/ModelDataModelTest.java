...
public class ModelDataModelTest {
    ...
    private static final ModelDataModel full = ModelDataModel._internal()
            .guid("guid")
    ...
    private static ModelDataModel frodo;
    private static String serialized;

    @Test(groups = {"ModelDataModel.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"ModelDataModel.serialize"},
            dependsOnGroups = {"ModelDataModel.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"ModelDataModel.deserialize"},
            dependsOnGroups = {"ModelDataModel.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, ModelDataModel.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"ModelDataModel.equivalency"},
            dependsOnGroups = {"ModelDataModel.serialize", "ModelDataModel.deserialize"})
