...
public class CosmosMongoDBCollectionTest {

    private final CosmosMongoDBCollection full = CosmosMongoDBCollection._internal()
            .guid("guid")
            ...
            .mongoDBColumn(Column.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .mongoDBColumn(Column.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleCosmosMongoDBCollection() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CosmosMongoDBCollection,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CosmosMongoDBCollection via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CosmosMongoDBCollection,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CosmosMongoDBCollection frodo = MockAtlanTenant.client.readValue(serialized, CosmosMongoDBCollection.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CosmosMongoDBCollection,");
