...
public class CosmosMongoDBCollectionTest {
    ...
    private static final CosmosMongoDBCollection full = CosmosMongoDBCollection._internal()
            .guid("guid")
    ...
    private static CosmosMongoDBCollection frodo;
    private static String serialized;

    @Test(groups = {"CosmosMongoDBCollection.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CosmosMongoDBCollection.serialize"},
            dependsOnGroups = {"CosmosMongoDBCollection.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CosmosMongoDBCollection.deserialize"},
            dependsOnGroups = {"CosmosMongoDBCollection.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CosmosMongoDBCollection.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CosmosMongoDBCollection.equivalency"},
            dependsOnGroups = {"CosmosMongoDBCollection.serialize", "CosmosMongoDBCollection.deserialize"})
