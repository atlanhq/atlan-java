...
public class CosmosMongoDBCollectionTest {
    ...
    void serdeCycleCosmosMongoDBCollection() throws IOException {
        ...
        // Deserialization
        final CosmosMongoDBCollection frodo =
                MockAtlanTenant.client.readValue(serialized, CosmosMongoDBCollection.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of CosmosMongoDBCollection,");
