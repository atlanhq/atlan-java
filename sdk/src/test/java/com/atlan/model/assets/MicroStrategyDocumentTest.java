...
public class MicroStrategyDocumentTest {
    ...
    private static final MicroStrategyDocument full = MicroStrategyDocument._internal()
            .guid("guid")
    ...
    private static MicroStrategyDocument frodo;
    private static String serialized;

    @Test(groups = {"MicroStrategyDocument.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"MicroStrategyDocument.serialize"},
    ...
    @Test(
            groups = {"MicroStrategyDocument.deserialize"},
            dependsOnGroups = {"MicroStrategyDocument.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyDocument.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"MicroStrategyDocument.equivalency"},
            dependsOnGroups = {"MicroStrategyDocument.serialize", "MicroStrategyDocument.deserialize"})
