...
public class MicroStrategyDocumentTest {

    private final MicroStrategyDocument full = MicroStrategyDocument._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleMicroStrategyDocument() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MicroStrategyDocument,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MicroStrategyDocument via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MicroStrategyDocument,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MicroStrategyDocument frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyDocument.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MicroStrategyDocument,");
