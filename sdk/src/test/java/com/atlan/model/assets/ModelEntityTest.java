...
public class ModelEntityTest {
    ...
    private final ModelEntity full = ModelEntity._internal()
            ...
            .modelEntitySubjectArea("String0")
            .modelEntityGeneralizationName("String0")
            .modelEntityGeneralizationQualifiedName("String0")
            .modelVersion(ModelVersion.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelVersion(ModelVersion.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelEntityMappedToEntity(ModelEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelEntityMappedToEntity(ModelEntity.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelEntityMappedFromEntity(ModelEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelEntityMappedFromEntity(ModelEntity.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelEntityImplementedByAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelEntityImplementedByAsset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelEntitySpecializationEntity(ModelEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelEntitySpecializationEntity(ModelEntity.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelEntityGeneralizationEntity(ModelEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelEntityRelatedFromEntity(ModelEntityAssociation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelEntityRelatedFromEntity(ModelEntityAssociation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .modelEntityRelatedToEntity(ModelEntityAssociation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelEntityRelatedToEntity(ModelEntityAssociation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
