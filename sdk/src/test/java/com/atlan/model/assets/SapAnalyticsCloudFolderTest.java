...
public class SapAnalyticsCloudFolderTest {

    private final SapAnalyticsCloudFolder full = SapAnalyticsCloudFolder._internal()
            .guid("guid")
            ...
            .sapAnalyticsCloudSubFolder(SapAnalyticsCloudFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapAnalyticsCloudSubFolder(
                    SapAnalyticsCloudFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapAnalyticsCloudParentFolder(SapAnalyticsCloudFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapAnalyticsCloudModel(SapAnalyticsCloudModel.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapAnalyticsCloudModel(
                    SapAnalyticsCloudModel.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sapAnalyticsCloudStory(SapAnalyticsCloudStory.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapAnalyticsCloudStory(
                    SapAnalyticsCloudStory.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSapAnalyticsCloudFolder() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SapAnalyticsCloudFolder,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SapAnalyticsCloudFolder via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SapAnalyticsCloudFolder,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SapAnalyticsCloudFolder frodo =
                MockAtlanTenant.client.readValue(serialized, SapAnalyticsCloudFolder.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of SapAnalyticsCloudFolder,");
