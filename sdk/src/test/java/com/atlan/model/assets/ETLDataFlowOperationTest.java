...
public class ETLDataFlowOperationTest {

    private static final ETLDataFlowOperation full = ETLDataFlowOperation._internal()
            .guid("guid")
            ...
            .etlDetailedDataFlowOperation(ETLDataFlowOperation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .etlDetailedDataFlowOperation(
                    ETLDataFlowOperation.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .etlParentDataFlowOperation(ETLDataFlowOperation.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .etlParentProcess(LineageProcess.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();

    private static final int hash = full.hashCode();
    private static ETLDataFlowOperation frodo;
    private static String serialized;

    @Test(groups = {"ETLDataFlowOperation.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"ETLDataFlowOperation.serialize"},
            dependsOnGroups = {"ETLDataFlowOperation.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"ETLDataFlowOperation.deserialize"},
            dependsOnGroups = {"ETLDataFlowOperation.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, ETLDataFlowOperation.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"ETLDataFlowOperation.equivalency"},
            dependsOnGroups = {"ETLDataFlowOperation.serialize", "ETLDataFlowOperation.deserialize"})
