...
public class FlowV02InterimDatasetTest {

    private static final FlowV02InterimDataset full = FlowV02InterimDataset._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .flowV02DetailedBy(FlowV02ProcessGrouping.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    private static FlowV02InterimDataset frodo;
    private static String serialized;

    @Test(groups = {"FlowV02InterimDataset.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowV02InterimDataset.serialize"},
            dependsOnGroups = {"FlowV02InterimDataset.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowV02InterimDataset.deserialize"},
            dependsOnGroups = {"FlowV02InterimDataset.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowV02InterimDataset.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowV02InterimDataset.equivalency"},
            dependsOnGroups = {"FlowV02InterimDataset.serialize", "FlowV02InterimDataset.deserialize"})
