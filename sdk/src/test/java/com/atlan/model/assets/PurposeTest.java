...
public class PurposeTest {
    ...
    private final Purpose full = Purpose._internal()
            .guid("guid")
    ...
    @Test
    void serdeCyclePurpose() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Purpose,");
        ...
        // Deserialization
        final Purpose frodo = MockAtlanTenant.client.readValue(serialized, Purpose.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Purpose,");
