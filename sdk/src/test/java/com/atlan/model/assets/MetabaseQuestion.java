...
public class MetabaseQuestion extends Asset implements IMetabaseQuestion, IMetabase, IBI, ICatalog, IAsset, IReferenceable {
     ...
     *
     * @return the minimal object necessary to relate to the MetabaseQuestion
     * @throws InvalidRequestException if any of the minimal set of required properties for a MetabaseQuestion relationship are not found in the initial object
     */
    @Override
    ...
    /**
     * Start a fluent search that will return all MetabaseQuestion assets.
     * Additional conditions can be chained onto the returned search before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) MetabaseQuestion assets will be included.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @return a fluent search that includes all MetabaseQuestion assets
     */
     ...
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @param includeArchived when true, archived (soft-deleted) MetabaseQuestions will be included
     * @return a fluent search that includes all MetabaseQuestion assets
     */
    ...
    /**
     * Reference to a MetabaseQuestion by GUID. Use this to create a relationship to this MetabaseQuestion,
    ...
    public static MetabaseQuestion refByGuid(String guid, Reference.SaveSemantic semantic) {
        return MetabaseQuestion._internal().guid(guid).semantic(semantic).build();
    }

    /**
     * Reference to a MetabaseQuestion by qualifiedName. Use this to create a relationship to this MetabaseQuestion,
     * where the relationship should be replaced.
     *
    ...
    /**
     * Retrieves a MetabaseQuestion by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the MetabaseQuestion to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the MetabaseQuestion, including any relationships
     * @return the requested MetabaseQuestion, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MetabaseQuestion does not exist or the provided GUID is not a MetabaseQuestion
     */
    @JsonIgnore
     ...
     * @param id of the MetabaseQuestion to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the MetabaseQuestion, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the MetabaseQuestion
     * @return the requested MetabaseQuestion, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MetabaseQuestion does not exist or the provided GUID is not a MetabaseQuestion
     */
    @JsonIgnore
    public static MetabaseQuestion get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = MetabaseQuestion.select(client)
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof MetabaseQuestion) {
    ...
    /**
     * Builds the minimal object necessary to apply an update to a MetabaseQuestion,
     * from a potentially more-complete MetabaseQuestion object.
     *
     * @return the minimal object necessary to update the MetabaseQuestion, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a MetabaseQuestion are not present in the initial object
     */
    @Override
