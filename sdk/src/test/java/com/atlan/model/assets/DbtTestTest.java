...
public class DbtTestTest {
    ...
    private final DbtTest full = DbtTest._internal()
            .guid("guid")
            ...
            .dbtTestError("String0")
            .dbtTestRawSQL("String0")
            .dbtTestCompiledSQL("String0")
            .dbtTestRawCode("String0")
            .dbtTestCompiledCode("String0")
            .dbtTestLanguage("String0")
            ...
            .sqlAsset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sqlAsset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDbtTest() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtTest,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtTest via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtTest,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtTest frodo = MockAtlanTenant.client.readValue(serialized, DbtTest.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtTest,");
