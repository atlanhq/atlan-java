...
public class DbtTestTest {
    ...
    private static DbtTest frodo;
    private static String serialized;

    @Test(groups = {"DbtTest.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DbtTest.serialize"},
            dependsOnGroups = {"DbtTest.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DbtTest.deserialize"},
            dependsOnGroups = {"DbtTest.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DbtTest.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DbtTest.equivalency"},
            dependsOnGroups = {"DbtTest.serialize", "DbtTest.deserialize"})
