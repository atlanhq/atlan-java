...
public class LookerModel extends Asset implements ILookerModel, ILooker, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Builds the minimal object necessary to create a relationship to a LookerModel, from a potentially
     * more-complete LookerModel object.
     *
     * @return the minimal object necessary to relate to the LookerModel
     * @throws InvalidRequestException if any of the minimal set of required properties for a LookerModel relationship are not found in the initial object
     */
    @Override
    public LookerModel trimToReference() throws InvalidRequestException {
    ...
    /**
     * Reference to a LookerModel by GUID. Use this to create a relationship to this LookerModel,
     ...
     * @return reference to a LookerModel that can be used for defining a relationship to a LookerModel
     */
    public static LookerModel refByGuid(String guid, Reference.SaveSemantic semantic) {
        return LookerModel._internal().guid(guid).semantic(semantic).build();
    }

    /**
     * Reference to a LookerModel by qualifiedName. Use this to create a relationship to this LookerModel,
     * where the relationship should be replaced.
     *
     ...
     * @return reference to a LookerModel that can be used for defining a relationship to a LookerModel
     */
    public static LookerModel refByQualifiedName(String qualifiedName, Reference.SaveSemantic semantic) {
    ...
    /**
     * Retrieves a LookerModel by one of its identifiers, optionally complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the LookerModel to retrieve, either its GUID or its full qualifiedName
     * @param includeAllRelationships if true, all the asset's relationships will also be retrieved; if false, no relationships will be retrieved
     * @return the requested full LookerModel, optionally complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the LookerModel does not exist or the provided GUID is not a LookerModel
     */
    @JsonIgnore
    ...
    /**
     * Retrieves a LookerModel by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the LookerModel to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the LookerModel, including any relationships
     * @return the requested LookerModel, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the LookerModel does not exist or the provided GUID is not a LookerModel
     */
    @JsonIgnore
     ...
     * @param id of the LookerModel to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the LookerModel, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the LookerModel
     * @return the requested LookerModel, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the LookerModel does not exist or the provided GUID is not a LookerModel
     */
    @JsonIgnore
    public static LookerModel get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = LookerModel.select(client)
                    .where(LookerModel.GUID.eq(id))
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof LookerModel) {
                return (LookerModel) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
            Optional<Asset> asset = LookerModel.select(client)
                    .where(LookerModel.QUALIFIED_NAME.eq(id))
                    .includesOnResults(attributes)
                    .includesOnRelations(attributesOnRelated)
                    .includeRelationshipAttributes(true)
                    .pageSize(1)
    ...
    /**
     * Builds the minimal object necessary to apply an update to a LookerModel,
     * from a potentially more-complete LookerModel object.
     *
     * @return the minimal object necessary to update the LookerModel, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a LookerModel are not present in the initial object
     */
    @Override
     ...
     * @throws AtlanException on any API problems
     */
    public static LookerModel removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (LookerModel) Asset.removeUserDescription(client, updater(qualifiedName, name));
    }
     ...
     *
     * @param client connectivity to the Atlan tenant on which to update the LookerModel's certificate
     * @param qualifiedName of the LookerModel
     ...
     *
     * @param client connectivity to the Atlan tenant on which to update the LookerModel's announcement
     * @param qualifiedName of the LookerModel
     ...
     *
     * @param client connectivity to the Atlan tenant on which to replace the LookerModel's assigned terms
     * @param qualifiedName for the LookerModel
     ...
     *
     * @param client connectivity to the Atlan tenant on which to append terms to the LookerModel
     * @param qualifiedName for the LookerModel
     ...
     */
    @Deprecated
    public static LookerModel appendTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
        return (LookerModel) Asset.appendTerms(client, TYPE_NAME, qualifiedName, terms);
    }
     ...
     */
    @Deprecated
    public static LookerModel removeTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
        return (LookerModel) Asset.removeTerms(client, TYPE_NAME, qualifiedName, terms);
    }
     ...
     *
     * @param client connectivity to the Atlan tenant from which to remove an Atlan tag from a LookerModel
     * @param qualifiedName of the LookerModel
