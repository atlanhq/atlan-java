...
public class DatabricksExternalLocationTest {

    private final DatabricksExternalLocation full = DatabricksExternalLocation._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .databricksUrl("String0")
            .databricksOwner("String0")
            .databricksExternalLocationPath(DatabricksExternalLocationPath.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .databricksExternalLocationPath(DatabricksExternalLocationPath.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDatabricksExternalLocation() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DatabricksExternalLocation,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DatabricksExternalLocation via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DatabricksExternalLocation,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DatabricksExternalLocation frodo = MockAtlanTenant.client.readValue(serialized, DatabricksExternalLocation.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DatabricksExternalLocation,");
