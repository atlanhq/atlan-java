...
public class DatabricksExternalLocationTest {
    ...
    private static final DatabricksExternalLocation full = DatabricksExternalLocation._internal()
            .guid("guid")
    ...
    private static DatabricksExternalLocation frodo;
    ...
    @Test(groups = {"DatabricksExternalLocation.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DatabricksExternalLocation.serialize"},
            dependsOnGroups = {"DatabricksExternalLocation.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DatabricksExternalLocation.deserialize"},
            dependsOnGroups = {"DatabricksExternalLocation.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DatabricksExternalLocation.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DatabricksExternalLocation.equivalency"},
            dependsOnGroups = {"DatabricksExternalLocation.serialize", "DatabricksExternalLocation.deserialize"})
