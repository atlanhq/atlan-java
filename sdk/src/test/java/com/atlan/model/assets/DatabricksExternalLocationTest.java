...
public class DatabricksExternalLocationTest {
    ...
    private final DatabricksExternalLocation full = DatabricksExternalLocation._internal()
            ...
            .databricksExternalLocationPath(
                    DatabricksExternalLocationPath.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .databricksExternalLocationPath(DatabricksExternalLocationPath.refByQualifiedName(
    ...
    void serdeCycleDatabricksExternalLocation() throws IOException {
        ...
        // Deserialization
        final DatabricksExternalLocation frodo =
                MockAtlanTenant.client.readValue(serialized, DatabricksExternalLocation.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of DatabricksExternalLocation,");
