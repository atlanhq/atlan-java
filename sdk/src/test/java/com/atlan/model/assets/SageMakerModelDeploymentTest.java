...
public class SageMakerModelDeploymentTest {
    ...
    void serdeCycleSageMakerModelDeployment() throws IOException {
        ...
        // Deserialization
        final SageMakerModelDeployment frodo =
                MockAtlanTenant.client.readValue(serialized, SageMakerModelDeployment.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of SageMakerModelDeployment,");
