...
public class SageMakerModelDeploymentTest {

    private final SageMakerModelDeployment full = SageMakerModelDeployment._internal()
            .guid("guid")
            ...
            .sageMakerModelDeploymentStatus("String0")
            .sageMakerModelDeploymentEndpointConfigName("String0")
            .sageMakerModelDeploymentModelName("String0")
            .sageMakerModelDeploymentModelQualifiedName("String0")
    ...
    @Test
    void serdeCycleSageMakerModelDeployment() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SageMakerModelDeployment,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SageMakerModelDeployment via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SageMakerModelDeployment,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SageMakerModelDeployment frodo = MockAtlanTenant.client.readValue(serialized, SageMakerModelDeployment.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerModelDeployment,");
