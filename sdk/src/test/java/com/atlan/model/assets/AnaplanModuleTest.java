...
public class AnaplanModuleTest {

    private static final AnaplanModule full = AnaplanModule._internal()
            .guid("guid")
            ...
            .anaplanLineItem(AnaplanLineItem.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanModel(AnaplanModel.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanView(AnaplanView.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanView(AnaplanView.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static AnaplanModule frodo;
    private static String serialized;

    @Test(groups = {"AnaplanModule.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AnaplanModule.serialize"},
            dependsOnGroups = {"AnaplanModule.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AnaplanModule.deserialize"},
            dependsOnGroups = {"AnaplanModule.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AnaplanModule.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AnaplanModule.equivalency"},
            dependsOnGroups = {"AnaplanModule.serialize", "AnaplanModule.deserialize"})
