...
public class AnaplanModuleTest {
    ...
    private final AnaplanModule full = AnaplanModule._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAnaplanModule() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AnaplanModule,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AnaplanModule via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AnaplanModule,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AnaplanModule frodo = MockAtlanTenant.client.readValue(serialized, AnaplanModule.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AnaplanModule,");
