...
public class SisenseDatamodelTableTest {
    ...
    private final SisenseDatamodelTable full = SisenseDatamodelTable._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSisenseDatamodelTable() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SisenseDatamodelTable,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SisenseDatamodelTable via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SisenseDatamodelTable,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SisenseDatamodelTable frodo = MockAtlanTenant.client.readValue(serialized, SisenseDatamodelTable.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SisenseDatamodelTable,");
