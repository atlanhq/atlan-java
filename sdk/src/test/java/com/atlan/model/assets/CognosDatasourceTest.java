...
public class CognosDatasourceTest {

    private static final CognosDatasource full = CognosDatasource._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .cognosDatasourceConnectionString("String0")
            .build();

    private static final int hash = full.hashCode();
    private static CognosDatasource frodo;
    private static String serialized;

    @Test(groups = {"CognosDatasource.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CognosDatasource.serialize"},
            dependsOnGroups = {"CognosDatasource.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CognosDatasource.deserialize"},
            dependsOnGroups = {"CognosDatasource.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CognosDatasource.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CognosDatasource.equivalency"},
            dependsOnGroups = {"CognosDatasource.serialize", "CognosDatasource.deserialize"})
