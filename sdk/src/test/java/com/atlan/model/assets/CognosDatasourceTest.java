...
public class CognosDatasourceTest {
    ...
    private final CognosDatasource full = CognosDatasource._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCognosDatasource() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CognosDatasource,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CognosDatasource via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CognosDatasource,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CognosDatasource frodo = MockAtlanTenant.client.readValue(serialized, CognosDatasource.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CognosDatasource,");
