...
public class SisenseDatamodelTest {
    ...
    private final SisenseDatamodel full = SisenseDatamodel._internal()
            .guid("guid")
            ...
            .sisenseDatamodelTable(SisenseDatamodelTable.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSisenseDatamodel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SisenseDatamodel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SisenseDatamodel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SisenseDatamodel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SisenseDatamodel frodo = MockAtlanTenant.client.readValue(serialized, SisenseDatamodel.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SisenseDatamodel,");
