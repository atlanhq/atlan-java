...
public class SisenseDatamodelTest {

    private static final SisenseDatamodel full = SisenseDatamodel._internal()
            .guid("guid")
            ...
            .sisenseDatamodelLastBuildTime(123456789L)
            .sisenseDatamodelLastPublishTime(123456789L)
            .sisenseDatamodelLastSuccessfulBuildTime(123456789L)
            .sisenseDatamodelRelationType("String0")
            .sisenseDatamodelRevision("String0")
            .sisenseDatamodelServer("String0")
            .sisenseDatamodelTableCount(123456789L)
            .sisenseDatamodelTable(SisenseDatamodelTable.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sisenseDatamodelTable(
                    SisenseDatamodelTable.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sisenseDatamodelType("String0")
            .build();

    private static final int hash = full.hashCode();
    private static SisenseDatamodel frodo;
    private static String serialized;

    @Test(groups = {"SisenseDatamodel.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SisenseDatamodel.serialize"},
            dependsOnGroups = {"SisenseDatamodel.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SisenseDatamodel.deserialize"},
            dependsOnGroups = {"SisenseDatamodel.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SisenseDatamodel.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SisenseDatamodel.equivalency"},
            dependsOnGroups = {"SisenseDatamodel.serialize", "SisenseDatamodel.deserialize"})
