...
public class SigmaDataModelTest {

    private final SigmaDataModel full = SigmaDataModel._internal()
            .guid("guid")
            ...
            .sigmaDataModelUrlId("String0")
            .sigmaDataModelDocumentVersion(123456789L)
            .sigmaDataModelLatestDocumentVersion(123456789L)
            .sigmaDataModelSchemaVersion(123456789L)
            .sigmaDataModelElementCount(123456789L)
            .sigmaDataModelColumnCount(123456789L)
            .sigmaDataModelPath("String0")
            .sigmaDataModelColumn(SigmaDataModelColumn.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sigmaDataModelColumn(
                    SigmaDataModelColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSigmaDataModel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SigmaDataModel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SigmaDataModel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SigmaDataModel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SigmaDataModel frodo = MockAtlanTenant.client.readValue(serialized, SigmaDataModel.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SigmaDataModel,");
