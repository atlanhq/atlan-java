...
public class TableauDatasourceTest {
    ...
    private final TableauDatasource full = TableauDatasource._internal()
            .guid("guid")
            ...
            .hasExtracts(true)
            .isCertified(true)
            .putCertifier("String0", "String0")
            .putCertifier("String1", "String1")
            .certificationNote("String0")
            .certifierDisplayName("String0")
            .upstreamTable(Map.of("key1", "value1"))
            .upstreamTable(Map.of("key2", "value2"))
            .upstreamDatasource(Map.of("key1", "value1"))
            .upstreamDatasource(Map.of("key2", "value2"))
    ...
    @Test
    void serdeCycleTableauDatasource() throws IOException {
        assertNotNull(full, "Unable to build sample instance of TableauDatasource,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting TableauDatasource via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of TableauDatasource,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final TableauDatasource frodo = MockAtlanTenant.client.readValue(serialized, TableauDatasource.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of TableauDatasource,");
