...
public class ADLSAccount extends Asset implements IADLSAccount, IADLS, IObjectStore, IAzure, ICatalog, IAsset, IReferenceable, ICloud {
     ...
     */
    @JsonIgnore
    public static ADLSAccount get(AtlanClient client, String id, boolean includeAllRelationships) throws AtlanException {
        if (id == null) {
     ...
     */
    @JsonIgnore
    public static ADLSAccount get(AtlanClient client, String id, Collection<AtlanField> attributes) throws AtlanException {
...
/**
    ...
    /**
     * Builds the minimal object necessary to apply an update to a ADLSAccount,
     * from a potentially more-complete ADLSAccount object.
     *
     * @return the minimal object necessary to update the ADLSAccount, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a ADLSAccount are not present in the initial object
     */
    @Override
     ...
     * @throws AtlanException on any API problems
     */
    public static ADLSAccount replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
