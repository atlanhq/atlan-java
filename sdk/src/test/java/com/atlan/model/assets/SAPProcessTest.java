...
public class SAPProcessTest {

    private final SAPProcess full = SAPProcess._internal()
            .guid("guid")
            ...
            .sapBwDtp(SAPBWDTP.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sapBwDtp(SAPBWDTP.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSAPProcess() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPProcess,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPProcess via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPProcess,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPProcess frodo = MockAtlanTenant.client.readValue(serialized, SAPProcess.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPProcess,");
