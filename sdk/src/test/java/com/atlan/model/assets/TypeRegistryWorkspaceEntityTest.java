...
public class TypeRegistryWorkspaceEntityTest {

    private static final TypeRegistryWorkspaceEntity full = TypeRegistryWorkspaceEntity._internal()
            .guid("guid")
            ...
            .typeRegistrySuperType("String0")
            .typeRegistrySuperType("String1")
    ...
    private static TypeRegistryWorkspaceEntity frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryWorkspaceEntity.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryWorkspaceEntity.serialize"},
            dependsOnGroups = {"TypeRegistryWorkspaceEntity.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryWorkspaceEntity.deserialize"},
            dependsOnGroups = {"TypeRegistryWorkspaceEntity.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryWorkspaceEntity.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryWorkspaceEntity.equivalency"},
            dependsOnGroups = {"TypeRegistryWorkspaceEntity.serialize", "TypeRegistryWorkspaceEntity.deserialize"})
