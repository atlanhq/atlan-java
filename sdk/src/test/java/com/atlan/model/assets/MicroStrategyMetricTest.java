...
public class MicroStrategyMetricTest {
    ...
    private static final MicroStrategyMetric full = MicroStrategyMetric._internal()
            .guid("guid")
            ...
            .microStrategyMetricChild(
                    MicroStrategyMetric.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test(
            groups = {"MicroStrategyMetric.serialize"},
            dependsOnGroups = {"MicroStrategyMetric.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"MicroStrategyMetric.deserialize"},
            dependsOnGroups = {"MicroStrategyMetric.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyMetric.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"MicroStrategyMetric.equivalency"},
            dependsOnGroups = {"MicroStrategyMetric.serialize", "MicroStrategyMetric.deserialize"})
