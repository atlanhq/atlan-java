...
public class DatabricksAIModelVersionTest {
    ...
    void serdeCycleDatabricksAIModelVersion() throws IOException {
        ...
        // Deserialization
        final DatabricksAIModelVersion frodo =
                MockAtlanTenant.client.readValue(serialized, DatabricksAIModelVersion.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of DatabricksAIModelVersion,");
