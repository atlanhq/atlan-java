...
public class DatabricksAIModelVersionTest {
    ...
    private final DatabricksAIModelVersion full = DatabricksAIModelVersion._internal()
            .guid("guid")
            ...
            .databricksAIModelVersionMetric(DatabricksAIModelVersionMetric.builder()
                    ...
                    .build())
            .databricksAIModelVersionParam("String0", "String0")
            .databricksAIModelVersionParam("String1", "String1")
    ...
    @Test
    void serdeCycleDatabricksAIModelVersion() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DatabricksAIModelVersion,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DatabricksAIModelVersion via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DatabricksAIModelVersion,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DatabricksAIModelVersion frodo = MockAtlanTenant.client.readValue(serialized, DatabricksAIModelVersion.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DatabricksAIModelVersion,");
