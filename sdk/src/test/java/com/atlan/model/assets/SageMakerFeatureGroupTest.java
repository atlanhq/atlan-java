...
public class SageMakerFeatureGroupTest {

    private final SageMakerFeatureGroup full = SageMakerFeatureGroup._internal()
            .guid("guid")
            ...
            .sageMakerFeatureGroupStatus("String0")
            .sageMakerFeatureGroupRecordIdName("String0")
            .sageMakerFeatureGroupGlueDatabaseName("String0")
            .sageMakerFeatureGroupGlueTableName("String0")
            .sageMakerFeatureGroupFeatureCount(123456789L)
            .sageMakerFeature(SageMakerFeature.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sageMakerFeature(SageMakerFeature.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSageMakerFeatureGroup() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SageMakerFeatureGroup,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SageMakerFeatureGroup via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SageMakerFeatureGroup,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SageMakerFeatureGroup frodo = MockAtlanTenant.client.readValue(serialized, SageMakerFeatureGroup.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerFeatureGroup,");
