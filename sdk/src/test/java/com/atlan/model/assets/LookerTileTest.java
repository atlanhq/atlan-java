...
public class LookerTileTest {
    ...
    private final LookerTile full = LookerTile._internal()
            .guid("guid")
            ...
            .mergeResultId("String0")
            .noteText("String0")
            .queryID(123)
            .lookerQueryID("String0")
            .resultMakerID(123)
            .subtitleText("String0")
            .lookId(123)
    ...
    @Test
    void serdeCycleLookerTile() throws IOException {
        assertNotNull(full, "Unable to build sample instance of LookerTile,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting LookerTile via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of LookerTile,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final LookerTile frodo = MockAtlanTenant.client.readValue(serialized, LookerTile.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of LookerTile,");
