...
public class LookerModelTest {
    ...
    private static final LookerModel full = LookerModel._internal()
            .guid("guid")
            ...
            .projectName("String0")
            .query(LookerQuery.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .query(LookerQuery.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, LookerModel.class);
        assertNotNull(frodo);
    }
