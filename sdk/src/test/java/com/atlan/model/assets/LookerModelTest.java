...
public class LookerModelTest {
    ...
    private final LookerModel full = LookerModel._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleLookerModel() throws IOException {
        assertNotNull(full, "Unable to build sample instance of LookerModel,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting LookerModel via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of LookerModel,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final LookerModel frodo = MockAtlanTenant.client.readValue(serialized, LookerModel.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of LookerModel,");
