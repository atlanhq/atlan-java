...
public class QlikChartTest {
    ...
    private final QlikChart full = QlikChart._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleQlikChart() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QlikChart,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QlikChart via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QlikChart,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QlikChart frodo = MockAtlanTenant.client.readValue(serialized, QlikChart.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QlikChart,");
