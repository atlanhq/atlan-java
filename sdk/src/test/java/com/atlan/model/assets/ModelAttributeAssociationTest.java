...
public class ModelAttributeAssociationTest {

    private static final ModelAttributeAssociation full = ModelAttributeAssociation._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .modelAttributeAssociationFrom(ModelAttribute.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelAttributeAssociationFromQualifiedName("String0")
            .modelAttributeAssociationTo(ModelAttribute.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelAttributeAssociationToQualifiedName("String0")
            .modelEntityAssociationQualifiedName("String0")
            .build();

    private static final int hash = full.hashCode();
    private static ModelAttributeAssociation frodo;
    private static String serialized;

    @Test(groups = {"ModelAttributeAssociation.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"ModelAttributeAssociation.serialize"},
    ...
    @Test(
            groups = {"ModelAttributeAssociation.deserialize"},
            dependsOnGroups = {"ModelAttributeAssociation.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, ModelAttributeAssociation.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"ModelAttributeAssociation.equivalency"},
            dependsOnGroups = {"ModelAttributeAssociation.serialize", "ModelAttributeAssociation.deserialize"})
