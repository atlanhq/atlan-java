...
public class ModelAttributeAssociationTest {
    ...
    private static final ModelAttributeAssociation full = ModelAttributeAssociation._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .modelAttributeAssociationCardinality(ModelCardinalityType.ONE_TO_ONE)
            .modelAttributeAssociationFrom(ModelAttribute.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelAttributeAssociationFromLabel("String0")
            .modelAttributeAssociationFromMaxCardinality(123456789L)
            .modelAttributeAssociationFromMinCardinality(123456789L)
            .modelAttributeAssociationFromQualifiedName("String0")
            .modelAttributeAssociationLabel("String0")
            .modelAttributeAssociationTo(ModelAttribute.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .modelAttributeAssociationToLabel("String0")
            .modelAttributeAssociationToMaxCardinality(123456789L)
            .modelAttributeAssociationToMinCardinality(123456789L)
