...
public class ModelAttributeAssociationTest {
    ...
    private final ModelAttributeAssociation full = ModelAttributeAssociation._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleModelAttributeAssociation() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ModelAttributeAssociation,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ModelAttributeAssociation via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ModelAttributeAssociation,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ModelAttributeAssociation frodo = MockAtlanTenant.client.readValue(serialized, ModelAttributeAssociation.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ModelAttributeAssociation,");
