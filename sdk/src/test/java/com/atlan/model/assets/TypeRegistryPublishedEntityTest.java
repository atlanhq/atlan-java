...
public class TypeRegistryPublishedEntityTest {

    private static final TypeRegistryPublishedEntity full = TypeRegistryPublishedEntity._internal()
            .guid("guid")
    ...
    private static TypeRegistryPublishedEntity frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryPublishedEntity.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryPublishedEntity.serialize"},
            dependsOnGroups = {"TypeRegistryPublishedEntity.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryPublishedEntity.deserialize"},
            dependsOnGroups = {"TypeRegistryPublishedEntity.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryPublishedEntity.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryPublishedEntity.equivalency"},
            dependsOnGroups = {"TypeRegistryPublishedEntity.serialize", "TypeRegistryPublishedEntity.deserialize"})
