...
public class AzureTest {
    ...
    private final Azure full = Azure._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAzure() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Azure,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Azure via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Azure,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Azure frodo = MockAtlanTenant.client.readValue(serialized, Azure.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Azure,");
