...
public class CosmosMongoDBAccountTest {
    ...
    private final CosmosMongoDBAccount full = CosmosMongoDBAccount._internal()
            .guid("guid")
            ...
            .cosmosMongoDBDatabase(CosmosMongoDBDatabase.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleCosmosMongoDBAccount() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CosmosMongoDBAccount,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CosmosMongoDBAccount via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CosmosMongoDBAccount,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CosmosMongoDBAccount frodo = MockAtlanTenant.client.readValue(serialized, CosmosMongoDBAccount.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CosmosMongoDBAccount,");
