...
public class SageMakerUnifiedStudioAssetTest {

    private final SageMakerUnifiedStudioAsset full = SageMakerUnifiedStudioAsset._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSageMakerUnifiedStudioAsset() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SageMakerUnifiedStudioAsset,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SageMakerUnifiedStudioAsset via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SageMakerUnifiedStudioAsset,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SageMakerUnifiedStudioAsset frodo = MockAtlanTenant.client.readValue(serialized, SageMakerUnifiedStudioAsset.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SageMakerUnifiedStudioAsset,");
