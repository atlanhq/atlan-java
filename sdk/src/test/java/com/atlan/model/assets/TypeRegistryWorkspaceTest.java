...
public class TypeRegistryWorkspaceTest {

    private static final TypeRegistryWorkspace full = TypeRegistryWorkspace._internal()
            .guid("guid")
            ...
            .typeRegistryType(TypeRegistryAssociationRelationship.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryType(TypeRegistryAssociationRelationship.refByQualifiedName(
                    "default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static TypeRegistryWorkspace frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryWorkspace.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryWorkspace.serialize"},
            dependsOnGroups = {"TypeRegistryWorkspace.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryWorkspace.deserialize"},
            dependsOnGroups = {"TypeRegistryWorkspace.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryWorkspace.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryWorkspace.equivalency"},
            dependsOnGroups = {"TypeRegistryWorkspace.serialize", "TypeRegistryWorkspace.deserialize"})
