...
public class SAPBWDataSourceFieldTest {

    private final SAPBWDataSourceField full = SAPBWDataSourceField._internal()
            .guid("guid")
            ...
            .sapBwDataSource(SAPBWDataSource.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleSAPBWDataSourceField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWDataSourceField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWDataSourceField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWDataSourceField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWDataSourceField frodo = MockAtlanTenant.client.readValue(serialized, SAPBWDataSourceField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWDataSourceField,");
