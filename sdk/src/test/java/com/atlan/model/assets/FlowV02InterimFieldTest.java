...
public class FlowV02InterimFieldTest {

    private static final FlowV02InterimField full = FlowV02InterimField._internal()
            .guid("guid")
    ...
    private static FlowV02InterimField frodo;
    private static String serialized;

    @Test(groups = {"FlowV02InterimField.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowV02InterimField.serialize"},
            dependsOnGroups = {"FlowV02InterimField.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowV02InterimField.deserialize"},
            dependsOnGroups = {"FlowV02InterimField.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowV02InterimField.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowV02InterimField.equivalency"},
            dependsOnGroups = {"FlowV02InterimField.serialize", "FlowV02InterimField.deserialize"})
