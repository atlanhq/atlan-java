...
public class IcebergTableTest {
    ...
    private final IcebergTable full = IcebergTable._internal()
            .guid("guid")
            ...
            .icebergCurrentSnapshotId(123456789L)
            .icebergFormatVersion(123)
            .icebergTableProperty("String0", "String0")
            .icebergTableProperty("String1", "String1")
            .icebergTablePartition(IcebergPartition.builder()
                    .icebergFieldName("String0")
                    .icebergTransform("String0")
                    .icebergSourceId(123)
                    .build())
            .icebergTablePartition(IcebergPartition.builder()
                    .icebergFieldName("String1")
                    .icebergTransform("String1")
                    .icebergSourceId(456)
                    .build())
            .icebergSnapshot("String0", "String0")
            .icebergSnapshot("String1", "String1")
    ...
    @Test
    void serdeCycleIcebergTable() throws IOException {
        assertNotNull(full, "Unable to build sample instance of IcebergTable,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting IcebergTable via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of IcebergTable,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final IcebergTable frodo = MockAtlanTenant.client.readValue(serialized, IcebergTable.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of IcebergTable,");
