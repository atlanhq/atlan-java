...
public class FlowV02FolderTest {

    private static final FlowV02Folder full = FlowV02Folder._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .flowV02ErrorMessage("String0")
            .flowV02FinishedAt(123456789L)
            .flowV02FolderName("String0")
            .flowV02FolderQualifiedName("String0")
            .flowV02Id("String0")
            .flowV02ProjectName("String0")
            .flowV02ProjectQualifiedName("String0")
            .flowV02RunId("String0")
            .flowV02Schedule("String0")
            .flowV02StartedAt(123456789L)
            .flowV02Status("String0")
            .adminGroup("String0")
            .adminGroup("String1")
            .adminRole("String0")
            .adminRole("String1")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .flowV02Dataset(FlowV02InterimDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV02Dataset(FlowV02InterimDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .flowV02Field(FlowV02InterimField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV02Field(FlowV02InterimField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .flowV02Grouping(FlowV02ProcessGrouping.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV02Grouping(
                    FlowV02ProcessGrouping.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .flowV02ParentFolder(FlowV02Folder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV02SubFolder(FlowV02Folder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV02SubFolder(FlowV02Folder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static FlowV02Folder frodo;
    private static String serialized;

    @Test(groups = {"FlowV02Folder.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowV02Folder.serialize"},
            dependsOnGroups = {"FlowV02Folder.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowV02Folder.deserialize"},
            dependsOnGroups = {"FlowV02Folder.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowV02Folder.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowV02Folder.equivalency"},
            dependsOnGroups = {"FlowV02Folder.serialize", "FlowV02Folder.deserialize"})
