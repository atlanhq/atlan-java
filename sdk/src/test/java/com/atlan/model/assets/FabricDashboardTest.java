...
public class FabricDashboardTest {

    private final FabricDashboard full = FabricDashboard._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleFabricDashboard() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FabricDashboard,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FabricDashboard via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FabricDashboard,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FabricDashboard frodo = MockAtlanTenant.client.readValue(serialized, FabricDashboard.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of FabricDashboard,");
