...
public class FabricDashboardTest {
    ...
    private static final FabricDashboard full = FabricDashboard._internal()
            .guid("guid")
    ...
    private static FabricDashboard frodo;
    ...
    @Test(groups = {"FabricDashboard.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FabricDashboard.serialize"},
            dependsOnGroups = {"FabricDashboard.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FabricDashboard.deserialize"},
            dependsOnGroups = {"FabricDashboard.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FabricDashboard.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FabricDashboard.equivalency"},
            dependsOnGroups = {"FabricDashboard.serialize", "FabricDashboard.deserialize"})
