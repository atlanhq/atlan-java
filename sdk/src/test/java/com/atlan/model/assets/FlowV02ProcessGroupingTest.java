...
public class FlowV02ProcessGroupingTest {

    private static final FlowV02ProcessGrouping full = FlowV02ProcessGrouping._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .flowV02Abstract(FlowV02InterimDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV02Abstract(
                    FlowV02InterimDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .flowV02DataFlow(LineageProcess.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV02DataFlow(LineageProcess.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .flowV02Folder(FlowV02Folder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowV02Project(FlowV02Project.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();

    private static final int hash = full.hashCode();
    private static FlowV02ProcessGrouping frodo;
    private static String serialized;

    @Test(groups = {"FlowV02ProcessGrouping.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FlowV02ProcessGrouping.serialize"},
            dependsOnGroups = {"FlowV02ProcessGrouping.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FlowV02ProcessGrouping.deserialize"},
            dependsOnGroups = {"FlowV02ProcessGrouping.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FlowV02ProcessGrouping.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FlowV02ProcessGrouping.equivalency"},
            dependsOnGroups = {"FlowV02ProcessGrouping.serialize", "FlowV02ProcessGrouping.deserialize"})
