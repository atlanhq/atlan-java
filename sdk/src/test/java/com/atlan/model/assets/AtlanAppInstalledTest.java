...
public class AtlanAppInstalledTest {

    private final AtlanAppInstalled full = AtlanAppInstalled._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .atlanAppCurrentVersionId(123)
            .atlanAppCurrentVersionUUID("String0")
            .atlanAppDeploymentConfig("String0")
    ...
    @Test
    void serdeCycleAtlanAppInstalled() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AtlanAppInstalled,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AtlanAppInstalled via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AtlanAppInstalled,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AtlanAppInstalled frodo = MockAtlanTenant.client.readValue(serialized, AtlanAppInstalled.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AtlanAppInstalled,");
