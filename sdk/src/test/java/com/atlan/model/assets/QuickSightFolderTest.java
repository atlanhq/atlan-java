...
public class QuickSightFolderTest {
    ...
    private final QuickSightFolder full = QuickSightFolder._internal()
            .guid("guid")
            ...
            .addQuickSightFolderHierarchy("String0", "String0")
            .addQuickSightFolderHierarchy("String1", "String1")
            ...
            .quickSightDataset(QuickSightDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .quickSightDataset(QuickSightDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .quickSightAnalysis(QuickSightAnalysis.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .quickSightAnalysis(QuickSightAnalysis.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .quickSightDashboard(QuickSightDashboard.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .quickSightDashboard(QuickSightDashboard.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleQuickSightFolder() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QuickSightFolder,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QuickSightFolder via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QuickSightFolder,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QuickSightFolder frodo = MockAtlanTenant.client.readValue(serialized, QuickSightFolder.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QuickSightFolder,");
