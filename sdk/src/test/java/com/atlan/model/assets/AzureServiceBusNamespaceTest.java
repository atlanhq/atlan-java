...
public class AzureServiceBusNamespaceTest {
    ...
    private static final AzureServiceBusNamespace full = AzureServiceBusNamespace._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .azureServiceBusTopic(AzureServiceBusTopic.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .azureServiceBusTopic(
                    AzureServiceBusTopic.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static AzureServiceBusNamespace frodo;
    private static String serialized;

    @Test(groups = {"AzureServiceBusNamespace.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"AzureServiceBusNamespace.serialize"},
            dependsOnGroups = {"AzureServiceBusNamespace.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"AzureServiceBusNamespace.deserialize"},
            dependsOnGroups = {"AzureServiceBusNamespace.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, AzureServiceBusNamespace.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"AzureServiceBusNamespace.equivalency"},
            dependsOnGroups = {"AzureServiceBusNamespace.serialize", "AzureServiceBusNamespace.deserialize"})
