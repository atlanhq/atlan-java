...
public class AzureServiceBusNamespaceTest {
    ...
    private final AzureServiceBusNamespace full = AzureServiceBusNamespace._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAzureServiceBusNamespace() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AzureServiceBusNamespace,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AzureServiceBusNamespace via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AzureServiceBusNamespace,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AzureServiceBusNamespace frodo = MockAtlanTenant.client.readValue(serialized, AzureServiceBusNamespace.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AzureServiceBusNamespace,");
