...
public class LookerQueryTest {
    ...
    private final LookerQuery full = LookerQuery._internal()
            .guid("guid")
            ...
            .sourceDefinitionDatabase("String0")
            .sourceDefinitionSchema("String0")
            .field("String0")
            .field("String1")
    ...
    @Test
    void serdeCycleLookerQuery() throws IOException {
        assertNotNull(full, "Unable to build sample instance of LookerQuery,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting LookerQuery via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of LookerQuery,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final LookerQuery frodo = MockAtlanTenant.client.readValue(serialized, LookerQuery.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of LookerQuery,");
