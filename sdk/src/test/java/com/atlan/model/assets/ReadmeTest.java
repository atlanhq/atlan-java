...
public class ReadmeTest {
    ...
    private final Readme full = Readme._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleReadme() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Readme,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Readme via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Readme,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Readme frodo = MockAtlanTenant.client.readValue(serialized, Readme.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Readme,");
