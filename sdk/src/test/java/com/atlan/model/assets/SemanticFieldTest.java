...
public class SemanticFieldTest {
    ...
    private final SemanticField full = SemanticField._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSemanticField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SemanticField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SemanticField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SemanticField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SemanticField frodo = MockAtlanTenant.client.readValue(serialized, SemanticField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SemanticField,");
