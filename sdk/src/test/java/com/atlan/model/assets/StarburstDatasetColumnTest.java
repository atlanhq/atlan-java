...
public class StarburstDatasetColumnTest {

    private final StarburstDatasetColumn full = StarburstDatasetColumn._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .starburstDataProductName("String0")
            .starburstDatasetQualifiedName("String0")
            .starburstDatasetName("String0")
            ...
            .putColumnHierarchy("String0", "String0")
            .putColumnHierarchy("String1", "String1")
            .isPartition(true)
            .partitionOrder(123)
            .isClustered(true)
            .isPrimary(true)
            ...
            .validation("String0", "String0")
            .validation("String1", "String1")
            ...
            .starburstSqlColumnQualifiedName("String0")
            ...
            .metricTimestamp(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .metricTimestamp(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dataQualityMetricDimension(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dataQualityMetricDimension(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .dqReferenceColumnRule(DataQualityRule.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleStarburstDatasetColumn() throws IOException {
        assertNotNull(full, "Unable to build sample instance of StarburstDatasetColumn,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting StarburstDatasetColumn via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of StarburstDatasetColumn,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final StarburstDatasetColumn frodo = MockAtlanTenant.client.readValue(serialized, StarburstDatasetColumn.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of StarburstDatasetColumn,");
