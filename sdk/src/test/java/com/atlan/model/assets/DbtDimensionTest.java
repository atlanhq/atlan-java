...
public class DbtDimensionTest {

    private final DbtDimension full = DbtDimension._internal()
            .guid("guid")
            ...
            .dbtSemanticModelQualifiedName("String0")
            .dbtSemanticFieldTimeGranularity("String0")
    ...
    @Test
    void serdeCycleDbtDimension() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DbtDimension,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DbtDimension via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DbtDimension,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DbtDimension frodo = MockAtlanTenant.client.readValue(serialized, DbtDimension.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DbtDimension,");
