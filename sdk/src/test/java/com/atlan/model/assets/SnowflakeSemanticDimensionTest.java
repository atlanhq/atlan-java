...
public class SnowflakeSemanticDimensionTest {

    private final SnowflakeSemanticDimension full = SnowflakeSemanticDimension._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSnowflakeSemanticDimension() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeSemanticDimension,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeSemanticDimension via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeSemanticDimension,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeSemanticDimension frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeSemanticDimension.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeSemanticDimension,");
