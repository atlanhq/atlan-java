...
public class FabricActivityTest {
    ...
    private static final FabricActivity full = FabricActivity._internal()
            .guid("guid")
    ...
    private static FabricActivity frodo;
    ...
    @Test(groups = {"FabricActivity.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"FabricActivity.serialize"},
            dependsOnGroups = {"FabricActivity.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"FabricActivity.deserialize"},
            dependsOnGroups = {"FabricActivity.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, FabricActivity.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"FabricActivity.equivalency"},
            dependsOnGroups = {"FabricActivity.serialize", "FabricActivity.deserialize"})
