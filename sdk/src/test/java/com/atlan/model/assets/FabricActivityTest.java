...
public class FabricActivityTest {

    private final FabricActivity full = FabricActivity._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .fabricDataPipelineQualifiedName("String0")
            .fabricActivityType("String0")
            .fabricDataPipeline(FabricDataPipeline.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .fabricProcess(LineageProcess.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleFabricActivity() throws IOException {
        assertNotNull(full, "Unable to build sample instance of FabricActivity,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting FabricActivity via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of FabricActivity,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final FabricActivity frodo = MockAtlanTenant.client.readValue(serialized, FabricActivity.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of FabricActivity,");
