...
public class CassandraTableTest {
    ...
    private static final CassandraTable full = CassandraTable._internal()
            .guid("guid")
            ...
            .customMetadata(
                    ...
                    CustomMetadataAttributes.builder()
                            ...
                            .build())
            .cassandraKeyspaceName("String0")
            .cassandraTableName("String0")
            .cassandraTableQualifiedName("String0")
            .cassandraViewName("String0")
            .cassandraViewQualifiedName("String0")
            ...
            .assetV2ExternalDQMetadataDetail(
                    ...
                    AssetExternalDQMetadata.builder()
                            ...
                            .assetV2ExternalDQSourceURL("String0")
                            .assetV2ExternalDQLastSyncRunAt(123456789L)
                            .assetV2ExternalDQTestEntityName("String0")
                            .assetV2ExternalDQTestTotalCount(123)
                            .assetV2ExternalDQTestLastRunSuccessCount(123)
                            .assetV2ExternalDQTestLastRunFailureCount(123)
                            .assetV2ExternalDQOverallScoreValue("String0")
                            .assetV2ExternalDQOverallScoreType("String0")
                            .assetV2ExternalDQScoreDimensions(List.of(
                                    AssetExternalDQScoreBreakdownByDimension.builder()
                                            .assetV2ExternalDQScoreDimensionName("String0")
                                            .assetV2ExternalDQScoreDimensionDescription("String0")
                                            .assetV2ExternalDQScoreDimensionScoreValue("String0")
                                            .assetV2ExternalDQScoreDimensionScoreType("String0")
                                            .build(),
                                    AssetExternalDQScoreBreakdownByDimension.builder()
                                            .assetV2ExternalDQScoreDimensionName("String1")
                                            .assetV2ExternalDQScoreDimensionDescription("String1")
                                            .assetV2ExternalDQScoreDimensionScoreValue("String1")
                                            .assetV2ExternalDQScoreDimensionScoreType("String1")
                                            .build()))
                            .assetV2ExternalDQTests(List.of(
                                    AssetExternalDQTestDetails.builder()
                                            .assetV2ExternalDQTestName("String0")
                                            .assetV2ExternalDQTestId("String0")
                                            .assetV2ExternalDQTestDescription("String0")
                                            .assetV2ExternalDQTestScheduleType("String0")
                                            .assetV2ExternalDQTestLastRunStatus("String0")
                                            .assetV2ExternalDQTestRuns(List.of(
                                                    AssetExternalDQTestRunHistory.builder()
                                                            .assetV2ExternalDQTestRunStartedAt(123456789L)
                                                            .assetV2ExternalDQTestRunEndedAt(123456789L)
                                                            .assetV2ExternalDQTestRunStatus("String0")
                                                            .build(),
                                                    AssetExternalDQTestRunHistory.builder()
                                                            .assetV2ExternalDQTestRunStartedAt(987654321L)
                                                            .assetV2ExternalDQTestRunEndedAt(987654321L)
                                                            .assetV2ExternalDQTestRunStatus("String1")
                                                            .build()))
                                            .build(),
                                    AssetExternalDQTestDetails.builder()
                                            .assetV2ExternalDQTestName("String1")
                                            .assetV2ExternalDQTestId("String1")
                                            .assetV2ExternalDQTestDescription("String1")
                                            .assetV2ExternalDQTestScheduleType("String1")
                                            .assetV2ExternalDQTestLastRunStatus("String1")
                                            .assetV2ExternalDQTestRuns(List.of(
                                                    AssetExternalDQTestRunHistory.builder()
                                                            .assetV2ExternalDQTestRunStartedAt(123456789L)
                                                            .assetV2ExternalDQTestRunEndedAt(123456789L)
            ...
            .assetV2ExternalDQMetadataDetail(
                    ...
                    AssetExternalDQMetadata.builder()
                            ...
                            .assetV2ExternalDQSourceURL("String1")
                            .assetV2ExternalDQLastSyncRunAt(987654321L)
                            .assetV2ExternalDQTestEntityName("String1")
                            .assetV2ExternalDQTestTotalCount(456)
                            .assetV2ExternalDQTestLastRunSuccessCount(456)
                            .assetV2ExternalDQTestLastRunFailureCount(456)
                            .assetV2ExternalDQOverallScoreValue("String1")
                            .assetV2ExternalDQOverallScoreType("String1")
                            .assetV2ExternalDQScoreDimensions(List.of(
                                    AssetExternalDQScoreBreakdownByDimension.builder()
                                            .assetV2ExternalDQScoreDimensionName("String0")
                                            .assetV2ExternalDQScoreDimensionDescription("String0")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .cassandraColumn(CassandraColumn.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cassandraColumn(CassandraColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cassandraIndex(CassandraIndex.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cassandraIndex(CassandraIndex.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cassandraKeyspace(CassandraKeyspace.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cassandraTableBloomFilterFPChance(123.456)
            .cassandraTableCRCCheckChance(123.456)
            .putCassandraTableCaching("key1", "value1")
            .putCassandraTableCaching("key2", "value2")
            .cassandraTableComment("String0")
            .putCassandraTableCompaction("key1", "value1")
            .putCassandraTableCompaction("key2", "value2")
            .putCassandraTableCompression("key1", "value1")
            .putCassandraTableCompression("key2", "value2")
            .cassandraTableDCLocalReadRepairChance(123.456)
            .cassandraTableDefaultTTL(123456789L)
            .cassandraTableFlag("String0")
            .cassandraTableFlag("String1")
            .cassandraTableGCGraceSeconds(123456789L)
            .cassandraTableId("String0")
            .cassandraTableMaxIndexInterval(123456789L)
            .cassandraTableMemtableFlushPeriodInMs(123456789L)
            .cassandraTableMinIndexInterval(123456789L)
            .cassandraTableQuery("String0")
            .cassandraTableReadRepairChance(123.456)
            .cassandraTableSpeculativeRetry("String0")
            .cassandraTableVirtual(true)
            .build();

    private static final int hash = full.hashCode();
    private static CassandraTable frodo;
    private static String serialized;

    @Test(groups = {"CassandraTable.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CassandraTable.serialize"},
            dependsOnGroups = {"CassandraTable.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CassandraTable.deserialize"},
            dependsOnGroups = {"CassandraTable.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CassandraTable.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CassandraTable.equivalency"},
            dependsOnGroups = {"CassandraTable.serialize", "CassandraTable.deserialize"})
