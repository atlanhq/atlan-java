...
public class CognosReportTest {
    ...
    private final CognosReport full = CognosReport._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCognosReport() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CognosReport,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CognosReport via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CognosReport,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CognosReport frodo = MockAtlanTenant.client.readValue(serialized, CognosReport.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CognosReport,");
