...
public class CognosReportTest {

    private static final CognosReport full = CognosReport._internal()
            .guid("guid")
    ...
    private static CognosReport frodo;
    private static String serialized;

    @Test(groups = {"CognosReport.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CognosReport.serialize"},
            dependsOnGroups = {"CognosReport.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CognosReport.deserialize"},
            dependsOnGroups = {"CognosReport.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CognosReport.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CognosReport.equivalency"},
            dependsOnGroups = {"CognosReport.serialize", "CognosReport.deserialize"})
