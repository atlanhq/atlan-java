...
public class BigqueryRoutineTest {
    ...
    private static final BigqueryRoutine full = BigqueryRoutine._internal()
            .guid("guid")
    ...
    private static BigqueryRoutine frodo;
    ...
    @Test(groups = {"BigqueryRoutine.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"BigqueryRoutine.serialize"},
            dependsOnGroups = {"BigqueryRoutine.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"BigqueryRoutine.deserialize"},
            dependsOnGroups = {"BigqueryRoutine.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, BigqueryRoutine.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"BigqueryRoutine.equivalency"},
            dependsOnGroups = {"BigqueryRoutine.serialize", "BigqueryRoutine.deserialize"})
