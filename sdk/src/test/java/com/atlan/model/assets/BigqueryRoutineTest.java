...
public class BigqueryRoutineTest {

    private final BigqueryRoutine full = BigqueryRoutine._internal()
            .guid("guid")
            ...
            .definition("String0")
            .sqlLanguage("String0")
            .sqlRuntimeVersion("String0")
            .sqlOwnerRoleType("String0")
            .sqlArgument(SQLProcedureArgument.builder()
                    .sqlArgumentName("String0")
                    .sqlArgumentType("String0")
                    .build())
            .sqlArgument(SQLProcedureArgument.builder()
                    .sqlArgumentName("String1")
                    .sqlArgumentType("String1")
                    .build())
            .sqlProcedureReturn(SQLProcedureReturn.builder()
                    .sqlReturnType("String0")
                    .sqlReturnCharacterMaximumLength(123456789L)
                    .sqlReturnCharacterOctetLength(123456789L)
                    .sqlReturnNumericPrecision(123456789L)
                    .sqlReturnNumericPrecisionRadix(123456789L)
                    .build())
            .sqlExternalAccessIntegrations("String0")
            .sqlSecrets("String0")
            .sqlPackages("String0")
            ...
            .bigqueryRoutineReturnType("String0")
            .bigqueryRoutineSecurityType("String0")
            .bigqueryRoutineDdl("String0")
            .bigqueryProcess(LineageProcess.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .bigqueryProcess(LineageProcess.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .bigqueryAtlanSchema(Schema.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleBigqueryRoutine() throws IOException {
        assertNotNull(full, "Unable to build sample instance of BigqueryRoutine,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting BigqueryRoutine via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of BigqueryRoutine,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final BigqueryRoutine frodo = MockAtlanTenant.client.readValue(serialized, BigqueryRoutine.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of BigqueryRoutine,");
