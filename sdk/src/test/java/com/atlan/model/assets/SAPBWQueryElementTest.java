...
public class SAPBWQueryElementTest {

    private final SAPBWQueryElement full = SAPBWQueryElement._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSAPBWQueryElement() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SAPBWQueryElement,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SAPBWQueryElement via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SAPBWQueryElement,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SAPBWQueryElement frodo = MockAtlanTenant.client.readValue(serialized, SAPBWQueryElement.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SAPBWQueryElement,");
