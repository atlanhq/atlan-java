...
public class TypeRegistryNamespaceTest {

    private static final TypeRegistryNamespace full = TypeRegistryNamespace._internal()
            .guid("guid")
            ...
            .typeRegistryEntity(
                    TypeRegistryEntity.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .typeRegistryEnumeration(TypeRegistryEnum.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryEnumeration(
                    TypeRegistryEnum.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .typeRegistryPrefix("String0")
            .typeRegistryRelationship(
                    TypeRegistryAssociationRelationship.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryRelationship(TypeRegistryAssociationRelationship.refByQualifiedName(
            ...
            .typeRegistryStruct(
                    TypeRegistryStruct.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static TypeRegistryNamespace frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryNamespace.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryNamespace.serialize"},
            dependsOnGroups = {"TypeRegistryNamespace.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryNamespace.deserialize"},
            dependsOnGroups = {"TypeRegistryNamespace.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryNamespace.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryNamespace.equivalency"},
            dependsOnGroups = {"TypeRegistryNamespace.serialize", "TypeRegistryNamespace.deserialize"})
