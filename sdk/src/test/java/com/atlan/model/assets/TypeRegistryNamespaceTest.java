...
public class TypeRegistryNamespaceTest {
    ...
    private static final TypeRegistryNamespace full = TypeRegistryNamespace._internal()
            ...
            .typeRegistryReplacedBy(TypeRegistryWorkspace.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryReplace(TypeRegistryWorkspace.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryReplace(
                    TypeRegistryWorkspace.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .adminGroup("String0")
            .adminGroup("String1")
            .adminRole("String0")
            .adminRole("String1")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .typeRegistryEntity(TypeRegistryPublishedEntity.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryEntity(
                    TypeRegistryPublishedEntity.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .typeRegistryEnumeration(TypeRegistryWorkspaceEnum.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryEnumeration(
                    TypeRegistryWorkspaceEnum.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .typeRegistryPrefix("String0")
            .typeRegistryRelationship(
                    TypeRegistryPublishedRelationship.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryRelationship(TypeRegistryPublishedRelationship.refByQualifiedName(
                    "default/snowflake/1234567890/test/qualifiedName"))
            .typeRegistryStruct(TypeRegistryWorkspaceStruct.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryStruct(
                    TypeRegistryWorkspaceStruct.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .typeRegistryWorkspace(TypeRegistryWorkspace.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .typeRegistryWorkspace(
                    TypeRegistryWorkspace.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
