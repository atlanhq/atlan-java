...
public class MicroStrategyReportTest {
    ...
    private static final MicroStrategyReport full = MicroStrategyReport._internal()
            .guid("guid")
    ...
    private static MicroStrategyReport frodo;
    private static String serialized;

    @Test(groups = {"MicroStrategyReport.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"MicroStrategyReport.serialize"},
            dependsOnGroups = {"MicroStrategyReport.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"MicroStrategyReport.deserialize"},
            dependsOnGroups = {"MicroStrategyReport.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyReport.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"MicroStrategyReport.equivalency"},
            dependsOnGroups = {"MicroStrategyReport.serialize", "MicroStrategyReport.deserialize"})
