...
public class CubeTest {
    ...
    private static final Cube full = Cube._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .cubeDimensionCount(123456789L)
            .cubeDimension(CubeDimension.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cubeDimension(CubeDimension.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static Cube frodo;
    private static String serialized;

    @Test(groups = {"Cube.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"Cube.serialize"},
            dependsOnGroups = {"Cube.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"Cube.deserialize"},
            dependsOnGroups = {"Cube.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, Cube.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"Cube.equivalency"},
            dependsOnGroups = {"Cube.serialize", "Cube.deserialize"})
