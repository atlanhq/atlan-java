...
public class CubeTest {
    ...
    private final Cube full = Cube._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCube() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Cube,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Cube via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Cube,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Cube frodo = MockAtlanTenant.client.readValue(serialized, Cube.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Cube,");
