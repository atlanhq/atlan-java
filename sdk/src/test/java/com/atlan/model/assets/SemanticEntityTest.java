...
public class SemanticEntityTest {

    private final SemanticEntity full = SemanticEntity._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSemanticEntity() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SemanticEntity,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SemanticEntity via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SemanticEntity,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SemanticEntity frodo = MockAtlanTenant.client.readValue(serialized, SemanticEntity.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SemanticEntity,");
