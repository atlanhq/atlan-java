...
public class SchemaRegistrySubjectTest {
    ...
    private static final SchemaRegistrySubject full = SchemaRegistrySubject._internal()
            ...
            .schemaRegistrySubjectBaseName("String0")
            .schemaRegistrySubjectGoverningAssetQualifiedName("String0")
            .schemaRegistrySubjectGoverningAssetQualifiedName("String1")
            .schemaRegistrySubjectIsKeySchema(true)
            .schemaRegistrySubjectLatestSchemaDefinition("String0")
            .schemaRegistrySubjectLatestSchemaVersion("String0")
