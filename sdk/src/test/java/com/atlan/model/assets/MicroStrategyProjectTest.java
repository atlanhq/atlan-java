...
public class MicroStrategyProjectTest {
    ...
    private static final MicroStrategyProject full = MicroStrategyProject._internal()
            .guid("guid")
            ...
            .microStrategyDocument(
                    MicroStrategyDocument.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .microStrategyDossier(MicroStrategyDossier.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .microStrategyDossier(
                    MicroStrategyDossier.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .microStrategyVisualization(
                    MicroStrategyVisualization.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();

    private static final int hash = full.hashCode();
    private static MicroStrategyProject frodo;
    private static String serialized;

    @Test(groups = {"MicroStrategyProject.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"MicroStrategyProject.serialize"},
            dependsOnGroups = {"MicroStrategyProject.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"MicroStrategyProject.deserialize"},
            dependsOnGroups = {"MicroStrategyProject.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyProject.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"MicroStrategyProject.equivalency"},
            dependsOnGroups = {"MicroStrategyProject.serialize", "MicroStrategyProject.deserialize"})
