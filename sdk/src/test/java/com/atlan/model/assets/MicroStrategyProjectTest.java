...
public class MicroStrategyProjectTest {

    private final MicroStrategyProject full = MicroStrategyProject._internal()
            .guid("guid")
            ...
            .microStrategyMetric(MicroStrategyMetric.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .microStrategyVisualization(MicroStrategyVisualization.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .microStrategyVisualization(MicroStrategyVisualization.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .microStrategyDocument(MicroStrategyDocument.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .microStrategyDossier(MicroStrategyDossier.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .microStrategyDossier(MicroStrategyDossier.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleMicroStrategyProject() throws IOException {
        assertNotNull(full, "Unable to build sample instance of MicroStrategyProject,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting MicroStrategyProject via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of MicroStrategyProject,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final MicroStrategyProject frodo = MockAtlanTenant.client.readValue(serialized, MicroStrategyProject.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of MicroStrategyProject,");
