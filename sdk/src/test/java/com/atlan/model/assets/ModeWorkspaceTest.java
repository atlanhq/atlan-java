...
public class ModeWorkspaceTest {
    ...
    private final ModeWorkspace full = ModeWorkspace._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .modeCollectionCount(123456789L)
    ...
    @Test
    void serdeCycleModeWorkspace() throws IOException {
        assertNotNull(full, "Unable to build sample instance of ModeWorkspace,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting ModeWorkspace via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of ModeWorkspace,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final ModeWorkspace frodo = MockAtlanTenant.client.readValue(serialized, ModeWorkspace.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of ModeWorkspace,");
