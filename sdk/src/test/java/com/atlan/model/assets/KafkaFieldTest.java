...
public class KafkaFieldTest {

    private final KafkaField full = KafkaField._internal()
            .guid("guid")
            ...
            .kafkaFieldDataType("String0")
            .kafkaFieldIsOptional(true)
            .kafkaFieldDefaultValue("String0")
            .kafkaFieldVersionIntroduced("String0")
            .kafkaFieldOrder(123)
            .kafkaTopicQualifiedName("String0")
            .kafkaFieldSchemaType("String0")
            .kafkaParentFieldQualifiedName("String0")
            .kafkaParentFieldName("String0")
            .kafkaFieldDepthLevel(123)
            .kafkaNestedFieldCount(123)
            .kafkaNestedFieldOrder("String0")
            .kafkaFieldHierarchy(Map.of("key1", "value1"))
            .kafkaFieldHierarchy(Map.of("key2", "value2"))
            .kafkaFieldNestedOrder("String0")
            .kafkaTopic(KafkaTopic.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .kafkaNestedField(KafkaField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .kafkaNestedField(KafkaField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .kafkaParentField(KafkaField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleKafkaField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of KafkaField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting KafkaField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of KafkaField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final KafkaField frodo = MockAtlanTenant.client.readValue(serialized, KafkaField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of KafkaField,");
