...
public class TypeRegistryWorkspaceEnumTest {

    private static final TypeRegistryWorkspaceEnum full = TypeRegistryWorkspaceEnum._internal()
            .guid("guid")
    ...
    private static TypeRegistryWorkspaceEnum frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryWorkspaceEnum.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryWorkspaceEnum.serialize"},
            dependsOnGroups = {"TypeRegistryWorkspaceEnum.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryWorkspaceEnum.deserialize"},
            dependsOnGroups = {"TypeRegistryWorkspaceEnum.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryWorkspaceEnum.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryWorkspaceEnum.equivalency"},
            dependsOnGroups = {"TypeRegistryWorkspaceEnum.serialize", "TypeRegistryWorkspaceEnum.deserialize"})
