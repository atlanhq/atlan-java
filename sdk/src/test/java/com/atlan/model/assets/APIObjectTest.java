...
public class APIObjectTest {
    ...
    private final APIObject full = APIObject._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleAPIObject() throws IOException {
        assertNotNull(full, "Unable to build sample instance of APIObject,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting APIObject via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of APIObject,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final APIObject frodo = MockAtlanTenant.client.readValue(serialized, APIObject.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of APIObject,");
