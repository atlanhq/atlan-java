...
public class LinkTest {
    ...
    private final Link full = Link._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleLink() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Link,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Link via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Link,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Link frodo = MockAtlanTenant.client.readValue(serialized, Link.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Link,");
