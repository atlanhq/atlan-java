...
public class AssetGroupingCollectionTest {

    private final AssetGroupingCollection full = AssetGroupingCollection._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .assetGroupingCollectionStrategyQualifiedName("String0")
            .assetGroupingCollectionTrackedCategory(AssetGroupingTrackedCategories.DESCRIPTION)
            .assetGroupingCollectionTrackedCategory(AssetGroupingTrackedCategories.MEANINGS)
            ...
            .assetGroupingStrategy(AssetGroupingStrategy.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
    ...
    @Test
    void serdeCycleAssetGroupingCollection() throws IOException {
        assertNotNull(full, "Unable to build sample instance of AssetGroupingCollection,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting AssetGroupingCollection via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of AssetGroupingCollection,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final AssetGroupingCollection frodo = MockAtlanTenant.client.readValue(serialized, AssetGroupingCollection.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of AssetGroupingCollection,");
