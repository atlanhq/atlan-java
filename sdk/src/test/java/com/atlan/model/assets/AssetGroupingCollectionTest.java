...
public class AssetGroupingCollectionTest {
    ...
    void serdeCycleAssetGroupingCollection() throws IOException {
        ...
        // Deserialization
        final AssetGroupingCollection frodo =
                MockAtlanTenant.client.readValue(serialized, AssetGroupingCollection.class);
        assertNotNull(
                frodo, "Unable to reverse-read serialized value back into an instance of AssetGroupingCollection,");
