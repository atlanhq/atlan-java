...
public class SparkJobTest {
    ...
    private final SparkJob full = SparkJob._internal()
            ...
            .sparkOrchestratedByAirflowAsset(Airflow.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .sparkOrchestratedByAirflowAsset(Airflow.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .build();
