...
public class CosmosMongoDBDatabaseTest {

    private static final CosmosMongoDBDatabase full = CosmosMongoDBDatabase._internal()
            .guid("guid")
    ...
    private static CosmosMongoDBDatabase frodo;
    private static String serialized;

    @Test(groups = {"CosmosMongoDBDatabase.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CosmosMongoDBDatabase.serialize"},
            dependsOnGroups = {"CosmosMongoDBDatabase.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CosmosMongoDBDatabase.deserialize"},
            dependsOnGroups = {"CosmosMongoDBDatabase.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CosmosMongoDBDatabase.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CosmosMongoDBDatabase.equivalency"},
            dependsOnGroups = {"CosmosMongoDBDatabase.serialize", "CosmosMongoDBDatabase.deserialize"})
