...
public class CosmosMongoDBDatabaseTest {
    ...
    private final CosmosMongoDBDatabase full = CosmosMongoDBDatabase._internal()
            .guid("guid")
            ...
            .cosmosMongoDBCollection(CosmosMongoDBCollection.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleCosmosMongoDBDatabase() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CosmosMongoDBDatabase,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CosmosMongoDBDatabase via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CosmosMongoDBDatabase,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CosmosMongoDBDatabase frodo = MockAtlanTenant.client.readValue(serialized, CosmosMongoDBDatabase.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CosmosMongoDBDatabase,");
