...
public class QuickSightAnalysis extends Asset implements IQuickSightAnalysis, IQuickSight, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Builds the minimal object necessary to apply an update to a QuickSightAnalysis,
     * from a potentially more-complete QuickSightAnalysis object.
     *
     * @return the minimal object necessary to update the QuickSightAnalysis, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a QuickSightAnalysis are not present in the initial object
     */
    @Override
