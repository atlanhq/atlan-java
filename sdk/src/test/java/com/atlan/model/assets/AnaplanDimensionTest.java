...
public class AnaplanDimensionTest {
    ...
    private static final AnaplanDimension full = AnaplanDimension._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .anaplanColumnView(AnaplanView.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanColumnView(AnaplanView.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .anaplanPageView(AnaplanView.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .anaplanPageView(AnaplanView.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .anaplanRowView(AnaplanView.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
