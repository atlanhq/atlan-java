...
public class CognosModuleTest {
    ...
    private final CognosModule full = CognosModule._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCognosModule() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CognosModule,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CognosModule via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CognosModule,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CognosModule frodo = MockAtlanTenant.client.readValue(serialized, CognosModule.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CognosModule,");
