...
public class CognosModuleTest {

    private static final CognosModule full = CognosModule._internal()
            .guid("guid")
    ...
    private static CognosModule frodo;
    private static String serialized;

    @Test(groups = {"CognosModule.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CognosModule.serialize"},
            dependsOnGroups = {"CognosModule.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CognosModule.deserialize"},
            dependsOnGroups = {"CognosModule.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CognosModule.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CognosModule.equivalency"},
            dependsOnGroups = {"CognosModule.serialize", "CognosModule.deserialize"})
