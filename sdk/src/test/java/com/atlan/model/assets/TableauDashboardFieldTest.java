...
public class TableauDashboardFieldTest {
    ...
    private final TableauDashboardField full = TableauDashboardField._internal()
            .guid("guid")
            ...
            .tableauUpstreamTable("String0", "String0")
            .tableauUpstreamTable("String1", "String1")
            .tableauDashboardFieldFormula("String0")
            .tableauDashboardFieldBinSize("String0")
            .tableauDashboardFieldUpstreamColumn("String0", "String0")
            .tableauDashboardFieldUpstreamColumn("String1", "String1")
            .tableauDashboardFieldUpstreamField("String0", "String0")
            .tableauDashboardFieldUpstreamField("String1", "String1")
    ...
    @Test
    void serdeCycleTableauDashboardField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of TableauDashboardField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting TableauDashboardField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of TableauDashboardField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final TableauDashboardField frodo = MockAtlanTenant.client.readValue(serialized, TableauDashboardField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of TableauDashboardField,");
