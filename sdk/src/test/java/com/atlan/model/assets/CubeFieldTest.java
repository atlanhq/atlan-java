...
public class CubeFieldTest {
    ...
    private final CubeField full = CubeField._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCubeField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CubeField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CubeField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CubeField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CubeField frodo = MockAtlanTenant.client.readValue(serialized, CubeField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CubeField,");
