...
public class CubeFieldTest {

    private static final CubeField full = CubeField._internal()
            .guid("guid")
            ...
            .cubeNestedField(CubeField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cubeNestedField(CubeField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .cubeParentField(CubeField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .cubeParentFieldName("String0")
            .cubeParentFieldQualifiedName("String0")
            .cubeSubFieldCount(123456789L)
            .build();

    private static final int hash = full.hashCode();
    private static CubeField frodo;
    private static String serialized;

    @Test(groups = {"CubeField.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CubeField.serialize"},
            dependsOnGroups = {"CubeField.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CubeField.deserialize"},
            dependsOnGroups = {"CubeField.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CubeField.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CubeField.equivalency"},
            dependsOnGroups = {"CubeField.serialize", "CubeField.deserialize"})
