...
public class CogniteEventTest {

    private static final CogniteEvent full = CogniteEvent._internal()
            .guid("guid")
    ...
    private static CogniteEvent frodo;
    private static String serialized;

    @Test(groups = {"CogniteEvent.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"CogniteEvent.serialize"},
            dependsOnGroups = {"CogniteEvent.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"CogniteEvent.deserialize"},
            dependsOnGroups = {"CogniteEvent.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, CogniteEvent.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"CogniteEvent.equivalency"},
            dependsOnGroups = {"CogniteEvent.serialize", "CogniteEvent.deserialize"})
