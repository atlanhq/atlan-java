...
public class CogniteEventTest {
    ...
    private final CogniteEvent full = CogniteEvent._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleCogniteEvent() throws IOException {
        assertNotNull(full, "Unable to build sample instance of CogniteEvent,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting CogniteEvent via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of CogniteEvent,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final CogniteEvent frodo = MockAtlanTenant.client.readValue(serialized, CogniteEvent.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of CogniteEvent,");
