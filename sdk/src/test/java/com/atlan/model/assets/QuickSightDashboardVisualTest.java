...
public class QuickSightDashboardVisualTest {
    ...
    private final QuickSightDashboardVisual full = QuickSightDashboardVisual._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .quickSightDashboardQualifiedName("String0")
    ...
    @Test
    void serdeCycleQuickSightDashboardVisual() throws IOException {
        assertNotNull(full, "Unable to build sample instance of QuickSightDashboardVisual,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting QuickSightDashboardVisual via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of QuickSightDashboardVisual,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final QuickSightDashboardVisual frodo = MockAtlanTenant.client.readValue(serialized, QuickSightDashboardVisual.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of QuickSightDashboardVisual,");
