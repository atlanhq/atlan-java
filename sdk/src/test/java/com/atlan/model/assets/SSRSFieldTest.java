...
public class SSRSFieldTest {

    private final SSRSField full = SSRSField._internal()
            .guid("guid")
            ...
            .ssrsFieldDatatype("String0")
            .ssrsFieldFunction("String0")
            .ssrsFieldCalculatedField(true)
            .ssrsFieldDatabaseField(true)
            .ssrsFieldReferencedColumnName("String0")
            .ssrsFieldReferencedColumnName("String1")
            .ssrsFieldSqlTransformExpression("String0")
            .ssrsFieldOrdinalPosition(123)
            .ssrsFieldLogMessages("String0")
            .ssrsFieldErrorCode("String0")
            .ssrsFieldReportSource("String0")
            .ssrsFieldDataGroup("String0")
            .ssrsFieldConnected(true)
    ...
    @Test
    void serdeCycleSSRSField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SSRSField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SSRSField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SSRSField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SSRSField frodo = MockAtlanTenant.client.readValue(serialized, SSRSField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SSRSField,");
