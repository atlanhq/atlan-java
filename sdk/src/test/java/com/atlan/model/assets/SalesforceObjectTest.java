...
public class SalesforceObjectTest {
    ...
    private final SalesforceObject full = SalesforceObject._internal()
            .guid("guid")
            ...
            .isMergable(true)
            .isQueryable(true)
            .fieldCount(123456789L)
            .organization(SalesforceOrganization.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .field(SalesforceField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .field(SalesforceField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .lookupField(SalesforceField.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .lookupField(SalesforceField.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleSalesforceObject() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SalesforceObject,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SalesforceObject via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SalesforceObject,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SalesforceObject frodo = MockAtlanTenant.client.readValue(serialized, SalesforceObject.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SalesforceObject,");
