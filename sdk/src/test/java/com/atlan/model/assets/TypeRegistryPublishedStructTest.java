...
public class TypeRegistryPublishedStructTest {

    private static final TypeRegistryPublishedStruct full = TypeRegistryPublishedStruct._internal()
            .guid("guid")
    ...
    private static TypeRegistryPublishedStruct frodo;
    private static String serialized;

    @Test(groups = {"TypeRegistryPublishedStruct.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"TypeRegistryPublishedStruct.serialize"},
            dependsOnGroups = {"TypeRegistryPublishedStruct.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"TypeRegistryPublishedStruct.deserialize"},
            dependsOnGroups = {"TypeRegistryPublishedStruct.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, TypeRegistryPublishedStruct.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"TypeRegistryPublishedStruct.equivalency"},
            dependsOnGroups = {"TypeRegistryPublishedStruct.serialize", "TypeRegistryPublishedStruct.deserialize"})
