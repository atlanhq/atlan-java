...
public class FlowFolderTest {
    ...
    private static final FlowFolder full = FlowFolder._internal()
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .flowAsset(FlowFolder.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowAsset(FlowFolder.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .flowDataset(FlowInterimDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .flowDataset(FlowInterimDataset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
