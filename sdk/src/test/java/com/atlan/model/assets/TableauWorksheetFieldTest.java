...
public class TableauWorksheetFieldTest {
    ...
    private final TableauWorksheetField full = TableauWorksheetField._internal()
            .guid("guid")
            ...
            .addTableauProjectHierarchy("String0", "String0")
            .addTableauProjectHierarchy("String1", "String1")
            ...
            .tableauWorksheetFieldUpstreamTable("String0", "String0")
            .tableauWorksheetFieldUpstreamTable("String1", "String1")
            .tableauWorksheetFieldFormula("String0")
            .tableauWorksheetFieldBinSize("String0")
            .tableauWorksheetFieldUpstreamColumn("String0", "String0")
            .tableauWorksheetFieldUpstreamColumn("String1", "String1")
            .tableauWorksheetFieldUpstreamField("String0", "String0")
            .tableauWorksheetFieldUpstreamField("String1", "String1")
    ...
    @Test
    void serdeCycleTableauWorksheetField() throws IOException {
        assertNotNull(full, "Unable to build sample instance of TableauWorksheetField,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting TableauWorksheetField via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of TableauWorksheetField,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final TableauWorksheetField frodo = MockAtlanTenant.client.readValue(serialized, TableauWorksheetField.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of TableauWorksheetField,");
