...
public class DataQualityRuleTest {
    ...
    private final DataQualityRule full = DataQualityRule._internal()
            ...
            .dqRuleBaseDataset(Asset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dqRuleBaseColumn(Column.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dqRuleReferenceDataset(Asset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dqRuleReferenceDataset(Asset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
