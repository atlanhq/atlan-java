...
public class DataQualityRuleTest {
    ...
    private final DataQualityRule full = DataQualityRule._internal()
            .guid("guid")
            ...
            .assetSmusMetadataFormDetail(AssetSmusMetadataFormDetails.builder()
                    ...
                    .assetMetadataFormFields(List.of(Map.of("key1", "value1"), Map.of("key2", "value2")))
                    .build())
            .dqRuleBaseDatasetQualifiedName("String0")
            .dqRuleBaseColumnQualifiedName("String0")
            .dqRuleReferenceDatasetQualifiedName("String0")
            .dqRuleReferenceDatasetQualifiedName("String1")
            .dqRuleReferenceColumnQualifiedName("String0")
            .dqRuleReferenceColumnQualifiedName("String1")
            .dqRuleSourceSyncStatus(DataQualitySourceSyncStatus.SUCCESSFUL)
            .dqRuleSourceSyncErrorCode("String0")
            .dqRuleSourceSyncErrorMessage("String0")
            .dqRuleSourceSyncRawError("String0")
            .dqRuleSourceSyncedAt(123456789L)
            .dqRuleLatestResult(DataQualityResult.PASS)
            ...
            .dqRuleStatus(DataQualityRuleStatus.ACTIVE)
            .dqRuleAlertPriority(DataQualityRuleAlertPriority.URGENT)
            .dqRuleConfigArguments(DataQualityRuleConfigArguments.builder()
                    .dqRuleThresholdObject(DataQualityRuleThresholdObject.builder()
                            .dqRuleThresholdCompareOperator("String0")
                            .dqRuleThresholdValue(123.456)
                            .dqRuleThresholdUnit(DataQualityRuleThresholdUnit.PERCENTAGE)
                            .build())
                    .dqRuleConfigArgumentsRaw("String0")
                    .dqRuleConfigRuleConditions("String0")
                    .build())
            .dqRuleCustomSQL("String0")
            .dqRuleCustomSQLReturnType(DataQualityRuleCustomSQLReturnType.ROW_COUNT)
            .dqRuleFailedRowsSQL("String0")
            ...
            .dqRuleTemplate(DataQualityRuleTemplate.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            ...
            .dqRuleBaseDataset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dqRuleBaseColumn(Column.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dqRuleReferenceDataset(IndistinctAsset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dqRuleReferenceDataset(IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            ...
            .dqRuleReferenceColumn(Column.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dqRuleReferenceColumn(Column.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCycleDataQualityRule() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DataQualityRule,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DataQualityRule via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of DataQualityRule,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final DataQualityRule frodo = MockAtlanTenant.client.readValue(serialized, DataQualityRule.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of DataQualityRule,");
