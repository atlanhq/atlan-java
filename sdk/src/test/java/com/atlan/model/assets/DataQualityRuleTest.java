...
public class DataQualityRuleTest {
    ...
    private final DataQualityRule full = DataQualityRule._internal()
            ...
            .assetSummaryProvider(AssetSummaryProvider.builder()
                    .assetSummaryProviderName("String0")
                    .assetSummaryProviderUrl("String0")
                    .build())
            .assetSummary("String0")
            .assetSummaryFilterToken("String0")
            .assetSummaryFilterToken("String1")
            ...
            .dqRuleLatestResultDetails("String0")
            .dqRuleADStatus(DataQualityRuleADStatus.TRAINING)
            ...
            .dqRuleReferenceDataset(
                    IndistinctAsset.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
