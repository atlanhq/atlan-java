...
public class DataQualityRuleTest {
    ...
    private static final DataQualityRule full = DataQualityRule._internal()
            .guid("guid")
    ...
    private static DataQualityRule frodo;
    ...
    @Test(groups = {"DataQualityRule.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DataQualityRule.serialize"},
            dependsOnGroups = {"DataQualityRule.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DataQualityRule.deserialize"},
            dependsOnGroups = {"DataQualityRule.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DataQualityRule.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DataQualityRule.equivalency"},
            dependsOnGroups = {"DataQualityRule.serialize", "DataQualityRule.deserialize"})
