...
public class BadgeTest {
    ...
    private final Badge full = Badge._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleBadge() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Badge,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(), full, "Unable to converting Badge via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Badge,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Badge frodo = MockAtlanTenant.client.readValue(serialized, Badge.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Badge,");
