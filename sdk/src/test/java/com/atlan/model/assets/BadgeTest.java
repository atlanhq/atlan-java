...
public class BadgeTest {
    ...
    private static final Badge full = Badge._internal()
            .guid("guid")
            ...
            .badgeCondition(BadgeCondition.builder()
                    .badgeConditionOperator(BadgeComparisonOperator.GT)
                    .badgeConditionValue("String0")
                    .badgeConditionColorhex("String0")
                    .build())
            .badgeCondition(BadgeCondition.builder()
                    .badgeConditionOperator(BadgeComparisonOperator.GTE)
                    .badgeConditionValue("String1")
                    .badgeConditionColorhex("String1")
                    .build())
            .badgeMetadataAttribute("String0")
            .build();
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, Badge.class);
        assertNotNull(frodo);
    }
