...
public class SnowflakeStageTest {
    ...
    private final SnowflakeStage full = SnowflakeStage._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSnowflakeStage() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SnowflakeStage,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SnowflakeStage via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SnowflakeStage,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SnowflakeStage frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeStage.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SnowflakeStage,");
