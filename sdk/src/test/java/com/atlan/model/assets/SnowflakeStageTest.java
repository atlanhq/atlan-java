...
public class SnowflakeStageTest {

    private static final SnowflakeStage full = SnowflakeStage._internal()
            .guid("guid")
            ...
            .viewerUser("String0")
            .viewerUser("String1")
            .snowflakeStageExternalLocation("String0")
            .snowflakeStageExternalLocationRegion("String0")
            .snowflakeStageStorageIntegration("String0")
            .snowflakeStageType("String0")
            .sqlStageSchema(Schema.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .build();

    private static final int hash = full.hashCode();
    private static SnowflakeStage frodo;
    private static String serialized;

    @Test(groups = {"SnowflakeStage.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SnowflakeStage.serialize"},
            dependsOnGroups = {"SnowflakeStage.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SnowflakeStage.deserialize"},
            dependsOnGroups = {"SnowflakeStage.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SnowflakeStage.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SnowflakeStage.equivalency"},
            dependsOnGroups = {"SnowflakeStage.serialize", "SnowflakeStage.deserialize"})
