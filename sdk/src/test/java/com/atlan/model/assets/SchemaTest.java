...
public class SchemaTest {
    ...
    private final Schema full = Schema._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleSchema() throws IOException {
        assertNotNull(full, "Unable to build sample instance of Schema,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting Schema via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of Schema,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final Schema frodo = MockAtlanTenant.client.readValue(serialized, Schema.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of Schema,");
