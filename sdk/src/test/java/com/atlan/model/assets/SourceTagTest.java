...
public class SourceTagTest {
    ...
    private static final SourceTag full = SourceTag._internal()
            .guid("guid")
    ...
    private static SourceTag frodo;
    private static String serialized;

    @Test(groups = {"SourceTag.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"SourceTag.serialize"},
            dependsOnGroups = {"SourceTag.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"SourceTag.deserialize"},
            dependsOnGroups = {"SourceTag.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, SourceTag.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"SourceTag.equivalency"},
            dependsOnGroups = {"SourceTag.serialize", "SourceTag.deserialize"})
