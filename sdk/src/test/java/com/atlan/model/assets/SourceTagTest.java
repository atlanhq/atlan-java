...
public class SourceTagTest {
    ...
    private final SourceTag full = SourceTag._internal()
            .guid("guid")
            ...
            .tagAttribute(SourceTagAttribute.builder()
                    ...
                    .tagAttributeProperties(Map.of("String0", "String0"))
                    .build())
            .tagAttribute(SourceTagAttribute.builder()
    ...
    @Test
    void serdeCycleSourceTag() throws IOException {
        assertNotNull(full, "Unable to build sample instance of SourceTag,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting SourceTag via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of SourceTag,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final SourceTag frodo = MockAtlanTenant.client.readValue(serialized, SourceTag.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of SourceTag,");
