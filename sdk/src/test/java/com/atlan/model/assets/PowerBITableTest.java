...
public class PowerBITableTest {
    ...
    private final PowerBITable full = PowerBITable._internal()
            .guid("guid")
            ...
            .datasetQualifiedName("String0")
            .dataflowQualifiedName("String0")
            .dataflowQualifiedName("String1")
            .powerBITableSourceExpression("String0")
            .powerBITableSourceExpression("String1")
            .powerBITableColumnCount(123456789L)
            .powerBITableMeasureCount(123456789L)
            .measure(PowerBIMeasure.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .measure(PowerBIMeasure.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dataset(PowerBIDataset.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .column(PowerBIColumn.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .column(PowerBIColumn.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .dataflow(PowerBIDataflow.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .dataflow(PowerBIDataflow.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
    ...
    @Test
    void serdeCyclePowerBITable() throws IOException {
        assertNotNull(full, "Unable to build sample instance of PowerBITable,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting PowerBITable via builder back to its original state,");
        // Serialization
        final String serialized = full.toJson(MockAtlanTenant.client);
        assertNotNull(serialized, "Unable to serialize sample instance of PowerBITable,");
        assertEquals(full.hashCode(), hash, "Serialization mutated the original value,");
        // Deserialization
        final PowerBITable frodo = MockAtlanTenant.client.readValue(serialized, PowerBITable.class);
        assertNotNull(frodo, "Unable to reverse-read serialized value back into an instance of PowerBITable,");
