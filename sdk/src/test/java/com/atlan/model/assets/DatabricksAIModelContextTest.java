...
public class DatabricksAIModelContextTest {
    ...
    private final DatabricksAIModelContext full = DatabricksAIModelContext._internal()
            .guid("guid")
    ...
    @Test
    void serdeCycleDatabricksAIModelContext() throws IOException {
        assertNotNull(full, "Unable to build sample instance of DatabricksAIModelContext,");
        final int hash = full.hashCode();
        // Builder equivalency
        assertEquals(
                full.toBuilder().build(),
                full,
                "Unable to converting DatabricksAIModelContext via builder back to its original state,");
        // Serialization
