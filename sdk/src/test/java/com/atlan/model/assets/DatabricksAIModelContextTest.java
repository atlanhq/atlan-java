...
public class DatabricksAIModelContextTest {

    private static final DatabricksAIModelContext full = DatabricksAIModelContext._internal()
            .guid("guid")
            ...
            .databricksAIModelContextMetastoreId("String0")
    ...
    private static DatabricksAIModelContext frodo;
    private static String serialized;

    @Test(groups = {"DatabricksAIModelContext.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"DatabricksAIModelContext.serialize"},
            dependsOnGroups = {"DatabricksAIModelContext.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"DatabricksAIModelContext.deserialize"},
            dependsOnGroups = {"DatabricksAIModelContext.serialize"})
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = MockAtlanTenant.client.readValue(serialized, DatabricksAIModelContext.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"DatabricksAIModelContext.equivalency"},
            dependsOnGroups = {"DatabricksAIModelContext.serialize", "DatabricksAIModelContext.deserialize"})
