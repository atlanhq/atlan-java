...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = DataQualityRuleConfigArguments.class, name = DataQualityRuleConfigArguments.TYPE_NAME),
    @JsonSubTypes.Type(value = DataQualityRuleTemplateConfig.class, name = DataQualityRuleTemplateConfig.TYPE_NAME),
    @JsonSubTypes.Type(value = DataQualityRuleThresholdObject.class, name = DataQualityRuleThresholdObject.TYPE_NAME),
    @JsonSubTypes.Type(value = DatabricksAIModelVersionMetric.class, name = DatabricksAIModelVersionMetric.TYPE_NAME),
    @JsonSubTypes.Type(value = DbtInputContext.class, name = DbtInputContext.TYPE_NAME),
    ...
    @JsonSubTypes.Type(value = IcebergPartition.class, name = IcebergPartition.TYPE_NAME),
    ...
    @JsonSubTypes.Type(value = SQLProcedureReturn.class, name = SQLProcedureReturn.TYPE_NAME),
    @JsonSubTypes.Type(value = SageMakerUnifiedStudioSsoUser.class, name = SageMakerUnifiedStudioSsoUser.TYPE_NAME),
    ...
    @JsonSubTypes.Type(value = TableauReadCountWindow.class, name = TableauReadCountWindow.TYPE_NAME),
})
@Slf4j
