...
public class AttributeDefOptions extends AtlanObject {
    ...
    public static final Set<String> ALL_ASSET_TYPES = Set.of(
            ...
            TypeRegistryAssociationRelationship.TYPE_NAME,
            TypeRegistryAttribute.TYPE_NAME,
            TypeRegistryContainmentRelationship.TYPE_NAME,
            TypeRegistryNamespace.TYPE_NAME,
            TypeRegistryPublishedEntity.TYPE_NAME,
            TypeRegistryPublishedEnum.TYPE_NAME,
            TypeRegistryPublishedRelationship.TYPE_NAME,
            TypeRegistryPublishedStruct.TYPE_NAME,
            TypeRegistryWorkspace.TYPE_NAME,
            TypeRegistryWorkspaceEntity.TYPE_NAME,
            TypeRegistryWorkspaceEnum.TYPE_NAME,
            TypeRegistryWorkspaceStruct.TYPE_NAME,
            View.TYPE_NAME,
            Workflow.TYPE_NAME,
