...
public class AttributeDefOptions extends AtlanObject {
    ...
    public static final Set<String> ALL_ASSET_TYPES = Set.of(
            ...
            AtlanAppDeployment.TYPE_NAME,
            AtlanAppInstalled.TYPE_NAME,
            ...
            S3Object.TYPE_NAME,
            S3Prefix.TYPE_NAME,
            SageMakerUnifiedStudioAssetSchema.TYPE_NAME,
            SageMakerUnifiedStudioProject.TYPE_NAME,
            SageMakerUnifiedStudioPublishedAsset.TYPE_NAME,
            SageMakerUnifiedStudioSubscribedAsset.TYPE_NAME,
