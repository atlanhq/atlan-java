...
public class AttributeDefOptions extends AtlanObject {
    ...
    public static final Set<String> ALL_ASSET_TYPES = Set.of(
            ...
            ETLControlFlow.TYPE_NAME,
            ETLControlFlowOperation.TYPE_NAME,
            ETLDataFlowOperation.TYPE_NAME,
            ETLExecutableUnit.TYPE_NAME,
            ...
            GCSObject.TYPE_NAME,
            Insight.TYPE_NAME,
            InterimDataset.TYPE_NAME,
            InterimField.TYPE_NAME,
