...
public interface ISapAnalyticsCloudModel {

    public static final String TYPE_NAME = "SapAnalyticsCloudModel";

    /** Columns defined within this model. */
    RelationField SAP_ANALYTICS_CLOUD_COLUMNS = new RelationField("sapAnalyticsCloudColumns");
    ...
    KeywordField SAP_ANALYTICS_CLOUD_DATA_ACCESS_MODE =
            new KeywordField("sapAnalyticsCloudDataAccessMode", "sapAnalyticsCloudDataAccessMode");

    /** Folder containing this model. */
    RelationField SAP_ANALYTICS_CLOUD_FOLDER = new RelationField("sapAnalyticsCloudFolder");

    /** Host of the remote system a live model reads from. Empty for imported models. */
    KeywordField SAP_ANALYTICS_CLOUD_LIVE_CONNECTION_HOST =
            new KeywordField("sapAnalyticsCloudLiveConnectionHost", "sapAnalyticsCloudLiveConnectionHost");

    /** Identifier of the remote connection a live model reads from. Empty for imported models. */
    KeywordField SAP_ANALYTICS_CLOUD_LIVE_CONNECTION_ID =
            new KeywordField("sapAnalyticsCloudLiveConnectionId", "sapAnalyticsCloudLiveConnectionId");

    /** Simple name of the remote connection a live model reads from. Empty for imported models. */
    KeywordField SAP_ANALYTICS_CLOUD_LIVE_CONNECTION_NAME =
            new KeywordField("sapAnalyticsCloudLiveConnectionName", "sapAnalyticsCloudLiveConnectionName");

    /** Port of the remote system a live model reads from. Empty for imported models. */
    NumericField SAP_ANALYTICS_CLOUD_LIVE_CONNECTION_PORT =
            new NumericField("sapAnalyticsCloudLiveConnectionPort", "sapAnalyticsCloudLiveConnectionPort");

    /** Protocol used to reach the remote system a live model reads from, such as HTTPS. Empty for imported models. */
    KeywordField SAP_ANALYTICS_CLOUD_LIVE_CONNECTION_PROTOCOL =
    ...
    KeywordField SAP_ANALYTICS_CLOUD_LIVE_CONNECTION_SYSTEM_TYPE =
            new KeywordField("sapAnalyticsCloudLiveConnectionSystemType", "sapAnalyticsCloudLiveConnectionSystemType");

    /** Type of the remote connection a live model reads from, such as DIRECT. Empty for imported models. */
    KeywordField SAP_ANALYTICS_CLOUD_LIVE_CONNECTION_TYPE =
            new KeywordField("sapAnalyticsCloudLiveConnectionType", "sapAnalyticsCloudLiveConnectionType");
    ...
    KeywordField SAP_ANALYTICS_CLOUD_MODEL_ID =
            new KeywordField("sapAnalyticsCloudModelId", "sapAnalyticsCloudModelId");
    ...
    KeywordField SAP_ANALYTICS_CLOUD_MODEL_KIND =
            new KeywordField("sapAnalyticsCloudModelKind", "sapAnalyticsCloudModelKind");

    /** Identifier of the OData provider that exposes this model's metadata. This is the key that joins a model to its columns. */
    KeywordField SAP_ANALYTICS_CLOUD_PROVIDER_ID =
            new KeywordField("sapAnalyticsCloudProviderId", "sapAnalyticsCloudProviderId");

    /** Number of SAP Analytics Cloud stories that consume this model, as reported by the source. */
    NumericField SAP_ANALYTICS_CLOUD_STORY_COUNT =
            new NumericField("sapAnalyticsCloudStoryCount", "sapAnalyticsCloudStoryCount");
    ...
    /** Columns defined within this model. */
    default SortedSet<ISapAnalyticsCloudColumn> getSapAnalyticsCloudColumns() {
        return null;
    }

    /** How this model reaches its data, as reported by the source. IMPORT when the data is acquired into SAP Analytics Cloud and stored there, LIVE when it stays in a remote system and is queried live over a connection. */
    String getSapAnalyticsCloudDataAccessMode();

    /** Folder containing this model. */
    default ISapAnalyticsCloudFolder getSapAnalyticsCloudFolder() {
        return null;
    }

    /** Host of the remote system a live model reads from. Empty for imported models. */
    String getSapAnalyticsCloudLiveConnectionHost();

    /** Identifier of the remote connection a live model reads from. Empty for imported models. */
    String getSapAnalyticsCloudLiveConnectionId();

    /** Simple name of the remote connection a live model reads from. Empty for imported models. */
    String getSapAnalyticsCloudLiveConnectionName();

    /** Port of the remote system a live model reads from. Empty for imported models. */
    Integer getSapAnalyticsCloudLiveConnectionPort();

    /** Protocol used to reach the remote system a live model reads from, such as HTTPS. Empty for imported models. */
    String getSapAnalyticsCloudLiveConnectionProtocol();

    /** Type of the remote system a live model reads from, such as DWC for SAP Datasphere. Empty for imported models. */
    String getSapAnalyticsCloudLiveConnectionSystemType();

    /** Type of the remote connection a live model reads from, such as DIRECT. Empty for imported models. */
    String getSapAnalyticsCloudLiveConnectionType();

    /** Model identifier reported by the SAP Analytics Cloud tenant APIs, which differs from the file-repository resource identifier for live models. */
    String getSapAnalyticsCloudModelId();

    /** Whether this model is an analytic model or a planning model, as reported by the source. ANALYTIC for a read-only model used for analysis and reporting, PLANNING for a model that supports write-back, versions and planning operations. */
    String getSapAnalyticsCloudModelKind();

    /** Underlying object identifier reported by the SAP Analytics Cloud file repository for this asset. */
    String getSapAnalyticsCloudObjectId();
    ...
    String getSapAnalyticsCloudParentFolderName();
    ...
    String getSapAnalyticsCloudParentFolderQualifiedName();

    /** Identifier of the OData provider that exposes this model's metadata. This is the key that joins a model to its columns. */
    String getSapAnalyticsCloudProviderId();
    ...
    String getSapAnalyticsCloudRepositoryPartition();
    ...
    String getSapAnalyticsCloudResourceId();

    /** Number of SAP Analytics Cloud stories that consume this model, as reported by the source. */
    Long getSapAnalyticsCloudStoryCount();

    /** Identifier of the SAP Analytics Cloud workspace that owns this asset. */
    String getSapAnalyticsCloudWorkspaceId();

    /** Simple name of the SAP Analytics Cloud workspace that owns this asset. */
    String getSapAnalyticsCloudWorkspaceName();
