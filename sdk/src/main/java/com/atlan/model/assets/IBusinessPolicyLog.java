...
public interface IBusinessPolicyLog {

    public static final String TYPE_NAME = "BusinessPolicyLog";

    /** business policy guid for which log are created */
    KeywordField BUSINESS_POLICY_ID = new KeywordField("businessPolicyId", "businessPolicyId");

    /** business policy type for which log are created */
    KeywordField BUSINESS_POLICY_LOG_POLICY_TYPE =
            new KeywordField("businessPolicyLogPolicyType", "businessPolicyLogPolicyType");

    /** number of compliant assets in the policy */
    NumericField COMPLIANT_ASSETS_COUNT = new NumericField("compliantAssetsCount", "compliantAssetsCount");

    /** number of governed assets in the policy */
    NumericField GOVERNED_ASSETS_COUNT = new NumericField("governedAssetsCount", "governedAssetsCount");

    /** number of non compliant assets in the policy */
    NumericField NON_COMPLIANT_ASSETS_COUNT = new NumericField("nonCompliantAssetsCount", "nonCompliantAssetsCount");

    /** number of non governed assets in the policy */
    NumericField NON_GOVERNED_ASSETS_COUNT = new NumericField("nonGovernedAssetsCount", "nonGovernedAssetsCount");
    ...
    /** business policy guid for which log are created */
    String getBusinessPolicyId();

    /** business policy type for which log are created */
    String getBusinessPolicyLogPolicyType();
    ...
    /** number of non compliant assets in the policy */
    Long getNonCompliantAssetsCount();

    /** number of non governed assets in the policy */
    Long getNonGovernedAssetsCount();
