...
public class AdfPipeline extends Asset implements IAdfPipeline, IADF, ICatalog, IAsset, IReferenceable {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfPipeline updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfPipeline replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
