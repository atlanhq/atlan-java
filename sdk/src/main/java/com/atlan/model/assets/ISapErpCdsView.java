...
public interface ISapErpCdsView {

    public static final String TYPE_NAME = "SapErpCdsView";

    /** The source name of the SAP ERP CDS View Definition. */
    KeywordField SAP_ERP_CDS_VIEW_SOURCE_NAME = new KeywordField("sapErpCdsViewSourceName", "sapErpCdsViewSourceName");

    /** The source type of the SAP ERP CDS View Definition. */
    KeywordField SAP_ERP_CDS_VIEW_SOURCE_TYPE = new KeywordField("sapErpCdsViewSourceType", "sapErpCdsViewSourceType");

    /** The technical database view name of the SAP ERP CDS View. */
    KeywordField SAP_ERP_CDS_VIEW_TECHNICAL_NAME =
            new KeywordField("sapErpCdsViewTechnicalName", "sapErpCdsViewTechnicalName");

    /** SAP ERP Columns that exist within this CDS view. */
    RelationField SAP_ERP_COLUMNS = new RelationField("sapErpColumns");
    ...
    /** The source name of the SAP ERP CDS View Definition. */
    String getSapErpCdsViewSourceName();

    /** The source type of the SAP ERP CDS View Definition. */
    String getSapErpCdsViewSourceType();

    /** The technical database view name of the SAP ERP CDS View. */
    String getSapErpCdsViewTechnicalName();

    /** SAP ERP Columns that exist within this CDS view. */
    SortedSet<ISapErpColumn> getSapErpColumns();
