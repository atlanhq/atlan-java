...
public interface IDatabricksGenieAgent {
    ...
    KeywordField DATABRICKS_GENIE_AGENT_ETAG = new KeywordField("databricksGenieAgentEtag", "databricksGenieAgentEtag");

    /** Workspace folder path containing the Genie space. It is descriptive only and creates no containment or hierarchy edge. */
    KeywordField DATABRICKS_GENIE_AGENT_PARENT_PATH =
            new KeywordField("databricksGenieAgentParentPath", "databricksGenieAgentParentPath");

    /** Identifier of the SQL warehouse backing the Genie space. */
    KeywordField DATABRICKS_GENIE_AGENT_WAREHOUSE_ID =
            new KeywordField("databricksGenieAgentWarehouseId", "databricksGenieAgentWarehouseId");

    /** Identifier of the workspace containing the Genie space. */
    KeywordField DATABRICKS_GENIE_AGENT_WORKSPACE_ID =
            new KeywordField("databricksGenieAgentWorkspaceId", "databricksGenieAgentWorkspaceId");
    ...
    /** Entity tag used as a change token for the Genie space. It is populated only by an enabled serialized-detail read, so it is null when that read is disabled, denied, or omitted by the source. */
    String getDatabricksGenieAgentEtag();

    /** Workspace folder path containing the Genie space. It is descriptive only and creates no containment or hierarchy edge. */
    String getDatabricksGenieAgentParentPath();

    /** Identifier of the SQL warehouse backing the Genie space. */
    String getDatabricksGenieAgentWarehouseId();

    /** Identifier of the workspace containing the Genie space. */
    String getDatabricksGenieAgentWorkspaceId();
