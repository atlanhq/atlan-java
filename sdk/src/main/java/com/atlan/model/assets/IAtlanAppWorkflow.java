...
public interface IAtlanAppWorkflow {
    ...
    SortedSet<IAtlanAppTool> getAtlanAppTools();
    ...
    /** The workflow runs contained within the workflow. */
    SortedSet<IAppWorkflowRun> getAtlanAppWorkflowRuns();
    ...
    SortedSet<IAtlanAppWorkflow> getAtlanAppWorkflows();
