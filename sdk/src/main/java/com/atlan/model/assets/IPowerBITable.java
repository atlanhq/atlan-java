...
public interface IPowerBITable {
    ...
    /** Columns that exist within this table. */
    default SortedSet<IPowerBIColumn> getColumns() {
        return null;
    }
    ...
    /** PowerBI Dataflow that is associated with this PowerBI Table. */
    default SortedSet<IPowerBIDataflow> getDataflows() {
        return null;
    }

    /** Dataset in which this table exists. */
    default IPowerBIDataset getDataset() {
        return null;
    }
    ...
    /** Measures that exist within this table. */
    default SortedSet<IPowerBIMeasure> getMeasures() {
        return null;
    }
