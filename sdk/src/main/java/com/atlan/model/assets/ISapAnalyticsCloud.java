...
public interface ISapAnalyticsCloud {
    ...
    KeywordField SAP_ANALYTICS_CLOUD_OBJECT_ID =
            new KeywordField("sapAnalyticsCloudObjectId", "sapAnalyticsCloudObjectId");
    ...
    KeywordField SAP_ANALYTICS_CLOUD_PARENT_FOLDER_NAME =
            new KeywordField("sapAnalyticsCloudParentFolderName", "sapAnalyticsCloudParentFolderName");
    ...
    KeywordField SAP_ANALYTICS_CLOUD_PARENT_FOLDER_QUALIFIED_NAME = new KeywordField(
            "sapAnalyticsCloudParentFolderQualifiedName", "sapAnalyticsCloudParentFolderQualifiedName");
    ...
    KeywordField SAP_ANALYTICS_CLOUD_REPOSITORY_PARTITION =
            new KeywordField("sapAnalyticsCloudRepositoryPartition", "sapAnalyticsCloudRepositoryPartition");
    ...
    KeywordField SAP_ANALYTICS_CLOUD_RESOURCE_ID =
            new KeywordField("sapAnalyticsCloudResourceId", "sapAnalyticsCloudResourceId");

    /** Identifier of the SAP Analytics Cloud workspace that owns this asset. */
    KeywordField SAP_ANALYTICS_CLOUD_WORKSPACE_ID =
            new KeywordField("sapAnalyticsCloudWorkspaceId", "sapAnalyticsCloudWorkspaceId");

    /** Simple name of the SAP Analytics Cloud workspace that owns this asset. */
    KeywordField SAP_ANALYTICS_CLOUD_WORKSPACE_NAME =
            new KeywordField("sapAnalyticsCloudWorkspaceName", "sapAnalyticsCloudWorkspaceName");
