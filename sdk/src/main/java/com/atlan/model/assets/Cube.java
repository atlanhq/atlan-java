...
public class Cube extends Asset implements ICube, IMultiDimensionalDataset, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all Cube assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) Cube assets will be included.
     *
     * @return an asset filter that includes all Cube assets
    ...
    /**
     * Retrieves a Cube by its GUID, complete with all of its relationships.
     *
     * @param guid of the Cube to retrieve
     * @return the requested full Cube, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Cube does not exist or the provided GUID is not a Cube
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static Cube retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static Cube retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a Cube by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the Cube to retrieve
     * @return the requested full Cube, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Cube does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static Cube retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static Cube retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static Cube removeUserDescription(AtlanClient client, String qualifiedName, String name)
     ...
     * @throws AtlanException on any API problems
     */
    public static Cube updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static Cube updateCertificate(
     ...
     * @throws AtlanException on any API problems
     */
    public static Cube updateAnnouncement(
     ...
     * @throws AtlanException on any API problems
     */
    public static Cube replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static Cube replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
    ...
    public static Cube appendAtlanTags(
            ...
            boolean restrictLineagePropagation)
            throws AtlanException {
        return (Cube) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
    ...
    /**
     * Add Atlan tags to a Cube.
     *
     * @param qualifiedName of the Cube
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the Cube
     ...
     * Add Atlan tags to a Cube.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the Cube
     * @param qualifiedName of the Cube
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the Cube
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
