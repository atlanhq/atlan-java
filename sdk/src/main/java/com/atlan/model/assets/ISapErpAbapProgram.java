...
public interface ISapErpAbapProgram {
    ...
    KeywordField SAP_ERP_ABAP_PROGRAM_TYPE = new KeywordField("sapErpAbapProgramType", "sapErpAbapProgramType");
    ...
    /** Specifies the type of ABAP program in SAP ERP (e.g., Report, Module Pool, Function Group). */
    String getSapErpAbapProgramType();
    ...
    /** SAP ERP ABAP Program associated with this SAP ERP Transaction Code. */
    SortedSet<ISapErpTransactionCode> getSapErpTransactionCodes();
