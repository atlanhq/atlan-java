...
public interface ISqlInsightFilter {

    public static final String TYPE_NAME = "SqlInsightFilter";

    /** Column that this filter insight observes. */
    RelationField SQL_INSIGHT_COLUMN = new RelationField("sqlInsightColumn");

    /** Qualified name of the filtered column. */
    KeywordField SQL_INSIGHT_FILTER_COLUMN_QUALIFIED_NAME =
            new KeywordField("sqlInsightFilterColumnQualifiedName", "sqlInsightFilterColumnQualifiedName");

    /** Common values observed for this filter. */
    KeywordField SQL_INSIGHT_FILTER_COMMON_VALUES =
            new KeywordField("sqlInsightFilterCommonValues", "sqlInsightFilterCommonValues");

    /** Qualified name of the dataset containing the filtered column. */
    KeywordField SQL_INSIGHT_FILTER_DATASET_QUALIFIED_NAME =
            new KeywordField("sqlInsightFilterDatasetQualifiedName", "sqlInsightFilterDatasetQualifiedName");

    /** Example SQL queries that demonstrate this filter pattern, with usage details. */
    KeywordField SQL_INSIGHT_FILTER_EXAMPLE_QUERIES =
            new KeywordField("sqlInsightFilterExampleQueries", "sqlInsightFilterExampleQueries");

    /** Time (epoch) at which this filter pattern was last observed, in milliseconds. */
    NumericField SQL_INSIGHT_FILTER_LAST_SEEN_AT =
            new NumericField("sqlInsightFilterLastSeenAt", "sqlInsightFilterLastSeenAt");

    /** SQL operator observed on this column, such as =, !=, IN, LIKE. */
    KeywordField SQL_INSIGHT_FILTER_OPERATOR = new KeywordField("sqlInsightFilterOperator", "sqlInsightFilterOperator");

    /** SQL predicate expression for this filter pattern. */
    KeywordField SQL_INSIGHT_FILTER_PREDICATE_SQL =
            new KeywordField("sqlInsightFilterPredicateSQL", "sqlInsightFilterPredicateSQL");

    /** Number of queries that use this filter pattern. */
    NumericField SQL_INSIGHT_FILTER_QUERY_COUNT =
            new NumericField("sqlInsightFilterQueryCount", "sqlInsightFilterQueryCount");

    /** Number of unique users who have used this filter pattern. */
    NumericField SQL_INSIGHT_FILTER_UNIQUE_USERS =
            new NumericField("sqlInsightFilterUniqueUsers", "sqlInsightFilterUniqueUsers");

    /** Guidance on when this filter pattern should be used. */
    KeywordField SQL_INSIGHT_FILTER_WHEN_TO_USE =
            new KeywordField("sqlInsightFilterWhenToUse", "sqlInsightFilterWhenToUse");
    ...
    /** Column that this filter insight observes. */
    default IColumn getSqlInsightColumn() {
        return null;
    }

    /** Qualified name of the filtered column. */
    String getSqlInsightFilterColumnQualifiedName();

    /** Common values observed for this filter. */
    SortedSet<String> getSqlInsightFilterCommonValues();

    /** Qualified name of the dataset containing the filtered column. */
    String getSqlInsightFilterDatasetQualifiedName();

    /** Example SQL queries that demonstrate this filter pattern, with usage details. */
    List<PopularityInsights> getSqlInsightFilterExampleQueries();

    /** Time (epoch) at which this filter pattern was last observed, in milliseconds. */
    Long getSqlInsightFilterLastSeenAt();

    /** SQL operator observed on this column, such as =, !=, IN, LIKE. */
    String getSqlInsightFilterOperator();

    /** SQL predicate expression for this filter pattern. */
    String getSqlInsightFilterPredicateSQL();

    /** Number of queries that use this filter pattern. */
    Integer getSqlInsightFilterQueryCount();

    /** Number of unique users who have used this filter pattern. */
    Integer getSqlInsightFilterUniqueUsers();

    /** Guidance on when this filter pattern should be used. */
    String getSqlInsightFilterWhenToUse();
