...
public class DynamoDBGlobalSecondaryIndex extends Asset
    ...
    /**
     * Start an asset filter that will return all DynamoDBGlobalSecondaryIndex assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DynamoDBGlobalSecondaryIndex assets will be included.
     *
     * @return an asset filter that includes all DynamoDBGlobalSecondaryIndex assets
     ...
     */
    @JsonIgnore
    public static DynamoDBGlobalSecondaryIndex get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a DynamoDBGlobalSecondaryIndex by its GUID, complete with all of its relationships.
     *
     * @param guid of the DynamoDBGlobalSecondaryIndex to retrieve
     * @return the requested full DynamoDBGlobalSecondaryIndex, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DynamoDBGlobalSecondaryIndex does not exist or the provided GUID is not a DynamoDBGlobalSecondaryIndex
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DynamoDBGlobalSecondaryIndex retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DynamoDBGlobalSecondaryIndex retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DynamoDBGlobalSecondaryIndex by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DynamoDBGlobalSecondaryIndex to retrieve
     * @return the requested full DynamoDBGlobalSecondaryIndex, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DynamoDBGlobalSecondaryIndex does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DynamoDBGlobalSecondaryIndex retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DynamoDBGlobalSecondaryIndex retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public DynamoDBGlobalSecondaryIndexBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "DynamoDBGlobalSecondaryIndex", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static DynamoDBGlobalSecondaryIndex removeDescription(String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DynamoDBGlobalSecondaryIndex removeUserDescription(String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DynamoDBGlobalSecondaryIndex removeCertificate(String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DynamoDBGlobalSecondaryIndex removeAnnouncement(String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DynamoDBGlobalSecondaryIndex removeAnnouncement(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
    ...
    public static DynamoDBGlobalSecondaryIndex replaceTerms(
            String qualifiedName, String name, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DynamoDBGlobalSecondaryIndex appendTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DynamoDBGlobalSecondaryIndex removeTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static DynamoDBGlobalSecondaryIndex appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    public static DynamoDBGlobalSecondaryIndex appendAtlanTags(
            ...
            boolean restrictLineagePropagation)
            throws AtlanException {
        return (DynamoDBGlobalSecondaryIndex) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
    ...
    /**
     * Add Atlan tags to a DynamoDBGlobalSecondaryIndex.
     *
     * @param qualifiedName of the DynamoDBGlobalSecondaryIndex
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DynamoDBGlobalSecondaryIndex
     ...
     * Add Atlan tags to a DynamoDBGlobalSecondaryIndex.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DynamoDBGlobalSecondaryIndex
     * @param qualifiedName of the DynamoDBGlobalSecondaryIndex
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DynamoDBGlobalSecondaryIndex
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
