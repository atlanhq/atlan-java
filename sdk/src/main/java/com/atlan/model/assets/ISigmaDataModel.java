...
public interface ISigmaDataModel {

    public static final String TYPE_NAME = "SigmaDataModel";

    /** Number of columns defined across all elements of this data model. */
    NumericField SIGMA_DATA_MODEL_COLUMN_COUNT =
            new NumericField("sigmaDataModelColumnCount", "sigmaDataModelColumnCount");

    /** Data model columns that exist in this data model. */
    RelationField SIGMA_DATA_MODEL_COLUMNS = new RelationField("sigmaDataModelColumns");

    /** Current document version of this data model, as reported by the Sigma /spec endpoint. Sigma increments this on each save. */
    NumericField SIGMA_DATA_MODEL_DOCUMENT_VERSION =
            new NumericField("sigmaDataModelDocumentVersion", "sigmaDataModelDocumentVersion");

    /** Number of elements (warehouse-table, sql, data-model, dataset sources) inside this data model. */
    NumericField SIGMA_DATA_MODEL_ELEMENT_COUNT =
            new NumericField("sigmaDataModelElementCount", "sigmaDataModelElementCount");
    ...
    NumericField SIGMA_DATA_MODEL_LATEST_DOCUMENT_VERSION =
            new NumericField("sigmaDataModelLatestDocumentVersion", "sigmaDataModelLatestDocumentVersion");

    /** Folder path of this data model in Sigma (for example, the root path "/My Documents"). */
    TextField SIGMA_DATA_MODEL_PATH = new TextField("sigmaDataModelPath", "sigmaDataModelPath");

    /** Schema version of this data model, as reported by the Sigma /spec endpoint. */
    NumericField SIGMA_DATA_MODEL_SCHEMA_VERSION =
            new NumericField("sigmaDataModelSchemaVersion", "sigmaDataModelSchemaVersion");

    /** Short (21-22 character) URL-safe identifier of this data model in Sigma, used in deep-link URLs into the Sigma UI. */
    KeywordField SIGMA_DATA_MODEL_URL_ID = new KeywordField("sigmaDataModelUrlId", "sigmaDataModelUrlId");
    ...
    /** Number of columns defined across all elements of this data model. */
    Long getSigmaDataModelColumnCount();

    /** Data model columns that exist in this data model. */
    default SortedSet<ISigmaDataModelColumn> getSigmaDataModelColumns() {
        return null;
    }

    /** Current document version of this data model, as reported by the Sigma /spec endpoint. Sigma increments this on each save. */
    Long getSigmaDataModelDocumentVersion();

    /** Number of elements (warehouse-table, sql, data-model, dataset sources) inside this data model. */
    Long getSigmaDataModelElementCount();

    /** Latest document version of this data model, as reported by the Sigma /spec endpoint (falls back to the latestVersion field from /dataModels when /spec is unavailable). */
    Long getSigmaDataModelLatestDocumentVersion();

    /** Folder path of this data model in Sigma (for example, the root path "/My Documents"). */
    String getSigmaDataModelPath();

    /** Schema version of this data model, as reported by the Sigma /spec endpoint. */
    Long getSigmaDataModelSchemaVersion();

    /** Short (21-22 character) URL-safe identifier of this data model in Sigma, used in deep-link URLs into the Sigma UI. */
    String getSigmaDataModelUrlId();
