...
public class CogniteSequence extends Asset
    ...
    /**
     * Start an asset filter that will return all CogniteSequence assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CogniteSequence assets will be included.
     *
     * @return an asset filter that includes all CogniteSequence assets
     ...
     */
    @JsonIgnore
    public static CogniteSequence get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a CogniteSequence by its GUID, complete with all of its relationships.
     *
     * @param guid of the CogniteSequence to retrieve
     * @return the requested full CogniteSequence, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteSequence does not exist or the provided GUID is not a CogniteSequence
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteSequence retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteSequence retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CogniteSequence by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CogniteSequence to retrieve
     * @return the requested full CogniteSequence, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteSequence does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteSequence retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteSequence retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public CogniteSequenceBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "CogniteSequence", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteSequence updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteSequence replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static CogniteSequence appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CogniteSequence.
     *
     * @param qualifiedName of the CogniteSequence
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteSequence
     ...
     * Add Atlan tags to a CogniteSequence.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CogniteSequence
     * @param qualifiedName of the CogniteSequence
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteSequence
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
