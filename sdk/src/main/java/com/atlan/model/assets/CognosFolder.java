...
public class CognosFolder extends Asset implements ICognosFolder, ICognos, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all CognosFolder assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CognosFolder assets will be included.
     *
     * @return an asset filter that includes all CognosFolder assets
    ...
    /**
     * Retrieves a CognosFolder by its GUID, complete with all of its relationships.
     *
     * @param guid of the CognosFolder to retrieve
     * @return the requested full CognosFolder, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosFolder does not exist or the provided GUID is not a CognosFolder
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosFolder retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosFolder retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CognosFolder by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CognosFolder to retrieve
     * @return the requested full CognosFolder, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosFolder does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosFolder retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosFolder retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFolder updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFolder replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CognosFolder.
     *
     * @param qualifiedName of the CognosFolder
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosFolder
     ...
     * Add Atlan tags to a CognosFolder.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CognosFolder
     * @param qualifiedName of the CognosFolder
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosFolder
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
