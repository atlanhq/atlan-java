...
public interface ICustomTable {
    ...
    RelationField CUSTOM_DATASET = new RelationField("customDataset");

    /** CustomField assets contained within this CustomTable. */
    RelationField CUSTOM_FIELDS = new RelationField("customFields");

    /** Ratings for the CustomTable asset from the source system. */
    KeywordField CUSTOM_RATINGS = new KeywordField("customRatings", "customRatings");
    ...
    /** CustomDataset asset containing this CustomTable. */
    ICustomDataset getCustomDataset();
    ...
    /** CustomField assets contained within this CustomTable. */
    SortedSet<ICustomField> getCustomFields();

    /** Ratings for the CustomTable asset from the source system. */
    List<CustomRatings> getCustomRatings();
