...
public interface ISSRSDataSet {

    public static final String TYPE_NAME = "SSRSDataSet";

    /** Whether the data set is connected. */
    BooleanField SSRS_DATA_SET_CONNECTED = new BooleanField("ssrsDataSetConnected", "ssrsDataSetConnected");

    /** Cube name for the data set. */
    KeywordField SSRS_DATA_SET_CUBE_NAME = new KeywordField("ssrsDataSetCubeName", "ssrsDataSetCubeName");

    /** Data source connection string for the data set. */
    KeywordField SSRS_DATA_SET_DATA_SOURCE_CONNECTION_STRING =
            new KeywordField("ssrsDataSetDataSourceConnectionString", "ssrsDataSetDataSourceConnectionString");

    /** Data source reference for the data set. */
    KeywordField SSRS_DATA_SET_DATA_SOURCE_REFERENCE =
            new KeywordField("ssrsDataSetDataSourceReference", "ssrsDataSetDataSourceReference");

    /** Error code for the data set. */
    KeywordField SSRS_DATA_SET_ERROR_CODE = new KeywordField("ssrsDataSetErrorCode", "ssrsDataSetErrorCode");

    /** Extension for the data set. */
    KeywordField SSRS_DATA_SET_EXTENSION = new KeywordField("ssrsDataSetExtension", "ssrsDataSetExtension");

    /** Number of fields in this dataset. */
    NumericField SSRS_DATA_SET_FIELD_COUNT = new NumericField("ssrsDataSetFieldCount", "ssrsDataSetFieldCount");

    /** Whether the data set is shared. */
    BooleanField SSRS_DATA_SET_IS_SHARED_DATA_SET =
            new BooleanField("ssrsDataSetIsSharedDataSet", "ssrsDataSetIsSharedDataSet");

    /** Log messages for the data set. */
    KeywordField SSRS_DATA_SET_LOG_MESSAGES = new KeywordField("ssrsDataSetLogMessages", "ssrsDataSetLogMessages");

    /** Processed SQL for the data set. */
    KeywordField SSRS_DATA_SET_PROCESSED_SQL = new KeywordField("ssrsDataSetProcessedSql", "ssrsDataSetProcessedSql");

    /** Query parameters for the data set. */
    KeywordField SSRS_DATA_SET_QUERY_PARAMETERS =
            new KeywordField("ssrsDataSetQueryParameters", "ssrsDataSetQueryParameters");

    /** Reference table names for the data set. */
    KeywordField SSRS_DATA_SET_REFERENCE_TABLE_NAMES =
            new KeywordField("ssrsDataSetReferenceTableNames", "ssrsDataSetReferenceTableNames");

    /** SQL query for the data set. */
    KeywordField SSRS_DATA_SET_SQL_QUERY = new KeywordField("ssrsDataSetSqlQuery", "ssrsDataSetSqlQuery");

    /** Stored procedure name for the data set. */
    KeywordField SSRS_DATA_SET_STORED_PROCEDURE_NAME =
            new KeywordField("ssrsDataSetStoredProcedureName", "ssrsDataSetStoredProcedureName");

    /** Fields contained in the data set. */
    RelationField SSRS_FIELDS = new RelationField("ssrsFields");

    /** Report containing the data set. */
    RelationField SSRS_REPORT = new RelationField("ssrsReport");
    ...
    String getSsrsCatalogName();

    /** Whether the data set is connected. */
    Boolean getSsrsDataSetConnected();

    /** Cube name for the data set. */
    String getSsrsDataSetCubeName();

    /** Data source connection string for the data set. */
    String getSsrsDataSetDataSourceConnectionString();

    /** Data source reference for the data set. */
    String getSsrsDataSetDataSourceReference();

    /** Error code for the data set. */
    String getSsrsDataSetErrorCode();

    /** Extension for the data set. */
    String getSsrsDataSetExtension();

    /** Number of fields in this dataset. */
    Long getSsrsDataSetFieldCount();

    /** Whether the data set is shared. */
    Boolean getSsrsDataSetIsSharedDataSet();

    /** Log messages for the data set. */
    String getSsrsDataSetLogMessages();

    /** Simple name of the DataSet asset that contains this asset. */
    String getSsrsDataSetName();

    /** Processed SQL for the data set. */
    String getSsrsDataSetProcessedSql();

    /** Unique name of the DataSet asset that contains this asset. */
    String getSsrsDataSetQualifiedName();

    /** Query parameters for the data set. */
    String getSsrsDataSetQueryParameters();

    /** Reference table names for the data set. */
    SortedSet<String> getSsrsDataSetReferenceTableNames();

    /** SQL query for the data set. */
    String getSsrsDataSetSqlQuery();

    /** Stored procedure name for the data set. */
    String getSsrsDataSetStoredProcedureName();

    /** Fields contained in the data set. */
    default SortedSet<ISSRSField> getSsrsFields() {
        return null;
    }
