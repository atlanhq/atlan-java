...
public interface IDatabricksVolume {

    public static final String TYPE_NAME = "DatabricksVolume";

    /** The storage location where the volume is created. */
    KeywordField DATABRICKS_VOLUME_EXTERNAL_LOCATION =
            new KeywordField("databricksVolumeExternalLocation", "databricksVolumeExternalLocation");

    /** User or group (principal) currently owning the volume. */
    KeywordField DATABRICKS_VOLUME_OWNER = new KeywordField("databricksVolumeOwner", "databricksVolumeOwner");

    /** Paths contained within the volume. */
    RelationField DATABRICKS_VOLUME_PATHS = new RelationField("databricksVolumePaths");

    /** Schema that contains the volume. */
    RelationField DATABRICKS_VOLUME_SCHEMA = new RelationField("databricksVolumeSchema");

    /** Type of the volume. */
    KeywordField DATABRICKS_VOLUME_TYPE = new KeywordField("databricksVolumeType", "databricksVolumeType");
    ...
    /** The storage location where the volume is created. */
    String getDatabricksVolumeExternalLocation();

    /** User or group (principal) currently owning the volume. */
    String getDatabricksVolumeOwner();

    /** Paths contained within the volume. */
    SortedSet<IDatabricksVolumePath> getDatabricksVolumePaths();

    /** Schema that contains the volume. */
    ISchema getDatabricksVolumeSchema();

    /** Type of the volume. */
    DatabricksVolumeType getDatabricksVolumeType();
