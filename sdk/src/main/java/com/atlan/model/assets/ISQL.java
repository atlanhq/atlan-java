...
public interface ISQL {
    ...
    KeywordField SQL_AI_MODEL_CONTEXT_QUALIFIED_NAME =
            new KeywordField("sqlAIModelContextQualifiedName", "sqlAIModelContextQualifiedName");

    /** Time (epoch) at which this asset was last analyzed for AI insights, in milliseconds. */
    NumericField SQL_AI_INSIGHTS_LAST_ANALYZED_AT =
            new NumericField("sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt");

    /** Number of popular business questions associated with this asset. */
    NumericField SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT =
            new NumericField("sqlAiInsightsPopularBusinessQuestionCount", "sqlAiInsightsPopularBusinessQuestionCount");

    /** Number of popular filter patterns associated with this asset. */
    NumericField SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT =
            new NumericField("sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount");

    /** Number of popular join patterns associated with this asset. */
    NumericField SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT =
            new NumericField("sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount");
    ...
    BooleanField SQL_HAS_AI_INSIGHTS = new BooleanField("sqlHasAiInsights", "sqlHasAiInsights");
