...
public interface IDataModeling {
    ...
    public static final String TYPE_NAME = "DataModeling";

    /** TBC */
    KeywordField DATA_ENTITY_ID = new KeywordField("dataEntityId", "dataEntityId");
    ...
    /** TBC */
    KeywordField DATA_MODEL_ID = new KeywordField("dataModelId", "dataModelId");

    /** Simple name of the data model in which this asset exists, or empty if it is itself a data model. */
    KeywordTextField DATA_MODEL_NAME = new KeywordTextField("dataModelName", "dataModelName.keyword", "dataModelName");

    /** TBC */
    KeywordField DATA_MODEL_NAMESPACE = new KeywordField("dataModelNamespace", "dataModelNamespace");
