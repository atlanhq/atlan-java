...
public interface IInterimField {

    public static final String TYPE_NAME = "InterimField";

    /** Dataset in which the field exists. */
    RelationField INTERIM_DATASET = new RelationField("interimDataset");
    ...
    /** Dataset in which the field exists. */
    IInterimDataset getInterimDataset();

    /** Unique name of the InterimDataset. */
    String getInterimDatasetQualifiedName();
