...
public interface ISAPBWDataSource {

    public static final String TYPE_NAME = "SAPBWDataSource";

    /** Fields in this DataSource. */
    RelationField SAP_BW_DATA_SOURCE_FIELDS = new RelationField("sapBwDataSourceFields");

    /** Delta extraction method (RSDS.DELTA) such as AIMD or AIM. Empty means full-load only. */
    KeywordField SAP_BW_DELTA_METHOD = new KeywordField("sapBwDeltaMethod", "sapBwDeltaMethod");

    /** Source logical system this DataSource belongs to (RSDS.LOGSYS). Part of the composite primary key. */
    KeywordField SAP_BW_LOGICAL_SYSTEM = new KeywordField("sapBwLogicalSystem", "sapBwLogicalSystem");

    /** Data type (RSDS.TYPE): M (master), T (text), D (transaction), or H (hierarchy). */
    KeywordField SAP_BW_SOURCE_TYPE = new KeywordField("sapBwSourceType", "sapBwSourceType");
    ...
    /** Fields in this DataSource. */
    default SortedSet<ISAPBWDataSourceField> getSapBwDataSourceFields() {
        return null;
    }

    /** Delta extraction method (RSDS.DELTA) such as AIMD or AIM. Empty means full-load only. */
    String getSapBwDeltaMethod();
