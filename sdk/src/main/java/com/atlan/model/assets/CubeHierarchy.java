...
public class CubeHierarchy extends Asset
    ...
    /**
     * Start an asset filter that will return all CubeHierarchy assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CubeHierarchy assets will be included.
     *
     * @return an asset filter that includes all CubeHierarchy assets
    ...
    /**
     * Retrieves a CubeHierarchy by its GUID, complete with all of its relationships.
     *
     * @param guid of the CubeHierarchy to retrieve
     * @return the requested full CubeHierarchy, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CubeHierarchy does not exist or the provided GUID is not a CubeHierarchy
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CubeHierarchy retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CubeHierarchy retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CubeHierarchy by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CubeHierarchy to retrieve
     * @return the requested full CubeHierarchy, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CubeHierarchy does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CubeHierarchy retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CubeHierarchy retrieveByQualifiedName(AtlanClient client, String qualifiedName)
    ...
    public static CubeHierarchyBuilder<?, ?> creator(String name, CubeDimension dimension)
        ...
        if (dimension.getQualifiedName() == null || dimension.getQualifiedName().isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_RELATIONSHIP_PARAM, "CubeDimension", "qualifiedName");
        }
    ...
    /**
     * Add Atlan tags to a CubeHierarchy.
     *
     * @param qualifiedName of the CubeHierarchy
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CubeHierarchy
     ...
     * Add Atlan tags to a CubeHierarchy.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CubeHierarchy
     * @param qualifiedName of the CubeHierarchy
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CubeHierarchy
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
