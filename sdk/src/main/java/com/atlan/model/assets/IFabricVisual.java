...
public interface IFabricVisual {

    public static final String TYPE_NAME = "FabricVisual";

    /** Page containing the visual. */
    RelationField FABRIC_PAGE = new RelationField("fabricPage");

    /** Name of the Fabric page that contains this asset. */
    KeywordField FABRIC_PAGE_NAME = new KeywordField("fabricPageName", "fabricPageName");

    /** Unique name of the Fabric page that contains this asset. */
    KeywordField FABRIC_PAGE_QUALIFIED_NAME = new KeywordField("fabricPageQualifiedName", "fabricPageQualifiedName");

    /** Type of visual. */
    KeywordField FABRIC_VISUAL_TYPE = new KeywordField("fabricVisualType", "fabricVisualType");
    ...
    /** Page containing the visual. */
    IFabricPage getFabricPage();

    /** Name of the Fabric page that contains this asset. */
    String getFabricPageName();

    /** Unique name of the Fabric page that contains this asset. */
    String getFabricPageQualifiedName();

    /** Type of visual. */
    String getFabricVisualType();
