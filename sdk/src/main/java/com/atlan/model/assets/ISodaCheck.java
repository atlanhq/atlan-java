...
public interface ISodaCheck {
    ...
    KeywordField SODA_CHECK_LINKED_ASSET_QUALIFIED_NAME =
            new KeywordField("sodaCheckLinkedAssetQualifiedName", "sodaCheckLinkedAssetQualifiedName");
    ...
    /** TBC */
    SortedSet<IAsset> getSodaCheckAssets();
    ...
    /** TBC */
    Long getSodaCheckIncidentCount();

    /** TBC */
    Long getSodaCheckLastScanAt();

    /** QualifiedName of the asset associated with the check. */
    String getSodaCheckLinkedAssetQualifiedName();
