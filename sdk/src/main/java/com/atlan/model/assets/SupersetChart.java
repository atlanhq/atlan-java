...
public class SupersetChart extends Asset implements ISupersetChart, ISuperset, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all SupersetChart assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SupersetChart assets will be included.
     *
     * @return an asset filter that includes all SupersetChart assets
    ...
    /**
     * Retrieves a SupersetChart by its GUID, complete with all of its relationships.
     *
     * @param guid of the SupersetChart to retrieve
     * @return the requested full SupersetChart, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SupersetChart does not exist or the provided GUID is not a SupersetChart
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SupersetChart retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static SupersetChart retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a SupersetChart by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the SupersetChart to retrieve
     * @return the requested full SupersetChart, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SupersetChart does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SupersetChart retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static SupersetChart retrieveByQualifiedName(AtlanClient client, String qualifiedName)
     ...
     * @throws AtlanException on any API problems
     */
    public static SupersetChart updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SupersetChart replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static SupersetChart appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a SupersetChart.
     *
     * @param qualifiedName of the SupersetChart
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SupersetChart
     ...
     * Add Atlan tags to a SupersetChart.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the SupersetChart
     * @param qualifiedName of the SupersetChart
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SupersetChart
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
