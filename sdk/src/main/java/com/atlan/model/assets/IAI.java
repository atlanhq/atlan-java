...
public interface IAI {
    ...
    public static final String TYPE_NAME = "AI";

    /** Accountability configuration for ensuring the ethical use of an AI asset */
    KeywordField ETHICAL_AI_ACCOUNTABILITY_CONFIG =
            new KeywordField("ethicalAIAccountabilityConfig", "ethicalAIAccountabilityConfig");

    /** Bias mitigation configuration for ensuring the ethical use of an AI asset */
    KeywordField ETHICAL_AI_BIAS_MITIGATION_CONFIG =
            new KeywordField("ethicalAIBiasMitigationConfig", "ethicalAIBiasMitigationConfig");

    /** Environmental consciousness configuration for ensuring the ethical use of an AI asset */
    KeywordField ETHICAL_AI_ENVIRONMENTAL_CONSCIOUSNESS_CONFIG =
            new KeywordField("ethicalAIEnvironmentalConsciousnessConfig", "ethicalAIEnvironmentalConsciousnessConfig");

    /** Fairness configuration for ensuring the ethical use of an AI asset */
    KeywordField ETHICAL_AI_FAIRNESS_CONFIG = new KeywordField("ethicalAIFairnessConfig", "ethicalAIFairnessConfig");

    /** Privacy configuration for ensuring the ethical use of an AI asset */
    KeywordField ETHICAL_AI_PRIVACY_CONFIG = new KeywordField("ethicalAIPrivacyConfig", "ethicalAIPrivacyConfig");

    /** Reliability and safety configuration for ensuring the ethical use of an AI asset */
    KeywordField ETHICAL_AI_RELIABILITY_AND_SAFETY_CONFIG =
            new KeywordField("ethicalAIReliabilityAndSafetyConfig", "ethicalAIReliabilityAndSafetyConfig");

    /** Transparency configuration for ensuring the ethical use of an AI asset */
    KeywordField ETHICAL_AI_TRANSPARENCY_CONFIG =
            new KeywordField("ethicalAITransparencyConfig", "ethicalAITransparencyConfig");
