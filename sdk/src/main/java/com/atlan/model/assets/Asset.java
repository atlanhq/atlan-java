...
public abstract class Asset extends Reference implements IAsset, IReferenceable {
    ...
    @Attribute
    String assetAiGeneratedDescriptionReasoning;
    ...
    @Attribute
    @Date
    Long assetAnnouncementExpiredAt;
    ...
    @Attribute
    AssetDQRunStatus assetDQManualRunStatus;
    ...
    @Attribute
    AssetGCPDataplexMetadata assetGCPDataplexMetadataDetails;

    /** Whether this asset has an AI-generated readme. */
    @Attribute
    Boolean assetHasAiReadme;
