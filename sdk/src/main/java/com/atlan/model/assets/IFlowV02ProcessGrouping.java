...
public interface IFlowV02ProcessGrouping {
    ...
    RelationField FLOW_V02ABSTRACTS = new RelationField("flowV02Abstracts");

    /** Individual data flows (processes) contained in this grouping. */
    RelationField FLOW_V02DATA_FLOWS = new RelationField("flowV02DataFlows");

    /** Folder in which this grouping is contained. */
    RelationField FLOW_V02FOLDER = new RelationField("flowV02Folder");

    /** Project, workspace or namespace in which this grouping is contained. */
    RelationField FLOW_V02PROJECT = new RelationField("flowV02Project");
    ...
    /** Interim datasets that abstract the sub-processing carried out by the process grouping. */
    SortedSet<IFlowV02InterimDataset> getFlowV02Abstracts();

    /** Individual data flows (processes) contained in this grouping. */
    SortedSet<ILineageProcess> getFlowV02DataFlows();
    ...
    /** Folder in which this grouping is contained. */
    IFlowV02Folder getFlowV02Folder();
    ...
    /** Project, workspace or namespace in which this grouping is contained. */
    IFlowV02Project getFlowV02Project();
