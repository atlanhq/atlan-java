...
public interface IModelVersion {
    ...
    RelationField MODEL_DATA_MODEL = new RelationField("modelDataModel");

    /** Individual entities that make up this version of the data model. */
    RelationField MODEL_VERSION_ENTITIES = new RelationField("modelVersionEntities");

    /** Number of entities in the version. */
    NumericField MODEL_VERSION_ENTITY_COUNT = new NumericField("modelVersionEntityCount", "modelVersionEntityCount");
    ...
    /** Data model for which this version exists. */
    IModelDataModel getModelDataModel();
    ...
    /** Number of entities in the version. */
    Long getModelVersionEntityCount();
