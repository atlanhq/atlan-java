...
public interface IDataMeshDataset {

    public static final String TYPE_NAME = "DataMeshDataset";

    /** Data products associated with this dataset. */
    RelationField DATA_MESH_DATA_PRODUCTS = new RelationField("dataMeshDataProducts");

    /** Type classification of this dataset (Raw, Refined, or Aggregated). */
    KeywordField DATA_MESH_DATASET_TYPE = new KeywordField("dataMeshDatasetType", "dataMeshDatasetType");
    ...
    /** Data products associated with this dataset. */
    default SortedSet<IDataProduct> getDataMeshDataProducts() {
        return null;
    }

    /** Type classification of this dataset (Raw, Refined, or Aggregated). */
    DataMeshDatasetType getDataMeshDatasetType();
