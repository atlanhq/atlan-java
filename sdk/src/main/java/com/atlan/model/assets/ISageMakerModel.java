...
public interface ISageMakerModel {

    public static final String TYPE_NAME = "SageMakerModel";

    /** Docker container image used for the model. */
    KeywordField SAGE_MAKER_MODEL_CONTAINER_IMAGE =
            new KeywordField("sageMakerModelContainerImage", "sageMakerModelContainerImage");

    /** Deployments (endpoints) of this SageMaker Model. */
    RelationField SAGE_MAKER_MODEL_DEPLOYMENTS = new RelationField("sageMakerModelDeployments");

    /** ARN of the IAM role used by the model for accessing AWS resources. */
    KeywordField SAGE_MAKER_MODEL_EXECUTION_ROLE_ARN =
            new KeywordField("sageMakerModelExecutionRoleArn", "sageMakerModelExecutionRoleArn");

    /** SageMaker Model Group that contains the models. */
    RelationField SAGE_MAKER_MODEL_GROUP = new RelationField("sageMakerModelGroup");

    /** Name of the parent Model Group. */
    KeywordField SAGE_MAKER_MODEL_MODEL_GROUP_NAME =
            new KeywordField("sageMakerModelModelGroupName", "sageMakerModelModelGroupName");

    /** Qualified name of the parent Model Group. */
    KeywordField SAGE_MAKER_MODEL_MODEL_GROUP_QUALIFIED_NAME =
            new KeywordField("sageMakerModelModelGroupQualifiedName", "sageMakerModelModelGroupQualifiedName");

    /** Status of the SageMaker Model Package (ACTIVE or INACTIVE). */
    KeywordField SAGE_MAKER_MODEL_STATUS = new KeywordField("sageMakerModelStatus", "sageMakerModelStatus");

    /** Version of the SageMaker Model Package. */
    KeywordField SAGE_MAKER_MODEL_VERSION = new KeywordField("sageMakerModelVersion", "sageMakerModelVersion");
    ...
    String getCloudUniformResourceName();
    ...
    /** Docker container image used for the model. */
    String getSageMakerModelContainerImage();

    /** Deployments (endpoints) of this SageMaker Model. */
    default SortedSet<ISageMakerModelDeployment> getSageMakerModelDeployments() {
        return null;
    }

    /** ARN of the IAM role used by the model for accessing AWS resources. */
    String getSageMakerModelExecutionRoleArn();

    /** SageMaker Model Group that contains the models. */
    default ISageMakerModelGroup getSageMakerModelGroup() {
        return null;
    }

    /** Name of the parent Model Group. */
    String getSageMakerModelModelGroupName();

    /** Qualified name of the parent Model Group. */
    String getSageMakerModelModelGroupQualifiedName();

    /** Status of the SageMaker Model Package (ACTIVE or INACTIVE). */
    String getSageMakerModelStatus();

    /** Version of the SageMaker Model Package. */
    String getSageMakerModelVersion();

    /** Primary S3 URI associated with this SageMaker asset. */
    String getSageMakerS3Uri();
