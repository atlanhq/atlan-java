...
public interface ISAPBWQuery {
    ...
    RelationField SAP_BW_QUERY_ELEMENTS = new RelationField("sapBwQueryElements");
    ...
    KeywordField SAP_BW_QUERY_UID = new KeywordField("sapBwQueryUid", "sapBwQueryUid");
    ...
    /** Elements in this BEx Query. */
    default SortedSet<ISAPBWQueryElement> getSapBwQueryElements() {
        return null;
    }

    /** Internal stable UID of the query (RSZCOMPDIR.COMPUID). This is the join key inside SAP BW and is the preferred identifier for qualifiedName. */
    String getSapBwQueryUid();
