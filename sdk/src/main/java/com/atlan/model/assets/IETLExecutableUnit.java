...
public interface IETLExecutableUnit {
    ...
    /** Control flow operations that are contained in this executable unit. */
    SortedSet<IETLControlFlowOperation> getEtlControlFlowOperations();
