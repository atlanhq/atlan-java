...
public class ThoughtspotTable extends Asset
    ...
    /**
     * Start an asset filter that will return all ThoughtspotTable assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) ThoughtspotTable assets will be included.
     *
     * @return an asset filter that includes all ThoughtspotTable assets
     ...
     */
    @JsonIgnore
    public static ThoughtspotTable get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a ThoughtspotTable by its GUID, complete with all of its relationships.
     *
     * @param guid of the ThoughtspotTable to retrieve
     * @return the requested full ThoughtspotTable, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the ThoughtspotTable does not exist or the provided GUID is not a ThoughtspotTable
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static ThoughtspotTable retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static ThoughtspotTable retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a ThoughtspotTable by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the ThoughtspotTable to retrieve
     * @return the requested full ThoughtspotTable, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the ThoughtspotTable does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static ThoughtspotTable retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static ThoughtspotTable retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public ThoughtspotTableBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "ThoughtspotTable", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static ThoughtspotTable replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static ThoughtspotTable appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a ThoughtspotTable.
     *
     * @param qualifiedName of the ThoughtspotTable
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the ThoughtspotTable
     ...
     * Add Atlan tags to a ThoughtspotTable.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the ThoughtspotTable
     * @param qualifiedName of the ThoughtspotTable
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the ThoughtspotTable
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
