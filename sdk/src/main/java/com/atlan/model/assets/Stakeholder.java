...
public class Stakeholder extends Asset implements IStakeholder, IPersona, IAccessControl, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all Stakeholder assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) Stakeholder assets will be included.
     *
     * @return an asset filter that includes all Stakeholder assets
    ...
    /**
     * Retrieves a Stakeholder by its GUID, complete with all of its relationships.
     *
     * @param guid of the Stakeholder to retrieve
     * @return the requested full Stakeholder, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Stakeholder does not exist or the provided GUID is not a Stakeholder
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static Stakeholder retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static Stakeholder retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a Stakeholder by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the Stakeholder to retrieve
     * @return the requested full Stakeholder, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Stakeholder does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static Stakeholder retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static Stakeholder retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    /**
     * Add Atlan tags to a Stakeholder.
     *
     * @param qualifiedName of the Stakeholder
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the Stakeholder
     ...
     * Add Atlan tags to a Stakeholder.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the Stakeholder
     * @param qualifiedName of the Stakeholder
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the Stakeholder
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
