...
public interface IAtlanApp {
    ...
    TextField ATLAN_APP_METADATA = new TextField("atlanAppMetadata", "atlanAppMetadata");

    /** Name of the Atlan application this asset belongs to. */
    KeywordField ATLAN_APP_NAME = new KeywordField("atlanAppName", "atlanAppName");

    /** Qualified name of the Atlan application this asset belongs to. */
    KeywordField ATLAN_APP_QUALIFIED_NAME = new KeywordField("atlanAppQualifiedName", "atlanAppQualifiedName");

    /** Tools that exist within this Atlan application. */
    RelationField ATLAN_APP_TOOLS = new RelationField("atlanAppTools");

    /** Workflows that exist within this Atlan application. */
    RelationField ATLAN_APP_WORKFLOWS = new RelationField("atlanAppWorkflows");
