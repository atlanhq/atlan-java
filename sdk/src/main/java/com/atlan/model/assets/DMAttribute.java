...
public class DMAttribute extends Asset implements IDMAttribute, IDM, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all DMAttribute assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DMAttribute assets will be included.
     *
     * @return an asset filter that includes all DMAttribute assets
    ...
    /**
     * Retrieves a DMAttribute by its GUID, complete with all of its relationships.
     *
     * @param guid of the DMAttribute to retrieve
     * @return the requested full DMAttribute, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DMAttribute does not exist or the provided GUID is not a DMAttribute
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DMAttribute retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DMAttribute retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DMAttribute by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DMAttribute to retrieve
     * @return the requested full DMAttribute, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DMAttribute does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DMAttribute retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DMAttribute retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    /**
     * Add Atlan tags to a DMAttribute.
     *
     * @param qualifiedName of the DMAttribute
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DMAttribute
     ...
     * Add Atlan tags to a DMAttribute.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DMAttribute
     * @param qualifiedName of the DMAttribute
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DMAttribute
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
