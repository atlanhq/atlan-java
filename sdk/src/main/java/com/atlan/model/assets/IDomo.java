...
public interface IDomo {

    public static final String TYPE_NAME = "Domo";

    /** Id of the Domo dataset. */
    KeywordField DOMO_ID = new KeywordField("domoId", "domoId");

    /** Id of the owner of the Domo dataset. */
    KeywordField DOMO_OWNER_ID = new KeywordField("domoOwnerId", "domoOwnerId");
