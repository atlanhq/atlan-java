...
public interface IAssetGroupingStrategy {
    ...
    KeywordField ASSET_GROUPING_STRATEGY_SOURCE =
            new KeywordField("assetGroupingStrategySource", "assetGroupingStrategySource");

    /** Type of criteria used by this grouping strategy to identify assets. */
    KeywordField ASSET_GROUPING_STRATEGY_TYPE =
            new KeywordField("assetGroupingStrategyType", "assetGroupingStrategyType");
    ...
    /** Collections derived from this grouping strategy. */
    default SortedSet<IAssetGroupingCollection> getAssetGroupingCollections() {
        return null;
    }

    /** Stringified JSON configuration of the criteria used by this grouping strategy. */
    String getAssetGroupingStrategyConfig();

    /** Number of assets matching this strategy at last evaluation. */
    Long getAssetGroupingStrategyLastEvaluatedAssetCount();

    /** Time (epoch) at which this strategy was last evaluated. */
    Long getAssetGroupingStrategyLastEvaluatedTimestamp();

    /** Source of this grouping strategy. */
    AssetGroupingStrategySource getAssetGroupingStrategySource();

    /** Type of criteria used by this grouping strategy to identify assets. */
    AssetGroupingStrategyType getAssetGroupingStrategyType();
