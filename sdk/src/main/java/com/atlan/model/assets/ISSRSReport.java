...
public interface ISSRSReport {
    ...
    RelationField SSRS_DATA_SETS = new RelationField("ssrsDataSets");

    /** Folder containing the report. */
    RelationField SSRS_FOLDER = new RelationField("ssrsFolder");

    /** Reports that this report is linked from (the source reports this report aliases). */
    RelationField SSRS_LINKED_FROM_REPORTS = new RelationField("ssrsLinkedFromReports");

    /** Reports that are linked from (alias) this report. */
    RelationField SSRS_LINKED_REPORTS = new RelationField("ssrsLinkedReports");

    /** Number of datasets in this report. */
    NumericField SSRS_REPORT_DATA_SET_COUNT = new NumericField("ssrsReportDataSetCount", "ssrsReportDataSetCount");

    /** Number of data sources in this report. */
    NumericField SSRS_REPORT_DATA_SOURCE_COUNT =
            new NumericField("ssrsReportDataSourceCount", "ssrsReportDataSourceCount");

    /** Parameters for the report. */
    KeywordField SSRS_REPORT_PARAMETERS = new KeywordField("ssrsReportParameters", "ssrsReportParameters");

    /** Size of the report. */
    NumericField SSRS_REPORT_SIZE = new NumericField("ssrsReportSize", "ssrsReportSize");
    ...
    /** Data sets contained in the report. */
    default SortedSet<ISSRSDataSet> getSsrsDataSets() {
        return null;
    }

    /** Folder containing the report. */
    default ISSRSFolder getSsrsFolder() {
        return null;
    }
    ...
    /** Reports that this report is linked from (the source reports this report aliases). */
    default SortedSet<ISSRSReport> getSsrsLinkedFromReports() {
        return null;
    }

    /** Reports that are linked from (alias) this report. */
    default SortedSet<ISSRSReport> getSsrsLinkedReports() {
        return null;
    }
