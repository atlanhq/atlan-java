...
public class DMEntityAssociation extends Asset implements IDMEntityAssociation, IDM, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all DMEntityAssociation assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DMEntityAssociation assets will be included.
     *
     * @return an asset filter that includes all DMEntityAssociation assets
    ...
    /**
     * Retrieves a DMEntityAssociation by its GUID, complete with all of its relationships.
     *
     * @param guid of the DMEntityAssociation to retrieve
     * @return the requested full DMEntityAssociation, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DMEntityAssociation does not exist or the provided GUID is not a DMEntityAssociation
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DMEntityAssociation retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DMEntityAssociation retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DMEntityAssociation by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DMEntityAssociation to retrieve
     * @return the requested full DMEntityAssociation, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DMEntityAssociation does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DMEntityAssociation retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DMEntityAssociation retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a DMEntityAssociation.
     *
     * @param qualifiedName of the DMEntityAssociation
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DMEntityAssociation
     ...
     * Add Atlan tags to a DMEntityAssociation.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DMEntityAssociation
     * @param qualifiedName of the DMEntityAssociation
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DMEntityAssociation
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
