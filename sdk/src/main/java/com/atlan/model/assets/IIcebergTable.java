...
public interface IIcebergTable {

    public static final String TYPE_NAME = "IcebergTable";

    /** Current snapshot identifier for this Iceberg table. */
    NumericField ICEBERG_CURRENT_SNAPSHOT_ID = new NumericField("icebergCurrentSnapshotId", "icebergCurrentSnapshotId");

    /** Iceberg format version of the table. */
    NumericField ICEBERG_FORMAT_VERSION = new NumericField("icebergFormatVersion", "icebergFormatVersion");

    /** Snapshot information for the Iceberg table. */
    KeywordField ICEBERG_SNAPSHOTS = new KeywordField("icebergSnapshots", "icebergSnapshots");

    /** Partition information for the Iceberg table. */
    KeywordField ICEBERG_TABLE_PARTITIONS = new KeywordField("icebergTablePartitions", "icebergTablePartitions");

    /** Properties of the Iceberg table. */
    KeywordField ICEBERG_TABLE_PROPERTIES = new KeywordField("icebergTableProperties", "icebergTableProperties");
    ...
    /** Current snapshot identifier for this Iceberg table. */
    Long getIcebergCurrentSnapshotId();
    ...
    /** Partition information for the Iceberg table. */
    List<IcebergPartition> getIcebergTablePartitions();

    /** Properties of the Iceberg table. */
    Map<String, String> getIcebergTableProperties();
