...
/**
 * Unpublished definition in the metamodel.
 */
@Generated(value = "com.atlan.generators.ModelGeneratorV2")
@JsonSerialize(using = AssetSerializer.class)
@JsonDeserialize(using = AssetDeserializer.class)
public interface ITypeRegistryWorkspaced {

    public static final String TYPE_NAME = "TypeRegistryWorkspaced";

    /** Unpublished workspace in which this portion of the metamodel is contained. */
    RelationField TYPE_REGISTRY_WORKSPACE = new RelationField("typeRegistryWorkspace");
