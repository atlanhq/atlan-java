...
public interface IStakeholder {
    ...
    RelationField STAKEHOLDER_DATA_DOMAIN = new RelationField("stakeholderDataDomain");

    /** TBC */
    KeywordField STAKEHOLDER_DOMAIN_QUALIFIED_NAME =
            new KeywordField("stakeholderDomainQualifiedName", "stakeholderDomainQualifiedName");

    /** Stakeholder-title assigned for this Stakeholder-Persona */
    RelationField STAKEHOLDER_TITLE = new RelationField("stakeholderTitle");

    /** TBC */
    KeywordField STAKEHOLDER_TITLE_GUID = new KeywordField("stakeholderTitleGuid", "stakeholderTitleGuid");
    ...
    /** Domain assigned to the Stakeholder */
    IDataDomain getStakeholderDataDomain();

    /** TBC */
    String getStakeholderDomainQualifiedName();

    /** Stakeholder-title assigned for this Stakeholder-Persona */
    IStakeholderTitle getStakeholderTitle();

    /** TBC */
    String getStakeholderTitleGuid();
