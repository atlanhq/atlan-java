...
public interface IContextRepository {
    ...
    RelationField CONTEXT_OUTPUT_AGENTS = new RelationField("contextOutputAgents");
    ...
    KeywordField CONTEXT_REPOSITORY_LIFECYCLE_STATUS =
            new KeywordField("contextRepositoryLifecycleStatus", "contextRepositoryLifecycleStatus");

    /** Qualified name of the connection used as the execution engine for deploying and running queries against this repository. */
    KeywordField CONTEXT_REPOSITORY_TARGET_CONNECTION_QUALIFIED_NAME = new KeywordField(
            "contextRepositoryTargetConnectionQualifiedName", "contextRepositoryTargetConnectionQualifiedName");
    ...
    /** Agents produced by this context repository. */
    default SortedSet<IAgent> getContextOutputAgents() {
        return null;
    }
    ...
    /** LLM guidance and constraints for NL2SQL generation using this repository's context. */
    String getContextRepositoryAgentInstructions();

    /** Lifecycle status of the context repository. */
    ContextLifecycleStatus getContextRepositoryLifecycleStatus();

    /** Qualified name of the context repository to which this asset belongs. */
    String getContextRepositoryQualifiedName();

    /** Qualified name of the connection used as the execution engine for deploying and running queries against this repository. */
    String getContextRepositoryTargetConnectionQualifiedName();
