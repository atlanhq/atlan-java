...
public class CosmosMongoDBDatabase extends Asset
    ...
    /**
     * Start an asset filter that will return all CosmosMongoDBDatabase assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CosmosMongoDBDatabase assets will be included.
     *
     * @return an asset filter that includes all CosmosMongoDBDatabase assets
     ...
     */
    @JsonIgnore
    public static CosmosMongoDBDatabase get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a CosmosMongoDBDatabase by its GUID, complete with all of its relationships.
     *
     * @param guid of the CosmosMongoDBDatabase to retrieve
     * @return the requested full CosmosMongoDBDatabase, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CosmosMongoDBDatabase does not exist or the provided GUID is not a CosmosMongoDBDatabase
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CosmosMongoDBDatabase retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CosmosMongoDBDatabase retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CosmosMongoDBDatabase by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CosmosMongoDBDatabase to retrieve
     * @return the requested full CosmosMongoDBDatabase, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CosmosMongoDBDatabase does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CosmosMongoDBDatabase retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CosmosMongoDBDatabase retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public CosmosMongoDBDatabaseBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "CosmosMongoDBDatabase", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBDatabase replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBDatabase appendTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBDatabase removeTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static CosmosMongoDBDatabase appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CosmosMongoDBDatabase.
     *
     * @param qualifiedName of the CosmosMongoDBDatabase
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CosmosMongoDBDatabase
     ...
     * Add Atlan tags to a CosmosMongoDBDatabase.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CosmosMongoDBDatabase
     * @param qualifiedName of the CosmosMongoDBDatabase
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CosmosMongoDBDatabase
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
