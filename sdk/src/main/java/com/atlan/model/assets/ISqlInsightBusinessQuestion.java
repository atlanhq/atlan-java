...
public interface ISqlInsightBusinessQuestion {
    ...
    NumericField SQL_INSIGHT_BUSINESS_QUESTION_QUERY_COUNT =
            new NumericField("sqlInsightBusinessQuestionQueryCount", "sqlInsightBusinessQuestionQueryCount");

    /** Natural language text of the business question. */
    KeywordField SQL_INSIGHT_BUSINESS_QUESTION_TEXT =
            new KeywordField("sqlInsightBusinessQuestionText", "sqlInsightBusinessQuestionText");

    /** Number of unique users who have asked this question. */
    NumericField SQL_INSIGHT_BUSINESS_QUESTION_UNIQUE_USERS =
            new NumericField("sqlInsightBusinessQuestionUniqueUsers", "sqlInsightBusinessQuestionUniqueUsers");

    /** SQL dataset (table, view, or materialized view) that this question insight relates to. */
    RelationField SQL_INSIGHT_DATASET = new RelationField("sqlInsightDataset");
    ...
    /** Number of queries associated with this business question. */
    Integer getSqlInsightBusinessQuestionQueryCount();

    /** Natural language text of the business question. */
    String getSqlInsightBusinessQuestionText();

    /** Number of unique users who have asked this question. */
    Integer getSqlInsightBusinessQuestionUniqueUsers();

    /** SQL dataset (table, view, or materialized view) that this question insight relates to. */
    default ISQL getSqlInsightDataset() {
        return null;
    }
