...
public class TagAttachment extends Asset implements ITagAttachment, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all TagAttachment assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) TagAttachment assets will be included.
     *
     * @return an asset filter that includes all TagAttachment assets
    ...
    /**
     * Reference to a TagAttachment by GUID.
     *
    ...
    public static TagAttachment refByGuid(String guid) {
        return TagAttachment._internal().guid(guid).build();
    }

    /**
     * Reference to a TagAttachment by qualifiedName.
     *
    ...
    public static TagAttachment refByQualifiedName(String qualifiedName) {
        return TagAttachment._internal()
                .uniqueAttributes(
    ...
    /**
     * Retrieves a TagAttachment by its GUID, complete with all of its relationships.
     *
     * @param guid of the TagAttachment to retrieve
     * @return the requested full TagAttachment, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the TagAttachment does not exist or the provided GUID is not a TagAttachment
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static TagAttachment retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static TagAttachment retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a TagAttachment by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the TagAttachment to retrieve
     * @return the requested full TagAttachment, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the TagAttachment does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static TagAttachment retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static TagAttachment retrieveByQualifiedName(AtlanClient client, String qualifiedName)
    ...
    public TagAttachmentBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "TagAttachment", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static TagAttachment removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static TagAttachment appendTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static TagAttachment removeTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
    ...
    public static TagAttachment appendAtlanTags(
            ...
            boolean restrictLineagePropagation)
            throws AtlanException {
        return (TagAttachment) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
    ...
    /**
     * Add Atlan tags to a TagAttachment.
     *
     * @param qualifiedName of the TagAttachment
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the TagAttachment
     ...
     * Add Atlan tags to a TagAttachment.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the TagAttachment
     * @param qualifiedName of the TagAttachment
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the TagAttachment
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
