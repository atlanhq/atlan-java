...
public interface IPartialField {

    public static final String TYPE_NAME = "PartialField";

    /** Type of data captured as values in the field. */
    KeywordField PARTIAL_DATA_TYPE = new KeywordField("partialDataType", "partialDataType");

    /** Parent asset containing partial field. */
    RelationField PARTIAL_PARENT_ASSET = new RelationField("partialParentAsset");
    ...
    /** Type of data captured as values in the field. */
    String getPartialDataType();

    /** Parent asset containing partial field. */
    ICatalog getPartialParentAsset();
