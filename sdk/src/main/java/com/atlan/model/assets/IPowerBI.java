...
public interface IPowerBI {
    ...
    NumericField POWER_BI_ENDORSED_AT = new NumericField("powerBIEndorsedAt", "powerBIEndorsedAt");

    /** User who endorsed this asset in Power BI. */
    KeywordField POWER_BI_ENDORSED_BY = new KeywordField("powerBIEndorsedBy", "powerBIEndorsedBy");
