...
public interface ISnowflakeShare {

    public static final String TYPE_NAME = "SnowflakeShare";

    /** Snowflake listing this share is published under. */
    RelationField SNOWFLAKE_LISTING = new RelationField("snowflakeListing");

    /** Direction of the share (inbound or outbound). */
    KeywordField SNOWFLAKE_SHARE_KIND = new KeywordField("snowflakeShareKind", "snowflakeShareKind");

    /** Global name of the listing this share is bound to. */
    KeywordField SNOWFLAKE_SHARE_LISTING_GLOBAL_NAME =
            new KeywordField("snowflakeShareListingGlobalName", "snowflakeShareListingGlobalName");

    /** Account that owns the share. Drives the share qualified name. */
    KeywordField SNOWFLAKE_SHARE_OWNER_ACCOUNT =
            new KeywordField("snowflakeShareOwnerAccount", "snowflakeShareOwnerAccount");

    /** Whether only secure objects are allowed in this share (true) or not (false). */
    BooleanField SNOWFLAKE_SHARE_SECURE_OBJECT =
            new BooleanField("snowflakeShareSecureObject", "snowflakeShareSecureObject");

    /** Consumer accounts targeted by the share. */
    KeywordField SNOWFLAKE_SHARE_TARGET_ACCOUNTS =
            new KeywordField("snowflakeShareTargetAccounts", "snowflakeShareTargetAccounts");
    ...
    /** Snowflake listing this share is published under. */
    default ISnowflakeListing getSnowflakeListing() {
        return null;
    }
    ...
    /** Direction of the share (inbound or outbound). */
    SnowflakeShareKind getSnowflakeShareKind();

    /** Global name of the listing this share is bound to. */
    String getSnowflakeShareListingGlobalName();

    /** Account that owns the share. Drives the share qualified name. */
    String getSnowflakeShareOwnerAccount();

    /** Whether only secure objects are allowed in this share (true) or not (false). */
    Boolean getSnowflakeShareSecureObject();

    /** Consumer accounts targeted by the share. */
    SortedSet<String> getSnowflakeShareTargetAccounts();
