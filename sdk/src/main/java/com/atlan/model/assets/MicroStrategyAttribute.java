...
public class MicroStrategyAttribute extends Asset
     ...
     */
    @JsonIgnore
    public static MicroStrategyAttribute get(AtlanClient client, String id, boolean includeAllRelationships)
     ...
     */
    @JsonIgnore
    public static MicroStrategyAttribute get(AtlanClient client, String id, Collection<AtlanField> attributes)
            throws AtlanException {
