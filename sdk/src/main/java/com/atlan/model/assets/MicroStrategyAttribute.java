...
public class MicroStrategyAttribute extends Asset implements IMicroStrategyAttribute, IMicroStrategy, IBI, ICatalog, IAsset, IReferenceable {
     ...
     */
    @JsonIgnore
    public static MicroStrategyAttribute get(AtlanClient client, String id, boolean includeAllRelationships) throws AtlanException {
        if (id == null) {
    ...
    /**
     * Retrieves a MicroStrategyAttribute by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the MicroStrategyAttribute to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the MicroStrategyAttribute, including any relationships
     * @return the requested MicroStrategyAttribute, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MicroStrategyAttribute does not exist or the provided GUID is not a MicroStrategyAttribute
     */
    @JsonIgnore
    public static MicroStrategyAttribute get(AtlanClient client, String id, Collection<AtlanField> attributes) throws AtlanException {
     ...
     * @param id of the MicroStrategyAttribute to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the MicroStrategyAttribute, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the MicroStrategyAttribute
     * @return the requested MicroStrategyAttribute, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MicroStrategyAttribute does not exist or the provided GUID is not a MicroStrategyAttribute
     */
    @JsonIgnore
    public static MicroStrategyAttribute get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = MicroStrategyAttribute.select(client)
                    .where(MicroStrategyAttribute.GUID.eq(id))
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof MicroStrategyAttribute) {
                return (MicroStrategyAttribute) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
            Optional<Asset> asset = MicroStrategyAttribute.select(client)
                    .where(MicroStrategyAttribute.QUALIFIED_NAME.eq(id))
                    .includesOnResults(attributes)
                    .includesOnRelations(attributesOnRelated)
                    .includeRelationshipAttributes(true)
                    .pageSize(1)
    ...
    /**
     * Builds the minimal object necessary to apply an update to a MicroStrategyAttribute,
     * from a potentially more-complete MicroStrategyAttribute object.
     *
     * @return the minimal object necessary to update the MicroStrategyAttribute, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a MicroStrategyAttribute are not present in the initial object
     */
    @Override
    ...
    public abstract static class MicroStrategyAttributeBuilder<C extends MicroStrategyAttribute, B extends MicroStrategyAttributeBuilder<C, B>>
    ...
    public static MicroStrategyAttribute updateCertificate(
            ...
            throws AtlanException {
        return (MicroStrategyAttribute) Asset.updateCertificate(client, _internal(), TYPE_NAME, qualifiedName, certificate, message);
    }
    ...
    public static MicroStrategyAttribute updateAnnouncement(
            ...
            throws AtlanException {
        return (MicroStrategyAttribute) Asset.updateAnnouncement(client, _internal(), TYPE_NAME, qualifiedName, type, title, message);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static MicroStrategyAttribute replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    @Deprecated
    public static MicroStrategyAttribute appendTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    @Deprecated
    public static MicroStrategyAttribute removeTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    @Deprecated
    public static MicroStrategyAttribute appendAtlanTags(AtlanClient client, String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
