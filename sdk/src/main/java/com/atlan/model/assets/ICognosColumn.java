...
public interface ICognosColumn {

    public static final String TYPE_NAME = "CognosColumn";

    /** Data type of the CognosColumn. */
    KeywordField COGNOS_COLUMN_DATATYPE = new KeywordField("cognosColumnDatatype", "cognosColumnDatatype");

    /** Whether the CognosColumn is nullable. */
    KeywordField COGNOS_COLUMN_NULLABLE = new KeywordField("cognosColumnNullable", "cognosColumnNullable");

    /** How data should be summarized when aggregated across different dimensions or groupings. */
    KeywordField COGNOS_COLUMN_REGULAR_AGGREGATE =
            new KeywordField("cognosColumnRegularAggregate", "cognosColumnRegularAggregate");

    /** Parent dashboard containing the columns. */
    RelationField COGNOS_DASHBOARD = new RelationField("cognosDashboard");

    /** Parent dataset containing the columns. */
    RelationField COGNOS_DATASET = new RelationField("cognosDataset");

    /** Parent exploration containing the columns. */
    RelationField COGNOS_EXPLORATION = new RelationField("cognosExploration");

    /** Parent file containing the columns. */
    RelationField COGNOS_FILE = new RelationField("cognosFile");

    /** Parent module containing the columns. */
    RelationField COGNOS_MODULE = new RelationField("cognosModule");

    /** Parent package containing the columns. */
    RelationField COGNOS_PACKAGE = new RelationField("cognosPackage");
    ...
    /** Data type of the CognosColumn. */
    String getCognosColumnDatatype();

    /** Whether the CognosColumn is nullable. */
    String getCognosColumnNullable();

    /** How data should be summarized when aggregated across different dimensions or groupings. */
    String getCognosColumnRegularAggregate();

    /** Parent dashboard containing the columns. */
    ICognosDashboard getCognosDashboard();

    /** Parent dataset containing the columns. */
    ICognosDataset getCognosDataset();

    /** Tooltip text present for the Cognos asset. */
    String getCognosDefaultScreenTip();

    /** Parent exploration containing the columns. */
    ICognosExploration getCognosExploration();

    /** Parent file containing the columns. */
    ICognosFile getCognosFile();
    ...
    /** Parent module containing the columns. */
    ICognosModule getCognosModule();

    /** Parent package containing the columns. */
    ICognosPackage getCognosPackage();
