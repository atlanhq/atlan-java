...
public interface ISageMakerUnifiedStudioAsset {
    ...
    KeywordField SMUS_ASSET_REVISION = new KeywordField("smusAssetRevision", "smusAssetRevision");
    ...
    KeywordField SMUS_ASSET_SOURCE_IDENTIFIER =
            new KeywordField("smusAssetSourceIdentifier", "smusAssetSourceIdentifier");

    /** Summary text for the asset in SageMaker Unified Studio. */
    KeywordField SMUS_ASSET_SUMMARY = new KeywordField("smusAssetSummary", "smusAssetSummary");

    /** Technical name for the asset in SageMaker Unified Studio. */
    KeywordField SMUS_ASSET_TECHNICAL_NAME = new KeywordField("smusAssetTechnicalName", "smusAssetTechnicalName");

    /** Type of asset in SageMaker Unified Studio. */
    KeywordField SMUS_ASSET_TYPE = new KeywordField("smusAssetType", "smusAssetType");
