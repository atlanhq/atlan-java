...
public interface IDatabricksVolumePath {

    public static final String TYPE_NAME = "DatabricksVolumePath";

    /** Volume that contains the paths. */
    RelationField DATABRICKS_VOLUME = new RelationField("databricksVolume");

    /** Path of data on the volume. */
    KeywordField DATABRICKS_VOLUME_PATH_PATH = new KeywordField("databricksVolumePathPath", "databricksVolumePathPath");

    /** Name of the parent volume. */
    KeywordField DATABRICKS_VOLUME_PATH_VOLUME_NAME =
            new KeywordField("databricksVolumePathVolumeName", "databricksVolumePathVolumeName");

    /** Qualified name of the parent volume. */
    KeywordField DATABRICKS_VOLUME_PATH_VOLUME_QUALIFIED_NAME =
            new KeywordField("databricksVolumePathVolumeQualifiedName", "databricksVolumePathVolumeQualifiedName");
    ...
    /** Volume that contains the paths. */
    IDatabricksVolume getDatabricksVolume();

    /** Path of data on the volume. */
    String getDatabricksVolumePathPath();

    /** Name of the parent volume. */
    String getDatabricksVolumePathVolumeName();

    /** Qualified name of the parent volume. */
    String getDatabricksVolumePathVolumeQualifiedName();
