...
public interface ISapAnalyticsCloudStory {
    ...
    BooleanField SAP_ANALYTICS_CLOUD_IS_SAMPLE =
            new BooleanField("sapAnalyticsCloudIsSample", "sapAnalyticsCloudIsSample");
    ...
    KeywordField SAP_ANALYTICS_CLOUD_STORY_KIND =
            new KeywordField("sapAnalyticsCloudStoryKind", "sapAnalyticsCloudStoryKind");
    ...
    /** Whether this story is one of the samples shipped with SAP Analytics Cloud rather than tenant content. */
    Boolean getSapAnalyticsCloudIsSample();
    ...
    /** Subtype of this story as reported by the source, such as COMPOSITE for a story that embeds other stories or TEMPLATE for a story used as the starting point for new ones. Empty for an ordinary story. */
    String getSapAnalyticsCloudStoryKind();
