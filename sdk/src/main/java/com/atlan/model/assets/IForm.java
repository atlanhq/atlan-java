...
public interface IForm {
    ...
    /** Fields in a form. */
    KeywordField FORM_FIELDS = new KeywordField("formFields", "formFields");

    /** Options of the form. */
    KeywordField FORM_OPTIONS = new KeywordField("formOptions", "formOptions");
    ...
    /** Options of the form. */
    Map<String, String> getFormOptions();
