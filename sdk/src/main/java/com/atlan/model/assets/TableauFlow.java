...
public class TableauFlow extends Asset implements ITableauFlow, ITableau, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all TableauFlow assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) TableauFlow assets will be included.
     *
     * @return an asset filter that includes all TableauFlow assets
    ...
    /**
     * Add Atlan tags to a TableauFlow.
     *
     * @param qualifiedName of the TableauFlow
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the TableauFlow
     ...
     * Add Atlan tags to a TableauFlow.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the TableauFlow
     * @param qualifiedName of the TableauFlow
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the TableauFlow
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
