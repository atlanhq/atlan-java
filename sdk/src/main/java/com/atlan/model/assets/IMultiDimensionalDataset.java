...
public interface IMultiDimensionalDataset {
    ...
    public static final String TYPE_NAME = "MultiDimensionalDataset";
    ...
    KeywordField CUBE_DIMENSION_QUALIFIED_NAME =
            new KeywordField("cubeDimensionQualifiedName", "cubeDimensionQualifiedName");
    ...
    /** Unique name of the dimension hierarchy in which this asset exists, or empty if it is itself a hierarchy. */
    String getCubeHierarchyQualifiedName();
