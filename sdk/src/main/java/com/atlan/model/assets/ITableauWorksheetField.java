...
public interface ITableauWorksheetField {

    public static final String TYPE_NAME = "TableauWorksheetField";

    /** Calculated field this worksheet field uses. */
    RelationField TABLEAU_CALCULATED_FIELD = new RelationField("tableauCalculatedField");

    /** Worksheet field used by this dashboard field. */
    RelationField TABLEAU_DASHBOARD_FIELD = new RelationField("tableauDashboardField");

    /** Datasource field this worksheet field uses. */
    RelationField TABLEAU_DATASOURCE_FIELD = new RelationField("tableauDatasourceField");

    /** Name used internally in Tableau to uniquely identify this field. */
    TextField TABLEAU_FULLY_QUALIFIED_NAME = new TextField("tableauFullyQualifiedName", "tableauFullyQualifiedName");
    ...
    TextField TABLEAU_TOP_LEVEL_PROJECT_QUALIFIED_NAME =
            new TextField("tableauTopLevelProjectQualifiedName", "tableauTopLevelProjectQualifiedName");

    /** Unique name of the workbook in which this worksheet field exists. */
    TextField TABLEAU_WORKBOOK_QUALIFIED_NAME =
            new TextField("tableauWorkbookQualifiedName", "tableauWorkbookQualifiedName");

    /** Worksheet in which this field exists. */
    RelationField TABLEAU_WORKSHEET = new RelationField("tableauWorksheet");

    /** Bin size of this field. */
    TextField TABLEAU_WORKSHEET_FIELD_BIN_SIZE =
            new TextField("tableauWorksheetFieldBinSize", "tableauWorksheetFieldBinSize");

    /** Data category of this field. */
    TextField TABLEAU_WORKSHEET_FIELD_DATA_CATEGORY =
    ...
    TextField TABLEAU_WORKSHEET_FIELD_FORMULA =
            new TextField("tableauWorksheetFieldFormula", "tableauWorksheetFieldFormula");

    /** Role of this field, for example: 'dimension', 'measure', or 'unknown'. */
    TextField TABLEAU_WORKSHEET_FIELD_ROLE = new TextField("tableauWorksheetFieldRole", "tableauWorksheetFieldRole");

    /** Type of this worksheet field. */
    TextField TABLEAU_WORKSHEET_FIELD_TYPE = new TextField("tableauWorksheetFieldType", "tableauWorksheetFieldType");

    /** Columns upstream to this field. */
    KeywordField TABLEAU_WORKSHEET_FIELD_UPSTREAM_COLUMNS =
            new KeywordField("tableauWorksheetFieldUpstreamColumns", "tableauWorksheetFieldUpstreamColumns");

    /** Fields upstream to this field. */
    KeywordField TABLEAU_WORKSHEET_FIELD_UPSTREAM_FIELDS =
            new KeywordField("tableauWorksheetFieldUpstreamFields", "tableauWorksheetFieldUpstreamFields");

    /** Tables upstream to this worksheet field. */
    KeywordField TABLEAU_WORKSHEET_FIELD_UPSTREAM_TABLES =
            new KeywordField("tableauWorksheetFieldUpstreamTables", "tableauWorksheetFieldUpstreamTables");

    /** Unique name of the datasource in which this worksheet field exists. */
    TextField TABLEAU_WORKSHEET_QUALIFIED_NAME =
            new TextField("tableauWorksheetQualifiedName", "tableauWorksheetQualifiedName");
    ...
    /** Calculated field this worksheet field uses. */
    default ITableauCalculatedField getTableauCalculatedField() {
        return null;
    }

    /** Worksheet field used by this dashboard field. */
    default ITableauDashboardField getTableauDashboardField() {
        return null;
    }

    /** Datasource field this worksheet field uses. */
    default ITableauDatasourceField getTableauDatasourceField() {
        return null;
    }
    ...
    /** Unique name of the workbook in which this worksheet field exists. */
    String getTableauWorkbookQualifiedName();

    /** Worksheet in which this field exists. */
    default ITableauWorksheet getTableauWorksheet() {
        return null;
    }

    /** Bin size of this field. */
    String getTableauWorksheetFieldBinSize();

    /** Data category of this field. */
    String getTableauWorksheetFieldDataCategory();

    /** Data type of this field. */
    String getTableauWorksheetFieldDataType();

    /** Formula for this field. */
    String getTableauWorksheetFieldFormula();

    /** Role of this field, for example: 'dimension', 'measure', or 'unknown'. */
    String getTableauWorksheetFieldRole();
