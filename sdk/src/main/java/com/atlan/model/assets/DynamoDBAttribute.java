...
public class DynamoDBAttribute extends Asset
    ...
    /** Fixed typeName for DynamoDBAttributes. */
    ...
    /**
     * Builds the minimal object necessary to create a relationship to a DynamoDBAttribute, from a potentially
     * more-complete DynamoDBAttribute object.
     *
     * @return the minimal object necessary to relate to the DynamoDBAttribute
     * @throws InvalidRequestException if any of the minimal set of required properties for a DynamoDBAttribute relationship are not found in the initial object
     */
    @Override
    public DynamoDBAttribute trimToReference() throws InvalidRequestException {
    ...
    /**
     * Start a fluent search that will return all DynamoDBAttribute assets.
     * Additional conditions can be chained onto the returned search before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DynamoDBAttribute assets will be included.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @return a fluent search that includes all DynamoDBAttribute assets
     */
     ...
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @param includeArchived when true, archived (soft-deleted) DynamoDBAttributes will be included
     * @return a fluent search that includes all DynamoDBAttribute assets
     */
    ...
    /**
     * Reference to a DynamoDBAttribute by GUID. Use this to create a relationship to this DynamoDBAttribute,
     * where the relationship should be replaced.
     *
     * @param guid the GUID of the DynamoDBAttribute to reference
     * @return reference to a DynamoDBAttribute that can be used for defining a relationship to a DynamoDBAttribute
     */
    public static DynamoDBAttribute refByGuid(String guid) {
     ...
     * @return reference to a DynamoDBAttribute that can be used for defining a relationship to a DynamoDBAttribute
     */
    public static DynamoDBAttribute refByGuid(String guid, Reference.SaveSemantic semantic) {
        return DynamoDBAttribute._internal().guid(guid).semantic(semantic).build();
    }

    /**
     * Reference to a DynamoDBAttribute by qualifiedName. Use this to create a relationship to this DynamoDBAttribute,
     * where the relationship should be replaced.
     *
     * @param qualifiedName the qualifiedName of the DynamoDBAttribute to reference
     * @return reference to a DynamoDBAttribute that can be used for defining a relationship to a DynamoDBAttribute
     */
    public static DynamoDBAttribute refByQualifiedName(String qualifiedName) {
     ...
     * @return reference to a DynamoDBAttribute that can be used for defining a relationship to a DynamoDBAttribute
     */
    public static DynamoDBAttribute refByQualifiedName(String qualifiedName, Reference.SaveSemantic semantic) {
        return DynamoDBAttribute._internal()
                .uniqueAttributes(
    ...
    /**
     * Retrieves a DynamoDBAttribute by one of its identifiers, complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the DynamoDBAttribute to retrieve, either its GUID or its full qualifiedName
     * @return the requested full DynamoDBAttribute, complete with all of its relationships
     ...
     */
    @JsonIgnore
    public static DynamoDBAttribute get(AtlanClient client, String id) throws AtlanException {
        return get(client, id, false);
    }

    /**
     * Retrieves a DynamoDBAttribute by one of its identifiers, optionally complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the DynamoDBAttribute to retrieve, either its GUID or its full qualifiedName
     * @param includeAllRelationships if true, all the asset's relationships will also be retrieved; if false, no relationships will be retrieved
     * @return the requested full DynamoDBAttribute, optionally complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DynamoDBAttribute does not exist or the provided GUID is not a DynamoDBAttribute
     */
    @JsonIgnore
    public static DynamoDBAttribute get(AtlanClient client, String id, boolean includeAllRelationships)
        ...
        if (id == null) {
            ...
            } else if (asset instanceof DynamoDBAttribute) {
                return (DynamoDBAttribute) asset;
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
            Asset asset = Asset.get(client, TYPE_NAME, id, includeAllRelationships);
            if (asset instanceof DynamoDBAttribute) {
                return (DynamoDBAttribute) asset;
            } else {
    ...
    /**
     * Retrieves a DynamoDBAttribute by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the DynamoDBAttribute to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the DynamoDBAttribute, including any relationships
     * @return the requested DynamoDBAttribute, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DynamoDBAttribute does not exist or the provided GUID is not a DynamoDBAttribute
     */
    @JsonIgnore
     ...
     * @param id of the DynamoDBAttribute to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the DynamoDBAttribute, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the DynamoDBAttribute
     * @return the requested DynamoDBAttribute, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DynamoDBAttribute does not exist or the provided GUID is not a DynamoDBAttribute
     */
    @JsonIgnore
    public static DynamoDBAttribute get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = DynamoDBAttribute.select(client)
                    .where(DynamoDBAttribute.GUID.eq(id))
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof DynamoDBAttribute) {
                return (DynamoDBAttribute) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
            Optional<Asset> asset = DynamoDBAttribute.select(client)
                    .where(DynamoDBAttribute.QUALIFIED_NAME.eq(id))
                    .includesOnResults(attributes)
                    .includesOnRelations(attributesOnRelated)
                    .includeRelationshipAttributes(true)
                    .pageSize(1)
    ...
    /**
     * Restore the archived (soft-deleted) DynamoDBAttribute to active.
     *
     * @param client connectivity to the Atlan tenant on which to restore the asset
     * @param qualifiedName for the DynamoDBAttribute
     * @return true if the DynamoDBAttribute is now active, and false otherwise
    ...
    /**
     * Builds the minimal object necessary to update a DynamoDBAttribute.
     *
     * @param qualifiedName of the DynamoDBAttribute
     * @param name of the DynamoDBAttribute
     * @return the minimal request necessary to update the DynamoDBAttribute, as a builder
     */
    public static DynamoDBAttributeBuilder<?, ?> updater(String qualifiedName, String name) {
        return DynamoDBAttribute._internal()
    ...
    /**
     * Builds the minimal object necessary to apply an update to a DynamoDBAttribute,
     * from a potentially more-complete DynamoDBAttribute object.
     *
     * @return the minimal object necessary to update the DynamoDBAttribute, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a DynamoDBAttribute are not present in the initial object
     */
    @Override
    public DynamoDBAttributeBuilder<?, ?> trimToRequired() throws InvalidRequestException {
    ...
    /**
     * Remove the system description from a DynamoDBAttribute.
     *
    ...
    /**
     * Remove the user's description from a DynamoDBAttribute.
     *
     * @param client connectivity to the Atlan tenant on which to remove the asset's description
     * @param qualifiedName of the DynamoDBAttribute
     * @param name of the DynamoDBAttribute
     ...
     * @throws AtlanException on any API problems
     */
    public static DynamoDBAttribute removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (DynamoDBAttribute) Asset.removeUserDescription(client, updater(qualifiedName, name));
    }

    /**
     * Remove the owners from a DynamoDBAttribute.
     *
     * @param client connectivity to the Atlan tenant from which to remove the DynamoDBAttribute's owners
     * @param qualifiedName of the DynamoDBAttribute
     * @param name of the DynamoDBAttribute
     * @return the updated DynamoDBAttribute, or null if the removal failed
     * @throws AtlanException on any API problems
    ...
    /**
     * Update the certificate on a DynamoDBAttribute.
     *
     * @param client connectivity to the Atlan tenant on which to update the DynamoDBAttribute's certificate
     * @param qualifiedName of the DynamoDBAttribute
     * @param certificate to use
     * @param message (optional) message, or null if no message
     * @return the updated DynamoDBAttribute, or null if the update failed
     * @throws AtlanException on any API problems
     */
    ...
    /**
     * Remove the certificate from a DynamoDBAttribute.
     *
     * @param client connectivity to the Atlan tenant from which to remove the DynamoDBAttribute's certificate
     * @param qualifiedName of the DynamoDBAttribute
     * @param name of the DynamoDBAttribute
     * @return the updated DynamoDBAttribute, or null if the removal failed
     * @throws AtlanException on any API problems
    ...
    /**
     * Update the announcement on a DynamoDBAttribute.
     *
     * @param client connectivity to the Atlan tenant on which to update the DynamoDBAttribute's announcement
     * @param qualifiedName of the DynamoDBAttribute
    ...
    /**
     * Remove the announcement from a DynamoDBAttribute.
     *
     * @param client connectivity to the Atlan client from which to remove the DynamoDBAttribute's announcement
     * @param qualifiedName of the DynamoDBAttribute
     * @param name of the DynamoDBAttribute
     * @return the updated DynamoDBAttribute, or null if the removal failed
     * @throws AtlanException on any API problems
     */
    public static DynamoDBAttribute removeAnnouncement(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (DynamoDBAttribute) Asset.removeAnnouncement(client, updater(qualifiedName, name));
    }

    /**
     * Replace the terms linked to the DynamoDBAttribute.
     *
     * @param client connectivity to the Atlan tenant on which to replace the DynamoDBAttribute's assigned terms
     * @param qualifiedName for the DynamoDBAttribute
     * @param name human-readable name of the DynamoDBAttribute
     * @param terms the list of terms to replace on the DynamoDBAttribute, or null to remove all terms from the DynamoDBAttribute
    ...
    /**
     * Link additional terms to the DynamoDBAttribute, without replacing existing terms linked to the DynamoDBAttribute.
     * Note: this operation must make two API calls — one to retrieve the DynamoDBAttribute's existing terms,
     * and a second to append the new terms.
     *
     * @param client connectivity to the Atlan tenant on which to append terms to the DynamoDBAttribute
     * @param qualifiedName for the DynamoDBAttribute
     * @param terms the list of terms to append to the DynamoDBAttribute
     * @return the DynamoDBAttribute that was updated  (note that it will NOT contain details of the appended terms)
     * @throws AtlanException on any API problems
     * @deprecated see {@link com.atlan.model.assets.Asset.AssetBuilder#appendAssignedTerm(GlossaryTerm)}
     */
    @Deprecated
    public static DynamoDBAttribute appendTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
        return (DynamoDBAttribute) Asset.appendTerms(client, TYPE_NAME, qualifiedName, terms);
    }

    /**
     * Remove terms from a DynamoDBAttribute, without replacing all existing terms linked to the DynamoDBAttribute.
     * Note: this operation must make two API calls — one to retrieve the DynamoDBAttribute's existing terms,
     * and a second to remove the provided terms.
     *
     * @param client connectivity to the Atlan tenant from which to remove terms from the DynamoDBAttribute
     * @param qualifiedName for the DynamoDBAttribute
     * @param terms the list of terms to remove from the DynamoDBAttribute, which must be referenced by GUID
     * @return the DynamoDBAttribute that was updated (note that it will NOT contain details of the resulting terms)
     * @throws AtlanException on any API problems
     * @deprecated see {@link com.atlan.model.assets.Asset.AssetBuilder#removeAssignedTerm(GlossaryTerm)}
     */
    @Deprecated
    public static DynamoDBAttribute removeTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
        return (DynamoDBAttribute) Asset.removeTerms(client, TYPE_NAME, qualifiedName, terms);
    }

    /**
     * Add Atlan tags to a DynamoDBAttribute, without replacing existing Atlan tags linked to the DynamoDBAttribute.
     * Note: this operation must make two API calls — one to retrieve the DynamoDBAttribute's existing Atlan tags,
     * and a second to append the new Atlan tags.
     *
     * @param client connectivity to the Atlan tenant on which to append Atlan tags to the DynamoDBAttribute
     * @param qualifiedName of the DynamoDBAttribute
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems
     * @return the updated DynamoDBAttribute
    ...
    public static DynamoDBAttribute appendAtlanTags(
            ...
            throws AtlanException {
        return (DynamoDBAttribute) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
    ...
    /**
     * Remove an Atlan tag from a DynamoDBAttribute.
     *
     * @param client connectivity to the Atlan tenant from which to remove an Atlan tag from a DynamoDBAttribute
     * @param qualifiedName of the DynamoDBAttribute
     * @param atlanTagName human-readable name of the Atlan tag to remove
     * @throws AtlanException on any API problems, or if the Atlan tag does not exist on the DynamoDBAttribute
