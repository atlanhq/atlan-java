...
public interface ITypeRegistryNamespace {

    public static final String TYPE_NAME = "TypeRegistryNamespace";

    /** Asset types contained within the namespace. */
    RelationField TYPE_REGISTRY_ENTITIES = new RelationField("typeRegistryEntities");

    /** Enumerations contained wtihin the namespace. */
    RelationField TYPE_REGISTRY_ENUMERATIONS = new RelationField("typeRegistryEnumerations");

    /** Unique string to prefix all objects in the namespace with, to ensure their uniqueness. */
    KeywordField TYPE_REGISTRY_PREFIX = new KeywordField("typeRegistryPrefix", "typeRegistryPrefix");

    /** Relationships contained within the namespace. */
    RelationField TYPE_REGISTRY_RELATIONSHIPS = new RelationField("typeRegistryRelationships");

    /** Structs contained within the namespace. */
    RelationField TYPE_REGISTRY_STRUCTS = new RelationField("typeRegistryStructs");

    /** Unpublished workspaces contained in this namespace. */
    RelationField TYPE_REGISTRY_WORKSPACES = new RelationField("typeRegistryWorkspaces");
    ...
    /** Asset types contained within the namespace. */
    SortedSet<ITypeRegistryPublishedEntity> getTypeRegistryEntities();

    /** Enumerations contained wtihin the namespace. */
    SortedSet<ITypeRegistryEnum> getTypeRegistryEnumerations();

    /** Whether this portion of the metamodel should no longer be used. */
    Boolean getTypeRegistryIsDeprecated();

    /** Unique string to prefix all objects in the namespace with, to ensure their uniqueness. */
    String getTypeRegistryPrefix();

    /** Relationships contained within the namespace. */
    SortedSet<ITypeRegistryPublishedRelationship> getTypeRegistryRelationships();
    ...
    /** Structs contained within the namespace. */
    SortedSet<ITypeRegistryStruct> getTypeRegistryStructs();

    /** Unpublished workspaces contained in this namespace. */
    SortedSet<ITypeRegistryWorkspace> getTypeRegistryWorkspaces();
