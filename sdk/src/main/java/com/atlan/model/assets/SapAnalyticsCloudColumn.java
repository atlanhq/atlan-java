...
public class SapAnalyticsCloudColumn extends Asset
        implements ISapAnalyticsCloudColumn, IColumn, ISapAnalyticsCloud, ISQL, ISAP, ICatalog, IAsset, IReferenceable {
    private static final long serialVersionUID = 2L;

    public static final String TYPE_NAME = "SapAnalyticsCloudColumn";

    /** Fixed typeName for SapAnalyticsCloudColumns. */
    ...
    /**
     * Builds the minimal object necessary to create a relationship to a SapAnalyticsCloudColumn, from a potentially
     * more-complete SapAnalyticsCloudColumn object.
     *
     * @return the minimal object necessary to relate to the SapAnalyticsCloudColumn
     * @throws InvalidRequestException if any of the minimal set of required properties for a SapAnalyticsCloudColumn relationship are not found in the initial object
     */
    @Override
    public SapAnalyticsCloudColumn trimToReference() throws InvalidRequestException {
    ...
    /**
     * Start a fluent search that will return all SapAnalyticsCloudColumn assets.
     * Additional conditions can be chained onto the returned search before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SapAnalyticsCloudColumn assets will be included.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @return a fluent search that includes all SapAnalyticsCloudColumn assets
     */
     ...
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @param includeArchived when true, archived (soft-deleted) SapAnalyticsCloudColumns will be included
     * @return a fluent search that includes all SapAnalyticsCloudColumn assets
     */
    ...
    /**
     * Reference to a SapAnalyticsCloudColumn by GUID. Use this to create a relationship to this SapAnalyticsCloudColumn,
     * where the relationship should be replaced.
     *
     * @param guid the GUID of the SapAnalyticsCloudColumn to reference
     * @return reference to a SapAnalyticsCloudColumn that can be used for defining a relationship to a SapAnalyticsCloudColumn
     */
    public static SapAnalyticsCloudColumn refByGuid(String guid) {
     ...
     * @return reference to a SapAnalyticsCloudColumn that can be used for defining a relationship to a SapAnalyticsCloudColumn
     */
    public static SapAnalyticsCloudColumn refByGuid(String guid, Reference.SaveSemantic semantic) {
        return SapAnalyticsCloudColumn._internal().guid(guid).semantic(semantic).build();
    }

    /**
     * Reference to a SapAnalyticsCloudColumn by qualifiedName. Use this to create a relationship to this SapAnalyticsCloudColumn,
     * where the relationship should be replaced.
     *
     * @param qualifiedName the qualifiedName of the SapAnalyticsCloudColumn to reference
     * @return reference to a SapAnalyticsCloudColumn that can be used for defining a relationship to a SapAnalyticsCloudColumn
     */
    public static SapAnalyticsCloudColumn refByQualifiedName(String qualifiedName) {
     ...
     * @return reference to a SapAnalyticsCloudColumn that can be used for defining a relationship to a SapAnalyticsCloudColumn
     */
    public static SapAnalyticsCloudColumn refByQualifiedName(String qualifiedName, Reference.SaveSemantic semantic) {
        return SapAnalyticsCloudColumn._internal()
                .uniqueAttributes(
    ...
    /**
     * Retrieves a SapAnalyticsCloudColumn by one of its identifiers, complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the SapAnalyticsCloudColumn to retrieve, either its GUID or its full qualifiedName
     * @return the requested full SapAnalyticsCloudColumn, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SapAnalyticsCloudColumn does not exist or the provided GUID is not a SapAnalyticsCloudColumn
     */
    @JsonIgnore
    public static SapAnalyticsCloudColumn get(AtlanClient client, String id) throws AtlanException {
        return get(client, id, false);
    }

    /**
     * Retrieves a SapAnalyticsCloudColumn by one of its identifiers, optionally complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the SapAnalyticsCloudColumn to retrieve, either its GUID or its full qualifiedName
     * @param includeAllRelationships if true, all the asset's relationships will also be retrieved; if false, no relationships will be retrieved
     * @return the requested full SapAnalyticsCloudColumn, optionally complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SapAnalyticsCloudColumn does not exist or the provided GUID is not a SapAnalyticsCloudColumn
     */
    @JsonIgnore
    public static SapAnalyticsCloudColumn get(AtlanClient client, String id, boolean includeAllRelationships)
        ...
        if (id == null) {
            ...
            } else if (asset instanceof SapAnalyticsCloudColumn) {
            ...
            if (asset instanceof SapAnalyticsCloudColumn) {
                return (SapAnalyticsCloudColumn) asset;
            } else {
    ...
    /**
     * Retrieves a SapAnalyticsCloudColumn by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the SapAnalyticsCloudColumn to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the SapAnalyticsCloudColumn, including any relationships
     * @return the requested SapAnalyticsCloudColumn, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SapAnalyticsCloudColumn does not exist or the provided GUID is not a SapAnalyticsCloudColumn
     */
    @JsonIgnore
    public static SapAnalyticsCloudColumn get(AtlanClient client, String id, Collection<AtlanField> attributes)
            throws AtlanException {
     ...
     * @param id of the SapAnalyticsCloudColumn to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the SapAnalyticsCloudColumn, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the SapAnalyticsCloudColumn
     * @return the requested SapAnalyticsCloudColumn, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SapAnalyticsCloudColumn does not exist or the provided GUID is not a SapAnalyticsCloudColumn
     */
    @JsonIgnore
    public static SapAnalyticsCloudColumn get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = SapAnalyticsCloudColumn.select(client)
                    .where(SapAnalyticsCloudColumn.GUID.eq(id))
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof SapAnalyticsCloudColumn) {
                return (SapAnalyticsCloudColumn) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
            Optional<Asset> asset = SapAnalyticsCloudColumn.select(client)
                    .where(SapAnalyticsCloudColumn.QUALIFIED_NAME.eq(id))
                    .includesOnResults(attributes)
                    .includesOnRelations(attributesOnRelated)
                    .includeRelationshipAttributes(true)
                    .pageSize(1)
    ...
    /**
     * Restore the archived (soft-deleted) SapAnalyticsCloudColumn to active.
     *
     * @param client connectivity to the Atlan tenant on which to restore the asset
     * @param qualifiedName for the SapAnalyticsCloudColumn
     * @return true if the SapAnalyticsCloudColumn is now active, and false otherwise
    ...
    /**
     * Builds the minimal object necessary to update a SapAnalyticsCloudColumn.
     *
     * @param qualifiedName of the SapAnalyticsCloudColumn
     * @param name of the SapAnalyticsCloudColumn
     * @return the minimal request necessary to update the SapAnalyticsCloudColumn, as a builder
     */
    public static SapAnalyticsCloudColumnBuilder<?, ?> updater(String qualifiedName, String name) {
        return SapAnalyticsCloudColumn._internal()
    ...
    /**
     * Builds the minimal object necessary to apply an update to a SapAnalyticsCloudColumn,
     * from a potentially more-complete SapAnalyticsCloudColumn object.
     *
     * @return the minimal object necessary to update the SapAnalyticsCloudColumn, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a SapAnalyticsCloudColumn are not present in the initial object
     */
    @Override
    public SapAnalyticsCloudColumnBuilder<?, ?> trimToRequired() throws InvalidRequestException {
    ...
    public abstract static class SapAnalyticsCloudColumnBuilder<
                    C extends SapAnalyticsCloudColumn, B extends SapAnalyticsCloudColumnBuilder<C, B>>
            extends Asset.AssetBuilder<C, B> {}

    /**
     * Remove the system description from a SapAnalyticsCloudColumn.
     *
     * @param client connectivity to the Atlan tenant on which to remove the asset's description
     * @param qualifiedName of the SapAnalyticsCloudColumn
     * @param name of the SapAnalyticsCloudColumn
     * @return the updated SapAnalyticsCloudColumn, or null if the removal failed
     * @throws AtlanException on any API problems
     */
    public static SapAnalyticsCloudColumn removeDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.removeDescription(client, updater(qualifiedName, name));
    }

    /**
     * Remove the user's description from a SapAnalyticsCloudColumn.
     *
     * @param client connectivity to the Atlan tenant on which to remove the asset's description
     * @param qualifiedName of the SapAnalyticsCloudColumn
     * @param name of the SapAnalyticsCloudColumn
     ...
     * @throws AtlanException on any API problems
     */
    public static SapAnalyticsCloudColumn removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.removeUserDescription(client, updater(qualifiedName, name));
    }

    /**
     * Remove the owners from a SapAnalyticsCloudColumn.
     *
     * @param client connectivity to the Atlan tenant from which to remove the SapAnalyticsCloudColumn's owners
     * @param qualifiedName of the SapAnalyticsCloudColumn
     * @param name of the SapAnalyticsCloudColumn
     * @return the updated SapAnalyticsCloudColumn, or null if the removal failed
     * @throws AtlanException on any API problems
     */
    public static SapAnalyticsCloudColumn removeOwners(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.removeOwners(client, updater(qualifiedName, name));
    }

    /**
     * Update the certificate on a SapAnalyticsCloudColumn.
     *
     * @param client connectivity to the Atlan tenant on which to update the SapAnalyticsCloudColumn's certificate
     * @param qualifiedName of the SapAnalyticsCloudColumn
     * @param certificate to use
     * @param message (optional) message, or null if no message
     * @return the updated SapAnalyticsCloudColumn, or null if the update failed
     * @throws AtlanException on any API problems
     */
    public static SapAnalyticsCloudColumn updateCertificate(
    ...
    /**
     * Remove the certificate from a SapAnalyticsCloudColumn.
     *
     * @param client connectivity to the Atlan tenant from which to remove the SapAnalyticsCloudColumn's certificate
     * @param qualifiedName of the SapAnalyticsCloudColumn
     * @param name of the SapAnalyticsCloudColumn
     * @return the updated SapAnalyticsCloudColumn, or null if the removal failed
     * @throws AtlanException on any API problems
     */
    public static SapAnalyticsCloudColumn removeCertificate(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.removeCertificate(client, updater(qualifiedName, name));
    }

    /**
     * Update the announcement on a SapAnalyticsCloudColumn.
     *
     * @param client connectivity to the Atlan tenant on which to update the SapAnalyticsCloudColumn's announcement
     * @param qualifiedName of the SapAnalyticsCloudColumn
     ...
     * @throws AtlanException on any API problems
     */
    public static SapAnalyticsCloudColumn updateAnnouncement(
    ...
    /**
     * Remove the announcement from a SapAnalyticsCloudColumn.
     *
     * @param client connectivity to the Atlan client from which to remove the SapAnalyticsCloudColumn's announcement
     * @param qualifiedName of the SapAnalyticsCloudColumn
     * @param name of the SapAnalyticsCloudColumn
     * @return the updated SapAnalyticsCloudColumn, or null if the removal failed
     * @throws AtlanException on any API problems
     */
    public static SapAnalyticsCloudColumn removeAnnouncement(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.removeAnnouncement(client, updater(qualifiedName, name));
    }

    /**
     * Replace the terms linked to the SapAnalyticsCloudColumn.
     *
     * @param client connectivity to the Atlan tenant on which to replace the SapAnalyticsCloudColumn's assigned terms
     * @param qualifiedName for the SapAnalyticsCloudColumn
     * @param name human-readable name of the SapAnalyticsCloudColumn
     * @param terms the list of terms to replace on the SapAnalyticsCloudColumn, or null to remove all terms from the SapAnalyticsCloudColumn
     * @return the SapAnalyticsCloudColumn that was updated (note that it will NOT contain details of the replaced terms)
     * @throws AtlanException on any API problems
     */
    public static SapAnalyticsCloudColumn replaceTerms(
            AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms) throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.replaceTerms(client, updater(qualifiedName, name), terms);
    }

    /**
     * Link additional terms to the SapAnalyticsCloudColumn, without replacing existing terms linked to the SapAnalyticsCloudColumn.
     * Note: this operation must make two API calls — one to retrieve the SapAnalyticsCloudColumn's existing terms,
     * and a second to append the new terms.
     *
     * @param client connectivity to the Atlan tenant on which to append terms to the SapAnalyticsCloudColumn
     * @param qualifiedName for the SapAnalyticsCloudColumn
     * @param terms the list of terms to append to the SapAnalyticsCloudColumn
     * @return the SapAnalyticsCloudColumn that was updated  (note that it will NOT contain details of the appended terms)
     * @throws AtlanException on any API problems
     * @deprecated see {@link com.atlan.model.assets.Asset.AssetBuilder#appendAssignedTerm(GlossaryTerm)}
     */
    @Deprecated
    public static SapAnalyticsCloudColumn appendTerms(
            AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.appendTerms(client, TYPE_NAME, qualifiedName, terms);
    }

    /**
     * Remove terms from a SapAnalyticsCloudColumn, without replacing all existing terms linked to the SapAnalyticsCloudColumn.
     * Note: this operation must make two API calls — one to retrieve the SapAnalyticsCloudColumn's existing terms,
     * and a second to remove the provided terms.
     *
     * @param client connectivity to the Atlan tenant from which to remove terms from the SapAnalyticsCloudColumn
     * @param qualifiedName for the SapAnalyticsCloudColumn
     * @param terms the list of terms to remove from the SapAnalyticsCloudColumn, which must be referenced by GUID
     * @return the SapAnalyticsCloudColumn that was updated (note that it will NOT contain details of the resulting terms)
     * @throws AtlanException on any API problems
     * @deprecated see {@link com.atlan.model.assets.Asset.AssetBuilder#removeAssignedTerm(GlossaryTerm)}
     */
    @Deprecated
    public static SapAnalyticsCloudColumn removeTerms(
            AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.removeTerms(client, TYPE_NAME, qualifiedName, terms);
    }

    /**
     * Add Atlan tags to a SapAnalyticsCloudColumn, without replacing existing Atlan tags linked to the SapAnalyticsCloudColumn.
     * Note: this operation must make two API calls — one to retrieve the SapAnalyticsCloudColumn's existing Atlan tags,
     * and a second to append the new Atlan tags.
     *
     * @param client connectivity to the Atlan tenant on which to append Atlan tags to the SapAnalyticsCloudColumn
     * @param qualifiedName of the SapAnalyticsCloudColumn
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems
     * @return the updated SapAnalyticsCloudColumn
     * @deprecated see {@link com.atlan.model.assets.Asset.AssetBuilder#appendAtlanTags(List)}
     */
    @Deprecated
    public static SapAnalyticsCloudColumn appendAtlanTags(
            AtlanClient client, String qualifiedName, List<String> atlanTagNames) throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.appendAtlanTags(client, TYPE_NAME, qualifiedName, atlanTagNames);
    }
    ...
    public static SapAnalyticsCloudColumn appendAtlanTags(
            ...
            throws AtlanException {
        return (SapAnalyticsCloudColumn) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
    ...
    /**
     * Remove an Atlan tag from a SapAnalyticsCloudColumn.
     *
     * @param client connectivity to the Atlan tenant from which to remove an Atlan tag from a SapAnalyticsCloudColumn
     * @param qualifiedName of the SapAnalyticsCloudColumn
     * @param atlanTagName human-readable name of the Atlan tag to remove
     * @throws AtlanException on any API problems, or if the Atlan tag does not exist on the SapAnalyticsCloudColumn
