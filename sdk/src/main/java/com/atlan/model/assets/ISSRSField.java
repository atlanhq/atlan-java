...
public interface ISSRSField {

    public static final String TYPE_NAME = "SSRSField";

    /** Data set containing the field. */
    RelationField SSRS_DATA_SET = new RelationField("ssrsDataSet");

    /** Whether the field is calculated. */
    BooleanField SSRS_FIELD_CALCULATED_FIELD = new BooleanField("ssrsFieldCalculatedField", "ssrsFieldCalculatedField");

    /** Whether the field is connected. */
    BooleanField SSRS_FIELD_CONNECTED = new BooleanField("ssrsFieldConnected", "ssrsFieldConnected");

    /** Data group for the field. */
    KeywordField SSRS_FIELD_DATA_GROUP = new KeywordField("ssrsFieldDataGroup", "ssrsFieldDataGroup");

    /** Whether the field is a database field. */
    BooleanField SSRS_FIELD_DATABASE_FIELD = new BooleanField("ssrsFieldDatabaseField", "ssrsFieldDatabaseField");

    /** Data type of the field. */
    KeywordField SSRS_FIELD_DATATYPE = new KeywordField("ssrsFieldDatatype", "ssrsFieldDatatype");

    /** Error code for the field. */
    KeywordField SSRS_FIELD_ERROR_CODE = new KeywordField("ssrsFieldErrorCode", "ssrsFieldErrorCode");

    /** Function applied to the field. */
    KeywordField SSRS_FIELD_FUNCTION = new KeywordField("ssrsFieldFunction", "ssrsFieldFunction");

    /** Log messages for the field. */
    KeywordField SSRS_FIELD_LOG_MESSAGES = new KeywordField("ssrsFieldLogMessages", "ssrsFieldLogMessages");

    /** Ordinal position of the field. */
    NumericField SSRS_FIELD_ORDINAL_POSITION = new NumericField("ssrsFieldOrdinalPosition", "ssrsFieldOrdinalPosition");

    /** Referenced column names for the field. */
    KeywordField SSRS_FIELD_REFERENCED_COLUMN_NAMES =
            new KeywordField("ssrsFieldReferencedColumnNames", "ssrsFieldReferencedColumnNames");

    /** Report source for the field. */
    KeywordField SSRS_FIELD_REPORT_SOURCE = new KeywordField("ssrsFieldReportSource", "ssrsFieldReportSource");

    /** SQL transform expression for the field. */
    KeywordField SSRS_FIELD_SQL_TRANSFORM_EXPRESSION =
            new KeywordField("ssrsFieldSqlTransformExpression", "ssrsFieldSqlTransformExpression");
    ...
    /** Data set containing the field. */
    default ISSRSDataSet getSsrsDataSet() {
        return null;
    }
    ...
    /** Whether the field is calculated. */
    Boolean getSsrsFieldCalculatedField();

    /** Whether the field is connected. */
    Boolean getSsrsFieldConnected();

    /** Data group for the field. */
    String getSsrsFieldDataGroup();

    /** Whether the field is a database field. */
    Boolean getSsrsFieldDatabaseField();

    /** Data type of the field. */
    String getSsrsFieldDatatype();

    /** Error code for the field. */
    String getSsrsFieldErrorCode();

    /** Function applied to the field. */
    String getSsrsFieldFunction();

    /** Log messages for the field. */
    String getSsrsFieldLogMessages();

    /** Ordinal position of the field. */
    Integer getSsrsFieldOrdinalPosition();

    /** Referenced column names for the field. */
    SortedSet<String> getSsrsFieldReferencedColumnNames();

    /** Report source for the field. */
    String getSsrsFieldReportSource();

    /** SQL transform expression for the field. */
    String getSsrsFieldSqlTransformExpression();
