...
public interface IDataverseAttribute {

    public static final String TYPE_NAME = "DataverseAttribute";

    /** Indicator if DataverseAttribute is the primary key. */
    BooleanField DATAVERSE_ATTRIBUTE_IS_PRIMARY_ID = new BooleanField("dataverseAttributeIsPrimaryId", "dataverseAttributeIsPrimaryId");

    /** Indicator if DataverseAttribute is searchable. */
    BooleanField DATAVERSE_ATTRIBUTE_IS_SEARCHABLE = new BooleanField("dataverseAttributeIsSearchable", "dataverseAttributeIsSearchable");

    /** Schema Name of the DataverseAttribute. */
    KeywordField DATAVERSE_ATTRIBUTE_SCHEMA_NAME = new KeywordField("dataverseAttributeSchemaName", "dataverseAttributeSchemaName");

    /** Type of the DataverseAttribute. */
    KeywordField DATAVERSE_ATTRIBUTE_TYPE = new KeywordField("dataverseAttributeType", "dataverseAttributeType");

    /** DataverseEntity asset containing this DataverseAttribute. */
    RelationField DATAVERSE_ENTITY = new RelationField("dataverseEntity");

    /** Entity Qualified Name of the DataverseAttribute. */
    KeywordField DATAVERSE_ENTITY_QUALIFIED_NAME = new KeywordField("dataverseEntityQualifiedName", "dataverseEntityQualifiedName");
    ...
    /** Indicator if DataverseAttribute is the primary key. */
    Boolean getDataverseAttributeIsPrimaryId();

    /** Indicator if DataverseAttribute is searchable. */
    Boolean getDataverseAttributeIsSearchable();

    /** Schema Name of the DataverseAttribute. */
    String getDataverseAttributeSchemaName();

    /** Type of the DataverseAttribute. */
    String getDataverseAttributeType();

    /** DataverseEntity asset containing this DataverseAttribute. */
    IDataverseEntity getDataverseEntity();

    /** Entity Qualified Name of the DataverseAttribute. */
    String getDataverseEntityQualifiedName();

    /** Indicator if DataverseEntity has auditing enabled. */
    Boolean getDataverseIsAuditEnabled();

    /** Indicator if DataverseEntity is custom built. */
    Boolean getDataverseIsCustom();

    /** Indicator if DataverseEntity is customizable. */
    Boolean getDataverseIsCustomizable();
