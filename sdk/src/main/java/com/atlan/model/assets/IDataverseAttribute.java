...
public interface IDataverseAttribute {
    ...
    BooleanField DATAVERSE_ATTRIBUTE_IS_PRIMARY_ID =
            new BooleanField("dataverseAttributeIsPrimaryId", "dataverseAttributeIsPrimaryId");

    /** Indicator if DataverseAttribute is searchable. */
    BooleanField DATAVERSE_ATTRIBUTE_IS_SEARCHABLE =
            new BooleanField("dataverseAttributeIsSearchable", "dataverseAttributeIsSearchable");

    /** Schema Name of the DataverseAttribute. */
    KeywordField DATAVERSE_ATTRIBUTE_SCHEMA_NAME =
            new KeywordField("dataverseAttributeSchemaName", "dataverseAttributeSchemaName");
    ...
    KeywordField DATAVERSE_ENTITY_QUALIFIED_NAME =
            new KeywordField("dataverseEntityQualifiedName", "dataverseEntityQualifiedName");
