...
public interface IWorkflow {
    ...
    KeywordField WORKFLOW_TEMPLATE_GUID = new KeywordField("workflowTemplateGuid", "workflowTemplateGuid");

    /** Type of the workflow. */
    KeywordField WORKFLOW_TYPE = new KeywordField("workflowType", "workflowType");

    /** Username of the user who updated this workflow. */
    KeywordField WORKFLOW_UPDATED_BY = new KeywordField("workflowUpdatedBy", "workflowUpdatedBy");
