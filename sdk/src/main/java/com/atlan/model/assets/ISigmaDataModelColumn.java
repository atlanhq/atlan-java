...
public interface ISigmaDataModelColumn {
    ...
    KeywordField SIGMA_DATA_MODEL_COLUMN_DATA_TYPE =
            new KeywordField("sigmaDataModelColumnDataType", "sigmaDataModelColumnDataType");
    ...
    KeywordTextField SIGMA_DATA_MODEL_NAME =
            new KeywordTextField("sigmaDataModelName", "sigmaDataModelName.keyword", "sigmaDataModelName");

    /** Unique name of the Sigma data model in which this column exists. */
    KeywordTextField SIGMA_DATA_MODEL_QUALIFIED_NAME = new KeywordTextField(
            "sigmaDataModelQualifiedName", "sigmaDataModelQualifiedName.keyword", "sigmaDataModelQualifiedName");
    ...
    /** Data model in which this data model column exists. */
    default ISigmaDataModel getSigmaDataModel() {
        return null;
    }

    /** Data type of this column as reported by Sigma (vocabulary: datetime, integer, number, text, variant). Flattened by the connector from the API's nested type.type field. */
    String getSigmaDataModelColumnDataType();

    /** Formula expression that defines this column (Sigma's formula language). Truncated to 100,000 characters by the connector for parity with sigmaDataElementFieldFormula. */
    String getSigmaDataModelColumnFormula();

    /** Simple name of the Sigma data model in which this column exists. */
    String getSigmaDataModelName();

    /** Unique name of the Sigma data model in which this column exists. */
    String getSigmaDataModelQualifiedName();
