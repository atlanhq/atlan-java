...
public interface IDremio {

    public static final String TYPE_NAME = "Dremio";
    ...
    KeywordField DREMIO_FOLDER_HIERARCHY = new KeywordField("dremioFolderHierarchy", "dremioFolderHierarchy");

    /** Source ID of this asset in Dremio. */
    KeywordField DREMIO_ID = new KeywordField("dremioId", "dremioId");

    /** Dremio Labels associated with this asset. */
    KeywordField DREMIO_LABELS = new KeywordField("dremioLabels", "dremioLabels");

    /** Unique qualified name of the immediate parent folder containing this asset. */
    KeywordField DREMIO_PARENT_FOLDER_QUALIFIED_NAME =
            new KeywordField("dremioParentFolderQualifiedName", "dremioParentFolderQualifiedName");

    /** Simple name of the Dremio Source containing this asset. */
    KeywordField DREMIO_SOURCE_NAME = new KeywordField("dremioSourceName", "dremioSourceName");

    /** Unique qualified name of the Dremio Source containing this asset. */
    KeywordField DREMIO_SOURCE_QUALIFIED_NAME =
            new KeywordField("dremioSourceQualifiedName", "dremioSourceQualifiedName");

    /** Simple name of the Dremio Space containing this asset. */
    KeywordField DREMIO_SPACE_NAME = new KeywordField("dremioSpaceName", "dremioSpaceName");

    /** Unique qualified name of the Dremio Space containing this asset. */
    KeywordField DREMIO_SPACE_QUALIFIED_NAME = new KeywordField("dremioSpaceQualifiedName", "dremioSpaceQualifiedName");
