...
public class SnowflakeDynamicTable extends Asset
    ...
    /**
     * Builds the minimal object necessary to apply an update to a SnowflakeDynamicTable,
     * from a potentially more-complete SnowflakeDynamicTable object.
     *
     * @return the minimal object necessary to update the SnowflakeDynamicTable, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a SnowflakeDynamicTable are not present in the initial object
     */
    @Override
