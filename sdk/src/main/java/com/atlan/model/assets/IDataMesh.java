...
public interface IDataMesh {
    ...
    KeywordField MESH_ABBREVIATION = new KeywordField("meshAbbreviation", "meshAbbreviation");

    /** URL for an image used as the cover for this asset. */
    KeywordField MESH_COVER_IMAGE_URL = new KeywordField("meshCoverImageUrl", "meshCoverImageUrl");

    /** Unique business key for this asset. */
    KeywordField MESH_SLUG = new KeywordField("meshSlug", "meshSlug");
