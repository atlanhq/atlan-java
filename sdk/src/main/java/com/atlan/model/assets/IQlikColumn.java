...
public interface IQlikColumn {

    public static final String TYPE_NAME = "QlikColumn";

    /** Parent chart containing the columns. */
    RelationField QLIK_CHART = new RelationField("qlikChart");

    /** Qlik Column name. */
    KeywordField QLIK_COLUMN_NAME = new KeywordField("qlikColumnName", "qlikColumnName");

    /** Column type can be: Dimension, Measure or Normal. */
    KeywordField QLIK_COLUMN_TYPE = new KeywordField("qlikColumnType", "qlikColumnType");

    /** Data type of the Qlik Column. */
    KeywordField QLIK_DATA_TYPE = new KeywordField("qlikDataType", "qlikDataType");

    /** Parent dataset containing the columns. */
    RelationField QLIK_DATASET = new RelationField("qlikDataset");

    /** Parent Qualified name of column. */
    KeywordField QLIK_PARENT_QUALIFIED_NAME = new KeywordField("qlikParentQualifiedName", "qlikParentQualifiedName");
    ...
    /** Parent chart containing the columns. */
    IQlikChart getQlikChart();

    /** Qlik Column name. */
    String getQlikColumnName();

    /** Column type can be: Dimension, Measure or Normal. */
    String getQlikColumnType();

    /** Data type of the Qlik Column. */
    String getQlikDataType();

    /** Parent dataset containing the columns. */
    IQlikDataset getQlikDataset();
    ...
    /** Parent Qualified name of column. */
    String getQlikParentQualifiedName();
