...
public interface IResponse {
    ...
    KeywordField FORM_GUID = new KeywordField("formGuid", "formGuid");

    /** Options of the response to a form. */
    KeywordField RESPONSE_OPTIONS = new KeywordField("responseOptions", "responseOptions");

    /** Fields in a form. */
    KeywordField RESPONSE_VALUES = new KeywordField("responseValues", "responseValues");
    ...
    /** Options of the response to a form. */
    Map<String, String> getResponseOptions();

    /** Fields in a form. */
    List<ResponseValue> getResponseValues();
