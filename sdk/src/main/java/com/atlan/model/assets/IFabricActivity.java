...
public interface IFabricActivity {

    public static final String TYPE_NAME = "FabricActivity";

    /** Type of activity. */
    KeywordField FABRIC_ACTIVITY_TYPE = new KeywordField("fabricActivityType", "fabricActivityType");

    /** Data pipeline containing the activity. */
    RelationField FABRIC_DATA_PIPELINE = new RelationField("fabricDataPipeline");

    /** Unique name of the Fabric data pipeline that contains this asset. */
    KeywordField FABRIC_DATA_PIPELINE_QUALIFIED_NAME =
            new KeywordField("fabricDataPipelineQualifiedName", "fabricDataPipelineQualifiedName");

    /** Process containing the Fabric activity. */
    RelationField FABRIC_PROCESS = new RelationField("fabricProcess");
    ...
    /** Type of activity. */
    String getFabricActivityType();

    /** Number of columns in this asset. */
    Integer getFabricColumnCount();

    /** Data pipeline containing the activity. */
    IFabricDataPipeline getFabricDataPipeline();

    /** Unique name of the Fabric data pipeline that contains this asset. */
    String getFabricDataPipelineQualifiedName();
    ...
    /** Process containing the Fabric activity. */
    ILineageProcess getFabricProcess();
