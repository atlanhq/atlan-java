...
public interface ITableauDashboardField {

    public static final String TYPE_NAME = "TableauDashboardField";

    /** Dashboard in which this field exists. */
    RelationField TABLEAU_DASHBOARD = new RelationField("tableauDashboard");

    /** Bin size of this field. */
    TextField TABLEAU_DASHBOARD_FIELD_BIN_SIZE =
            new TextField("tableauDashboardFieldBinSize", "tableauDashboardFieldBinSize");

    /** Data category of this field. */
    TextField TABLEAU_DASHBOARD_FIELD_DATA_CATEGORY =
    ...
    TextField TABLEAU_DASHBOARD_FIELD_FORMULA =
            new TextField("tableauDashboardFieldFormula", "tableauDashboardFieldFormula");

    /** Role of this field, for example: 'dimension', 'measure', or 'unknown'. */
    TextField TABLEAU_DASHBOARD_FIELD_ROLE = new TextField("tableauDashboardFieldRole", "tableauDashboardFieldRole");

    /** Type of this dashboard field. */
    TextField TABLEAU_DASHBOARD_FIELD_TYPE = new TextField("tableauDashboardFieldType", "tableauDashboardFieldType");

    /** Columns upstream to this field. */
    KeywordField TABLEAU_DASHBOARD_FIELD_UPSTREAM_COLUMNS =
            new KeywordField("tableauDashboardFieldUpstreamColumns", "tableauDashboardFieldUpstreamColumns");

    /** Fields upstream to this field. */
    KeywordField TABLEAU_DASHBOARD_FIELD_UPSTREAM_FIELDS =
            new KeywordField("tableauDashboardFieldUpstreamFields", "tableauDashboardFieldUpstreamFields");

    /** Unique name of the datasource in which this dashboard field exists. */
    TextField TABLEAU_DASHBOARD_QUALIFIED_NAME =
            new TextField("tableauDashboardQualifiedName", "tableauDashboardQualifiedName");
    ...
    KeywordField TABLEAU_UPSTREAM_TABLES = new KeywordField("tableauUpstreamTables", "tableauUpstreamTables");
    ...
    /** Dashboard in which this field exists. */
    default ITableauDashboard getTableauDashboard() {
        return null;
    }

    /** Bin size of this field. */
    String getTableauDashboardFieldBinSize();

    /** Data category of this field. */
    String getTableauDashboardFieldDataCategory();

    /** Data type of this field. */
    String getTableauDashboardFieldDataType();

    /** Formula for this field. */
    String getTableauDashboardFieldFormula();

    /** Role of this field, for example: 'dimension', 'measure', or 'unknown'. */
    String getTableauDashboardFieldRole();
