...
public class ThoughtspotWorksheet extends Asset
    ...
    /**
     * Start an asset filter that will return all ThoughtspotWorksheet assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) ThoughtspotWorksheet assets will be included.
     *
     * @return an asset filter that includes all ThoughtspotWorksheet assets
     ...
     */
    @JsonIgnore
    public static ThoughtspotWorksheet get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a ThoughtspotWorksheet by its GUID, complete with all of its relationships.
     *
     * @param guid of the ThoughtspotWorksheet to retrieve
     * @return the requested full ThoughtspotWorksheet, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the ThoughtspotWorksheet does not exist or the provided GUID is not a ThoughtspotWorksheet
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static ThoughtspotWorksheet retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static ThoughtspotWorksheet retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a ThoughtspotWorksheet by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the ThoughtspotWorksheet to retrieve
     * @return the requested full ThoughtspotWorksheet, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the ThoughtspotWorksheet does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static ThoughtspotWorksheet retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static ThoughtspotWorksheet retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public ThoughtspotWorksheetBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "ThoughtspotWorksheet", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static ThoughtspotWorksheet replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static ThoughtspotWorksheet appendTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static ThoughtspotWorksheet removeTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static ThoughtspotWorksheet appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a ThoughtspotWorksheet.
     *
     * @param qualifiedName of the ThoughtspotWorksheet
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the ThoughtspotWorksheet
     ...
     * Add Atlan tags to a ThoughtspotWorksheet.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the ThoughtspotWorksheet
     * @param qualifiedName of the ThoughtspotWorksheet
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the ThoughtspotWorksheet
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
