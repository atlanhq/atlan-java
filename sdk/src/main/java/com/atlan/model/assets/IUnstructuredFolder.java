...
public interface IUnstructuredFolder {

    public static final String TYPE_NAME = "UnstructuredFolder";

    /** Immediate child folders nested directly under this folder. */
    RelationField UNSTRUCTURED_CHILD_FOLDERS = new RelationField("unstructuredChildFolders");
    ...
    NumericField UNSTRUCTURED_FOLDER_COUNT = new NumericField("unstructuredFolderCount", "unstructuredFolderCount");

    /** Count of objects directly contained within this folder (immediate children only — objects in sub-folders are not counted). */
    NumericField UNSTRUCTURED_OBJECT_COUNT = new NumericField("unstructuredObjectCount", "unstructuredObjectCount");

    /** Objects directly contained within this folder. */
    RelationField UNSTRUCTURED_OBJECTS = new RelationField("unstructuredObjects");
    ...
    /** Immediate child folders nested directly under this folder. */
    default SortedSet<IUnstructuredFolder> getUnstructuredChildFolders() {
        return null;
    }
    ...
    /** Count of child folders directly nested under this folder (immediate children only — sub-folders further down the tree are not counted). */
    Long getUnstructuredFolderCount();
    ...
    /** Count of objects directly contained within this folder (immediate children only — objects in sub-folders are not counted). */
    Long getUnstructuredObjectCount();

    /** Objects directly contained within this folder. */
    default SortedSet<IUnstructuredObject> getUnstructuredObjects() {
        return null;
    }
