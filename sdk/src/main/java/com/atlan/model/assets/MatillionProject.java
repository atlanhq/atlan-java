...
public class MatillionProject extends Asset implements IMatillionProject, IMatillion, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all MatillionProject assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) MatillionProject assets will be included.
     *
     * @return an asset filter that includes all MatillionProject assets
    ...
    /**
     * Reference to a MatillionProject by GUID.
     *
    ...
    public static MatillionProject refByGuid(String guid) {
        return MatillionProject._internal().guid(guid).build();
    }

    /**
     * Reference to a MatillionProject by qualifiedName.
     *
    ...
    public static MatillionProject refByQualifiedName(String qualifiedName) {
        return MatillionProject._internal()
                .uniqueAttributes(
     ...
     */
    @JsonIgnore
    public static MatillionProject get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a MatillionProject by its GUID, complete with all of its relationships.
     *
     * @param guid of the MatillionProject to retrieve
     * @return the requested full MatillionProject, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MatillionProject does not exist or the provided GUID is not a MatillionProject
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static MatillionProject retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static MatillionProject retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a MatillionProject by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the MatillionProject to retrieve
     * @return the requested full MatillionProject, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MatillionProject does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static MatillionProject retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static MatillionProject retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public MatillionProjectBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "MatillionProject", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static MatillionProject removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static MatillionProject appendTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static MatillionProject removeTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
    ...
    public static MatillionProject appendAtlanTags(
            ...
            boolean restrictLineagePropagation)
            throws AtlanException {
        return (MatillionProject) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
    ...
    /**
     * Add Atlan tags to a MatillionProject.
     *
     * @param qualifiedName of the MatillionProject
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the MatillionProject
     ...
     * Add Atlan tags to a MatillionProject.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the MatillionProject
     * @param qualifiedName of the MatillionProject
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the MatillionProject
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
