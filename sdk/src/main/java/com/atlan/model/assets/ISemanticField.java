...
public interface ISemanticField {

    public static final String TYPE_NAME = "SemanticField";

    /** Access level for the semantic field (e.g., public_access/private_access). */
    KeywordField SEMANTIC_ACCESS_MODIFIER = new KeywordField("semanticAccessModifier", "semanticAccessModifier");

    /** Data type of the semantic field. */
    KeywordField SEMANTIC_DATA_TYPE = new KeywordField("semanticDataType", "semanticDataType");

    /** Column name or SQL expression for the semantic field. */
    KeywordField SEMANTIC_EXPRESSION = new KeywordField("semanticExpression", "semanticExpression");

    /** Labels associated with the semantic field. */
    KeywordField SEMANTIC_LABELS = new KeywordField("semanticLabels", "semanticLabels");

    /** Sample values for the semantic field. */
    TextField SEMANTIC_SAMPLE_VALUES = new TextField("semanticSampleValues", "semanticSampleValues");

    /** Alternative names or terms for the semantic field. */
    KeywordField SEMANTIC_SYNONYMS = new KeywordField("semanticSynonyms", "semanticSynonyms");

    /** Detailed type of the semantic field (e.g., type of measure, type of dimension, or type of entity). */
    KeywordField SEMANTIC_TYPE = new KeywordField("semanticType", "semanticType");
