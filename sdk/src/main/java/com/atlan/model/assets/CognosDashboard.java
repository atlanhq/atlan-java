...
public class CognosDashboard extends Asset implements ICognosDashboard, ICognos, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all CognosDashboard assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CognosDashboard assets will be included.
     *
     * @return an asset filter that includes all CognosDashboard assets
     ...
     */
    @JsonIgnore
    public static CognosDashboard get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a CognosDashboard by its GUID, complete with all of its relationships.
     *
     * @param guid of the CognosDashboard to retrieve
     * @return the requested full CognosDashboard, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosDashboard does not exist or the provided GUID is not a CognosDashboard
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosDashboard retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosDashboard retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CognosDashboard by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CognosDashboard to retrieve
     * @return the requested full CognosDashboard, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosDashboard does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosDashboard retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosDashboard retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CognosDashboard.
     *
     * @param qualifiedName of the CognosDashboard
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosDashboard
     ...
     * Add Atlan tags to a CognosDashboard.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CognosDashboard
     * @param qualifiedName of the CognosDashboard
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosDashboard
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
