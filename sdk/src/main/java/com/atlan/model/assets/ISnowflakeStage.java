...
public interface ISnowflakeStage {
    ...
    KeywordField SNOWFLAKE_STAGE_EXTERNAL_LOCATION =
            new KeywordField("snowflakeStageExternalLocation", "snowflakeStageExternalLocation");

    /** The geographic region identifier where the external stage is located in cloud storage. This is NULL for internal stages. */
    KeywordField SNOWFLAKE_STAGE_EXTERNAL_LOCATION_REGION =
            new KeywordField("snowflakeStageExternalLocationRegion", "snowflakeStageExternalLocationRegion");
    ...
    KeywordField SNOWFLAKE_STAGE_STORAGE_INTEGRATION =
            new KeywordField("snowflakeStageStorageIntegration", "snowflakeStageStorageIntegration");
    ...
    KeywordField SNOWFLAKE_STAGE_TYPE = new KeywordField("snowflakeStageType", "snowflakeStageType");
    ...
    RelationField SQL_STAGE_SCHEMA = new RelationField("sqlStageSchema");
    ...
    /** The URL or cloud storage path specifying the external location where the stage data files are stored. This is NULL for internal stages. */
    String getSnowflakeStageExternalLocation();

    /** The geographic region identifier where the external stage is located in cloud storage. This is NULL for internal stages. */
    String getSnowflakeStageExternalLocationRegion();

    /** The name of the storage integration associated with the stage; NULL for internal stages or stages that do not use a storage integration. */
    String getSnowflakeStageStorageIntegration();

    /** Categorization of the stage type in Snowflake, which can be 'Internal Named' or 'External Named', indicating whether the stage storage is within Snowflake or in external cloud storage. */
    String getSnowflakeStageType();
