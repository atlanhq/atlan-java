...
public interface IFlowField {
    ...
    KeywordField FLOW_DATA_TYPE = new KeywordField("flowDataType", "flowDataType");
    ...
    KeywordTextField FLOW_DATASET_NAME =
            new KeywordTextField("flowDatasetName", "flowDatasetName.keyword", "flowDatasetName");
    ...
    /** Type of the data captured in this field. */
    String getFlowDataType();

    /** Ephemeral dataset that contains these fields. */
    IFlowDataset getFlowDataset();

    /** Simple name of the ephemeral dataset in which this field is contained. */
    String getFlowDatasetName();

    /** Unique name of the ephemeral dataset in which this field is contained. */
    String getFlowDatasetQualifiedName();
