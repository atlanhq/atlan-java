...
public class CogniteAsset extends Asset implements ICogniteAsset, ICognite, ISaaS, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all CogniteAsset assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CogniteAsset assets will be included.
     *
     * @return an asset filter that includes all CogniteAsset assets
    ...
    /**
     * Retrieves a CogniteAsset by its GUID, complete with all of its relationships.
     *
     * @param guid of the CogniteAsset to retrieve
     * @return the requested full CogniteAsset, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteAsset does not exist or the provided GUID is not a CogniteAsset
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteAsset retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteAsset retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CogniteAsset by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CogniteAsset to retrieve
     * @return the requested full CogniteAsset, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteAsset does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteAsset retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteAsset retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    public CogniteAssetBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "CogniteAsset", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a CogniteAsset.
     *
     * @param qualifiedName of the CogniteAsset
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteAsset
     ...
     * Add Atlan tags to a CogniteAsset.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CogniteAsset
     * @param qualifiedName of the CogniteAsset
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteAsset
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
