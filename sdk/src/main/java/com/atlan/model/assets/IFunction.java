...
public interface IFunction {
    ...
    KeywordField FUNCTION_EXTERNAL_ACCESS_INTEGRATIONS =
            new KeywordField("functionExternalAccessIntegrations", "functionExternalAccessIntegrations");

    /** Packages actually installed for the function. */
    KeywordField FUNCTION_INSTALLED_PACKAGES =
            new KeywordField("functionInstalledPackages", "functionInstalledPackages");
    ...
    KeywordField FUNCTION_PACKAGES = new KeywordField("functionPackages", "functionPackages");
    ...
    KeywordTextField FUNCTION_RUNTIME_VERSION =
            new KeywordTextField("functionRuntimeVersion", "functionRuntimeVersion.keyword", "functionRuntimeVersion");
    ...
    KeywordField FUNCTION_SECRETS = new KeywordField("functionSecrets", "functionSecrets");
    ...
    /** Arguments that are passed in to the function. */
    SortedSet<String> getFunctionArguments();

    /** Code or set of statements that determine the output of the function. */
    String getFunctionDefinition();

    /** Names of external access integrations used by the function. */
    String getFunctionExternalAccessIntegrations();

    /** Packages actually installed for the function. */
    String getFunctionInstalledPackages();
    ...
    /** Packages requested by the function. */
    String getFunctionPackages();

    /** Data type of the value returned by the function. */
    String getFunctionReturnType();

    /** Version of the language runtime used by the function. */
    String getFunctionRuntimeVersion();

    /** Schema in which this function exists. */
    default ISchema getFunctionSchema() {
        return null;
    }

    /** Secret variables used by the function. */
    String getFunctionSecrets();
