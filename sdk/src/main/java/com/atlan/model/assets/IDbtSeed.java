...
public interface IDbtSeed {
    ...
    KeywordField DBT_SEED_FILE_PATH = new KeywordField("dbtSeedFilePath", "dbtSeedFilePath");

    /** SQL assets from warehouse that are materializations of the dbt seed. */
    RelationField DBT_SEED_SQL_ASSETS = new RelationField("dbtSeedSqlAssets");

    /** Statistics of the dbt seed. */
    KeywordField DBT_SEED_STATS = new KeywordField("dbtSeedStats", "dbtSeedStats");
    ...
    /** File path of the dbt seed. */
    String getDbtSeedFilePath();

    /** SQL assets from warehouse that are materializations of the dbt seed. */
    SortedSet<ISQL> getDbtSeedSqlAssets();

    /** Statistics of the dbt seed. */
    String getDbtSeedStats();
