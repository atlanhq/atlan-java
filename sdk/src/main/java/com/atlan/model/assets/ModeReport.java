...
public class ModeReport extends Asset implements IModeReport, IMode, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Retrieves a ModeReport by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the ModeReport to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the ModeReport, including any relationships
     * @return the requested ModeReport, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the ModeReport does not exist or the provided GUID is not a ModeReport
     */
    @JsonIgnore
     ...
     * @param id of the ModeReport to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the ModeReport, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the ModeReport
     * @return the requested ModeReport, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the ModeReport does not exist or the provided GUID is not a ModeReport
     */
    @JsonIgnore
    public static ModeReport get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = ModeReport.select(client)
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof ModeReport) {
