...
public class DomoCard extends Asset implements IDomoCard, IDomo, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all DomoCard assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DomoCard assets will be included.
     *
     * @return an asset filter that includes all DomoCard assets
    ...
    /**
     * Retrieves a DomoCard by its GUID, complete with all of its relationships.
     *
     * @param guid of the DomoCard to retrieve
     * @return the requested full DomoCard, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DomoCard does not exist or the provided GUID is not a DomoCard
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DomoCard retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DomoCard retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DomoCard by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DomoCard to retrieve
     * @return the requested full DomoCard, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DomoCard does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DomoCard retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DomoCard retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    public DomoCardBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "DomoCard", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a DomoCard.
     *
     * @param qualifiedName of the DomoCard
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DomoCard
     ...
     * Add Atlan tags to a DomoCard.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DomoCard
     * @param qualifiedName of the DomoCard
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DomoCard
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
