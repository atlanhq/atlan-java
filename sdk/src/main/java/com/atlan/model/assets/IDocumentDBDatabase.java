...
public interface IDocumentDBDatabase {

    public static final String TYPE_NAME = "DocumentDBDatabase";

    /** Collections that exist within this database. */
    RelationField DOCUMENT_DB_COLLECTIONS = new RelationField("documentDBCollections");

    /** Number of collections in the database. */
    NumericField DOCUMENT_DB_DATABASE_COLLECTION_COUNT =
            new NumericField("documentDBDatabaseCollectionCount", "documentDBDatabaseCollectionCount");
    ...
    /** Collections that exist within this database. */
    SortedSet<IDocumentDBCollection> getDocumentDBCollections();

    /** Number of collections in the database. */
    Long getDocumentDBDatabaseCollectionCount();
