...
public interface IStarburstDataset {

    public static final String TYPE_NAME = "StarburstDataset";

    /** Data product that publishes this dataset. */
    RelationField STARBURST_DATA_PRODUCT = new RelationField("starburstDataProduct");

    /** Columns that exist within this dataset. */
    RelationField STARBURST_DATASET_COLUMNS = new RelationField("starburstDatasetColumns");

    /** Whether this dataset is a materialized view. */
    BooleanField STARBURST_IS_MATERIALIZED = new BooleanField("starburstIsMaterialized", "starburstIsMaterialized");
    ...
    KeywordField STARBURST_SQL_QUALIFIED_NAME =
            new KeywordField("starburstSqlQualifiedName", "starburstSqlQualifiedName");

    /** SQL definition of the underlying view or materialized view. */
    KeywordField STARBURST_VIEW_DEFINITION = new KeywordField("starburstViewDefinition", "starburstViewDefinition");
