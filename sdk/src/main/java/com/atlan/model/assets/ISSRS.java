...
public interface ISSRS {

    public static final String TYPE_NAME = "SSRS";

    /** Catalog name associated with this asset in the source system. */
    KeywordField SSRS_CATALOG_NAME = new KeywordField("ssrsCatalogName", "ssrsCatalogName");

    /** Simple name of the DataSet asset that contains this asset. */
    KeywordField SSRS_DATA_SET_NAME = new KeywordField("ssrsDataSetName", "ssrsDataSetName");

    /** Unique name of the DataSet asset that contains this asset. */
    KeywordField SSRS_DATA_SET_QUALIFIED_NAME =
            new KeywordField("ssrsDataSetQualifiedName", "ssrsDataSetQualifiedName");
    ...
    KeywordField SSRS_FOLDER_HIERARCHIES = new KeywordField("ssrsFolderHierarchies", "ssrsFolderHierarchies");

    /** Whether the asset is hidden. */
    BooleanField SSRS_HIDDEN = new BooleanField("ssrsHidden", "ssrsHidden");

    /** Unique name of the immediate parent folder containing this asset. */
    KeywordField SSRS_PARENT_FOLDER_QUALIFIED_NAME =
            new KeywordField("ssrsParentFolderQualifiedName", "ssrsParentFolderQualifiedName");

    /** Path of the asset in SSRS. */
    KeywordField SSRS_PATH = new KeywordField("ssrsPath", "ssrsPath");

    /** Reference repository ID for this asset. */
    KeywordField SSRS_REFERENCE_REPOSITORY_ID =
            new KeywordField("ssrsReferenceRepositoryId", "ssrsReferenceRepositoryId");

    /** Simple name of the Report asset that contains this asset. */
    KeywordField SSRS_REPORT_NAME = new KeywordField("ssrsReportName", "ssrsReportName");

    /** Unique name of the Report asset that contains this asset. */
    KeywordField SSRS_REPORT_QUALIFIED_NAME = new KeywordField("ssrsReportQualifiedName", "ssrsReportQualifiedName");

    /** Schema name associated with this asset in the source system. */
    KeywordField SSRS_SCHEMA_NAME = new KeywordField("ssrsSchemaName", "ssrsSchemaName");

    /** Table name associated with this asset in the source system. */
    KeywordField SSRS_TABLE_NAME = new KeywordField("ssrsTableName", "ssrsTableName");

    /** Whether the asset is used in a report. */
    BooleanField SSRS_USED_IN_REPORTS = new BooleanField("ssrsUsedInReports", "ssrsUsedInReports");
