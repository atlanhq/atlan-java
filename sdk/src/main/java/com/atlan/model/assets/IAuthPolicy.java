...
public interface IAuthPolicy {
    ...
    /** Policies assigned to this access control entity. */
    default IAccessControl getAccessControl() {
        return null;
    }
    ...
    /** TBC */
    List<AuthPolicyCondition> getPolicyConditions();
    ...
    /** TBC */
    DataMaskingType getPolicyMaskType();

    /** TBC */
    Integer getPolicyPriority();

    /** TBC */
    AuthPolicyResourceCategory getPolicyResourceCategory();
    ...
    /** TBC */
    List<AuthPolicyValiditySchedule> getPolicyValiditySchedule();
