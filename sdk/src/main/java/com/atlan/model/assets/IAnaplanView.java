...
public interface IAnaplanView {

    public static final String TYPE_NAME = "AnaplanView";

    /** Column dimensions related to the view. */
    RelationField ANAPLAN_COLUMN_DIMENSIONS = new RelationField("anaplanColumnDimensions");
    ...
    RelationField ANAPLAN_PAGE_DIMENSIONS = new RelationField("anaplanPageDimensions");

    /** Row dimensions related to the view. */
    RelationField ANAPLAN_ROW_DIMENSIONS = new RelationField("anaplanRowDimensions");
    ...
    /** Column dimensions related to the view. */
    default SortedSet<IAnaplanDimension> getAnaplanColumnDimensions() {
        return null;
    }
    ...
    /** Module containing the view. */
    default IAnaplanModule getAnaplanModule() {
        return null;
    }
    ...
    /** Page dimensions related to the view. */
    default SortedSet<IAnaplanDimension> getAnaplanPageDimensions() {
        return null;
    }

    /** Row dimensions related to the view. */
    default SortedSet<IAnaplanDimension> getAnaplanRowDimensions() {
        return null;
    }
