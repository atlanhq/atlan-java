...
public interface IBusinessPolicyException {
    ...
    KeywordField BUSINESS_POLICY_EXCEPTION_GROUPS =
            new KeywordField("businessPolicyExceptionGroups", "businessPolicyExceptionGroups");

    /** List of users who are part of this exception */
    KeywordField BUSINESS_POLICY_EXCEPTION_USERS =
            new KeywordField("businessPolicyExceptionUsers", "businessPolicyExceptionUsers");
    ...
    /** Business Policy Exception Filter ES DSL to denote the associate asset/s involved. */
    String getBusinessPolicyExceptionFilterDSL();

    /** List of groups who are part of this exception */
    SortedSet<String> getBusinessPolicyExceptionGroups();

    /** List of users who are part of this exception */
    SortedSet<String> getBusinessPolicyExceptionUsers();

    /** Business policies related to exception */
    IBusinessPolicy getBusinessPolicyForException();

    /** Unique name of the business policy through which this asset is accessible. */
    String getBusinessPolicyQualifiedName();
