...
public interface IModelEntity {
    ...
    NumericField MODEL_ENTITY_ATTRIBUTE_COUNT =
            new NumericField("modelEntityAttributeCount", "modelEntityAttributeCount");
    ...
    RelationField MODEL_ENTITY_MAPPED_TO_ENTITIES = new RelationField("modelEntityMappedToEntities");

    /** Association from which this entity is related. */
    RelationField MODEL_ENTITY_RELATED_FROM_ENTITIES = new RelationField("modelEntityRelatedFromEntities");
    ...
    RelationField MODEL_VERSIONS = new RelationField("modelVersions");
    ...
    /** Number of attributes in the entity. */
    Long getModelEntityAttributeCount();

    /** Individual attributes that make up the entity. */
    default SortedSet<IModelAttribute> getModelEntityAttributes() {
        return null;
    }

    /** General entity, representing shared characteristics of specialized entities. */
    default IModelEntity getModelEntityGeneralizationEntity() {
        return null;
    }
    ...
    /** Assets that implement this entity. */
    default SortedSet<ICatalog> getModelEntityImplementedByAssets() {
        return null;
    }

    /** Entities from which this entity is mapped. */
    default SortedSet<IModelEntity> getModelEntityMappedFromEntities() {
        return null;
    }

    /** Entities to which this entity is mapped. */
    default SortedSet<IModelEntity> getModelEntityMappedToEntities() {
        return null;
    }
    ...
    /** Association from which this entity is related. */
    default SortedSet<IModelEntityAssociation> getModelEntityRelatedFromEntities() {
        return null;
    }

    /** Association to which this entity is related. */
    default SortedSet<IModelEntityAssociation> getModelEntityRelatedToEntities() {
        return null;
    }

    /** Specialized entities derived from the general entity. */
    default SortedSet<IModelEntity> getModelEntitySpecializationEntities() {
        return null;
    }
    ...
    /** Data model version(s) in which this entity exists. */
    default SortedSet<IModelVersion> getModelVersions() {
        return null;
    }
