...
public interface ISchemaRegistryVersion {
    ...
    KeywordField SCHEMA_REGISTRY_VERSION_NUMBER =
            new KeywordField("schemaRegistryVersionNumber", "schemaRegistryVersionNumber");

    /** Full schema definition for this specific version. */
    TextField SCHEMA_REGISTRY_VERSION_SCHEMA_DEFINITION =
            new TextField("schemaRegistryVersionSchemaDefinition", "schemaRegistryVersionSchemaDefinition");

    /** Type of schema language used in this version. */
    KeywordField SCHEMA_REGISTRY_VERSION_SCHEMA_TYPE =
            new KeywordField("schemaRegistryVersionSchemaType", "schemaRegistryVersionSchemaType");
    ...
    /** Schema registry subject to which this version belongs. */
    default ISchemaRegistrySubject getSchemaRegistrySubject() {
        return null;
    }

    /** Unique name of the schema registry subject to which this version belongs. */
    String getSchemaRegistrySubjectQualifiedName();
    ...
    /** Version number of this schema version. */
    String getSchemaRegistryVersionNumber();

    /** Full schema definition for this specific version. */
    String getSchemaRegistryVersionSchemaDefinition();

    /** Type of schema language used in this version. */
    SchemaRegistrySchemaType getSchemaRegistryVersionSchemaType();
