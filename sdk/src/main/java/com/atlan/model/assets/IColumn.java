...
public interface IColumn {
    ...
    KeywordField COLUMN_AI_INSIGHTS_DIMENSION_TYPE =
            new KeywordField("columnAiInsightsDimensionType", "columnAiInsightsDimensionType");
    ...
    KeywordField COLUMN_AI_INSIGHTS_FOREIGN_KEY_COLUMN_QUALIFIED_NAME = new KeywordField(
            "columnAiInsightsForeignKeyColumnQualifiedName", "columnAiInsightsForeignKeyColumnQualifiedName");

    /** When true, this column is identified as a dimension by AI analysis of query patterns. */
    BooleanField COLUMN_AI_INSIGHTS_IS_DIMENSION =
            new BooleanField("columnAiInsightsIsDimension", "columnAiInsightsIsDimension");

    /** When true, this column is identified as a measure/calculated column by AI analysis of query patterns. */
    BooleanField COLUMN_AI_INSIGHTS_IS_MEASURE =
            new BooleanField("columnAiInsightsIsMeasure", "columnAiInsightsIsMeasure");

    /** Type of measure/calculated column as classified by AI analysis, for example: base, calculated, derived. */
    KeywordField COLUMN_AI_INSIGHTS_MEASURE_TYPE =
            new KeywordField("columnAiInsightsMeasureType", "columnAiInsightsMeasureType");
    ...
    NumericField COLUMN_DISTINCT_VALUES_PERCENTAGE =
            new NumericField("columnDistinctValuesPercentage", "columnDistinctValuesPercentage");
    ...
    RelationField DQ_BASE_COLUMN_RULES = new RelationField("dqBaseColumnRules");

    /** Rules where this column is referenced. */
    RelationField DQ_REFERENCE_COLUMN_RULES = new RelationField("dqReferenceColumnRules");
    ...
    /** Type of dimension as classified by AI analysis, for example: time, categorical, geographic. */
    String getColumnAiInsightsDimensionType();

    /** Qualified name of the column in another table that this column likely references as a foreign key, inferred by AI analysis of query patterns. */
    String getColumnAiInsightsForeignKeyColumnQualifiedName();

    /** When true, this column is identified as a dimension by AI analysis of query patterns. */
    Boolean getColumnAiInsightsIsDimension();

    /** When true, this column is identified as a measure/calculated column by AI analysis of query patterns. */
    Boolean getColumnAiInsightsIsMeasure();

    /** Type of measure/calculated column as classified by AI analysis, for example: base, calculated, derived. */
    String getColumnAiInsightsMeasureType();
