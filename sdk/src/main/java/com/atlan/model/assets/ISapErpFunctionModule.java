...
public interface ISapErpFunctionModule {
    ...
    RelationField SAP_ERP_ABAP_PROGRAM = new RelationField("sapErpAbapProgram");
    ...
    KeywordField SAP_ERP_FUNCTION_EXCEPTION_LIST =
            new KeywordField("sapErpFunctionExceptionList", "sapErpFunctionExceptionList");

    /** Represents the total number of Exceptions in a given SAP ERP Function Module. */
    NumericField SAP_ERP_FUNCTION_EXCEPTION_LIST_COUNT =
            new NumericField("sapErpFunctionExceptionListCount", "sapErpFunctionExceptionListCount");

    /** Parameters exported by the SAP ERP function module, defined as key-value pairs. */
    KeywordField SAP_ERP_FUNCTION_MODULE_EXPORT_PARAMS =
            new KeywordField("sapErpFunctionModuleExportParams", "sapErpFunctionModuleExportParams");

    /** Represents the total number of Export Parameters in a given SAP ERP Function Module. */
    NumericField SAP_ERP_FUNCTION_MODULE_EXPORT_PARAMS_COUNT =
            new NumericField("sapErpFunctionModuleExportParamsCount", "sapErpFunctionModuleExportParamsCount");

    /** Represents the group to which the SAP ERP function module belongs. */
    KeywordField SAP_ERP_FUNCTION_MODULE_GROUP =
            new KeywordField("sapErpFunctionModuleGroup", "sapErpFunctionModuleGroup");

    /** Parameters imported by the SAP ERP function module, defined as key-value pairs. */
    KeywordField SAP_ERP_FUNCTION_MODULE_IMPORT_PARAMS =
            new KeywordField("sapErpFunctionModuleImportParams", "sapErpFunctionModuleImportParams");

    /** Represents the total number of Import Parameters in a given SAP ERP Function Module. */
    NumericField SAP_ERP_FUNCTION_MODULE_IMPORT_PARAMS_COUNT =
            new NumericField("sapErpFunctionModuleImportParamsCount", "sapErpFunctionModuleImportParamsCount");
    ...
    /** SAP ERP Function Modules that are associated with this SAP ERP ABAP Program. */
    ISapErpAbapProgram getSapErpAbapProgram();

    /** SAP ERP Function Modules that are associated with this SAP ERP Component. */
    ISapErpComponent getSapErpComponent();
