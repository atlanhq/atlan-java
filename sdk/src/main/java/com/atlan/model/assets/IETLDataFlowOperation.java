...
public interface IETLDataFlowOperation {
    ...
    RelationField ETL_DETAILED_DATA_FLOW_OPERATIONS = new RelationField("etlDetailedDataFlowOperations");

    /** Parent data flow operation that contains this data flow operation. */
    RelationField ETL_PARENT_DATA_FLOW_OPERATION = new RelationField("etlParentDataFlowOperation");

    /** Process that contains this data flow operation. */
    RelationField ETL_PARENT_PROCESS = new RelationField("etlParentProcess");
    ...
    /** Child data flow operations that show internal details of this data flow operation. */
    SortedSet<IETLDataFlowOperation> getEtlDetailedDataFlowOperations();
    ...
    /** Parent data flow operation that contains this data flow operation. */
    IETLDataFlowOperation getEtlParentDataFlowOperation();

    /** Process that contains this data flow operation. */
    ILineageProcess getEtlParentProcess();
