...
public class SupersetDataset extends Asset
    ...
    /**
     * Start an asset filter that will return all SupersetDataset assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SupersetDataset assets will be included.
     *
     * @return an asset filter that includes all SupersetDataset assets
     ...
     */
    @JsonIgnore
    public static SupersetDataset get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a SupersetDataset by its GUID, complete with all of its relationships.
     *
     * @param guid of the SupersetDataset to retrieve
     * @return the requested full SupersetDataset, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SupersetDataset does not exist or the provided GUID is not a SupersetDataset
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SupersetDataset retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static SupersetDataset retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a SupersetDataset by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the SupersetDataset to retrieve
     * @return the requested full SupersetDataset, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SupersetDataset does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SupersetDataset retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static SupersetDataset retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a SupersetDataset.
     *
     * @param qualifiedName of the SupersetDataset
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SupersetDataset
     ...
     * Add Atlan tags to a SupersetDataset.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the SupersetDataset
     * @param qualifiedName of the SupersetDataset
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SupersetDataset
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
