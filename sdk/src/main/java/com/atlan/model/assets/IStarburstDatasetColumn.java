...
public interface IStarburstDatasetColumn {

    public static final String TYPE_NAME = "StarburstDatasetColumn";

    /** Dataset in which this column exists. */
    RelationField STARBURST_DATASET = new RelationField("starburstDataset");
    ...
    KeywordField STARBURST_SQL_COLUMN_QUALIFIED_NAME =
            new KeywordField("starburstSqlColumnQualifiedName", "starburstSqlColumnQualifiedName");
    ...
    /** Dataset in which this column exists. */
    default IStarburstDataset getStarburstDataset() {
        return null;
    }
    ...
    /** Qualified name of the corresponding SQL Column. Enables cross-stream lookup between the Data Product perspective and the SQL perspective of the same underlying column. */
    String getStarburstSqlColumnQualifiedName();
