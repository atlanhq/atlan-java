...
public interface IAIApplication {
    ...
    KeywordField AI_APPLICATION_DEVELOPMENT_STAGE =
            new KeywordField("aiApplicationDevelopmentStage", "aiApplicationDevelopmentStage");
    ...
    /** Development stage of the AI application */
    AIApplicationDevelopmentStage getAiApplicationDevelopmentStage();

    /** Version of the AI application */
    String getAiApplicationVersion();
