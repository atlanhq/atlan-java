...
public interface IFlowV02 {

    public static final String TYPE_NAME = "FlowV02";

    /** Optional error message of the flow run. */
    KeywordField FLOW_V02ERROR_MESSAGE = new KeywordField("flowV02ErrorMessage", "flowV02ErrorMessage");

    /** Date and time at which this point in the data processing or orchestration finished. */
    NumericField FLOW_V02FINISHED_AT = new NumericField("flowV02FinishedAt", "flowV02FinishedAt");

    /** Simple name of the folder in which this asset is contained. */
    KeywordTextField FLOW_V02FOLDER_NAME =
            new KeywordTextField("flowV02FolderName", "flowV02FolderName.keyword", "flowV02FolderName");

    /** Unique name of the folder in which this asset is contained. */
    KeywordField FLOW_V02FOLDER_QUALIFIED_NAME =
            new KeywordField("flowV02FolderQualifiedName", "flowV02FolderQualifiedName");

    /** Unique ID for this flow asset, which will remain constant throughout the lifecycle of the asset. */
    KeywordField FLOW_V02ID = new KeywordField("flowV02Id", "flowV02Id");

    /** Simple name of the project in which this asset is contained. */
    KeywordTextField FLOW_V02PROJECT_NAME =
            new KeywordTextField("flowV02ProjectName", "flowV02ProjectName.keyword", "flowV02ProjectName");

    /** Unique name of the project in which this asset is contained. */
    KeywordField FLOW_V02PROJECT_QUALIFIED_NAME =
            new KeywordField("flowV02ProjectQualifiedName", "flowV02ProjectQualifiedName");

    /** Unique ID of the flow run, which could change on subsequent runs of the same flow. */
    KeywordField FLOW_V02RUN_ID = new KeywordField("flowV02RunId", "flowV02RunId");

    /** Schedule for this point in the data processing or orchestration. */
    KeywordField FLOW_V02SCHEDULE = new KeywordField("flowV02Schedule", "flowV02Schedule");

    /** Date and time at which this point in the data processing or orchestration started. */
    NumericField FLOW_V02STARTED_AT = new NumericField("flowV02StartedAt", "flowV02StartedAt");

    /** Overall status of this point in the data processing or orchestration. */
    KeywordField FLOW_V02STATUS = new KeywordField("flowV02Status", "flowV02Status");
    ...
    /** Optional error message of the flow run. */
    String getFlowV02ErrorMessage();

    /** Date and time at which this point in the data processing or orchestration finished. */
    Long getFlowV02FinishedAt();

    /** Simple name of the folder in which this asset is contained. */
    String getFlowV02FolderName();

    /** Unique name of the folder in which this asset is contained. */
    String getFlowV02FolderQualifiedName();

    /** Unique ID for this flow asset, which will remain constant throughout the lifecycle of the asset. */
    String getFlowV02Id();

    /** Simple name of the project in which this asset is contained. */
    String getFlowV02ProjectName();

    /** Unique name of the project in which this asset is contained. */
    String getFlowV02ProjectQualifiedName();

    /** Unique ID of the flow run, which could change on subsequent runs of the same flow. */
    String getFlowV02RunId();

    /** Schedule for this point in the data processing or orchestration. */
    String getFlowV02Schedule();

    /** Date and time at which this point in the data processing or orchestration started. */
    Long getFlowV02StartedAt();
