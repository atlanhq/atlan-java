...
public interface ICassandraView {
    ...
    NumericField CASSANDRA_VIEW_BLOOM_FILTER_FP_CHANCE =
            new NumericField("cassandraViewBloomFilterFPChance", "cassandraViewBloomFilterFPChance");

    /** CRC check chance for the CassandraView. */
    NumericField CASSANDRA_VIEW_CRC_CHECK_CHANCE =
            new NumericField("cassandraViewCRCCheckChance", "cassandraViewCRCCheckChance");

    /** Caching configuration in the CassandraView. */
    KeywordField CASSANDRA_VIEW_CACHING = new KeywordField("cassandraViewCaching", "cassandraViewCaching");

    /** Comment describing the CassandraView. */
    KeywordField CASSANDRA_VIEW_COMMENT = new KeywordField("cassandraViewComment", "cassandraViewComment");

    /** Compaction for the CassandraView. */
    KeywordField CASSANDRA_VIEW_COMPACTION = new KeywordField("cassandraViewCompaction", "cassandraViewCompaction");

    /** DC-local read repair chance for the CassandraView. */
    NumericField CASSANDRA_VIEW_DC_LOCAL_READ_REPAIR_CHANCE =
            new NumericField("cassandraViewDCLocalReadRepairChance", "cassandraViewDCLocalReadRepairChance");

    /** Default time-to-live (TTL) for the CassandraView. */
    NumericField CASSANDRA_VIEW_DEFAULT_TTL = new NumericField("cassandraViewDefaultTTL", "cassandraViewDefaultTTL");

    /** Grace period for garbage collection in the CassandraView. */
    NumericField CASSANDRA_VIEW_GC_GRACE_SECONDS =
            new NumericField("cassandraViewGCGraceSeconds", "cassandraViewGCGraceSeconds");

    /** Whether to include all columns in the CassandraView. */
    BooleanField CASSANDRA_VIEW_INCLUDE_ALL_COLUMNS =
            new BooleanField("cassandraViewIncludeAllColumns", "cassandraViewIncludeAllColumns");

    /** Maximum index interval for the CassandraView. */
    NumericField CASSANDRA_VIEW_MAX_INDEX_INTERVAL =
            new NumericField("cassandraViewMaxIndexInterval", "cassandraViewMaxIndexInterval");

    /** Memtable flush period (in milliseconds) for the CassandraView. */
    NumericField CASSANDRA_VIEW_MEMBTABLE_FLUSH_PERIOD_IN_MS =
            new NumericField("cassandraViewMembtableFlushPeriodInMS", "cassandraViewMembtableFlushPeriodInMS");

    /** Minimum index interval for the CassandraView. */
    NumericField CASSANDRA_VIEW_MIN_INDEX_INTERVAL =
            new NumericField("cassandraViewMinIndexInterval", "cassandraViewMinIndexInterval");

    /** Query used in the CassandraView. */
    KeywordField CASSANDRA_VIEW_QUERY = new KeywordField("cassandraViewQuery", "cassandraViewQuery");

    /** Read repair interval for the CassandraView. */
    NumericField CASSANDRA_VIEW_READ_REPAIR_INTERVAL =
            new NumericField("cassandraViewReadRepairInterval", "cassandraViewReadRepairInterval");

    /** SpeculativeRetry setting for the CassandraView. */
    KeywordField CASSANDRA_VIEW_SPECULATIVE_RETRY =
            new KeywordField("cassandraViewSpeculativeRetry", "cassandraViewSpeculativeRetry");

    /** ID of the base table in the CassandraView. */
    KeywordField CASSANDRA_VIEW_TABLE_ID = new KeywordField("cassandraViewTableId", "cassandraViewTableId");

    /** Where clause used for the CassandraView query. */
    KeywordField CASSANDRA_VIEW_WHERE_CLAUSE = new KeywordField("cassandraViewWhereClause", "cassandraViewWhereClause");
    ...
    /** False positive chance for the Bloom filter in the CassandraView. */
    Double getCassandraViewBloomFilterFPChance();

    /** CRC check chance for the CassandraView. */
    Double getCassandraViewCRCCheckChance();

    /** Caching configuration in the CassandraView. */
    Map<String, String> getCassandraViewCaching();

    /** Comment describing the CassandraView. */
    String getCassandraViewComment();

    /** Compaction for the CassandraView. */
    Map<String, String> getCassandraViewCompaction();

    /** DC-local read repair chance for the CassandraView. */
    Double getCassandraViewDCLocalReadRepairChance();

    /** Default time-to-live (TTL) for the CassandraView. */
    Long getCassandraViewDefaultTTL();

    /** Grace period for garbage collection in the CassandraView. */
    Long getCassandraViewGCGraceSeconds();

    /** Whether to include all columns in the CassandraView. */
    Boolean getCassandraViewIncludeAllColumns();

    /** Maximum index interval for the CassandraView. */
    Long getCassandraViewMaxIndexInterval();

    /** Memtable flush period (in milliseconds) for the CassandraView. */
    Long getCassandraViewMembtableFlushPeriodInMS();

    /** Minimum index interval for the CassandraView. */
    Long getCassandraViewMinIndexInterval();
    ...
    /** Query used in the CassandraView. */
    String getCassandraViewQuery();

    /** Read repair interval for the CassandraView. */
    Long getCassandraViewReadRepairInterval();

    /** SpeculativeRetry setting for the CassandraView. */
    String getCassandraViewSpeculativeRetry();

    /** ID of the base table in the CassandraView. */
    String getCassandraViewTableId();
