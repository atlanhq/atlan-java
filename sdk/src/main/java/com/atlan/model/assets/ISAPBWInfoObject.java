...
public interface ISAPBWInfoObject {

    public static final String TYPE_NAME = "SAPBWInfoObject";

    /** Associated ABAP field name (RSDIOBJ.FIELDNM). */
    KeywordField SAP_BW_FIELD_NAME = new KeywordField("sapBwFieldName", "sapBwFieldName");

    /** InfoArea containing this InfoObject. */
    RelationField SAP_BW_INFO_AREA = new RelationField("sapBwInfoArea");

    /** Related InfoObjects via navigation attributes or compounding. */
    RelationField SAP_BW_INFO_OBJECTS = new RelationField("sapBwInfoObjects");

    /** ADSO fields whose data element is this InfoObject. */
    RelationField SAP_BW_MAPPED_ADSO_FIELDS = new RelationField("sapBwMappedAdsoFields");

    /** CompositeProvider fields whose data element is this InfoObject. */
    RelationField SAP_BW_MAPPED_COMPOSITE_PROVIDER_FIELDS = new RelationField("sapBwMappedCompositeProviderFields");

    /** DataSource fields whose data element is this InfoObject. */
    RelationField SAP_BW_MAPPED_DATA_SOURCE_FIELDS = new RelationField("sapBwMappedDataSourceFields");

    /** InfoSource fields whose data element is this InfoObject. */
    RelationField SAP_BW_MAPPED_INFO_SOURCE_FIELDS = new RelationField("sapBwMappedInfoSourceFields");

    /** Query elements referencing this InfoObject. */
    RelationField SAP_BW_MAPPED_QUERY_ELEMENTS = new RelationField("sapBwMappedQueryElements");

    /** InfoObjects that reference this InfoObject via navigation attributes or compounding. */
    RelationField SAP_BW_RELATED_INFO_OBJECTS = new RelationField("sapBwRelatedInfoObjects");
    ...
    /** Associated ABAP field name (RSDIOBJ.FIELDNM). */
    String getSapBwFieldName();

    /** InfoArea containing this InfoObject. */
    default ISAPBWInfoArea getSapBwInfoArea() {
        return null;
    }

    /** Simple name of the SAP BW InfoObject asset related to this asset. */
    String getSapBwInfoObjectName();

    /** Unique name of the SAP BW InfoObject asset related to this asset. */
    String getSapBwInfoObjectQualifiedName();

    /** Related InfoObjects via navigation attributes or compounding. */
    default SortedSet<ISAPBWInfoObject> getSapBwInfoObjects() {
        return null;
    }
    ...
    /** ADSO fields whose data element is this InfoObject. */
    default SortedSet<ISAPBWADSOField> getSapBwMappedAdsoFields() {
        return null;
    }

    /** CompositeProvider fields whose data element is this InfoObject. */
    default SortedSet<ISAPBWCompositeProviderField> getSapBwMappedCompositeProviderFields() {
        return null;
    }

    /** DataSource fields whose data element is this InfoObject. */
    default SortedSet<ISAPBWDataSourceField> getSapBwMappedDataSourceFields() {
        return null;
    }

    /** InfoSource fields whose data element is this InfoObject. */
    default SortedSet<ISAPBWInfoSourceField> getSapBwMappedInfoSourceFields() {
        return null;
    }

    /** Query elements referencing this InfoObject. */
    default SortedSet<ISAPBWQueryElement> getSapBwMappedQueryElements() {
        return null;
    }

    /** Lifecycle status of the object in SAP BW such as active, inactive, or modified (e.g. RSDAREA.OBJSTAT, RSKSNEW.OBJSTAT). */
    String getSapBwObjectStatus();

    /** Simple name of the SAP BW parent asset in which this asset exists. */
    String getSapBwParentName();

    /** Unique name of the SAP BW parent asset in which this asset exists. */
    String getSapBwParentQualifiedName();

    /** InfoObjects that reference this InfoObject via navigation attributes or compounding. */
    default SortedSet<ISAPBWInfoObject> getSapBwRelatedInfoObjects() {
        return null;
    }
