...
public interface IETLControlFlow {
    ...
    /** Individual operations orchestrated through the control flow. */
    SortedSet<IETLControlFlowOperation> getEtlContainsOperations();

    /** Data flows (lineage processes) that are contained in this control flow. */
    SortedSet<ILineageProcess> getEtlDataFlows();
