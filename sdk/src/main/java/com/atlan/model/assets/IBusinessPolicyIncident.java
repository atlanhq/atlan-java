...
public interface IBusinessPolicyIncident {
    ...
    /** Filter ES DSL to denote the associate asset/s involved. */
    String getBusinessPolicyIncidentFilterDSL();

    /** count of noncompliant assets in the incident */
    Long getBusinessPolicyIncidentNoncompliantCount();

    /** policy ids related to this incident */
    SortedSet<String> getBusinessPolicyIncidentRelatedPolicyGUIDs();
