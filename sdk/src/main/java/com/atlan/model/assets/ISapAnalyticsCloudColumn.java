...
public interface ISapAnalyticsCloudColumn {

    public static final String TYPE_NAME = "SapAnalyticsCloudColumn";

    /** Model in which this column is defined. */
    RelationField SAP_ANALYTICS_CLOUD_MODEL = new RelationField("sapAnalyticsCloudModel");

    /** Simple name of the SAP Analytics Cloud model in which this column exists. */
    KeywordField SAP_ANALYTICS_CLOUD_MODEL_NAME =
            new KeywordField("sapAnalyticsCloudModelName", "sapAnalyticsCloudModelName");

    /** Unique name of the SAP Analytics Cloud model in which this column exists. */
    KeywordField SAP_ANALYTICS_CLOUD_MODEL_QUALIFIED_NAME =
            new KeywordField("sapAnalyticsCloudModelQualifiedName", "sapAnalyticsCloudModelQualifiedName");
    ...
    /** Model in which this column is defined. */
    default ISapAnalyticsCloudModel getSapAnalyticsCloudModel() {
        return null;
    }

    /** Simple name of the SAP Analytics Cloud model in which this column exists. */
    String getSapAnalyticsCloudModelName();

    /** Unique name of the SAP Analytics Cloud model in which this column exists. */
    String getSapAnalyticsCloudModelQualifiedName();
