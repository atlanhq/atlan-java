...
/**
 * Definition of a custom relationship in the metamodel.
 */
@Generated(value = "com.atlan.generators.ModelGeneratorV2")
@JsonSerialize(using = AssetSerializer.class)
@JsonDeserialize(using = AssetDeserializer.class)
public interface ITypeRegistryRelationship {

    public static final String TYPE_NAME = "TypeRegistryRelationship";
    ...
    KeywordField TYPE_REGISTRY_TAG_PROPAGATION =
            new KeywordField("typeRegistryTagPropagation", "typeRegistryTagPropagation");
    ...
    public static String generateQualifiedName(
            String parentQualifiedName, TypeRegistryEndDef end1, TypeRegistryEndDef end2) {
