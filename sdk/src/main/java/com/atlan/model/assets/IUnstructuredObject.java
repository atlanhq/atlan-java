...
public interface IUnstructuredObject {

    public static final String TYPE_NAME = "UnstructuredObject";

    /** Data container that directly holds this object. */
    RelationField UNSTRUCTURED_CONTAINER = new RelationField("unstructuredContainer");
    ...
    KeywordField UNSTRUCTURED_OBJECT_CONTENT_LANGUAGE =
            new KeywordField("unstructuredObjectContentLanguage", "unstructuredObjectContentLanguage");

    /** File extension of this object without the leading dot, for example: pdf, docx, csv. */
    KeywordField UNSTRUCTURED_OBJECT_EXTENSION =
            new KeywordField("unstructuredObjectExtension", "unstructuredObjectExtension");
    ...
    KeywordField UNSTRUCTURED_OBJECT_KEY = new KeywordField("unstructuredObjectKey", "unstructuredObjectKey");

    /** MIME type of this object's content, for example: text/plain, application/json, application/pdf. */
    KeywordField UNSTRUCTURED_OBJECT_MIME_TYPE =
            new KeywordField("unstructuredObjectMimeType", "unstructuredObjectMimeType");

    /** Object size in bytes. */
    NumericField UNSTRUCTURED_OBJECT_SIZE = new NumericField("unstructuredObjectSize", "unstructuredObjectSize");

    /** Immediate parent folder of this object. */
    RelationField UNSTRUCTURED_PARENT_FOLDER = new RelationField("unstructuredParentFolder");
    ...
    /** Data container that directly holds this object. */
    default IUnstructuredContainer getUnstructuredContainer() {
        return null;
    }

    /** Simple name of the data container that holds this asset. */
    String getUnstructuredContainerName();

    /** Unique name of the data container that holds this asset. */
    String getUnstructuredContainerQualifiedName();
    ...
    List<Map<String, String>> getUnstructuredFolderHierarchy();

    /** Natural (human) language of this object's content, as detected at the source. For example: English, Spanish, French. This is the language the content is written in — not a programming language. */
    String getUnstructuredObjectContentLanguage();

    /** File extension of this object without the leading dot, for example: pdf, docx, csv. */
    String getUnstructuredObjectExtension();

    /** Unique identity of this object within its container — typically the concatenation of any folder path and the object's own filename. */
    String getUnstructuredObjectKey();

    /** MIME type of this object's content, for example: text/plain, application/json, application/pdf. */
    String getUnstructuredObjectMimeType();

    /** Object size in bytes. */
    Long getUnstructuredObjectSize();

    /** Immediate parent folder of this object. */
    default IUnstructuredFolder getUnstructuredParentFolder() {
        return null;
    }

    /** Unique name of the immediate parent folder containing this asset. */
    String getUnstructuredParentFolderQualifiedName();
