...
public class StarburstDatasetColumn extends Asset implements IStarburstDatasetColumn, IColumn, IStarburst, ICatalog, IAsset, IReferenceable, ISQL {
    ...
    /** Fixed typeName for StarburstDatasetColumns. */
    ...
    @Attribute
    IStarburstDataset starburstDataset;
    ...
    @Attribute
    String starburstSqlColumnQualifiedName;
    ...
    /**
     * Builds the minimal object necessary to create a relationship to a StarburstDatasetColumn, from a potentially
     * more-complete StarburstDatasetColumn object.
     *
     * @return the minimal object necessary to relate to the StarburstDatasetColumn
     * @throws InvalidRequestException if any of the minimal set of required properties for a StarburstDatasetColumn relationship are not found in the initial object
     */
    @Override
    public StarburstDatasetColumn trimToReference() throws InvalidRequestException {
    ...
    /**
     * Start a fluent search that will return all StarburstDatasetColumn assets.
     * Additional conditions can be chained onto the returned search before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) StarburstDatasetColumn assets will be included.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @return a fluent search that includes all StarburstDatasetColumn assets
     */
     ...
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @param includeArchived when true, archived (soft-deleted) StarburstDatasetColumns will be included
     * @return a fluent search that includes all StarburstDatasetColumn assets
     */
    ...
    /**
     * Reference to a StarburstDatasetColumn by GUID. Use this to create a relationship to this StarburstDatasetColumn,
     * where the relationship should be replaced.
     *
     * @param guid the GUID of the StarburstDatasetColumn to reference
     * @return reference to a StarburstDatasetColumn that can be used for defining a relationship to a StarburstDatasetColumn
     */
    public static StarburstDatasetColumn refByGuid(String guid) {
     ...
     * @return reference to a StarburstDatasetColumn that can be used for defining a relationship to a StarburstDatasetColumn
     */
    public static StarburstDatasetColumn refByGuid(String guid, Reference.SaveSemantic semantic) {
        return StarburstDatasetColumn._internal().guid(guid).semantic(semantic).build();
    }

    /**
     * Reference to a StarburstDatasetColumn by qualifiedName. Use this to create a relationship to this StarburstDatasetColumn,
     * where the relationship should be replaced.
     *
     * @param qualifiedName the qualifiedName of the StarburstDatasetColumn to reference
     * @return reference to a StarburstDatasetColumn that can be used for defining a relationship to a StarburstDatasetColumn
     */
    public static StarburstDatasetColumn refByQualifiedName(String qualifiedName) {
     ...
     * @return reference to a StarburstDatasetColumn that can be used for defining a relationship to a StarburstDatasetColumn
     */
    public static StarburstDatasetColumn refByQualifiedName(String qualifiedName, Reference.SaveSemantic semantic) {
        return StarburstDatasetColumn._internal()
                .uniqueAttributes(
    ...
    /**
     * Retrieves a StarburstDatasetColumn by one of its identifiers, complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the StarburstDatasetColumn to retrieve, either its GUID or its full qualifiedName
     * @return the requested full StarburstDatasetColumn, complete with all of its relationships
     ...
     */
    @JsonIgnore
    public static StarburstDatasetColumn get(AtlanClient client, String id) throws AtlanException {
        return get(client, id, false);
    }

    /**
     * Retrieves a StarburstDatasetColumn by one of its identifiers, optionally complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the StarburstDatasetColumn to retrieve, either its GUID or its full qualifiedName
     * @param includeAllRelationships if true, all the asset's relationships will also be retrieved; if false, no relationships will be retrieved
     * @return the requested full StarburstDatasetColumn, optionally complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the StarburstDatasetColumn does not exist or the provided GUID is not a StarburstDatasetColumn
     */
    @JsonIgnore
    public static StarburstDatasetColumn get(AtlanClient client, String id, boolean includeAllRelationships) throws AtlanException {
        if (id == null) {
            ...
            } else if (asset instanceof StarburstDatasetColumn) {
                return (StarburstDatasetColumn) asset;
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
            Asset asset = Asset.get(client, TYPE_NAME, id, includeAllRelationships);
            if (asset instanceof StarburstDatasetColumn) {
                return (StarburstDatasetColumn) asset;
            } else {
    ...
    /**
     * Retrieves a StarburstDatasetColumn by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the StarburstDatasetColumn to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the StarburstDatasetColumn, including any relationships
     * @return the requested StarburstDatasetColumn, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the StarburstDatasetColumn does not exist or the provided GUID is not a StarburstDatasetColumn
     */
    @JsonIgnore
     ...
     * @param id of the StarburstDatasetColumn to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the StarburstDatasetColumn, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the StarburstDatasetColumn
     * @return the requested StarburstDatasetColumn, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the StarburstDatasetColumn does not exist or the provided GUID is not a StarburstDatasetColumn
     */
    @JsonIgnore
    public static StarburstDatasetColumn get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = StarburstDatasetColumn.select(client)
                    .where(StarburstDatasetColumn.GUID.eq(id))
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof StarburstDatasetColumn) {
                return (StarburstDatasetColumn) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
            Optional<Asset> asset = StarburstDatasetColumn.select(client)
                    .where(StarburstDatasetColumn.QUALIFIED_NAME.eq(id))
                    .includesOnResults(attributes)
                    .includesOnRelations(attributesOnRelated)
                    .includeRelationshipAttributes(true)
                    .pageSize(1)
    ...
    /**
     * Restore the archived (soft-deleted) StarburstDatasetColumn to active.
     *
     * @param client connectivity to the Atlan tenant on which to restore the asset
     * @param qualifiedName for the StarburstDatasetColumn
     * @return true if the StarburstDatasetColumn is now active, and false otherwise
    ...
    /**
     * Builds the minimal object necessary to update a StarburstDatasetColumn.
     *
     * @param qualifiedName of the StarburstDatasetColumn
     * @param name of the StarburstDatasetColumn
     * @return the minimal request necessary to update the StarburstDatasetColumn, as a builder
     */
    public static StarburstDatasetColumnBuilder<?, ?> updater(String qualifiedName, String name) {
        return StarburstDatasetColumn._internal()
    ...
    /**
     * Builds the minimal object necessary to apply an update to a StarburstDatasetColumn,
     * from a potentially more-complete StarburstDatasetColumn object.
     *
     * @return the minimal object necessary to update the StarburstDatasetColumn, as a builder
     * @throws InvalidRequestException if any of the minimal set of required fields for a StarburstDatasetColumn are not present in the initial object
     */
    @Override
    public StarburstDatasetColumnBuilder<?, ?> trimToRequired() throws InvalidRequestException {
    ...
    /**
     * Remove the system description from a StarburstDatasetColumn.
     *
    ...
    /**
     * Remove the user's description from a StarburstDatasetColumn.
     *
     * @param client connectivity to the Atlan tenant on which to remove the asset's description
     * @param qualifiedName of the StarburstDatasetColumn
     * @param name of the StarburstDatasetColumn
     ...
     * @throws AtlanException on any API problems
     */
    public static StarburstDatasetColumn removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (StarburstDatasetColumn) Asset.removeUserDescription(client, updater(qualifiedName, name));
    }

    /**
     * Remove the owners from a StarburstDatasetColumn.
     *
     * @param client connectivity to the Atlan tenant from which to remove the StarburstDatasetColumn's owners
     * @param qualifiedName of the StarburstDatasetColumn
     * @param name of the StarburstDatasetColumn
     * @return the updated StarburstDatasetColumn, or null if the removal failed
     * @throws AtlanException on any API problems
    ...
    /**
     * Update the certificate on a StarburstDatasetColumn.
     *
     * @param client connectivity to the Atlan tenant on which to update the StarburstDatasetColumn's certificate
     * @param qualifiedName of the StarburstDatasetColumn
     * @param certificate to use
     * @param message (optional) message, or null if no message
     * @return the updated StarburstDatasetColumn, or null if the update failed
     * @throws AtlanException on any API problems
     */
    ...
    /**
     * Remove the certificate from a StarburstDatasetColumn.
     *
     * @param client connectivity to the Atlan tenant from which to remove the StarburstDatasetColumn's certificate
     * @param qualifiedName of the StarburstDatasetColumn
     * @param name of the StarburstDatasetColumn
     * @return the updated StarburstDatasetColumn, or null if the removal failed
     * @throws AtlanException on any API problems
    ...
    /**
     * Update the announcement on a StarburstDatasetColumn.
     *
     * @param client connectivity to the Atlan tenant on which to update the StarburstDatasetColumn's announcement
     * @param qualifiedName of the StarburstDatasetColumn
    ...
    /**
     * Remove the announcement from a StarburstDatasetColumn.
     *
     * @param client connectivity to the Atlan client from which to remove the StarburstDatasetColumn's announcement
     * @param qualifiedName of the StarburstDatasetColumn
     * @param name of the StarburstDatasetColumn
     * @return the updated StarburstDatasetColumn, or null if the removal failed
     * @throws AtlanException on any API problems
     */
    public static StarburstDatasetColumn removeAnnouncement(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (StarburstDatasetColumn) Asset.removeAnnouncement(client, updater(qualifiedName, name));
    }

    /**
     * Replace the terms linked to the StarburstDatasetColumn.
     *
     * @param client connectivity to the Atlan tenant on which to replace the StarburstDatasetColumn's assigned terms
     * @param qualifiedName for the StarburstDatasetColumn
     * @param name human-readable name of the StarburstDatasetColumn
     * @param terms the list of terms to replace on the StarburstDatasetColumn, or null to remove all terms from the StarburstDatasetColumn
    ...
    /**
     * Link additional terms to the StarburstDatasetColumn, without replacing existing terms linked to the StarburstDatasetColumn.
     * Note: this operation must make two API calls — one to retrieve the StarburstDatasetColumn's existing terms,
     * and a second to append the new terms.
     *
     * @param client connectivity to the Atlan tenant on which to append terms to the StarburstDatasetColumn
     * @param qualifiedName for the StarburstDatasetColumn
     * @param terms the list of terms to append to the StarburstDatasetColumn
     * @return the StarburstDatasetColumn that was updated  (note that it will NOT contain details of the appended terms)
     * @throws AtlanException on any API problems
    ...
    /**
     * Remove terms from a StarburstDatasetColumn, without replacing all existing terms linked to the StarburstDatasetColumn.
     * Note: this operation must make two API calls — one to retrieve the StarburstDatasetColumn's existing terms,
     * and a second to remove the provided terms.
     *
     * @param client connectivity to the Atlan tenant from which to remove terms from the StarburstDatasetColumn
     * @param qualifiedName for the StarburstDatasetColumn
     * @param terms the list of terms to remove from the StarburstDatasetColumn, which must be referenced by GUID
     * @return the StarburstDatasetColumn that was updated (note that it will NOT contain details of the resulting terms)
     * @throws AtlanException on any API problems
    ...
    /**
     * Add Atlan tags to a StarburstDatasetColumn, without replacing existing Atlan tags linked to the StarburstDatasetColumn.
     * Note: this operation must make two API calls — one to retrieve the StarburstDatasetColumn's existing Atlan tags,
     * and a second to append the new Atlan tags.
     *
     * @param client connectivity to the Atlan tenant on which to append Atlan tags to the StarburstDatasetColumn
     * @param qualifiedName of the StarburstDatasetColumn
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems
     * @return the updated StarburstDatasetColumn
    ...
    public static StarburstDatasetColumn appendAtlanTags(
            ...
            throws AtlanException {
        return (StarburstDatasetColumn) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
    ...
    /**
     * Remove an Atlan tag from a StarburstDatasetColumn.
     *
     * @param client connectivity to the Atlan tenant from which to remove an Atlan tag from a StarburstDatasetColumn
     * @param qualifiedName of the StarburstDatasetColumn
     * @param atlanTagName human-readable name of the Atlan tag to remove
     * @throws AtlanException on any API problems, or if the Atlan tag does not exist on the StarburstDatasetColumn
