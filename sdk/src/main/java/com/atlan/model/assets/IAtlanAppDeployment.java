...
public interface IAtlanAppDeployment {

    public static final String TYPE_NAME = "AtlanAppDeployment";

    /** Type of operation requested. */
    KeywordField ATLAN_APP_OPERATION = new KeywordField("atlanAppOperation", "atlanAppOperation");

    /** Status of deployment. */
    KeywordField ATLAN_APP_STATUS = new KeywordField("atlanAppStatus", "atlanAppStatus");

    /** Version identifier for deployment. */
    NumericField ATLAN_APP_VERSION_ID = new NumericField("atlanAppVersionId", "atlanAppVersionId");
    ...
    /** Type of operation requested. */
    AtlanAppDeploymentOperation getAtlanAppOperation();

    /** Status of deployment. */
    AtlanAppDeploymentStatus getAtlanAppStatus();

    /** Version identifier for deployment. */
    Integer getAtlanAppVersionId();
