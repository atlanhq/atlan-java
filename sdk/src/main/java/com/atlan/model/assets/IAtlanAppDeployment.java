...
public interface IAtlanAppDeployment {
    ...
    KeywordField ATLAN_APP_ERROR_DETAILS = new KeywordField("atlanAppErrorDetails", "atlanAppErrorDetails");
    ...
    KeywordField ATLAN_APP_VERSION_UUID = new KeywordField("atlanAppVersionUUID", "atlanAppVersionUUID");
    ...
    /** Detailed error message explaining why the deployment failed. Should only be populated when status = FAILED. */
    String getAtlanAppErrorDetails();
