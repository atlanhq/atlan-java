...
public interface ICognosFolder {
    ...
    NumericField COGNOS_FOLDER_CHILD_OBJECTS_COUNT =
            new NumericField("cognosFolderChildObjectsCount", "cognosFolderChildObjectsCount");
    ...
    /** Dashboards contained in the folder. */
    default SortedSet<ICognosDashboard> getCognosDashboards() {
        return null;
    }

    /** Datasets contained in the folder. */
    default SortedSet<ICognosDataset> getCognosDatasets() {
        return null;
    }
    ...
    /** Explorations contained in the folder. */
    default SortedSet<ICognosExploration> getCognosExplorations() {
        return null;
    }

    /** Files contained in the folder. */
    default SortedSet<ICognosFile> getCognosFiles() {
        return null;
    }

    /** Parent folder containing this folder. */
    default ICognosFolder getCognosFolder() {
        return null;
    }

    /** Number of children in the folder (excluding subfolders). */
    Integer getCognosFolderChildObjectsCount();
    ...
    /** Modules contained in the folder. */
    default SortedSet<ICognosModule> getCognosModules() {
        return null;
    }

    /** Packages contained in the folder. */
    default SortedSet<ICognosPackage> getCognosPackages() {
        return null;
    }
    ...
    /** Reports contained in the folder. */
    default SortedSet<ICognosReport> getCognosReports() {
        return null;
    }

    /** Subfolders contained in the folder. */
    default SortedSet<ICognosFolder> getCognosSubFolders() {
        return null;
    }
