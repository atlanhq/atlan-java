...
public class DMAttributeAssociation extends Asset
    ...
    /**
     * Start an asset filter that will return all DMAttributeAssociation assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DMAttributeAssociation assets will be included.
     *
     * @return an asset filter that includes all DMAttributeAssociation assets
    ...
    /**
     * Retrieves a DMAttributeAssociation by its GUID, complete with all of its relationships.
     *
     * @param guid of the DMAttributeAssociation to retrieve
     * @return the requested full DMAttributeAssociation, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DMAttributeAssociation does not exist or the provided GUID is not a DMAttributeAssociation
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DMAttributeAssociation retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DMAttributeAssociation retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DMAttributeAssociation by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DMAttributeAssociation to retrieve
     * @return the requested full DMAttributeAssociation, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DMAttributeAssociation does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DMAttributeAssociation retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DMAttributeAssociation retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a DMAttributeAssociation.
     *
     * @param qualifiedName of the DMAttributeAssociation
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DMAttributeAssociation
     ...
     * Add Atlan tags to a DMAttributeAssociation.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DMAttributeAssociation
     * @param qualifiedName of the DMAttributeAssociation
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DMAttributeAssociation
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
