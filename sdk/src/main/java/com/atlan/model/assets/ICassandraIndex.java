...
public interface ICassandraIndex {

    public static final String TYPE_NAME = "CassandraIndex";

    /** Kind of index (e.g. COMPOSITES). */
    KeywordField CASSANDRA_INDEX_KIND = new KeywordField("cassandraIndexKind", "cassandraIndexKind");

    /** Options for the index. */
    KeywordField CASSANDRA_INDEX_OPTIONS = new KeywordField("cassandraIndexOptions", "cassandraIndexOptions");

    /** Query used to create the index. */
    KeywordField CASSANDRA_INDEX_QUERY = new KeywordField("cassandraIndexQuery", "cassandraIndexQuery");
    ...
    /** Kind of index (e.g. COMPOSITES). */
    String getCassandraIndexKind();

    /** Options for the index. */
    Map<String, String> getCassandraIndexOptions();

    /** Query used to create the index. */
    String getCassandraIndexQuery();
