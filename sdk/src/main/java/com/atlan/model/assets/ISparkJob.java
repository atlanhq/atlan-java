...
public interface ISparkJob {
    ...
    KeywordTextField SPARK_APP_NAME = new KeywordTextField("sparkAppName", "sparkAppName.keyword", "sparkAppName");

    /** The Spark master URL eg. local, local[4], or spark://master:7077 */
    KeywordField SPARK_MASTER = new KeywordField("sparkMaster", "sparkMaster");
