...
public interface ICassandraKeyspace {
    ...
    BooleanField CASSANDRA_KEYSPACE_DURABLE_WRITES =
            new BooleanField("cassandraKeyspaceDurableWrites", "cassandraKeyspaceDurableWrites");

    /** Query associated with the CassandraKeyspace. */
    KeywordField CASSANDRA_KEYSPACE_QUERY = new KeywordField("cassandraKeyspaceQuery", "cassandraKeyspaceQuery");

    /** Replication class for the CassandraKeyspace. */
    KeywordField CASSANDRA_KEYSPACE_REPLICATION =
            new KeywordField("cassandraKeyspaceReplication", "cassandraKeyspaceReplication");

    /** Indicates whether the CassandraKeyspace is virtual. */
    BooleanField CASSANDRA_KEYSPACE_VIRTUAL = new BooleanField("cassandraKeyspaceVirtual", "cassandraKeyspaceVirtual");

    /** Individual tables contained in the keyspace. */
    RelationField CASSANDRA_TABLES = new RelationField("cassandraTables");

    /** Individual views contained in the keyspace. */
    RelationField CASSANDRA_VIEWS = new RelationField("cassandraViews");
    ...
    /** Indicates whether durable writes are enabled for the CassandraKeyspace. */
    Boolean getCassandraKeyspaceDurableWrites();

    /** Name of the keyspace for the Cassandra asset. */
    String getCassandraKeyspaceName();

    /** Query associated with the CassandraKeyspace. */
    String getCassandraKeyspaceQuery();

    /** Replication class for the CassandraKeyspace. */
    Map<String, String> getCassandraKeyspaceReplication();

    /** Indicates whether the CassandraKeyspace is virtual. */
    Boolean getCassandraKeyspaceVirtual();
    ...
    /** Individual tables contained in the keyspace. */
    SortedSet<ICassandraTable> getCassandraTables();
    ...
    /** Individual views contained in the keyspace. */
    SortedSet<ICassandraView> getCassandraViews();
