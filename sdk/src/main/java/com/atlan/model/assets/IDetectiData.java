...
/**
 * Assets used to capture DetectiData context.
 */
@Generated(value = "com.atlan.generators.ModelGeneratorV2")
@JsonSerialize(using = AssetSerializer.class)
@JsonDeserialize(using = AssetDeserializer.class)
public interface IDetectiData {

    public static final String TYPE_NAME = "DetectiData";

    /** Simple name of the dossier in which this asset exists, or empty if it is itself a dossier. */
    KeywordTextField DETECTI_DATA_DOSSIER_NAME =
            new KeywordTextField("detectiDataDossierName", "detectiDataDossierName.keyword", "detectiDataDossierName");

    /** Unique name of the dossier in which this asset exists, or empty if it is itself a dossier. */
    KeywordField DETECTI_DATA_DOSSIER_QUALIFIED_NAME =
            new KeywordField("detectiDataDossierQualifiedName", "detectiDataDossierQualifiedName");
