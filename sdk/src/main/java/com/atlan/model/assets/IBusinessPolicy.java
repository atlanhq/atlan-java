...
public interface IBusinessPolicy {
    ...
    KeywordField BUSINESS_POLICY_BASE_PARENT_GUID =
    ...
    TextField BUSINESS_POLICY_LONG_DESCRIPTION =
            new TextField("businessPolicyLongDescription", "businessPolicyLongDescription");
    ...
    NumericField BUSINESS_POLICY_VALID_FROM = new NumericField("businessPolicyValidFrom", "businessPolicyValidFrom");

    /** Validity end date of the policy */
    NumericField BUSINESS_POLICY_VALID_TILL = new NumericField("businessPolicyValidTill", "businessPolicyValidTill");

    /** Version of the policy */
    NumericField BUSINESS_POLICY_VERSION = new NumericField("businessPolicyVersion", "businessPolicyVersion");

    /** Exception assigned to business polices */
    RelationField EXCEPTIONS_FOR_BUSINESS_POLICY = new RelationField("exceptionsForBusinessPolicy");

    /** BusinessPolicy that have the same (or relatable) compliance */
    RelationField RELATED_BUSINESS_POLICIES = new RelationField("relatedBusinessPolicies");
    ...
    /** Base parent Guid for policy used in version */
    String getBusinessPolicyBaseParentGuid();

    /** Business Policy Filter ES DSL to denote the associate asset/s involved. */
    String getBusinessPolicyFilterDSL();

    /** Body of the business policy, a long readme like document */
    String getBusinessPolicyLongDescription();
    ...
    /** Type of business policy */
    String getBusinessPolicyType();

    /** Validity start date of the policy */
    Long getBusinessPolicyValidFrom();

    /** Validity end date of the policy */
    Long getBusinessPolicyValidTill();

    /** Version of the policy */
    Integer getBusinessPolicyVersion();
    ...
    /** Exception assigned to business polices */
    default SortedSet<IBusinessPolicyException> getExceptionsForBusinessPolicy() {
        return null;
    }
    ...
    /** BusinessPolicy that have the same (or relatable) compliance */
    default SortedSet<IBusinessPolicy> getRelatedBusinessPolicies() {
        return null;
    }
