...
public interface IAzureServiceBusNamespace {
    ...
    RelationField AZURE_SERVICE_BUS_TOPICS = new RelationField("azureServiceBusTopics");
    ...
    String getAzureServiceBusNamespaceName();
