...
public interface IModelEntityAssociation {
    ...
    KeywordField MODEL_ENTITY_ASSOCIATION_TO_QUALIFIED_NAME =
            new KeywordField("modelEntityAssociationToQualifiedName", "modelEntityAssociationToQualifiedName");
    ...
    /** Entity from which this association is related. */
    default IModelEntity getModelEntityAssociationFrom() {
        return null;
    }
    ...
    /** Entity to which this association is related. */
    default IModelEntity getModelEntityAssociationTo() {
        return null;
    }
