...
/**
 * Instance of AWS SMUS Project in Atlan
 */
@Generated(value = "com.atlan.generators.ModelGeneratorV2")
@JsonSerialize(using = AssetSerializer.class)
@JsonDeserialize(using = AssetDeserializer.class)
public interface ISageMakerUnifiedStudioProject {

    public static final String TYPE_NAME = "SageMakerUnifiedStudioProject";

    /** DataProducts associated with this AWS SMUS Project. */
    RelationField SMUS_DATA_PRODUCTS = new RelationField("smusDataProducts");

    /** Project Profile Name of the AWS SMUS Project */
    KeywordField SMUS_PROJECT_PROFILE_NAME = new KeywordField("smusProjectProfileName", "smusProjectProfileName");

    /** Amazon IAM Role ARN of the AWS SMUS Project */
    KeywordField SMUS_PROJECT_ROLE_ARN = new KeywordField("smusProjectRoleArn", "smusProjectRoleArn");
    ...
    /** DataProducts associated with this AWS SMUS Project. */
    SortedSet<IDataProduct> getSmusDataProducts();
    ...
    /** Project Profile Name of the AWS SMUS Project */
    String getSmusProjectProfileName();

    /** Amazon IAM Role ARN of the AWS SMUS Project */
    String getSmusProjectRoleArn();
