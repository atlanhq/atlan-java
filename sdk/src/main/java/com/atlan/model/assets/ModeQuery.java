...
public class ModeQuery extends Asset implements IModeQuery, IMode, IBI, ICatalog, IAsset, IReferenceable {
     ...
     *
     * @return the minimal object necessary to relate to the ModeQuery
     * @throws InvalidRequestException if any of the minimal set of required properties for a ModeQuery relationship are not found in the initial object
     */
    @Override
    public ModeQuery trimToReference() throws InvalidRequestException {
    ...
    /**
     * Retrieves a ModeQuery by one of its identifiers, optionally complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the ModeQuery to retrieve, either its GUID or its full qualifiedName
     * @param includeAllRelationships if true, all the asset's relationships will also be retrieved; if false, no relationships will be retrieved
     * @return the requested full ModeQuery, optionally complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the ModeQuery does not exist or the provided GUID is not a ModeQuery
     */
    @JsonIgnore
    public static ModeQuery get(AtlanClient client, String id, boolean includeAllRelationships) throws AtlanException {
        if (id == null) {
    ...
    /**
     * Retrieves a ModeQuery by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the ModeQuery to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the ModeQuery, including any relationships
     * @return the requested ModeQuery, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the ModeQuery does not exist or the provided GUID is not a ModeQuery
     */
    @JsonIgnore
     ...
     * @param id of the ModeQuery to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the ModeQuery, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the ModeQuery
     * @return the requested ModeQuery, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the ModeQuery does not exist or the provided GUID is not a ModeQuery
     */
    @JsonIgnore
    public static ModeQuery get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = ModeQuery.select(client)
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof ModeQuery) {
                return (ModeQuery) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
