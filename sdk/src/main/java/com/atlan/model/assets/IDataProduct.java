...
public interface IDataProduct {
    ...
    RelationField DATA_CONTRACTS = new RelationField("dataContracts");
    ...
    KeywordField DATA_PRODUCT_THEME = new KeywordField("dataProductTheme", "dataProductTheme");
    ...
    /** Data contracts that exist within this data product. */
    SortedSet<IDataContract> getDataContracts();

    /** Data domain in which this data product exists. */
    IDataDomain getDataDomain();

    /** Search DSL used to define which assets are part of this data product. */
    String getDataProductAssetsDSL();

    /** Playbook filter to define which assets are part of this data product. */
    String getDataProductAssetsPlaybookFilter();
