...
public class CosmosMongoDBAccount extends Asset
     ...
     */
    @JsonIgnore
    public static CosmosMongoDBAccount get(AtlanClient client, String id, boolean includeAllRelationships)
     ...
     */
    @JsonIgnore
    public static CosmosMongoDBAccount get(AtlanClient client, String id, Collection<AtlanField> attributes)
            throws AtlanException {
    ...
    public abstract static class CosmosMongoDBAccountBuilder<
                    C extends CosmosMongoDBAccount, B extends CosmosMongoDBAccountBuilder<C, B>>
