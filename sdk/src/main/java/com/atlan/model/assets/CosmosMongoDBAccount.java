...
public class CosmosMongoDBAccount extends Asset implements ICosmosMongoDBAccount, ICosmosMongoDB, INoSQL, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Retrieves a CosmosMongoDBAccount by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the CosmosMongoDBAccount to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the CosmosMongoDBAccount, including any relationships
     * @return the requested CosmosMongoDBAccount, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CosmosMongoDBAccount does not exist or the provided GUID is not a CosmosMongoDBAccount
     */
    @JsonIgnore
     ...
     * @param id of the CosmosMongoDBAccount to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the CosmosMongoDBAccount, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the CosmosMongoDBAccount
     * @return the requested CosmosMongoDBAccount, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CosmosMongoDBAccount does not exist or the provided GUID is not a CosmosMongoDBAccount
     */
    @JsonIgnore
    public static CosmosMongoDBAccount get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = CosmosMongoDBAccount.select(client)
                    .where(CosmosMongoDBAccount.GUID.eq(id))
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof CosmosMongoDBAccount) {
            ...
            Optional<Asset> asset = CosmosMongoDBAccount.select(client)
                    .where(CosmosMongoDBAccount.QUALIFIED_NAME.eq(id))
                    .includesOnResults(attributes)
                    .includesOnRelations(attributesOnRelated)
                    .includeRelationshipAttributes(true)
                    .pageSize(1)
    ...
    public abstract static class CosmosMongoDBAccountBuilder<C extends CosmosMongoDBAccount, B extends CosmosMongoDBAccountBuilder<C, B>>
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBAccount replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    @Deprecated
    public static CosmosMongoDBAccount appendAtlanTags(AtlanClient client, String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
