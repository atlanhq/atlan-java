...
public interface IDbtTest {
    ...
    TextField DBT_TEST_RAW_CODE = new TextField("dbtTestRawCode", "dbtTestRawCode");

    /** Raw SQL of the test. */
    TextField DBT_TEST_RAW_SQL = new TextField("dbtTestRawSQL", "dbtTestRawSQL");
    ...
    /** Assets related to this test. */
    default SortedSet<ISQL> getSqlAssets() {
        return null;
    }
