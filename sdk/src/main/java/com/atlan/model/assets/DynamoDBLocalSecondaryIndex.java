...
public class DynamoDBLocalSecondaryIndex extends Asset
    ...
    /**
     * Start an asset filter that will return all DynamoDBLocalSecondaryIndex assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DynamoDBLocalSecondaryIndex assets will be included.
     *
     * @return an asset filter that includes all DynamoDBLocalSecondaryIndex assets
    ...
    /**
     * Reference to a DynamoDBLocalSecondaryIndex by GUID.
     *
    ...
    public static DynamoDBLocalSecondaryIndex refByGuid(String guid) {
        return DynamoDBLocalSecondaryIndex._internal().guid(guid).build();
    }

    /**
     * Reference to a DynamoDBLocalSecondaryIndex by qualifiedName.
     *
    ...
    /**
     * Retrieves a DynamoDBLocalSecondaryIndex by its GUID, complete with all of its relationships.
     *
     * @param guid of the DynamoDBLocalSecondaryIndex to retrieve
     * @return the requested full DynamoDBLocalSecondaryIndex, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DynamoDBLocalSecondaryIndex does not exist or the provided GUID is not a DynamoDBLocalSecondaryIndex
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DynamoDBLocalSecondaryIndex retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DynamoDBLocalSecondaryIndex retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DynamoDBLocalSecondaryIndex by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DynamoDBLocalSecondaryIndex to retrieve
     * @return the requested full DynamoDBLocalSecondaryIndex, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DynamoDBLocalSecondaryIndex does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DynamoDBLocalSecondaryIndex retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DynamoDBLocalSecondaryIndex retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public DynamoDBLocalSecondaryIndexBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "DynamoDBLocalSecondaryIndex", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a DynamoDBLocalSecondaryIndex.
     *
     * @param qualifiedName of the DynamoDBLocalSecondaryIndex
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DynamoDBLocalSecondaryIndex
     ...
     * Add Atlan tags to a DynamoDBLocalSecondaryIndex.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DynamoDBLocalSecondaryIndex
     * @param qualifiedName of the DynamoDBLocalSecondaryIndex
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DynamoDBLocalSecondaryIndex
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
