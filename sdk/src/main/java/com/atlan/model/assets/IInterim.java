...
/**
 * Base class for interim, ephemeral assets that nonetheless participate in lineage.
 */
@Generated(value = "com.atlan.generators.ModelGeneratorV2")
@JsonSerialize(using = AssetSerializer.class)
@JsonDeserialize(using = AssetDeserializer.class)
public interface IInterim {

    public static final String TYPE_NAME = "Interim";

    /** Unique name of the InterimDataset. */
    KeywordField INTERIM_DATASET_QUALIFIED_NAME =
            new KeywordField("interimDatasetQualifiedName", "interimDatasetQualifiedName");
