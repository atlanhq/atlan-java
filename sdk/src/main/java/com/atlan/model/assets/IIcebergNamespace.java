...
public interface IIcebergNamespace {

    public static final String TYPE_NAME = "IcebergNamespace";

    /** Parent Iceberg Namespace containing the sub-namespaces. */
    RelationField ICEBERG_PARENT_NAMESPACE = new RelationField("icebergParentNamespace");

    /** Child namespaces nested within the parent Iceberg Namespace. */
    RelationField ICEBERG_SUB_NAMESPACES = new RelationField("icebergSubNamespaces");
    ...
    /** Child namespaces nested within the parent Iceberg Namespace. */
    default SortedSet<IIcebergNamespace> getIcebergSubNamespaces() {
        return null;
    }
