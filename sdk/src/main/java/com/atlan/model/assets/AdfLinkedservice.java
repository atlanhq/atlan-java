...
public class AdfLinkedservice extends Asset implements IAdfLinkedservice, IADF, ICatalog, IAsset, IReferenceable {
     ...
     */
    @JsonIgnore
    public static AdfLinkedservice get(String id) throws AtlanException {
     ...
     */
    @JsonIgnore
    public static AdfLinkedservice get(AtlanClient client, String id, boolean includeRelationships)
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfLinkedservice removeDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfLinkedservice removeUserDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfLinkedservice removeOwners(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfLinkedservice removeCertificate(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfLinkedservice removeAnnouncement(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfLinkedservice replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfLinkedservice appendTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfLinkedservice removeTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     */
    public static AdfLinkedservice appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
