...
public class StakeholderTitle extends Asset implements IStakeholderTitle, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all StakeholderTitle assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) StakeholderTitle assets will be included.
     *
     * @return an asset filter that includes all StakeholderTitle assets
     ...
     */
    @JsonIgnore
    public static StakeholderTitle get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a StakeholderTitle by its GUID, complete with all of its relationships.
     *
     * @param guid of the StakeholderTitle to retrieve
     * @return the requested full StakeholderTitle, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the StakeholderTitle does not exist or the provided GUID is not a StakeholderTitle
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static StakeholderTitle retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static StakeholderTitle retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a StakeholderTitle by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the StakeholderTitle to retrieve
     * @return the requested full StakeholderTitle, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the StakeholderTitle does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static StakeholderTitle retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static StakeholderTitle retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static StakeholderTitle replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static StakeholderTitle appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a StakeholderTitle.
     *
     * @param qualifiedName of the StakeholderTitle
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the StakeholderTitle
     ...
     * Add Atlan tags to a StakeholderTitle.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the StakeholderTitle
     * @param qualifiedName of the StakeholderTitle
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the StakeholderTitle
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
