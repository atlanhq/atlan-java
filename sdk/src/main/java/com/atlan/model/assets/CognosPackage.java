...
public class CognosPackage extends Asset implements ICognosPackage, ICognos, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all CognosPackage assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CognosPackage assets will be included.
     *
     * @return an asset filter that includes all CognosPackage assets
    ...
    /**
     * Retrieves a CognosPackage by its GUID, complete with all of its relationships.
     *
     * @param guid of the CognosPackage to retrieve
     * @return the requested full CognosPackage, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosPackage does not exist or the provided GUID is not a CognosPackage
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosPackage retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosPackage retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CognosPackage by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CognosPackage to retrieve
     * @return the requested full CognosPackage, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosPackage does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosPackage retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosPackage retrieveByQualifiedName(AtlanClient client, String qualifiedName)
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosPackage updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosPackage replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static CognosPackage appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CognosPackage.
     *
     * @param qualifiedName of the CognosPackage
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosPackage
     ...
     * Add Atlan tags to a CognosPackage.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CognosPackage
     * @param qualifiedName of the CognosPackage
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosPackage
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
