...
public class CognosPackage extends Asset implements ICognosPackage, ICognos, IBI, ICatalog, IAsset, IReferenceable {
     ...
     */
    @JsonIgnore
    public static CognosPackage get(AtlanClient client, String id, boolean includeAllRelationships) throws AtlanException {
        if (id == null) {
     ...
     */
    @JsonIgnore
    public static CognosPackage get(AtlanClient client, String id, Collection<AtlanField> attributes) throws AtlanException {
    ...
    public static CognosPackage updateCertificate(
            ...
            throws AtlanException {
        return (CognosPackage) Asset.updateCertificate(client, _internal(), TYPE_NAME, qualifiedName, certificate, message);
    }
    ...
    public static CognosPackage updateAnnouncement(
            ...
            throws AtlanException {
        return (CognosPackage) Asset.updateAnnouncement(client, _internal(), TYPE_NAME, qualifiedName, type, title, message);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosPackage replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
