...
public interface IGCPDataplexAspectType {
    ...
    RelationField GCP_DATAPLEX_ASPECT_TYPE_ENTRIES = new RelationField("gcpDataplexAspectTypeEntries");

    /** GCP labels attached to this Aspect Type resource. */
    KeywordField GCP_DATAPLEX_ASPECT_TYPE_LABELS =
            new KeywordField("gcpDataplexAspectTypeLabels", "gcpDataplexAspectTypeLabels");

    /** GCP location (region or global) in which this Aspect Type is defined. */
    KeywordField GCP_DATAPLEX_ASPECT_TYPE_LOCATION =
            new KeywordField("gcpDataplexAspectTypeLocation", "gcpDataplexAspectTypeLocation");

    /** Full Dataplex metadataTemplate JSON schema, stored as a stringified JSON blob. */
    KeywordField GCP_DATAPLEX_ASPECT_TYPE_METADATA_TEMPLATE =
            new KeywordField("gcpDataplexAspectTypeMetadataTemplate", "gcpDataplexAspectTypeMetadataTemplate");
    ...
    /** Dataplex Aspect Types whose aspects are attached to this entry (asset). */
    default SortedSet<IAsset> getGcpDataplexAspectTypeEntries() {
        return null;
    }

    /** GCP labels attached to this Aspect Type resource. */
    Map<String, String> getGcpDataplexAspectTypeLabels();

    /** GCP location (region or global) in which this Aspect Type is defined. */
    String getGcpDataplexAspectTypeLocation();

    /** Full Dataplex metadataTemplate JSON schema, stored as a stringified JSON blob. */
    String getGcpDataplexAspectTypeMetadataTemplate();
