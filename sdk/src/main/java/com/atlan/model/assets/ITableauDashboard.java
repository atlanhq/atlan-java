...
public interface ITableauDashboard {
    ...
    /** Fields that exist within this dashboard. */
    default SortedSet<ITableauDashboardField> getTableauDashboardFields() {
        return null;
    }

    /** Dashboards that are embedded in this dashboard. */
    default SortedSet<ITableauDashboard> getTableauEmbeddedDashboards() {
        return null;
    }

    /** Dashboards in which this dashboard is embedded in (list of parent dashboards of this dashboard). */
    default SortedSet<ITableauDashboard> getTableauParentDashboards() {
        return null;
    }
    ...
    /** Worksheets that use this dashboard. */
    default SortedSet<ITableauWorksheet> getWorksheets() {
        return null;
    }
