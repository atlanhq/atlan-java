...
public interface IDetectiDataDossierElement {

    public static final String TYPE_NAME = "DetectiDataDossierElement";

    /** Score of this individual component of the Dossier. */
    NumericField DETECTI_DATA_COMPONENT_SCORE =
            new NumericField("detectiDataComponentScore", "detectiDataComponentScore");

    /** DetectiData Dossier in which this element is combined with others. */
    RelationField DETECTI_DATA_DOSSIER = new RelationField("detectiDataDossier");
    ...
    /** Score of this individual component of the Dossier. */
    Long getDetectiDataComponentScore();

    /** DetectiData Dossier in which this element is combined with others. */
    IDetectiDataDossier getDetectiDataDossier();
