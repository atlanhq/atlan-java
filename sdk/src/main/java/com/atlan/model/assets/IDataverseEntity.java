...
public interface IDataverseEntity {
    ...
    RelationField DATAVERSE_ATTRIBUTES = new RelationField("dataverseAttributes");

    /** Schema Name of the DataverseEntity. */
    KeywordField DATAVERSE_ENTITY_SCHEMA_NAME = new KeywordField("dataverseEntitySchemaName", "dataverseEntitySchemaName");

    /** Table Type of the DataverseEntity. */
    KeywordField DATAVERSE_ENTITY_TABLE_TYPE = new KeywordField("dataverseEntityTableType", "dataverseEntityTableType");
    ...
    /** DataverseAttribute assets contained within this DataverseEntity. */
    SortedSet<IDataverseAttribute> getDataverseAttributes();

    /** Schema Name of the DataverseEntity. */
    String getDataverseEntitySchemaName();

    /** Table Type of the DataverseEntity. */
    String getDataverseEntityTableType();
