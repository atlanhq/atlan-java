...
public interface ISageMakerFeatureGroup {

    public static final String TYPE_NAME = "SageMakerFeatureGroup";

    /** Number of features in this Feature Group. */
    NumericField SAGE_MAKER_FEATURE_GROUP_FEATURE_COUNT =
            new NumericField("sageMakerFeatureGroupFeatureCount", "sageMakerFeatureGroupFeatureCount");

    /** AWS Glue database name associated with this Feature Group. */
    KeywordField SAGE_MAKER_FEATURE_GROUP_GLUE_DATABASE_NAME =
            new KeywordField("sageMakerFeatureGroupGlueDatabaseName", "sageMakerFeatureGroupGlueDatabaseName");

    /** AWS Glue table name associated with this Feature Group. */
    KeywordField SAGE_MAKER_FEATURE_GROUP_GLUE_TABLE_NAME =
            new KeywordField("sageMakerFeatureGroupGlueTableName", "sageMakerFeatureGroupGlueTableName");

    /** Name of the feature that serves as the record identifier. */
    KeywordField SAGE_MAKER_FEATURE_GROUP_RECORD_ID_NAME =
            new KeywordField("sageMakerFeatureGroupRecordIdName", "sageMakerFeatureGroupRecordIdName");

    /** Current status of the Feature Group (e.g., Created, Creating, Failed). */
    KeywordField SAGE_MAKER_FEATURE_GROUP_STATUS =
            new KeywordField("sageMakerFeatureGroupStatus", "sageMakerFeatureGroupStatus");

    /** Features that are defined within the SageMaker Feature Group. */
    RelationField SAGE_MAKER_FEATURES = new RelationField("sageMakerFeatures");
    ...
    /** Number of features in this Feature Group. */
    Long getSageMakerFeatureGroupFeatureCount();

    /** AWS Glue database name associated with this Feature Group. */
    String getSageMakerFeatureGroupGlueDatabaseName();

    /** AWS Glue table name associated with this Feature Group. */
    String getSageMakerFeatureGroupGlueTableName();

    /** Name of the feature that serves as the record identifier. */
    String getSageMakerFeatureGroupRecordIdName();

    /** Current status of the Feature Group (e.g., Created, Creating, Failed). */
    String getSageMakerFeatureGroupStatus();

    /** Features that are defined within the SageMaker Feature Group. */
    default SortedSet<ISageMakerFeature> getSageMakerFeatures() {
        return null;
    }
