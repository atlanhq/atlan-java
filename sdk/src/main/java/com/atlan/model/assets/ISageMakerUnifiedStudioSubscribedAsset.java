...
public interface ISageMakerUnifiedStudioSubscribedAsset {
    ...
    RelationField SMUS_ASSET_SCHEMAS = new RelationField("smusAssetSchemas");
    ...
    RelationField SMUS_PUBLISHED_ASSETS = new RelationField("smusPublishedAssets");

    /** Date when the subscription request was approved */
    NumericField SMUS_SUBSCRIBED_ASSET_APPROVAL_DATE =
            new NumericField("smusSubscribedAssetApprovalDate", "smusSubscribedAssetApprovalDate");

    /** Reason provided by the approver for approving the subscription */
    KeywordField SMUS_SUBSCRIBED_ASSET_APPROVED_REASON =
            new KeywordField("smusSubscribedAssetApprovedReason", "smusSubscribedAssetApprovedReason");

    /** Name of the user who approved the subscription request */
    KeywordField SMUS_SUBSCRIBED_ASSET_APPROVER_NAME =
            new KeywordField("smusSubscribedAssetApproverName", "smusSubscribedAssetApproverName");

    /** Number of Columns provided access grant for this subscribed asset. Example : 3 out of 23 */
    KeywordField SMUS_SUBSCRIBED_ASSET_COLUMN_ACCESS_INFO =
            new KeywordField("smusSubscribedAssetColumnAccessInfo", "smusSubscribedAssetColumnAccessInfo");

    /** Name of the AWS SMUS Project from which this asset is subscribed */
    KeywordField SMUS_SUBSCRIBED_ASSET_PROJECT_NAME =
            new KeywordField("smusSubscribedAssetProjectName", "smusSubscribedAssetProjectName");

    /** Date when the subscription request was submitted */
    NumericField SMUS_SUBSCRIBED_ASSET_REQUEST_DATE =
            new NumericField("smusSubscribedAssetRequestDate", "smusSubscribedAssetRequestDate");

    /** Reason provided by the requestor for this subscribed asset */
    KeywordField SMUS_SUBSCRIBED_ASSET_REQUEST_REASON =
            new KeywordField("smusSubscribedAssetRequestReason", "smusSubscribedAssetRequestReason");

    /** Name of the user who requested access to this subscribed asset */
    KeywordField SMUS_SUBSCRIBED_ASSET_REQUESTOR_NAME =
            new KeywordField("smusSubscribedAssetRequestorName", "smusSubscribedAssetRequestorName");
    ...
    String getSmusAssetRevision();

    /** Schemas that exist within this subscribed asset. */
    SortedSet<ISageMakerUnifiedStudioAssetSchema> getSmusAssetSchemas();

    /** The asset source Identifier for a Published Asset in AWS SMUS */
    String getSmusAssetSourceIdentifier();

    /** The summary text for a Published Asset in AWS SMUS */
    String getSmusAssetSummary();

    /** The technical name for a Published Asset in AWS SMUS */
    String getSmusAssetTechnicalName();

    /** The Asset Type for a Published Asset in AWS SMUS */
    String getSmusAssetType();

    /** AWS SMUS Domain ID */
    String getSmusDomainId();

    /** AWS SMUS Domain Name */
    String getSmusDomainName();

    /** AWS SMUS Domain Unit ID */
    String getSmusDomainUnitId();

    /** AWS SMUS Domain Unit Name */
    String getSmusDomainUnitName();

    /** Unique ID of the AWS SMUS Project which owns an Asset */
    String getSmusOwningProjectId();

    /** Project containing the subscribed asset. */
    ISageMakerUnifiedStudioProject getSmusProject();

    /** Unique ID of the AWS SMUS Project */
    String getSmusProjectId();

    /** Published Asset associated with this Subscribed Asset in AWS SMUS */
    SortedSet<ISageMakerUnifiedStudioPublishedAsset> getSmusPublishedAssets();

    /** Date when the subscription request was approved */
    Long getSmusSubscribedAssetApprovalDate();

    /** Reason provided by the approver for approving the subscription */
    String getSmusSubscribedAssetApprovedReason();

    /** Name of the user who approved the subscription request */
    String getSmusSubscribedAssetApproverName();

    /** Number of Columns provided access grant for this subscribed asset. Example : 3 out of 23 */
    String getSmusSubscribedAssetColumnAccessInfo();

    /** Name of the AWS SMUS Project from which this asset is subscribed */
    String getSmusSubscribedAssetProjectName();

    /** Date when the subscription request was submitted */
    Long getSmusSubscribedAssetRequestDate();

    /** Reason provided by the requestor for this subscribed asset */
    String getSmusSubscribedAssetRequestReason();

    /** Name of the user who requested access to this subscribed asset */
    String getSmusSubscribedAssetRequestorName();
