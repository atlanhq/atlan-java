...
public interface IDbtMetric {
    ...
    KeywordField DBT_METRIC_CONVERSION_CALCULATION =
            new KeywordField("dbtMetricConversionCalculation", "dbtMetricConversionCalculation");

    /** Aggregation function for cumulative metrics within each period. */
    KeywordField DBT_METRIC_CUMULATIVE_PERIOD_AGG =
            new KeywordField("dbtMetricCumulativePeriodAgg", "dbtMetricCumulativePeriodAgg");

    /** Top-level filter applied to the entire metric query. */
    KeywordField DBT_METRIC_FILTER = new KeywordField("dbtMetricFilter", "dbtMetricFilter");
    ...
    KeywordField DBT_METRIC_WINDOW = new KeywordField("dbtMetricWindow", "dbtMetricWindow");
    ...
    /** Calculation type for conversion metrics. */
    String getDbtMetricConversionCalculation();

    /** Aggregation function for cumulative metrics within each period. */
    String getDbtMetricCumulativePeriodAgg();

    /** Top-level filter applied to the entire metric query. */
    String getDbtMetricFilter();

    /** Model columns related to this metric. */
    default SortedSet<IColumn> getDbtMetricFilterColumns() {
        return null;
    }
    ...
    /** Time window for cumulative/conversion metrics. */
    String getDbtMetricWindow();

    /** Model in which this metric exists. */
    default IDbtModel getDbtModel() {
        return null;
    }
