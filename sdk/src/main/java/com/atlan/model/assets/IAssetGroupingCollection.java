...
public interface IAssetGroupingCollection {
    ...
    KeywordField ASSET_GROUPING_COLLECTION_TRACKED_CATEGORIES =
            new KeywordField("assetGroupingCollectionTrackedCategories", "assetGroupingCollectionTrackedCategories");

    /** Grouping strategy from which this collection was created. */
    RelationField ASSET_GROUPING_STRATEGY = new RelationField("assetGroupingStrategy");
    ...
    /** Qualified name of the grouping strategy from which this collection was created. */
    String getAssetGroupingCollectionStrategyQualifiedName();

    /** Metadata categories the user explicitly selected for tracking. */
    SortedSet<AssetGroupingTrackedCategories> getAssetGroupingCollectionTrackedCategories();

    /** Grouping strategy from which this collection was created. */
    default IAssetGroupingStrategy getAssetGroupingStrategy() {
        return null;
    }
