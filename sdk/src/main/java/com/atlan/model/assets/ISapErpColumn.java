...
public interface ISapErpColumn {
    ...
    KeywordField SAP_ERP_COLUMN_DECIMALS = new KeywordField("sapErpColumnDecimals", "sapErpColumnDecimals");

    /** When true, this column is the foreign key for the SAP ERP table or view. */
    BooleanField SAP_ERP_COLUMN_IS_FOREIGN = new BooleanField("sapErpColumnIsForeign", "sapErpColumnIsForeign");

    /** When true, the values in this column can be null. */
    BooleanField SAP_ERP_COLUMN_IS_MANDATORY = new BooleanField("sapErpColumnIsMandatory", "sapErpColumnIsMandatory");

    /** When true, this column is the primary key for the SAP ERP table or view. */
    BooleanField SAP_ERP_COLUMN_IS_PRIMARY = new BooleanField("sapErpColumnIsPrimary", "sapErpColumnIsPrimary");
    ...
    RelationField SAP_ERP_TABLE = new RelationField("sapErpTable");

    /** Simple name of the SAP ERP table in which this column asset exists. */
    KeywordTextField SAP_ERP_TABLE_NAME =
    ...
    KeywordTextField SAP_ERP_VIEW_NAME =
            new KeywordTextField("sapErpViewName", "sapErpViewName.keyword", "sapErpViewName");

    /** Unique name of the SAP ERP view in which this column asset exists. */
    KeywordTextField SAP_ERP_VIEW_QUALIFIED_NAME =
            new KeywordTextField("sapErpViewQualifiedName", "sapErpViewQualifiedName", "sapErpViewQualifiedName.text");
    ...
    /** SAP ERP CDS View in which this column exists. */
    default ISapErpCdsView getSapErpCdsView() {
        return null;
    }
    ...
    /** Defines the number of decimal places allowed for numeric values in the SAP ERP column. */
    String getSapErpColumnDecimals();

    /** When true, this column is the foreign key for the SAP ERP table or view. */
    Boolean getSapErpColumnIsForeign();

    /** When true, the values in this column can be null. */
    Boolean getSapErpColumnIsMandatory();

    /** When true, this column is the primary key for the SAP ERP table or view. */
    Boolean getSapErpColumnIsPrimary();
    ...
    /** SAP ERP table in which this column exists. */
    default ISapErpTable getSapErpTable() {
        return null;
    }

    /** Simple name of the SAP ERP table in which this column asset exists. */
    String getSapErpTableName();

    /** Unique name of the SAP ERP table in which this SQL asset exists. */
    String getSapErpTableQualifiedName();

    /** SAP ERP View in which this column exists. */
    default ISapErpView getSapErpView() {
        return null;
    }

    /** Simple name of the SAP ERP view in which this column asset exists. */
    String getSapErpViewName();

    /** Unique name of the SAP ERP view in which this column asset exists. */
    String getSapErpViewQualifiedName();
