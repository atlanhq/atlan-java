...
public class CogniteFile extends Asset implements ICogniteFile, ICognite, ISaaS, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all CogniteFile assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CogniteFile assets will be included.
     *
     * @return an asset filter that includes all CogniteFile assets
    ...
    /**
     * Retrieves a CogniteFile by its GUID, complete with all of its relationships.
     *
     * @param guid of the CogniteFile to retrieve
     * @return the requested full CogniteFile, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteFile does not exist or the provided GUID is not a CogniteFile
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteFile retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteFile retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CogniteFile by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CogniteFile to retrieve
     * @return the requested full CogniteFile, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteFile does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteFile retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteFile retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    public CogniteFileBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "CogniteFile", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a CogniteFile.
     *
     * @param qualifiedName of the CogniteFile
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteFile
     ...
     * Add Atlan tags to a CogniteFile.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CogniteFile
     * @param qualifiedName of the CogniteFile
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteFile
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
