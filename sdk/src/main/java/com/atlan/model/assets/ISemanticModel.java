...
public interface ISemanticModel {
    ...
    RelationField SEMANTIC_DIMENSIONS = new RelationField("semanticDimensions");

    /** Entities that exist within this semantic model. */
    RelationField SEMANTIC_ENTITIES = new RelationField("semanticEntities");

    /** Measures that exist within this semantic model. */
    RelationField SEMANTIC_MEASURES = new RelationField("semanticMeasures");
    ...
    /** Dimensions that exist within this semantic model. */
    SortedSet<ISemanticDimension> getSemanticDimensions();

    /** Entities that exist within this semantic model. */
    SortedSet<ISemanticEntity> getSemanticEntities();

    /** Measures that exist within this semantic model. */
    SortedSet<ISemanticMeasure> getSemanticMeasures();
