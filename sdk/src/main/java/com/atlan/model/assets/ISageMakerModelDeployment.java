...
public interface ISageMakerModelDeployment {
    ...
    KeywordField SAGE_MAKER_MODEL_DEPLOYMENT_STATUS =
            new KeywordField("sageMakerModelDeploymentStatus", "sageMakerModelDeploymentStatus");
    ...
    /** SageMaker Model that is deployed. */
    default ISageMakerModel getSageMakerModel() {
        return null;
    }

    /** Name of the endpoint configuration used by this deployment. */
    String getSageMakerModelDeploymentEndpointConfigName();

    /** Name of the parent Model. */
    String getSageMakerModelDeploymentModelName();

    /** Qualified name of the parent Model. */
    String getSageMakerModelDeploymentModelQualifiedName();

    /** Current status of the endpoint (e.g., InService, OutOfService, Creating, Failed). */
    String getSageMakerModelDeploymentStatus();
