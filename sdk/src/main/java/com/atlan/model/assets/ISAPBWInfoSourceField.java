...
public interface ISAPBWInfoSourceField {
    ...
    RelationField SAP_BW_INFO_SOURCE = new RelationField("sapBwInfoSource");

    /** Whether this field is a key field (RSKSFIELDNEW.KEYFLAG). */
    BooleanField SAP_BW_IS_KEY_FIELD = new BooleanField("sapBwIsKeyField", "sapBwIsKeyField");
    ...
    /** InfoSource containing this field. */
    default ISAPBWInfoSource getSapBwInfoSource() {
        return null;
    }

    /** Whether this field is a key field (RSKSFIELDNEW.KEYFLAG). */
    Boolean getSapBwIsKeyField();
