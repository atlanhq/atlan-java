...
public interface IFabricSemanticModelMeasure {
    ...
    KeywordField FABRIC_DISPLAY_FOLDER = new KeywordField("fabricDisplayFolder", "fabricDisplayFolder");

    /** Format string applied to the values of this measure. */
    KeywordField FABRIC_FORMAT_STRING = new KeywordField("fabricFormatString", "fabricFormatString");

    /** Whether this measure is an external measure (true) or defined within the semantic model (false). */
    BooleanField FABRIC_IS_EXTERNAL_MEASURE = new BooleanField("fabricIsExternalMeasure", "fabricIsExternalMeasure");

    /** Whether this measure is hidden in the semantic model (true) or visible (false). */
    BooleanField FABRIC_IS_HIDDEN = new BooleanField("fabricIsHidden", "fabricIsHidden");

    /** DAX expression for this measure. */
    TextField FABRIC_MEASURE_EXPRESSION = new TextField("fabricMeasureExpression", "fabricMeasureExpression");
    ...
    RelationField FABRIC_SEMANTIC_MODEL_TABLE_COLUMNS = new RelationField("fabricSemanticModelTableColumns");

    /** Name of the Fabric semantic model table that contains this asset. */
    KeywordField FABRIC_SEMANTIC_MODEL_TABLE_NAME =
            new KeywordField("fabricSemanticModelTableName", "fabricSemanticModelTableName");

    /** Unique name of the Fabric semantic model table that contains this asset. */
    KeywordField FABRIC_SEMANTIC_MODEL_TABLE_QUALIFIED_NAME =
            new KeywordField("fabricSemanticModelTableQualifiedName", "fabricSemanticModelTableQualifiedName");
    ...
    Integer getFabricColumnCount();

    /** Data type of this asset. */
    String getFabricDataType();

    /** Display folder in which this measure is grouped within its table. */
    String getFabricDisplayFolder();

    /** Format string applied to the values of this measure. */
    String getFabricFormatString();

    /** Whether this measure is an external measure (true) or defined within the semantic model (false). */
    Boolean getFabricIsExternalMeasure();

    /** Whether this measure is hidden in the semantic model (true) or visible (false). */
    Boolean getFabricIsHidden();

    /** DAX expression for this measure. */
    String getFabricMeasureExpression();

    /** Order/position of this asset within its parent. */
    Integer getFabricOrdinal();

    /** Unique name of the Fabric semantic model that contains this asset. */
    String getFabricSemanticModelQualifiedName();
    ...
    /** Semantic model table columns referenced by the DAX expression of this measure. */
    default SortedSet<IFabricSemanticModelTableColumn> getFabricSemanticModelTableColumns() {
        return null;
    }

    /** Name of the Fabric semantic model table that contains this asset. */
    String getFabricSemanticModelTableName();

    /** Unique name of the Fabric semantic model table that contains this asset. */
    String getFabricSemanticModelTableQualifiedName();
