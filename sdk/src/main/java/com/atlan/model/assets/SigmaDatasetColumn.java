...
public class SigmaDatasetColumn extends Asset
    ...
    /**
     * Builds the minimal object necessary to create a relationship to a SigmaDatasetColumn, from a potentially
     * more-complete SigmaDatasetColumn object.
     *
     * @return the minimal object necessary to relate to the SigmaDatasetColumn
     * @throws InvalidRequestException if any of the minimal set of required properties for a SigmaDatasetColumn relationship are not found in the initial object
     */
    @Override
    public SigmaDatasetColumn trimToReference() throws InvalidRequestException {
    ...
    /**
     * Start a fluent search that will return all SigmaDatasetColumn assets.
     * Additional conditions can be chained onto the returned search before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SigmaDatasetColumn assets will be included.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @return a fluent search that includes all SigmaDatasetColumn assets
     */
     ...
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the assets
     * @param includeArchived when true, archived (soft-deleted) SigmaDatasetColumns will be included
     * @return a fluent search that includes all SigmaDatasetColumn assets
     */
    ...
    /**
     * Reference to a SigmaDatasetColumn by GUID. Use this to create a relationship to this SigmaDatasetColumn,
     ...
     * @return reference to a SigmaDatasetColumn that can be used for defining a relationship to a SigmaDatasetColumn
     */
    public static SigmaDatasetColumn refByGuid(String guid, Reference.SaveSemantic semantic) {
        return SigmaDatasetColumn._internal().guid(guid).semantic(semantic).build();
    }

    /**
     * Reference to a SigmaDatasetColumn by qualifiedName. Use this to create a relationship to this SigmaDatasetColumn,
     * where the relationship should be replaced.
     *
     ...
     * @return reference to a SigmaDatasetColumn that can be used for defining a relationship to a SigmaDatasetColumn
     */
    public static SigmaDatasetColumn refByQualifiedName(String qualifiedName, Reference.SaveSemantic semantic) {
    ...
    /**
     * Retrieves a SigmaDatasetColumn by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the SigmaDatasetColumn to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the SigmaDatasetColumn, including any relationships
     * @return the requested SigmaDatasetColumn, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SigmaDatasetColumn does not exist or the provided GUID is not a SigmaDatasetColumn
     */
    @JsonIgnore
     ...
     * @param id of the SigmaDatasetColumn to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the SigmaDatasetColumn, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the SigmaDatasetColumn
     * @return the requested SigmaDatasetColumn, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SigmaDatasetColumn does not exist or the provided GUID is not a SigmaDatasetColumn
     */
    @JsonIgnore
    public static SigmaDatasetColumn get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = SigmaDatasetColumn.select(client)
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof SigmaDatasetColumn) {
                return (SigmaDatasetColumn) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
