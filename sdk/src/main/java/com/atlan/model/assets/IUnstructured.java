...
public interface IUnstructured {
    ...
    KeywordField UNSTRUCTURED_CONTAINER_NAME =
            new KeywordField("unstructuredContainerName", "unstructuredContainerName");

    /** Unique name of the data container that holds this asset. */
    KeywordField UNSTRUCTURED_CONTAINER_QUALIFIED_NAME =
            new KeywordField("unstructuredContainerQualifiedName", "unstructuredContainerQualifiedName");
    ...
    KeywordField UNSTRUCTURED_FOLDER_HIERARCHY =
            new KeywordField("unstructuredFolderHierarchy", "unstructuredFolderHierarchy");

    /** Unique name of the immediate parent folder containing this asset. */
    KeywordField UNSTRUCTURED_PARENT_FOLDER_QUALIFIED_NAME =
            new KeywordField("unstructuredParentFolderQualifiedName", "unstructuredParentFolderQualifiedName");
