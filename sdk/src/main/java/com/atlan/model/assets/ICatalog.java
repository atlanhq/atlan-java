    ...
    public static ICatalog getLineageReference(String typeName, String qualifiedName) {
        ...
        switch (typeName) {
            ...
            case Column.TYPE_NAME:
                ...
                break;
            case ContextArtifact.TYPE_NAME:
                ref = ContextArtifact.refByQualifiedName(qualifiedName);
                break;
            case ContextRepository.TYPE_NAME:
                ref = ContextRepository.refByQualifiedName(qualifiedName);
                break;
            ...
            case KafkaField.TYPE_NAME:
                ...
                break;
            case KafkaTag.TYPE_NAME:
                ref = KafkaTag.refByQualifiedName(qualifiedName);
                break;
            ...
            case SparkJob.TYPE_NAME:
                ...
                break;
            case SqlInsightBusinessQuestion.TYPE_NAME:
                ref = SqlInsightBusinessQuestion.refByQualifiedName(qualifiedName);
                break;
            case SqlInsightFilter.TYPE_NAME:
                ref = SqlInsightFilter.refByQualifiedName(qualifiedName);
                break;
            case SqlInsightJoin.TYPE_NAME:
                ref = SqlInsightJoin.refByQualifiedName(qualifiedName);
                break;
