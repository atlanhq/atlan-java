...
public class BusinessPolicy extends Asset implements IBusinessPolicy, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all BusinessPolicy assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) BusinessPolicy assets will be included.
     *
     * @return an asset filter that includes all BusinessPolicy assets
     ...
     */
    @JsonIgnore
    public static BusinessPolicy get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a BusinessPolicy by its GUID, complete with all of its relationships.
     *
     * @param guid of the BusinessPolicy to retrieve
     * @return the requested full BusinessPolicy, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the BusinessPolicy does not exist or the provided GUID is not a BusinessPolicy
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static BusinessPolicy retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static BusinessPolicy retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a BusinessPolicy by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the BusinessPolicy to retrieve
     * @return the requested full BusinessPolicy, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the BusinessPolicy does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static BusinessPolicy retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static BusinessPolicy retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static BusinessPolicy updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static BusinessPolicy replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static BusinessPolicy appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a BusinessPolicy.
     *
     * @param qualifiedName of the BusinessPolicy
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the BusinessPolicy
     ...
     * Add Atlan tags to a BusinessPolicy.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the BusinessPolicy
     * @param qualifiedName of the BusinessPolicy
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the BusinessPolicy
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
