...
/**
 * Base class for ETL-specific assets.
 */
...
public interface IETL {
    ...
    public static final String TYPE_NAME = "ETL";

    /** Date and time at which this point in the data processing or orchestration finished. */
    NumericField ETL_FINISHED_AT = new NumericField("etlFinishedAt", "etlFinishedAt");

    /** Schedule for this point in the data processing or orchestration. */
    KeywordField ETL_SCHEDULE = new KeywordField("etlSchedule", "etlSchedule");

    /** Date and time at which this point in the data processing or orchestration started. */
    NumericField ETL_STARTED_AT = new NumericField("etlStartedAt", "etlStartedAt");

    /** Overall status of this point in the data processing or orchestration. */
    KeywordField ETL_STATUS = new KeywordField("etlStatus", "etlStatus");
