...
public interface IDetectiDataDossier {
    ...
    RelationField DETECTI_DATA_DOSSIER_ELEMENTS = new RelationField("detectiDataDossierElements");

    /** Privacy classification for this combination of data. */
    KeywordField DETECTI_DATA_PRIVACY_CLASSIFICATION =
            new KeywordField("detectiDataPrivacyClassification", "detectiDataPrivacyClassification");

    /** Overall trust score for the combination of assets. */
    NumericField DETECTI_DATA_TRUST_SCORE = new NumericField("detectiDataTrustScore", "detectiDataTrustScore");
    ...
    /** Individual elements that are combined as part of this DetectiData Dossier. */
    SortedSet<IDetectiDataDossierElement> getDetectiDataDossierElements();

    /** Simple name of the dossier in which this asset exists, or empty if it is itself a dossier. */
    String getDetectiDataDossierName();

    /** Unique name of the dossier in which this asset exists, or empty if it is itself a dossier. */
    String getDetectiDataDossierQualifiedName();

    /** Privacy classification for this combination of data. */
    String getDetectiDataPrivacyClassification();

    /** Overall trust score for the combination of assets. */
    Long getDetectiDataTrustScore();
