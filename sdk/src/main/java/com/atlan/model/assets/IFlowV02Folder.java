...
public interface IFlowV02Folder {

    public static final String TYPE_NAME = "FlowV02Folder";

    /** Interim datasets contained in this folder. */
    RelationField FLOW_V02DATASETS = new RelationField("flowV02Datasets");
    ...
    RelationField FLOW_V02GROUPINGS = new RelationField("flowV02Groupings");

    /** Parent folder containing the sub-folders. */
    RelationField FLOW_V02PARENT_FOLDER = new RelationField("flowV02ParentFolder");

    /** Child (sub) folders contained within the folder. */
    RelationField FLOW_V02SUB_FOLDERS = new RelationField("flowV02SubFolders");
    ...
    /** Interim datasets contained in this folder. */
    SortedSet<IFlowV02InterimDataset> getFlowV02Datasets();
    ...
    /** Flow groupings contained in this folder. */
    SortedSet<IFlowV02ProcessGrouping> getFlowV02Groupings();

    /** Unique ID for this flow asset, which will remain constant throughout the lifecycle of the asset. */
    String getFlowV02Id();

    /** Parent folder containing the sub-folders. */
    IFlowV02Folder getFlowV02ParentFolder();
    ...
    /** Child (sub) folders contained within the folder. */
    SortedSet<IFlowV02Folder> getFlowV02SubFolders();
