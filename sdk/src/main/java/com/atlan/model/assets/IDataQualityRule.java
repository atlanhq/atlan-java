...
public interface IDataQualityRule {
    ...
    KeywordField DQ_RULE_AD_STATUS = new KeywordField("dqRuleADStatus", "dqRuleADStatus");

    /** Default priority level for alerts involving this rule. */
    KeywordField DQ_RULE_ALERT_PRIORITY = new KeywordField("dqRuleAlertPriority", "dqRuleAlertPriority");

    /** Base column attached to this rule. */
    RelationField DQ_RULE_BASE_COLUMN = new RelationField("dqRuleBaseColumn");

    /** Base column qualified name that attached to this rule. */
    KeywordField DQ_RULE_BASE_COLUMN_QUALIFIED_NAME =
            new KeywordField("dqRuleBaseColumnQualifiedName", "dqRuleBaseColumnQualifiedName");

    /** Base dataset attached to this rule. */
    RelationField DQ_RULE_BASE_DATASET = new RelationField("dqRuleBaseDataset");

    /** Base dataset qualified name that attached to this rule. */
    KeywordField DQ_RULE_BASE_DATASET_QUALIFIED_NAME =
            new KeywordField("dqRuleBaseDatasetQualifiedName", "dqRuleBaseDatasetQualifiedName");

    /** Json string of the rule config that contains the rule definitions. */
    KeywordField DQ_RULE_CONFIG_ARGUMENTS = new KeywordField("dqRuleConfigArguments", "dqRuleConfigArguments");
    ...
    NumericField DQ_RULE_LATEST_METRIC_VALUE_COMPUTED_AT =
            new NumericField("dqRuleLatestMetricValueComputedAt", "dqRuleLatestMetricValueComputedAt");

    /** Latest result of the rule. */
    KeywordField DQ_RULE_LATEST_RESULT = new KeywordField("dqRuleLatestResult", "dqRuleLatestResult");

    /** Time (epoch) at which the latest rule result was evaluated. */
    NumericField DQ_RULE_LATEST_RESULT_COMPUTED_AT =
            new NumericField("dqRuleLatestResultComputedAt", "dqRuleLatestResultComputedAt");

    /** JSON string with anomaly detection result details (forecast, upper_bound, lower_bound, is_anomaly) from Snowflake AD. */
    KeywordField DQ_RULE_LATEST_RESULT_DETAILS =
            new KeywordField("dqRuleLatestResultDetails", "dqRuleLatestResultDetails");
    ...
    RelationField DQ_RULE_REFERENCE_COLUMNS = new RelationField("dqRuleReferenceColumns");

    /** List of unique reference dataset's qualified names related to this rule. */
    KeywordField DQ_RULE_REFERENCE_DATASET_QUALIFIED_NAMES =
            new KeywordField("dqRuleReferenceDatasetQualifiedNames", "dqRuleReferenceDatasetQualifiedNames");

    /** Datasets referenced in this rule. */
    RelationField DQ_RULE_REFERENCE_DATASETS = new RelationField("dqRuleReferenceDatasets");

    /** Whether row scope filtering is enabled for this data quality rule (true) or not (false). */
    BooleanField DQ_RULE_ROW_SCOPE_FILTERING_ENABLED =
            new BooleanField("dqRuleRowScopeFilteringEnabled", "dqRuleRowScopeFilteringEnabled");

    /** Error code in the case of state being "failure". */
    KeywordField DQ_RULE_SOURCE_SYNC_ERROR_CODE =
            new KeywordField("dqRuleSourceSyncErrorCode", "dqRuleSourceSyncErrorCode");

    /** Error message in the case of state being "error". */
    KeywordField DQ_RULE_SOURCE_SYNC_ERROR_MESSAGE =
            new KeywordField("dqRuleSourceSyncErrorMessage", "dqRuleSourceSyncErrorMessage");

    /** Raw error message from the source. */
    KeywordField DQ_RULE_SOURCE_SYNC_RAW_ERROR =
            new KeywordField("dqRuleSourceSyncRawError", "dqRuleSourceSyncRawError");

    /** Latest sync status of the rule to the source. */
    KeywordField DQ_RULE_SOURCE_SYNC_STATUS = new KeywordField("dqRuleSourceSyncStatus", "dqRuleSourceSyncStatus");

    /** Time (epoch) at which the rule synced to the source. */
    NumericField DQ_RULE_SOURCE_SYNCED_AT = new NumericField("dqRuleSourceSyncedAt", "dqRuleSourceSyncedAt");

    /** Status of the rule. */
    KeywordField DQ_RULE_STATUS = new KeywordField("dqRuleStatus", "dqRuleStatus");

    /** Template used to create this rule. */
    RelationField DQ_RULE_TEMPLATE = new RelationField("dqRuleTemplate");

    /** Name of the rule template corresponding to the rule. */
    KeywordField DQ_RULE_TEMPLATE_NAME = new KeywordField("dqRuleTemplateName", "dqRuleTemplateName");
    ...
    /** Anomaly detection lifecycle status for this rule. */
    DataQualityRuleADStatus getDqRuleADStatus();

    /** Default priority level for alerts involving this rule. */
    DataQualityRuleAlertPriority getDqRuleAlertPriority();

    /** Base column attached to this rule. */
    default IColumn getDqRuleBaseColumn() {
        return null;
    }

    /** Base column qualified name that attached to this rule. */
    String getDqRuleBaseColumnQualifiedName();

    /** Base dataset attached to this rule. */
    default IAsset getDqRuleBaseDataset() {
        return null;
    }

    /** Base dataset qualified name that attached to this rule. */
    String getDqRuleBaseDatasetQualifiedName();

    /** Json string of the rule config that contains the rule definitions. */
    DataQualityRuleConfigArguments getDqRuleConfigArguments();
    ...
    /** Time (epoch) at which the latest metric value was evaluated in the source. */
    Long getDqRuleLatestMetricValueComputedAt();

    /** Latest result of the rule. */
    DataQualityResult getDqRuleLatestResult();

    /** Time (epoch) at which the latest rule result was evaluated. */
    Long getDqRuleLatestResultComputedAt();

    /** JSON string with anomaly detection result details (forecast, upper_bound, lower_bound, is_anomaly) from Snowflake AD. */
    String getDqRuleLatestResultDetails();
    ...
    /** Columns referenced in this rule. */
    default SortedSet<IColumn> getDqRuleReferenceColumns() {
        return null;
    }

    /** List of unique reference dataset's qualified names related to this rule. */
    SortedSet<String> getDqRuleReferenceDatasetQualifiedNames();

    /** Datasets referenced in this rule. */
    default SortedSet<IAsset> getDqRuleReferenceDatasets() {
        return null;
    }

    /** Whether row scope filtering is enabled for this data quality rule (true) or not (false). */
    Boolean getDqRuleRowScopeFilteringEnabled();

    /** Error code in the case of state being "failure". */
    String getDqRuleSourceSyncErrorCode();

    /** Error message in the case of state being "error". */
    String getDqRuleSourceSyncErrorMessage();

    /** Raw error message from the source. */
    String getDqRuleSourceSyncRawError();

    /** Latest sync status of the rule to the source. */
    DataQualitySourceSyncStatus getDqRuleSourceSyncStatus();

    /** Time (epoch) at which the rule synced to the source. */
    Long getDqRuleSourceSyncedAt();

    /** Status of the rule. */
    DataQualityRuleStatus getDqRuleStatus();

    /** Template used to create this rule. */
    default IDataQualityRuleTemplate getDqRuleTemplate() {
        return null;
    }

    /** Name of the rule template corresponding to the rule. */
    String getDqRuleTemplateName();
