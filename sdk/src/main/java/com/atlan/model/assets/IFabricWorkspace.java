...
public interface IFabricWorkspace {

    public static final String TYPE_NAME = "FabricWorkspace";

    /** Individual dashboards contained in the workspace. */
    RelationField FABRIC_DASHBOARDS = new RelationField("fabricDashboards");

    /** Individual data pipelines contained in the workspace. */
    RelationField FABRIC_DATA_PIPELINES = new RelationField("fabricDataPipelines");

    /** Individual databases contained in the workspace. */
    RelationField FABRIC_DATABASES = new RelationField("fabricDatabases");

    /** Individual dataflows contained in the workspace. */
    RelationField FABRIC_DATAFLOWS = new RelationField("fabricDataflows");

    /** Individual reports contained in the workspace. */
    RelationField FABRIC_REPORTS = new RelationField("fabricReports");

    /** Individual semantic models contained in the workspace. */
    RelationField FABRIC_SEMANTIC_MODELS = new RelationField("fabricSemanticModels");
    ...
    /** Individual dashboards contained in the workspace. */
    SortedSet<IFabricDashboard> getFabricDashboards();

    /** Individual data pipelines contained in the workspace. */
    SortedSet<IFabricDataPipeline> getFabricDataPipelines();

    /** Data type of this asset. */
    String getFabricDataType();

    /** Individual databases contained in the workspace. */
    SortedSet<IDatabase> getFabricDatabases();

    /** Individual dataflows contained in the workspace. */
    SortedSet<IFabricDataflow> getFabricDataflows();

    /** Order/position of this asset within its parent. */
    Integer getFabricOrdinal();

    /** Individual reports contained in the workspace. */
    SortedSet<IFabricReport> getFabricReports();

    /** Individual semantic models contained in the workspace. */
    SortedSet<IFabricSemanticModel> getFabricSemanticModels();
