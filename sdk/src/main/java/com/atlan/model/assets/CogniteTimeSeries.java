...
public class CogniteTimeSeries extends Asset
    ...
    /**
     * Start an asset filter that will return all CogniteTimeSeries assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CogniteTimeSeries assets will be included.
     *
     * @return an asset filter that includes all CogniteTimeSeries assets
     ...
     */
    @JsonIgnore
    public static CogniteTimeSeries get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a CogniteTimeSeries by its GUID, complete with all of its relationships.
     *
     * @param guid of the CogniteTimeSeries to retrieve
     * @return the requested full CogniteTimeSeries, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteTimeSeries does not exist or the provided GUID is not a CogniteTimeSeries
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteTimeSeries retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteTimeSeries retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CogniteTimeSeries by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CogniteTimeSeries to retrieve
     * @return the requested full CogniteTimeSeries, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteTimeSeries does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteTimeSeries retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteTimeSeries retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public CogniteTimeSeriesBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "CogniteTimeSeries", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a CogniteTimeSeries.
     *
     * @param qualifiedName of the CogniteTimeSeries
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteTimeSeries
     ...
     * Add Atlan tags to a CogniteTimeSeries.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CogniteTimeSeries
     * @param qualifiedName of the CogniteTimeSeries
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteTimeSeries
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
