...
public class CosmosMongoDBCollection extends Asset
    ...
    /**
     * Start an asset filter that will return all CosmosMongoDBCollection assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CosmosMongoDBCollection assets will be included.
     *
     * @return an asset filter that includes all CosmosMongoDBCollection assets
     ...
     */
    @JsonIgnore
    public static CosmosMongoDBCollection get(String id) throws AtlanException {
     ...
     */
    @JsonIgnore
    public static CosmosMongoDBCollection get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a CosmosMongoDBCollection by its GUID, complete with all of its relationships.
     *
     * @param guid of the CosmosMongoDBCollection to retrieve
     * @return the requested full CosmosMongoDBCollection, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CosmosMongoDBCollection does not exist or the provided GUID is not a CosmosMongoDBCollection
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CosmosMongoDBCollection retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CosmosMongoDBCollection retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CosmosMongoDBCollection by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CosmosMongoDBCollection to retrieve
     * @return the requested full CosmosMongoDBCollection, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CosmosMongoDBCollection does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CosmosMongoDBCollection retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CosmosMongoDBCollection retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public CosmosMongoDBCollectionBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "CosmosMongoDBCollection", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBCollection removeDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBCollection removeUserDescription(String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBCollection removeOwners(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBCollection removeCertificate(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBCollection removeAnnouncement(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBCollection replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBCollection appendTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CosmosMongoDBCollection removeTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static CosmosMongoDBCollection appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CosmosMongoDBCollection.
     *
     * @param qualifiedName of the CosmosMongoDBCollection
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CosmosMongoDBCollection
     ...
     * Add Atlan tags to a CosmosMongoDBCollection.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CosmosMongoDBCollection
     * @param qualifiedName of the CosmosMongoDBCollection
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CosmosMongoDBCollection
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
