...
public interface IDatabricksAIModelVersion {

    public static final String TYPE_NAME = "DatabricksAIModelVersion";

    /** Context containing the version. */
    RelationField DATABRICKS_AI_MODEL_CONTEXT = new RelationField("databricksAIModelContext");

    /** The aliases of the model. */
    KeywordField DATABRICKS_AI_MODEL_VERSION_ALIASES =
            new KeywordField("databricksAIModelVersionAliases", "databricksAIModelVersionAliases");

    /** Artifact uri for the model. */
    KeywordField DATABRICKS_AI_MODEL_VERSION_ARTIFACT_URI =
            new KeywordField("databricksAIModelVersionArtifactUri", "databricksAIModelVersionArtifactUri");

    /** Number of datasets. */
    NumericField DATABRICKS_AI_MODEL_VERSION_DATASET_COUNT =
            new NumericField("databricksAIModelVersionDatasetCount", "databricksAIModelVersionDatasetCount");

    /** The id of the model, unique to every version. */
    NumericField DATABRICKS_AI_MODEL_VERSION_ID =
            new NumericField("databricksAIModelVersionId", "databricksAIModelVersionId");

    /** Metrics for an individual experiment. */
    KeywordField DATABRICKS_AI_MODEL_VERSION_METRICS =
            new KeywordField("databricksAIModelVersionMetrics", "databricksAIModelVersionMetrics");

    /** Params with key mapped to value for an individual experiment. */
    KeywordField DATABRICKS_AI_MODEL_VERSION_PARAMS =
            new KeywordField("databricksAIModelVersionParams", "databricksAIModelVersionParams");

    /** The run end time of the model. */
    NumericField DATABRICKS_AI_MODEL_VERSION_RUN_END_TIME =
            new NumericField("databricksAIModelVersionRunEndTime", "databricksAIModelVersionRunEndTime");

    /** The run id of the model. */
    KeywordField DATABRICKS_AI_MODEL_VERSION_RUN_ID =
            new KeywordField("databricksAIModelVersionRunId", "databricksAIModelVersionRunId");

    /** The run name of the model. */
    KeywordField DATABRICKS_AI_MODEL_VERSION_RUN_NAME =
            new KeywordField("databricksAIModelVersionRunName", "databricksAIModelVersionRunName");

    /** The run start time of the model. */
    NumericField DATABRICKS_AI_MODEL_VERSION_RUN_START_TIME =
            new NumericField("databricksAIModelVersionRunStartTime", "databricksAIModelVersionRunStartTime");

    /** Source artifact link for the model. */
    KeywordField DATABRICKS_AI_MODEL_VERSION_SOURCE =
            new KeywordField("databricksAIModelVersionSource", "databricksAIModelVersionSource");

    /** The status of the model. */
    KeywordField DATABRICKS_AI_MODEL_VERSION_STATUS =
            new KeywordField("databricksAIModelVersionStatus", "databricksAIModelVersionStatus");
    ...
    /** Context containing the version. */
    default IDatabricksAIModelContext getDatabricksAIModelContext() {
        return null;
    }

    /** The aliases of the model. */
    SortedSet<String> getDatabricksAIModelVersionAliases();

    /** Artifact uri for the model. */
    String getDatabricksAIModelVersionArtifactUri();

    /** Number of datasets. */
    Long getDatabricksAIModelVersionDatasetCount();

    /** The id of the model, unique to every version. */
    Long getDatabricksAIModelVersionId();

    /** Metrics for an individual experiment. */
    List<DatabricksAIModelVersionMetric> getDatabricksAIModelVersionMetrics();

    /** Params with key mapped to value for an individual experiment. */
    Map<String, String> getDatabricksAIModelVersionParams();

    /** The run end time of the model. */
    Long getDatabricksAIModelVersionRunEndTime();

    /** The run id of the model. */
    String getDatabricksAIModelVersionRunId();

    /** The run name of the model. */
    String getDatabricksAIModelVersionRunName();

    /** The run start time of the model. */
    Long getDatabricksAIModelVersionRunStartTime();

    /** Source artifact link for the model. */
    String getDatabricksAIModelVersionSource();

    /** The status of the model. */
    String getDatabricksAIModelVersionStatus();
    ...
    EthicalAIAccountabilityConfig getEthicalAIAccountabilityConfig();

    /** Bias mitigation configuration for ensuring the ethical use of an AI asset */
    EthicalAIBiasMitigationConfig getEthicalAIBiasMitigationConfig();

    /** Environmental consciousness configuration for ensuring the ethical use of an AI asset */
    EthicalAIEnvironmentalConsciousnessConfig getEthicalAIEnvironmentalConsciousnessConfig();

    /** Fairness configuration for ensuring the ethical use of an AI asset */
    EthicalAIFairnessConfig getEthicalAIFairnessConfig();

    /** Privacy configuration for ensuring the ethical use of an AI asset */
    EthicalAIPrivacyConfig getEthicalAIPrivacyConfig();

    /** Reliability and safety configuration for ensuring the ethical use of an AI asset */
    EthicalAIReliabilityAndSafetyConfig getEthicalAIReliabilityAndSafetyConfig();

    /** Transparency configuration for ensuring the ethical use of an AI asset */
    EthicalAITransparencyConfig getEthicalAITransparencyConfig();
