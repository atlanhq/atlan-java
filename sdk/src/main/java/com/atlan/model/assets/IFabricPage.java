...
public interface IFabricPage {

    public static final String TYPE_NAME = "FabricPage";

    /** Report containing the page. */
    RelationField FABRIC_REPORT = new RelationField("fabricReport");

    /** Unique name of the Fabric report that contains this asset. */
    KeywordField FABRIC_REPORT_QUALIFIED_NAME =
            new KeywordField("fabricReportQualifiedName", "fabricReportQualifiedName");

    /** Individual visuals contained in the page. */
    RelationField FABRIC_VISUALS = new RelationField("fabricVisuals");
    ...
    /** Report containing the page. */
    IFabricReport getFabricReport();

    /** Unique name of the Fabric report that contains this asset. */
    String getFabricReportQualifiedName();

    /** Individual visuals contained in the page. */
    SortedSet<IFabricVisual> getFabricVisuals();
