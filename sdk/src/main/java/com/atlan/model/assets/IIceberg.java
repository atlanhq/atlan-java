...
public interface IIceberg {
    ...
    KeywordField ICEBERG_NAMESPACE_HIERARCHY =
            new KeywordField("icebergNamespaceHierarchy", "icebergNamespaceHierarchy");

    /** Unique name of the immediate parent namespace in which this asset exists. */
    KeywordField ICEBERG_PARENT_NAMESPACE_QUALIFIED_NAME =
            new KeywordField("icebergParentNamespaceQualifiedName", "icebergParentNamespaceQualifiedName");
