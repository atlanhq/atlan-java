...
public interface IDbtDimension {

    public static final String TYPE_NAME = "DbtDimension";

    /** Time granularity for time dimensions only (day/week/month/quarter/year). */
    KeywordField DBT_SEMANTIC_FIELD_TIME_GRANULARITY =
            new KeywordField("dbtSemanticFieldTimeGranularity", "dbtSemanticFieldTimeGranularity");

    /** Qualified name of the dbt semantic model this dimension belongs to. */
    KeywordField DBT_SEMANTIC_MODEL_QUALIFIED_NAME =
            new KeywordField("dbtSemanticModelQualifiedName", "dbtSemanticModelQualifiedName");
    ...
    /** Time granularity for time dimensions only (day/week/month/quarter/year). */
    String getDbtSemanticFieldTimeGranularity();

    /** URL of the semantic layer proxy for this asset in dbt. */
    String getDbtSemanticLayerProxyUrl();

    /** Qualified name of the dbt semantic model this dimension belongs to. */
    String getDbtSemanticModelQualifiedName();
