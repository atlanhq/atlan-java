...
public interface IDataModel {
    ...
    /** TBC */
    KeywordField DATA_MODEL_OWNING_APPLICATION_SEAL_ID = new KeywordField("dataModelOwningApplicationSEALId", "dataModelOwningApplicationSEALId");

    /** TBC */
    NumericField DATA_MODEL_REFRESH_TIMESTAMP = new NumericField("dataModelRefreshTimestamp", "dataModelRefreshTimestamp");

    /** TBC */
    KeywordField DATA_MODEL_TOOL = new KeywordField("dataModelTool", "dataModelTool");

    /** TBC */
    KeywordField DATA_MODEL_TYPE = new KeywordField("dataModelType", "dataModelType");
    ...
    /** TBC */
    String getDataModelOwningApplicationSEALId();

    /** TBC */
    String getDataModelQualifiedName();

    /** TBC */
    Long getDataModelRefreshTimestamp();

    /** TBC */
    DataModelTool getDataModelTool();
