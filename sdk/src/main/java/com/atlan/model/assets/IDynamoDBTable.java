...
public interface IDynamoDBTable {
    ...
    RelationField DYNAMO_DB_COLUMNS = new RelationField("dynamoDBColumns");
    ...
    /** Columns (attributes) that exist within this DynamoDB table. */
    default SortedSet<IDynamoDBAttribute> getDynamoDBColumns() {
        return null;
    }

    /** DynamoDB table containing global secondary indexes. */
    default SortedSet<IDynamoDBGlobalSecondaryIndex> getDynamoDBGlobalSecondaryIndexes() {
        return null;
    }

    /** DynamoDB table containing local secondary indexes. */
    default SortedSet<IDynamoDBLocalSecondaryIndex> getDynamoDBLocalSecondaryIndexes() {
        return null;
    }
