...
public interface IDynamoDBTable {
    ...
    NumericField DYNAMO_DB_TABLE_GSI_COUNT = new NumericField("dynamoDBTableGSICount", "dynamoDBTableGSICount");

    /** Represents the number of local secondary indexes on the table. */
    NumericField DYNAMO_DB_TABLE_LSI_COUNT = new NumericField("dynamoDBTableLSICount", "dynamoDBTableLSICount");
    ...
    /** Represents the number of global secondary indexes on the table. */
    Integer getDynamoDBTableGSICount();

    /** Represents the number of local secondary indexes on the table. */
    Integer getDynamoDBTableLSICount();
