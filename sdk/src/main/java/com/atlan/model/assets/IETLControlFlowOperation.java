...
public interface IETLControlFlowOperation {
    ...
    RelationField ETL_EXECUTABLE_UNIT = new RelationField("etlExecutableUnit");

    /** Logic used within the operation. */
    KeywordField ETL_EXPRESSION = new KeywordField("etlExpression", "etlExpression");

    /** Previous steps (control flow operations) in the control flow. */
    RelationField ETL_PREDECESSORS = new RelationField("etlPredecessors");

    /** Next steps (control flow operations) in the control flow. */
    RelationField ETL_SUCCESSORS = new RelationField("etlSuccessors");
    ...
    /** Executable unit that contains this control flow operation. */
    IETLExecutableUnit getEtlExecutableUnit();

    /** Logic used within the operation. */
    String getEtlExpression();

    /** Date and time at which this point in the data processing or orchestration finished. */
    Long getEtlFinishedAt();

    /** Previous steps (control flow operations) in the control flow. */
    SortedSet<IETLControlFlowOperation> getEtlPredecessors();

    /** Schedule for this point in the data processing or orchestration. */
    String getEtlSchedule();

    /** Date and time at which this point in the data processing or orchestration started. */
    Long getEtlStartedAt();

    /** Overall status of this point in the data processing or orchestration. */
    String getEtlStatus();

    /** Next steps (control flow operations) in the control flow. */
    SortedSet<IETLControlFlowOperation> getEtlSuccessors();
