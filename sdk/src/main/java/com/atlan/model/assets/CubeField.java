...
public class CubeField extends Asset implements ICubeField, IMultiDimensionalDataset, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all CubeField assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CubeField assets will be included.
     *
     * @return an asset filter that includes all CubeField assets
    ...
    /**
     * Retrieves a CubeField by its GUID, complete with all of its relationships.
     *
     * @param guid of the CubeField to retrieve
     * @return the requested full CubeField, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CubeField does not exist or the provided GUID is not a CubeField
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CubeField retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CubeField retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CubeField by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CubeField to retrieve
     * @return the requested full CubeField, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CubeField does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CubeField retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CubeField retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    public static CubeFieldBuilder<?, ?> creator(String name, CubeHierarchy hierarchy) throws InvalidRequestException {
        if (hierarchy.getQualifiedName() == null || hierarchy.getQualifiedName().isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_RELATIONSHIP_PARAM, "CubeHierarchy", "qualifiedName");
        }
     ...
     */
    public static CubeFieldBuilder<?, ?> creator(String name, CubeHierarchy hierarchy, CubeField parentField)
            throws InvalidRequestException {
        if (hierarchy.getQualifiedName() == null || hierarchy.getQualifiedName().isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_RELATIONSHIP_PARAM, "CubeHierarchy", "qualifiedName");
        }
        if (parentField.getQualifiedName() == null
                || parentField.getQualifiedName().isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_RELATIONSHIP_PARAM, "CubeField", "qualifiedName");
        }
    ...
    public static CubeFieldBuilder<?, ?> creator(
            String name, String hierarchyQualifiedName, String parentFieldQualifiedName) {
     ...
     * @throws AtlanException on any API problems
     */
    public static CubeField updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CubeField replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CubeField.
     *
     * @param qualifiedName of the CubeField
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CubeField
     ...
     * Add Atlan tags to a CubeField.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CubeField
     * @param qualifiedName of the CubeField
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CubeField
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
