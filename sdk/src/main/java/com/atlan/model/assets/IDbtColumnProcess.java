...
public interface IDbtColumnProcess {

    public static final String TYPE_NAME = "DbtColumnProcess";

    /** Status of the dbt column process job. */
    KeywordField DBT_COLUMN_PROCESS_JOB_STATUS =
            new KeywordField("dbtColumnProcessJobStatus", "dbtColumnProcessJobStatus");
    ...
    /** Status of the dbt column process job. */
    String getDbtColumnProcessJobStatus();
