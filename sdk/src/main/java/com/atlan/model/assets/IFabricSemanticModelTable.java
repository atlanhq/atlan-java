...
public interface IFabricSemanticModelTable {
    ...
    /** Semantic model containing the table. */
    IFabricSemanticModel getFabricSemanticModel();

    /** Unique name of the Fabric semantic model that contains this asset. */
    String getFabricSemanticModelQualifiedName();

    /** Individual semantic model table columns contained in the semantic model table. */
    SortedSet<IFabricSemanticModelTableColumn> getFabricSemanticModelTableColumns();
