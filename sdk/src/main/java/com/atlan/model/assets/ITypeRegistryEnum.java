...
public interface ITypeRegistryEnum {
    ...
    KeywordField TYPE_REGISTRY_VALUES = new KeywordField("typeRegistryValues", "typeRegistryValues");
    ...
    /** Valid values defined for this enumeration. */
    List<TypeRegistryValidValue> getTypeRegistryValues();
