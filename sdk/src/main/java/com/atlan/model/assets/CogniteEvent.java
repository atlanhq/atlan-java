...
public class CogniteEvent extends Asset implements ICogniteEvent, ICognite, ISaaS, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all CogniteEvent assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CogniteEvent assets will be included.
     *
     * @return an asset filter that includes all CogniteEvent assets
     ...
     */
    @JsonIgnore
    public static CogniteEvent get(String id) throws AtlanException {
     ...
     */
    @JsonIgnore
    public static CogniteEvent get(AtlanClient client, String id, boolean includeRelationships) throws AtlanException {
        if (id == null) {
    ...
    /**
     * Retrieves a CogniteEvent by its GUID, complete with all of its relationships.
     *
     * @param guid of the CogniteEvent to retrieve
     * @return the requested full CogniteEvent, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteEvent does not exist or the provided GUID is not a CogniteEvent
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteEvent retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteEvent retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CogniteEvent by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CogniteEvent to retrieve
     * @return the requested full CogniteEvent, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CogniteEvent does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CogniteEvent retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CogniteEvent retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    public CogniteEventBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "CogniteEvent", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteEvent removeDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteEvent removeUserDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteEvent removeOwners(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteEvent updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteEvent removeCertificate(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteEvent removeAnnouncement(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteEvent replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteEvent appendTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CogniteEvent removeTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     */
    public static CogniteEvent appendAtlanTags(String qualifiedName, List<String> atlanTagNames) throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CogniteEvent.
     *
     * @param qualifiedName of the CogniteEvent
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteEvent
     ...
     * Add Atlan tags to a CogniteEvent.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CogniteEvent
     * @param qualifiedName of the CogniteEvent
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CogniteEvent
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
