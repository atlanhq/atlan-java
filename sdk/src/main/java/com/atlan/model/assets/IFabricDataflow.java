...
public interface IFabricDataflow {

    public static final String TYPE_NAME = "FabricDataflow";

    /** Individual dataflow entity columns contained in the dataflow. */
    RelationField FABRIC_DATAFLOW_ENTITY_COLUMNS = new RelationField("fabricDataflowEntityColumns");
    ...
    /** Individual dataflow entity columns contained in the dataflow. */
    SortedSet<IFabricDataflowEntityColumn> getFabricDataflowEntityColumns();
