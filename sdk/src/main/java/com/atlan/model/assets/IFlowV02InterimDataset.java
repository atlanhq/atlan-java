...
public interface IFlowV02InterimDataset {
    ...
    RelationField FLOW_V02DETAILED_BY = new RelationField("flowV02DetailedBy");

    /** Fields contained in the interim dataset. */
    RelationField FLOW_V02FIELDS = new RelationField("flowV02Fields");
    ...
    /** Process grouping that details the sub-processing to produce the interim dataset. */
    IFlowV02ProcessGrouping getFlowV02DetailedBy();

    /** Optional error message of the flow run. */
    String getFlowV02ErrorMessage();

    /** Fields contained in the interim dataset. */
    SortedSet<IFlowV02InterimField> getFlowV02Fields();
