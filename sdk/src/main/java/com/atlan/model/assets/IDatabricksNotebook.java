...
public interface IDatabricksNotebook {

    public static final String TYPE_NAME = "DatabricksNotebook";

    /** Path of the notebook. */
    KeywordField DATABRICKS_NOTEBOOK_PATH = new KeywordField("databricksNotebookPath", "databricksNotebookPath");

    /** Workspace Id of the notebook. */
    KeywordField DATABRICKS_NOTEBOOK_WORKSPACE_ID =
            new KeywordField("databricksNotebookWorkspaceId", "databricksNotebookWorkspaceId");
    ...
    /** Path of the notebook. */
    String getDatabricksNotebookPath();

    /** Workspace Id of the notebook. */
    String getDatabricksNotebookWorkspaceId();
