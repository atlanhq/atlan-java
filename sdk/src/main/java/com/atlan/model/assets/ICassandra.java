...
public interface ICassandra {
    ...
    public static final String TYPE_NAME = "Cassandra";

    /** Name of the keyspace for the Cassandra asset. */
    KeywordField CASSANDRA_KEYSPACE_NAME = new KeywordField("cassandraKeyspaceName", "cassandraKeyspaceName");

    /** Name of the table for the Cassandra asset. */
    KeywordField CASSANDRA_TABLE_NAME = new KeywordField("cassandraTableName", "cassandraTableName");

    /** Unique name of table for Cassandra asset */
    KeywordField CASSANDRA_TABLE_QUALIFIED_NAME =
            new KeywordField("cassandraTableQualifiedName", "cassandraTableQualifiedName");

    /** Name of view for Cassandra asset */
    KeywordField CASSANDRA_VIEW_NAME = new KeywordField("cassandraViewName", "cassandraViewName");

    /** Unique name of view for Cassandra asset */
    KeywordField CASSANDRA_VIEW_QUALIFIED_NAME =
            new KeywordField("cassandraViewQualifiedName", "cassandraViewQualifiedName");
