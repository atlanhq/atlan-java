...
public interface ISnowflakeListing {
    ...
    KeywordField SNOWFLAKE_LISTING_AUTO_FULFILLMENT =
            new KeywordField("snowflakeListingAutoFulfillment", "snowflakeListingAutoFulfillment");

    /** Discovery categories assigned to the listing. */
    KeywordField SNOWFLAKE_LISTING_CATEGORIES =
            new KeywordField("snowflakeListingCategories", "snowflakeListingCategories");

    /** Data properties of the listing (refresh rate, history, freshness window) as a JSON blob emitted by Snowflake. */
    KeywordField SNOWFLAKE_LISTING_DATA_ATTRIBUTES =
            new KeywordField("snowflakeListingDataAttributes", "snowflakeListingDataAttributes");

    /** Distribution scope of the listing (organization-internal vs external marketplace/exchange). */
    KeywordField SNOWFLAKE_LISTING_DISTRIBUTION =
    ...
    BooleanField SNOWFLAKE_LISTING_IS_APPLICATION =
            new BooleanField("snowflakeListingIsApplication", "snowflakeListingIsApplication");

    /** Whether this listing wraps a data share (true) or not (false). */
    BooleanField SNOWFLAKE_LISTING_IS_SHARE = new BooleanField("snowflakeListingIsShare", "snowflakeListingIsShare");

    /** External Snowflake provider profile attached to the listing. */
    KeywordField SNOWFLAKE_LISTING_PROFILE = new KeywordField("snowflakeListingProfile", "snowflakeListingProfile");

    /** Resharing configuration for the listing. */
    KeywordField SNOWFLAKE_LISTING_RESHARING =
            new KeywordField("snowflakeListingResharing", "snowflakeListingResharing");

    /** Publication state of the listing. */
    KeywordField SNOWFLAKE_LISTING_STATE = new KeywordField("snowflakeListingState", "snowflakeListingState");

    /** Marketplace subtitle of the listing. */
    KeywordField SNOWFLAKE_LISTING_SUBTITLE = new KeywordField("snowflakeListingSubtitle", "snowflakeListingSubtitle");

    /** Contact info for the listing. */
    KeywordField SNOWFLAKE_LISTING_SUPPORT_CONTACT =
            new KeywordField("snowflakeListingSupportContact", "snowflakeListingSupportContact");

    /** Distribution targets of the listing (accounts, regions) as a JSON blob emitted by Snowflake. */
    KeywordField SNOWFLAKE_LISTING_TARGETS = new KeywordField("snowflakeListingTargets", "snowflakeListingTargets");

    /** Terms of service for the listing. */
    KeywordField SNOWFLAKE_LISTING_TERMS = new KeywordField("snowflakeListingTerms", "snowflakeListingTerms");

    /** Snowflake's source-truthful title for the listing. Distinct from `name` (the non-human-readable Snowflake identifier). */
    KeywordField SNOWFLAKE_LISTING_TITLE = new KeywordField("snowflakeListingTitle", "snowflakeListingTitle");

    /** Uniform Listing Locator (ULL) of the listing. */
    KeywordField SNOWFLAKE_LISTING_UNIFORM_LISTING_LOCATOR =
            new KeywordField("snowflakeListingUniformListingLocator", "snowflakeListingUniformListingLocator");

    /** Snowflake shares wrapped by this listing. */
    RelationField SNOWFLAKE_SHARES = new RelationField("snowflakeShares");
    ...
    /** Application package name when this listing wraps a Native App. */
    String getSnowflakeListingApplicationPackage();

    /** Auto-fulfillment configuration for the listing. */
    String getSnowflakeListingAutoFulfillment();

    /** Discovery categories assigned to the listing. */
    SortedSet<String> getSnowflakeListingCategories();

    /** Data properties of the listing (refresh rate, history, freshness window) as a JSON blob emitted by Snowflake. */
    String getSnowflakeListingDataAttributes();

    /** Distribution scope of the listing (organization-internal vs external marketplace/exchange). */
    SnowflakeListingDistribution getSnowflakeListingDistribution();

    /** Whether this listing wraps a Snowflake Native App (true) or not (false). */
    Boolean getSnowflakeListingIsApplication();

    /** Whether this listing wraps a data share (true) or not (false). */
    Boolean getSnowflakeListingIsShare();

    /** External Snowflake provider profile attached to the listing. */
    String getSnowflakeListingProfile();

    /** Resharing configuration for the listing. */
    String getSnowflakeListingResharing();

    /** Publication state of the listing. */
    SnowflakeListingState getSnowflakeListingState();

    /** Marketplace subtitle of the listing. */
    String getSnowflakeListingSubtitle();

    /** Contact info for the listing. */
    String getSnowflakeListingSupportContact();

    /** Distribution targets of the listing (accounts, regions) as a JSON blob emitted by Snowflake. */
    String getSnowflakeListingTargets();

    /** Terms of service for the listing. */
    String getSnowflakeListingTerms();

    /** Snowflake's source-truthful title for the listing. Distinct from `name` (the non-human-readable Snowflake identifier). */
    String getSnowflakeListingTitle();

    /** Uniform Listing Locator (ULL) of the listing. */
    String getSnowflakeListingUniformListingLocator();
    ...
    /** Snowflake shares wrapped by this listing. */
    default SortedSet<ISnowflakeShare> getSnowflakeShares() {
        return null;
    }
