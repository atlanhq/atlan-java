...
public class Workflow extends Asset implements IWorkflow, IAsset, IReferenceable {
    ...
    /**
     * Retrieves a Workflow by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the Workflow to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the Workflow, including any relationships
     * @return the requested Workflow, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Workflow does not exist or the provided GUID is not a Workflow
     */
    @JsonIgnore
     ...
     * @param id of the Workflow to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the Workflow, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the Workflow
     * @return the requested Workflow, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Workflow does not exist or the provided GUID is not a Workflow
     */
    @JsonIgnore
    public static Workflow get(
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = Workflow.select(client)
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof Workflow) {
