...
public class Workflow extends Asset implements IWorkflow, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all Workflow assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) Workflow assets will be included.
     *
     * @return an asset filter that includes all Workflow assets
    ...
    /**
     * Retrieves a Workflow by its GUID, complete with all of its relationships.
     *
     * @param guid of the Workflow to retrieve
     * @return the requested full Workflow, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Workflow does not exist or the provided GUID is not a Workflow
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static Workflow retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static Workflow retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a Workflow by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the Workflow to retrieve
     * @return the requested full Workflow, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Workflow does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static Workflow retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static Workflow retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static Workflow removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static Workflow updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static Workflow updateCertificate(
     ...
     * @throws AtlanException on any API problems
     */
    public static Workflow updateAnnouncement(
     ...
     * @throws AtlanException on any API problems
     */
    public static Workflow removeAnnouncement(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static Workflow replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
    ...
    public static Workflow appendAtlanTags(
            ...
            boolean restrictLineagePropagation)
            throws AtlanException {
        return (Workflow) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
    ...
    /**
     * Add Atlan tags to a Workflow.
     *
     * @param qualifiedName of the Workflow
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the Workflow
     ...
     * Add Atlan tags to a Workflow.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the Workflow
     * @param qualifiedName of the Workflow
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the Workflow
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
