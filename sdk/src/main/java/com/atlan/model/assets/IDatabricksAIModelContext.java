...
public interface IDatabricksAIModelContext {

    public static final String TYPE_NAME = "DatabricksAIModelContext";

    /** The id of the model, common across versions. */
    KeywordField DATABRICKS_AI_MODEL_CONTEXT_METASTORE_ID =
            new KeywordField("databricksAIModelContextMetastoreId", "databricksAIModelContextMetastoreId");

    /** Schema containing the context. */
    RelationField DATABRICKS_AI_MODEL_SCHEMA = new RelationField("databricksAIModelSchema");

    /** Versions contained within the context. */
    RelationField DATABRICKS_AI_MODEL_VERSIONS = new RelationField("databricksAIModelVersions");
    ...
    /** The id of the model, common across versions. */
    String getDatabricksAIModelContextMetastoreId();

    /** Schema containing the context. */
    default ISchema getDatabricksAIModelSchema() {
        return null;
    }

    /** Versions contained within the context. */
    default SortedSet<IDatabricksAIModelVersion> getDatabricksAIModelVersions() {
        return null;
    }
