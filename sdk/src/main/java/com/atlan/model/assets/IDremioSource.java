...
public interface IDremioSource {

    public static final String TYPE_NAME = "DremioSource";

    /** Folders directly contained within the Dremio Source. */
    RelationField DREMIO_FOLDERS = new RelationField("dremioFolders");

    /** Physical datasets (tables) directly contained within the Dremio Source. */
    RelationField DREMIO_PHYSICAL_DATASETS = new RelationField("dremioPhysicalDatasets");

    /** Default acceleration settings for datasets in this source. */
    KeywordField DREMIO_SOURCE_ACCELERATION_SETTINGS =
            new KeywordField("dremioSourceAccelerationSettings", "dremioSourceAccelerationSettings");

    /** Configuration parameters for connecting to the external source. */
    KeywordField DREMIO_SOURCE_CONNECTION_CONFIGS =
            new KeywordField("dremioSourceConnectionConfigs", "dremioSourceConnectionConfigs");

    /** Current health status of the source connection. */
    KeywordField DREMIO_SOURCE_HEALTH_STATUS = new KeywordField("dremioSourceHealthStatus", "dremioSourceHealthStatus");

    /** Current health status message of the source connection. */
    KeywordField DREMIO_SOURCE_HEALTH_STATUS_MESSAGE =
            new KeywordField("dremioSourceHealthStatusMessage", "dremioSourceHealthStatusMessage");

    /** Metadata refresh and caching policies. */
    KeywordField DREMIO_SOURCE_METADATA_POLICIES =
            new KeywordField("dremioSourceMetadataPolicies", "dremioSourceMetadataPolicies");

    /** Type of external source. */
    KeywordField DREMIO_SOURCE_TYPE = new KeywordField("dremioSourceType", "dremioSourceType");
    ...
    /** Folders directly contained within the Dremio Source. */
    SortedSet<IDremioFolder> getDremioFolders();

    /** Source ID of this asset in Dremio. */
    String getDremioId();

    /** Dremio Labels associated with this asset. */
    SortedSet<String> getDremioLabels();

    /** Unique qualified name of the immediate parent folder containing this asset. */
    String getDremioParentFolderQualifiedName();

    /** Physical datasets (tables) directly contained within the Dremio Source. */
    SortedSet<IDremioPhysicalDataset> getDremioPhysicalDatasets();

    /** Default acceleration settings for datasets in this source. */
    Map<String, String> getDremioSourceAccelerationSettings();

    /** Configuration parameters for connecting to the external source. */
    Map<String, String> getDremioSourceConnectionConfigs();

    /** Current health status of the source connection. */
    String getDremioSourceHealthStatus();

    /** Current health status message of the source connection. */
    String getDremioSourceHealthStatusMessage();

    /** Metadata refresh and caching policies. */
    Map<String, String> getDremioSourceMetadataPolicies();

    /** Simple name of the Dremio Source containing this asset. */
    String getDremioSourceName();

    /** Unique qualified name of the Dremio Source containing this asset. */
    String getDremioSourceQualifiedName();

    /** Type of external source. */
    String getDremioSourceType();

    /** Simple name of the Dremio Space containing this asset. */
    String getDremioSpaceName();

    /** Unique qualified name of the Dremio Space containing this asset. */
    String getDremioSpaceQualifiedName();
