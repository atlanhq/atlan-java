...
public class AdfDataset extends Asset implements IAdfDataset, IADF, ICatalog, IAsset, IReferenceable {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfDataset updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfDataset replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfDataset appendTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AdfDataset removeTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     */
    public static AdfDataset appendAtlanTags(String qualifiedName, List<String> atlanTagNames) throws AtlanException {
