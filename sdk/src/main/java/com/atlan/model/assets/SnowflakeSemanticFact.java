...
public class SnowflakeSemanticFact extends Asset
        implements ISnowflakeSemanticFact,
                ISemanticMeasure,
                ISnowflake,
                ISemantic,
                ICatalog,
     ...
     */
    @JsonIgnore
    public static SnowflakeSemanticFact get(AtlanClient client, String id, boolean includeAllRelationships)
     ...
     */
    @JsonIgnore
    public static SnowflakeSemanticFact get(AtlanClient client, String id, Collection<AtlanField> attributes)
            throws AtlanException {
    ...
    public abstract static class SnowflakeSemanticFactBuilder<
                    C extends SnowflakeSemanticFact, B extends SnowflakeSemanticFactBuilder<C, B>>
     ...
     * @throws AtlanException on any API problems
     */
    public static SnowflakeSemanticFact removeDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SnowflakeSemanticFact removeOwners(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SnowflakeSemanticFact removeCertificate(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SnowflakeSemanticFact replaceTerms(
