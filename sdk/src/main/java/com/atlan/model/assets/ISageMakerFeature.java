...
public interface ISageMakerFeature {

    public static final String TYPE_NAME = "SageMakerFeature";

    /** Data type of the feature (e.g., String, Integral, Fractional). */
    KeywordField SAGE_MAKER_FEATURE_DATA_TYPE =
            new KeywordField("sageMakerFeatureDataType", "sageMakerFeatureDataType");

    /** SageMaker Feature Group that contains the features. */
    RelationField SAGE_MAKER_FEATURE_GROUP = new RelationField("sageMakerFeatureGroup");

    /** Name of the Feature Group that contains this feature. */
    KeywordField SAGE_MAKER_FEATURE_GROUP_NAME =
            new KeywordField("sageMakerFeatureGroupName", "sageMakerFeatureGroupName");

    /** Qualified name of the Feature Group that contains this feature. */
    KeywordField SAGE_MAKER_FEATURE_GROUP_QUALIFIED_NAME =
            new KeywordField("sageMakerFeatureGroupQualifiedName", "sageMakerFeatureGroupQualifiedName");

    /** Whether this feature serves as the record identifier for the Feature Group. */
    BooleanField SAGE_MAKER_FEATURE_IS_RECORD_IDENTIFIER =
            new BooleanField("sageMakerFeatureIsRecordIdentifier", "sageMakerFeatureIsRecordIdentifier");
    ...
    /** Data type of the feature (e.g., String, Integral, Fractional). */
    String getSageMakerFeatureDataType();

    /** SageMaker Feature Group that contains the features. */
    default ISageMakerFeatureGroup getSageMakerFeatureGroup() {
        return null;
    }

    /** Name of the Feature Group that contains this feature. */
    String getSageMakerFeatureGroupName();

    /** Qualified name of the Feature Group that contains this feature. */
    String getSageMakerFeatureGroupQualifiedName();

    /** Whether this feature serves as the record identifier for the Feature Group. */
    Boolean getSageMakerFeatureIsRecordIdentifier();
