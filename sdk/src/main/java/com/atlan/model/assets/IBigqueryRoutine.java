...
public interface IBigqueryRoutine {
    ...
    KeywordField BIGQUERY_ROUTINE_ARGUMENTS = new KeywordField("bigqueryRoutineArguments", "bigqueryRoutineArguments");

    /** The ddl statement used to create the bigquery routine. */
    KeywordField BIGQUERY_ROUTINE_DDL = new KeywordField("bigqueryRoutineDdl", "bigqueryRoutineDdl");

    /** Return data type of the bigquery routine (null for stored procedures). */
    KeywordField BIGQUERY_ROUTINE_RETURN_TYPE =
            new KeywordField("bigqueryRoutineReturnType", "bigqueryRoutineReturnType");

    /** Security type of the routine, always null. */
    KeywordField BIGQUERY_ROUTINE_SECURITY_TYPE =
            new KeywordField("bigqueryRoutineSecurityType", "bigqueryRoutineSecurityType");

    /** Type of bigquery routine (sp, udf, or tvf). */
    KeywordField BIGQUERY_ROUTINE_TYPE = new KeywordField("bigqueryRoutineType", "bigqueryRoutineType");
    ...
    /** Schema in which this routine exists. */
    default ISchema getBigqueryAtlanSchema() {
        return null;
    }

    /** Processes that utilize this routine. */
    default SortedSet<ILineageProcess> getBigqueryProcesses() {
        return null;
    }

    /** Arguments that are passed in to the routine. */
    SortedSet<String> getBigqueryRoutineArguments();

    /** The ddl statement used to create the bigquery routine. */
    String getBigqueryRoutineDdl();

    /** Return data type of the bigquery routine (null for stored procedures). */
    String getBigqueryRoutineReturnType();

    /** Security type of the routine, always null. */
    String getBigqueryRoutineSecurityType();

    /** Type of bigquery routine (sp, udf, or tvf). */
    BigqueryRoutineType getBigqueryRoutineType();
    ...
    default SortedSet<ILineageProcess> getSqlProcesses() {
        return null;
    }
