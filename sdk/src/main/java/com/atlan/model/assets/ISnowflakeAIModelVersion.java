...
public interface ISnowflakeAIModelVersion {

    public static final String TYPE_NAME = "SnowflakeAIModelVersion";

    /** Context containing the version. */
    RelationField SNOWFLAKE_AI_MODEL_CONTEXT = new RelationField("snowflakeAIModelContext");

    /** The aliases for the model version. */
    KeywordField SNOWFLAKE_AI_MODEL_VERSION_ALIASES =
            new KeywordField("snowflakeAIModelVersionAliases", "snowflakeAIModelVersionAliases");

    /** Functions used in the model version. */
    KeywordField SNOWFLAKE_AI_MODEL_VERSION_FUNCTIONS =
            new KeywordField("snowflakeAIModelVersionFunctions", "snowflakeAIModelVersionFunctions");

    /** Metrics for an individual experiment. */
    KeywordField SNOWFLAKE_AI_MODEL_VERSION_METRICS =
            new KeywordField("snowflakeAIModelVersionMetrics", "snowflakeAIModelVersionMetrics");

    /** Version part of the model name. */
    KeywordField SNOWFLAKE_AI_MODEL_VERSION_NAME =
            new KeywordField("snowflakeAIModelVersionName", "snowflakeAIModelVersionName");

    /** The type of the model version. */
    KeywordField SNOWFLAKE_AI_MODEL_VERSION_TYPE =
            new KeywordField("snowflakeAIModelVersionType", "snowflakeAIModelVersionType");
    ...
    /** Context containing the version. */
    default ISnowflakeAIModelContext getSnowflakeAIModelContext() {
        return null;
    }

    /** The aliases for the model version. */
    SortedSet<String> getSnowflakeAIModelVersionAliases();

    /** Functions used in the model version. */
    SortedSet<String> getSnowflakeAIModelVersionFunctions();

    /** Metrics for an individual experiment. */
    Map<String, String> getSnowflakeAIModelVersionMetrics();

    /** Version part of the model name. */
    String getSnowflakeAIModelVersionName();
