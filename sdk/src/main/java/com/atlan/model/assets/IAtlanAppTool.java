...
public interface IAtlanAppTool {
    ...
    KeywordField ATLAN_APP_TOOL_CATEGORY = new KeywordField("atlanAppToolCategory", "atlanAppToolCategory");

    /** Input schema for the Atlan application tool (escaped JSON string of JSONSchema). */
    TextField ATLAN_APP_TOOL_INPUT_SCHEMA = new TextField("atlanAppToolInputSchema", "atlanAppToolInputSchema");

    /** Output schema for the Atlan application tool (escaped JSON string of JSONSchema). */
    TextField ATLAN_APP_TOOL_OUTPUT_SCHEMA = new TextField("atlanAppToolOutputSchema", "atlanAppToolOutputSchema");

    /** Name of the Temporal task queue for the Atlan application tool. */
    KeywordField ATLAN_APP_TOOL_TASK_QUEUE = new KeywordField("atlanAppToolTaskQueue", "atlanAppToolTaskQueue");
    ...
    /** Category of the tool. */
    String getAtlanAppToolCategory();

    /** Input schema for the Atlan application tool (escaped JSON string of JSONSchema). */
    String getAtlanAppToolInputSchema();

    /** Output schema for the Atlan application tool (escaped JSON string of JSONSchema). */
    String getAtlanAppToolOutputSchema();

    /** Name of the Temporal task queue for the Atlan application tool. */
    String getAtlanAppToolTaskQueue();
