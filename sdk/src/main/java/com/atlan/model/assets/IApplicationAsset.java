...
public interface IApplicationAsset {
    ...
    IApplicationAsset getApplicationAsset();

    /** Qualified name of the Application Asset that contains this asset. */
    String getApplicationAssetQualifiedName();

    /** Catalog assets contained within this ApplicationAsset. */
    SortedSet<ICatalog> getApplicationCatalog();
