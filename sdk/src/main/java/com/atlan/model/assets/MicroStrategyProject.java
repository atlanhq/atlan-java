...
public class MicroStrategyProject extends Asset implements IMicroStrategyProject, IMicroStrategy, IBI, ICatalog, IAsset, IReferenceable {
     ...
     */
    @JsonIgnore
    public static MicroStrategyProject get(AtlanClient client, String id, boolean includeAllRelationships) throws AtlanException {
        if (id == null) {
    ...
    /**
     * Retrieves a MicroStrategyProject by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the MicroStrategyProject to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the MicroStrategyProject, including any relationships
     * @return the requested MicroStrategyProject, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MicroStrategyProject does not exist or the provided GUID is not a MicroStrategyProject
     */
    @JsonIgnore
    public static MicroStrategyProject get(AtlanClient client, String id, Collection<AtlanField> attributes) throws AtlanException {
     ...
     * @param id of the MicroStrategyProject to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the MicroStrategyProject, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the MicroStrategyProject
     * @return the requested MicroStrategyProject, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MicroStrategyProject does not exist or the provided GUID is not a MicroStrategyProject
     */
    @JsonIgnore
    public static MicroStrategyProject get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = MicroStrategyProject.select(client)
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof MicroStrategyProject) {
                return (MicroStrategyProject) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
    ...
    public abstract static class MicroStrategyProjectBuilder<C extends MicroStrategyProject, B extends MicroStrategyProjectBuilder<C, B>>
     ...
     * @throws AtlanException on any API problems
     */
    public static MicroStrategyProject replaceTerms(AtlanClient client, String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    @Deprecated
    public static MicroStrategyProject appendAtlanTags(AtlanClient client, String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
