...
public class MicroStrategyProject extends Asset
     ...
     */
    @JsonIgnore
    public static MicroStrategyProject get(AtlanClient client, String id, boolean includeAllRelationships)
     ...
     */
    @JsonIgnore
    public static MicroStrategyProject get(AtlanClient client, String id, Collection<AtlanField> attributes)
            throws AtlanException {
