...
public interface IDataQualityRuleTemplate {
    ...
    KeywordField DQ_RULE_TEMPLATE_CONFIG = new KeywordField("dqRuleTemplateConfig", "dqRuleTemplateConfig");

    /** Name of the dimension the rule belongs to. */
    KeywordField DQ_RULE_TEMPLATE_DIMENSION = new KeywordField("dqRuleTemplateDimension", "dqRuleTemplateDimension");

    /** Type of the metric value returned by the rule(absolute, percentage, time etc.). */
    KeywordField DQ_RULE_TEMPLATE_METRIC_VALUE_TYPE =
            new KeywordField("dqRuleTemplateMetricValueType", "dqRuleTemplateMetricValueType");

    /** Rules that are created from the template. */
    RelationField DQ_RULES = new RelationField("dqRules");
    ...
    /** Rule config that will help render the form and define the rule. */
    DataQualityRuleTemplateConfig getDqRuleTemplateConfig();

    /** Name of the dimension the rule belongs to. */
    DataQualityDimension getDqRuleTemplateDimension();

    /** Type of the metric value returned by the rule(absolute, percentage, time etc.). */
    DataQualityRuleTemplateMetricValueType getDqRuleTemplateMetricValueType();

    /** Rules that are created from the template. */
    SortedSet<IDataQualityRule> getDqRules();
