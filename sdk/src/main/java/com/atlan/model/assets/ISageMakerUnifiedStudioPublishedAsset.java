...
public interface ISageMakerUnifiedStudioPublishedAsset {
    ...
    NumericField SMUS_PUBLISHED_ASSET_SUBSCRIPTIONS_COUNT =
            new NumericField("smusPublishedAssetSubscriptionsCount", "smusPublishedAssetSubscriptionsCount");

    /** SubscribedAssets associated wih this Published Asset in AWS SMUS */
    RelationField SMUS_SUBSCRIBED_ASSETS = new RelationField("smusSubscribedAssets");
    ...
    /** SubscribedAssets associated wih this Published Asset in AWS SMUS */
    SortedSet<ISageMakerUnifiedStudioSubscribedAsset> getSmusSubscribedAssets();
