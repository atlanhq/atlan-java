...
public interface IDatabricksExternalLocation {

    public static final String TYPE_NAME = "DatabricksExternalLocation";

    /** Paths contained within the external location. */
    RelationField DATABRICKS_EXTERNAL_LOCATION_PATHS = new RelationField("databricksExternalLocationPaths");

    /** User or group (principal) currently owning the external location. */
    KeywordField DATABRICKS_OWNER = new KeywordField("databricksOwner", "databricksOwner");

    /** URL of the external location. */
    KeywordField DATABRICKS_URL = new KeywordField("databricksUrl", "databricksUrl");
    ...
    /** Paths contained within the external location. */
    SortedSet<IDatabricksExternalLocationPath> getDatabricksExternalLocationPaths();

    /** User or group (principal) currently owning the external location. */
    String getDatabricksOwner();

    /** URL of the external location. */
    String getDatabricksUrl();
