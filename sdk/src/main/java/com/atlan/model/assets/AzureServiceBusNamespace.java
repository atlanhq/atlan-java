...
public class AzureServiceBusNamespace extends Asset
    ...
    /**
     * Start an asset filter that will return all AzureServiceBusNamespace assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) AzureServiceBusNamespace assets will be included.
     *
     * @return an asset filter that includes all AzureServiceBusNamespace assets
    ...
    /**
     * Retrieves a AzureServiceBusNamespace by its GUID, complete with all of its relationships.
     *
     * @param guid of the AzureServiceBusNamespace to retrieve
     * @return the requested full AzureServiceBusNamespace, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the AzureServiceBusNamespace does not exist or the provided GUID is not a AzureServiceBusNamespace
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static AzureServiceBusNamespace retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static AzureServiceBusNamespace retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a AzureServiceBusNamespace by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the AzureServiceBusNamespace to retrieve
     * @return the requested full AzureServiceBusNamespace, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the AzureServiceBusNamespace does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static AzureServiceBusNamespace retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static AzureServiceBusNamespace retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public AzureServiceBusNamespaceBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "AzureServiceBusNamespace", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a AzureServiceBusNamespace.
     *
     * @param qualifiedName of the AzureServiceBusNamespace
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the AzureServiceBusNamespace
     ...
     * Add Atlan tags to a AzureServiceBusNamespace.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the AzureServiceBusNamespace
     * @param qualifiedName of the AzureServiceBusNamespace
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the AzureServiceBusNamespace
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
