...
public interface IFabricDataflowEntityColumn {

    public static final String TYPE_NAME = "FabricDataflowEntityColumn";

    /** Dataflow containing the columns. */
    RelationField FABRIC_DATAFLOW = new RelationField("fabricDataflow");

    /** Name of the Fabric dataflow that contains this asset. */
    KeywordField FABRIC_DATAFLOW_NAME = new KeywordField("fabricDataflowName", "fabricDataflowName");

    /** Unique name of the Fabric dataflow that contains this asset. */
    KeywordField FABRIC_DATAFLOW_QUALIFIED_NAME =
            new KeywordField("fabricDataflowQualifiedName", "fabricDataflowQualifiedName");
    ...
    /** Dataflow containing the columns. */
    IFabricDataflow getFabricDataflow();

    /** Name of the Fabric dataflow that contains this asset. */
    String getFabricDataflowName();

    /** Unique name of the Fabric dataflow that contains this asset. */
    String getFabricDataflowQualifiedName();
