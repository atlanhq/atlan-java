...
public interface ISqlInsightJoin {

    public static final String TYPE_NAME = "SqlInsightJoin";

    /** Observed cardinality of the join relationship. */
    KeywordField SQL_INSIGHT_JOIN_CARDINALITY =
            new KeywordField("sqlInsightJoinCardinality", "sqlInsightJoinCardinality");

    /** Column mappings in this join, pairing source columns to joined columns. */
    KeywordField SQL_INSIGHT_JOIN_COLUMN_PAIRS =
            new KeywordField("sqlInsightJoinColumnPairs", "sqlInsightJoinColumnPairs");

    /** Example SQL queries that demonstrate this join pattern, with usage details. */
    KeywordField SQL_INSIGHT_JOIN_EXAMPLE_QUERIES =
            new KeywordField("sqlInsightJoinExampleQueries", "sqlInsightJoinExampleQueries");

    /** Qualified name of the joined dataset in this join pattern. */
    KeywordField SQL_INSIGHT_JOIN_JOINED_DATASET_QUALIFIED_NAME =
            new KeywordField("sqlInsightJoinJoinedDatasetQualifiedName", "sqlInsightJoinJoinedDatasetQualifiedName");

    /** Time (epoch) at which this join pattern was last observed, in milliseconds. */
    NumericField SQL_INSIGHT_JOIN_LAST_SEEN_AT =
            new NumericField("sqlInsightJoinLastSeenAt", "sqlInsightJoinLastSeenAt");

    /** Number of queries that use this join pattern. */
    NumericField SQL_INSIGHT_JOIN_QUERY_COUNT =
            new NumericField("sqlInsightJoinQueryCount", "sqlInsightJoinQueryCount");

    /** Qualified name of the source dataset in this join pattern. */
    KeywordField SQL_INSIGHT_JOIN_SOURCE_DATASET_QUALIFIED_NAME =
            new KeywordField("sqlInsightJoinSourceDatasetQualifiedName", "sqlInsightJoinSourceDatasetQualifiedName");

    /** Type of SQL join observed in this pattern. */
    KeywordField SQL_INSIGHT_JOIN_TYPE = new KeywordField("sqlInsightJoinType", "sqlInsightJoinType");

    /** Number of unique users who have used this join pattern. */
    NumericField SQL_INSIGHT_JOIN_UNIQUE_USERS =
            new NumericField("sqlInsightJoinUniqueUsers", "sqlInsightJoinUniqueUsers");

    /** Guidance on when this join pattern should be used. */
    KeywordField SQL_INSIGHT_JOIN_WHEN_TO_USE = new KeywordField("sqlInsightJoinWhenToUse", "sqlInsightJoinWhenToUse");

    /** SQL dataset that is the joined side in this join insight. */
    RelationField SQL_INSIGHT_JOINED_DATASET = new RelationField("sqlInsightJoinedDataset");

    /** SQL dataset that is the source in this join insight. */
    RelationField SQL_INSIGHT_SOURCE_DATASET = new RelationField("sqlInsightSourceDataset");
    ...
    /** Observed cardinality of the join relationship. */
    SqlInsightJoinCardinality getSqlInsightJoinCardinality();

    /** Column mappings in this join, pairing source columns to joined columns. */
    List<SqlInsightJoinColumnPair> getSqlInsightJoinColumnPairs();

    /** Example SQL queries that demonstrate this join pattern, with usage details. */
    List<PopularityInsights> getSqlInsightJoinExampleQueries();

    /** Qualified name of the joined dataset in this join pattern. */
    String getSqlInsightJoinJoinedDatasetQualifiedName();

    /** Time (epoch) at which this join pattern was last observed, in milliseconds. */
    Long getSqlInsightJoinLastSeenAt();

    /** Number of queries that use this join pattern. */
    Integer getSqlInsightJoinQueryCount();

    /** Qualified name of the source dataset in this join pattern. */
    String getSqlInsightJoinSourceDatasetQualifiedName();

    /** Type of SQL join observed in this pattern. */
    SqlInsightJoinType getSqlInsightJoinType();

    /** Number of unique users who have used this join pattern. */
    Integer getSqlInsightJoinUniqueUsers();

    /** Guidance on when this join pattern should be used. */
    String getSqlInsightJoinWhenToUse();

    /** SQL dataset that is the joined side in this join insight. */
    default ISQL getSqlInsightJoinedDataset() {
        return null;
    }

    /** SQL dataset that is the source in this join insight. */
    default ISQL getSqlInsightSourceDataset() {
        return null;
    }
