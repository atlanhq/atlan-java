...
public class CubeDimension extends Asset
    ...
    /**
     * Start an asset filter that will return all CubeDimension assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CubeDimension assets will be included.
     *
     * @return an asset filter that includes all CubeDimension assets
    ...
    /**
     * Retrieves a CubeDimension by its GUID, complete with all of its relationships.
     *
     * @param guid of the CubeDimension to retrieve
     * @return the requested full CubeDimension, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CubeDimension does not exist or the provided GUID is not a CubeDimension
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CubeDimension retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CubeDimension retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CubeDimension by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CubeDimension to retrieve
     * @return the requested full CubeDimension, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CubeDimension does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CubeDimension retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CubeDimension retrieveByQualifiedName(AtlanClient client, String qualifiedName)
    ...
    /**
     * Add Atlan tags to a CubeDimension.
     *
     * @param qualifiedName of the CubeDimension
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CubeDimension
     ...
     * Add Atlan tags to a CubeDimension.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CubeDimension
     * @param qualifiedName of the CubeDimension
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CubeDimension
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
