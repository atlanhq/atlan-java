...
public interface ISnowflakeAIModelContext {

    public static final String TYPE_NAME = "SnowflakeAIModelContext";

    /** Schema containing the context. */
    RelationField SNOWFLAKE_AI_MODEL_SCHEMA = new RelationField("snowflakeAIModelSchema");

    /** Versions contained within the context. */
    RelationField SNOWFLAKE_AI_MODEL_VERSIONS = new RelationField("snowflakeAIModelVersions");
    ...
    /** Schema containing the context. */
    ISchema getSnowflakeAIModelSchema();

    /** Versions contained within the context. */
    SortedSet<ISnowflakeAIModelVersion> getSnowflakeAIModelVersions();
