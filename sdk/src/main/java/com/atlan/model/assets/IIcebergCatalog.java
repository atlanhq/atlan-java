...
public interface IIcebergCatalog {
    ...
    KeywordField ICEBERG_CATALOG_PROPERTIES = new KeywordField("icebergCatalogProperties", "icebergCatalogProperties");

    /** Type of the Iceberg catalog (e.g., 'hadoop', 'hive', 'nessie', 'rest'). */
    KeywordField ICEBERG_CATALOG_TYPE = new KeywordField("icebergCatalogType", "icebergCatalogType");

    /** Scope of the Iceberg catalog. */
    KeywordField ICEBERG_SCOPE = new KeywordField("icebergScope", "icebergScope");

    /** URI of the Iceberg catalog. */
    KeywordField ICEBERG_URI = new KeywordField("icebergUri", "icebergUri");

    /** Warehouse associated with this Iceberg catalog. */
    KeywordField ICEBERG_WAREHOUSE = new KeywordField("icebergWarehouse", "icebergWarehouse");
    ...
    /** Properties of the Iceberg catalog. */
    Map<String, String> getIcebergCatalogProperties();
    ...
    /** Scope of the Iceberg catalog. */
    String getIcebergScope();

    /** URI of the Iceberg catalog. */
    String getIcebergUri();
