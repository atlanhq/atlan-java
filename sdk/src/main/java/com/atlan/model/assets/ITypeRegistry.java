...
/**
 * Base class for self-served type definitions (metamodel).
 */
...
public interface ITypeRegistry {
    ...
    public static final String TYPE_NAME = "TypeRegistry";
    ...
    NumericField TYPE_REGISTRY_DEPRECATED_AT = new NumericField("typeRegistryDeprecatedAt", "typeRegistryDeprecatedAt");

    /** User who deprecated this portion of the metamodel. */
    KeywordField TYPE_REGISTRY_DEPRECATED_BY = new KeywordField("typeRegistryDeprecatedBy", "typeRegistryDeprecatedBy");

    /** Explanatory definition of this portion of the metamodel. */
    KeywordField TYPE_REGISTRY_DESCRIPTION = new KeywordField("typeRegistryDescription", "typeRegistryDescription");

    /** Whether this portion of the metamodel is deprecated (marked for removal). */
    BooleanField TYPE_REGISTRY_IS_DEPRECATED = new BooleanField("typeRegistryIsDeprecated", "typeRegistryIsDeprecated");

    /** Unique name for this portion of the metamodel. */
    KeywordField TYPE_REGISTRY_NAME = new KeywordField("typeRegistryName", "typeRegistryName");

    /** Metamodel object that replaces this one. */
    RelationField TYPE_REGISTRY_REPLACED_BY = new RelationField("typeRegistryReplacedBy");

    /** Metamodel object(s) that are replaced by this one. */
    RelationField TYPE_REGISTRY_REPLACES = new RelationField("typeRegistryReplaces");

    /** Status of this portion of the metamodel. */
    KeywordField TYPE_REGISTRY_STATUS = new KeywordField("typeRegistryStatus", "typeRegistryStatus");
