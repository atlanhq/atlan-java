...
public class DomoDashboard extends Asset implements IDomoDashboard, IDomo, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all DomoDashboard assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DomoDashboard assets will be included.
     *
     * @return an asset filter that includes all DomoDashboard assets
     ...
     */
    @JsonIgnore
    public static DomoDashboard get(String id) throws AtlanException {
     ...
     */
    @JsonIgnore
    public static DomoDashboard get(AtlanClient client, String id, boolean includeRelationships) throws AtlanException {
        if (id == null) {
    ...
    /**
     * Retrieves a DomoDashboard by its GUID, complete with all of its relationships.
     *
     * @param guid of the DomoDashboard to retrieve
     * @return the requested full DomoDashboard, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DomoDashboard does not exist or the provided GUID is not a DomoDashboard
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DomoDashboard retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DomoDashboard retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DomoDashboard by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DomoDashboard to retrieve
     * @return the requested full DomoDashboard, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DomoDashboard does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DomoDashboard retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DomoDashboard retrieveByQualifiedName(AtlanClient client, String qualifiedName)
    ...
    public DomoDashboardBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "DomoDashboard", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static DomoDashboard removeDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DomoDashboard removeUserDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DomoDashboard removeOwners(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DomoDashboard updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DomoDashboard removeCertificate(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DomoDashboard removeAnnouncement(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DomoDashboard replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DomoDashboard appendTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DomoDashboard removeTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     */
    public static DomoDashboard appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a DomoDashboard.
     *
     * @param qualifiedName of the DomoDashboard
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DomoDashboard
     ...
     * Add Atlan tags to a DomoDashboard.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DomoDashboard
     * @param qualifiedName of the DomoDashboard
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DomoDashboard
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
