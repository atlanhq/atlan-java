...
public class BusinessPolicyLog extends Asset implements IBusinessPolicyLog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all BusinessPolicyLog assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) BusinessPolicyLog assets will be included.
     *
     * @return an asset filter that includes all BusinessPolicyLog assets
     ...
     */
    @JsonIgnore
    public static BusinessPolicyLog get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a BusinessPolicyLog by its GUID, complete with all of its relationships.
     *
     * @param guid of the BusinessPolicyLog to retrieve
     * @return the requested full BusinessPolicyLog, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the BusinessPolicyLog does not exist or the provided GUID is not a BusinessPolicyLog
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static BusinessPolicyLog retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static BusinessPolicyLog retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a BusinessPolicyLog by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the BusinessPolicyLog to retrieve
     * @return the requested full BusinessPolicyLog, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the BusinessPolicyLog does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static BusinessPolicyLog retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static BusinessPolicyLog retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static BusinessPolicyLog replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static BusinessPolicyLog appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a BusinessPolicyLog.
     *
     * @param qualifiedName of the BusinessPolicyLog
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the BusinessPolicyLog
     ...
     * Add Atlan tags to a BusinessPolicyLog.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the BusinessPolicyLog
     * @param qualifiedName of the BusinessPolicyLog
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the BusinessPolicyLog
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
