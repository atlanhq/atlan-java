...
public interface ICustom {
    ...
    KeywordTextField CUSTOM_DATASET_NAME =
            new KeywordTextField("customDatasetName", "customDatasetName.keyword", "customDatasetName");

    /** Unique name of the dataset in which this asset exists, or empty if it is itself a dataset. */
    KeywordField CUSTOM_DATASET_QUALIFIED_NAME =
            new KeywordField("customDatasetQualifiedName", "customDatasetQualifiedName");

    /** Unique identifier for the Custom asset from the source system. */
    KeywordField CUSTOM_SOURCE_ID = new KeywordField("customSourceId", "customSourceId");
    ...
    /** Simple name of the dataset in which this asset exists, or empty if it is itself a dataset. */
    String getCustomDatasetName();

    /** Unique name of the dataset in which this asset exists, or empty if it is itself a dataset. */
    String getCustomDatasetQualifiedName();

    /** Unique identifier for the Custom asset from the source system. */
    String getCustomSourceId();
