...
public class CognosFile extends Asset implements ICognosFile, ICognos, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all CognosFile assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CognosFile assets will be included.
     *
     * @return an asset filter that includes all CognosFile assets
     ...
     */
    @JsonIgnore
    public static CognosFile get(String id) throws AtlanException {
     ...
     */
    @JsonIgnore
    public static CognosFile get(AtlanClient client, String id, boolean includeRelationships) throws AtlanException {
        if (id == null) {
    ...
    /**
     * Retrieves a CognosFile by its GUID, complete with all of its relationships.
     *
     * @param guid of the CognosFile to retrieve
     * @return the requested full CognosFile, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosFile does not exist or the provided GUID is not a CognosFile
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosFile retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosFile retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CognosFile by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CognosFile to retrieve
     * @return the requested full CognosFile, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosFile does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosFile retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosFile retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFile removeDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFile removeUserDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFile removeOwners(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFile updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFile removeCertificate(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFile removeAnnouncement(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFile replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFile appendTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosFile removeTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     */
    public static CognosFile appendAtlanTags(String qualifiedName, List<String> atlanTagNames) throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CognosFile.
     *
     * @param qualifiedName of the CognosFile
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosFile
     ...
     * Add Atlan tags to a CognosFile.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CognosFile
     * @param qualifiedName of the CognosFile
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosFile
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
