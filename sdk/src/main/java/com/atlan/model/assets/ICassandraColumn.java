...
public interface ICassandraColumn {

    public static final String TYPE_NAME = "CassandraColumn";

    /** Clustering order of the CassandraColumn. */
    KeywordField CASSANDRA_COLUMN_CLUSTERING_ORDER =
            new KeywordField("cassandraColumnClusteringOrder", "cassandraColumnClusteringOrder");

    /** Is the CassandraColumn clustering key. */
    BooleanField CASSANDRA_COLUMN_IS_CLUSTERING_KEY =
            new BooleanField("cassandraColumnIsClusteringKey", "cassandraColumnIsClusteringKey");

    /** Is the CassandraColumn partition key. */
    BooleanField CASSANDRA_COLUMN_IS_PARTITION_KEY =
            new BooleanField("cassandraColumnIsPartitionKey", "cassandraColumnIsPartitionKey");

    /** Indicates whether the CassandraColumn is static. */
    BooleanField CASSANDRA_COLUMN_IS_STATIC = new BooleanField("cassandraColumnIsStatic", "cassandraColumnIsStatic");

    /** Kind of CassandraColumn (e.g. partition key, clustering column, etc). */
    KeywordField CASSANDRA_COLUMN_KIND = new KeywordField("cassandraColumnKind", "cassandraColumnKind");

    /** Position of the CassandraColumn. */
    NumericField CASSANDRA_COLUMN_POSITION = new NumericField("cassandraColumnPosition", "cassandraColumnPosition");

    /** Type of the CassandraColumn. */
    KeywordTextField CASSANDRA_COLUMN_TYPE =
            new KeywordTextField("cassandraColumnType", "cassandraColumnType.keyword", "cassandraColumnType");

    /** Table containing the column. */
    RelationField CASSANDRA_TABLE = new RelationField("cassandraTable");

    /** View containing the column. */
    RelationField CASSANDRA_VIEW = new RelationField("cassandraView");
    ...
    /** Clustering order of the CassandraColumn. */
    String getCassandraColumnClusteringOrder();

    /** Is the CassandraColumn clustering key. */
    Boolean getCassandraColumnIsClusteringKey();

    /** Is the CassandraColumn partition key. */
    Boolean getCassandraColumnIsPartitionKey();

    /** Indicates whether the CassandraColumn is static. */
    Boolean getCassandraColumnIsStatic();

    /** Kind of CassandraColumn (e.g. partition key, clustering column, etc). */
    String getCassandraColumnKind();

    /** Position of the CassandraColumn. */
    Long getCassandraColumnPosition();

    /** Type of the CassandraColumn. */
    String getCassandraColumnType();

    /** Name of the keyspace for the Cassandra asset. */
    String getCassandraKeyspaceName();

    /** Table containing the column. */
    default ICassandraTable getCassandraTable() {
        return null;
    }
    ...
    /** View containing the column. */
    default ICassandraView getCassandraView() {
        return null;
    }
