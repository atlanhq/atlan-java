...
public interface ISAPBWADSO {

    public static final String TYPE_NAME = "SAPBWADSO";

    /** Fields in this ADSO. */
    RelationField SAP_BW_ADSO_FIELDS = new RelationField("sapBwAdsoFields");

    /** Subtype indicator (RSOADSO.DIRECT_UPDATE) for direct update versus standard storage. */
    KeywordField SAP_BW_DIRECT_UPDATE = new KeywordField("sapBwDirectUpdate", "sapBwDirectUpdate");
    ...
    RelationField SAP_BW_MEMBER_OF_COMPOSITE_PROVIDERS = new RelationField("sapBwMemberOfCompositeProviders");

    /** Whether this ADSO supports planning or write-back (RSOADSO.PLANNING_MODE). */
    KeywordField SAP_BW_PLANNING_MODE = new KeywordField("sapBwPlanningMode", "sapBwPlanningMode");
    ...
    /** Fields in this ADSO. */
    default SortedSet<ISAPBWADSOField> getSapBwAdsoFields() {
        return null;
    }

    /** Subtype indicator (RSOADSO.DIRECT_UPDATE) for direct update versus standard storage. */
    String getSapBwDirectUpdate();
    ...
    /** CompositeProviders this ADSO is a member of. */
    default SortedSet<ISAPBWCompositeProvider> getSapBwMemberOfCompositeProviders() {
        return null;
    }
