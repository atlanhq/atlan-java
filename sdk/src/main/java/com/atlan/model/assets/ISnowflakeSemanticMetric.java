...
public interface ISnowflakeSemanticMetric {
    ...
    KeywordField SNOWFLAKE_METRIC_ADDITIVE_DIMENSIONS =
            new KeywordField("snowflakeMetricAdditiveDimensions", "snowflakeMetricAdditiveDimensions");

    /** Dimensions over which the metric cannot be additively aggregated. */
    KeywordField SNOWFLAKE_METRIC_NON_ADDITIVE_DIMENSIONS =
            new KeywordField("snowflakeMetricNonAdditiveDimensions", "snowflakeMetricNonAdditiveDimensions");

    /** Relationships used by the metric for cross-table computation. */
    KeywordField SNOWFLAKE_METRIC_USING_RELATIONSHIPS =
            new KeywordField("snowflakeMetricUsingRelationships", "snowflakeMetricUsingRelationships");

    /** Logical table containing the metric. */
    RelationField SNOWFLAKE_SEMANTIC_LOGICAL_TABLE = new RelationField("snowflakeSemanticLogicalTable");

    /** Simple name of the logical table in which this metric exists. */
    KeywordField SNOWFLAKE_SEMANTIC_TABLE_NAME =
            new KeywordField("snowflakeSemanticTableName", "snowflakeSemanticTableName");

    /** Unique name of the logical table in which this metric exists. */
    KeywordField SNOWFLAKE_SEMANTIC_TABLE_QUALIFIED_NAME =
            new KeywordField("snowflakeSemanticTableQualifiedName", "snowflakeSemanticTableQualifiedName");
    ...
    /** Dimensions over which the metric can be additively aggregated. */
    SortedSet<String> getSnowflakeMetricAdditiveDimensions();

    /** Dimensions over which the metric cannot be additively aggregated. */
    SortedSet<String> getSnowflakeMetricNonAdditiveDimensions();

    /** Relationships used by the metric for cross-table computation. */
    SortedSet<String> getSnowflakeMetricUsingRelationships();

    /** Logical table containing the metric. */
    ISnowflakeSemanticLogicalTable getSnowflakeSemanticLogicalTable();

    /** Simple name of the logical table in which this metric exists. */
    String getSnowflakeSemanticTableName();

    /** Unique name of the logical table in which this metric exists. */
    String getSnowflakeSemanticTableQualifiedName();
