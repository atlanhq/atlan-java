...
public interface IModel {
    ...
    NumericField MODEL_BUSINESS_DATE = new NumericField("modelBusinessDate", "modelBusinessDate");

    /** Model domain in which this asset exists. */
    KeywordTextField MODEL_DOMAIN = new KeywordTextField("modelDomain", "modelDomain.keyword", "modelDomain");

    /** Simple name of the entity in which this asset exists, or empty if it is itself a data model entity. */
    KeywordTextField MODEL_ENTITY_NAME =
            new KeywordTextField("modelEntityName", "modelEntityName.keyword", "modelEntityName");

    /** Unique name of the entity in which this asset exists, or empty if it is itself a data model entity. */
    KeywordField MODEL_ENTITY_QUALIFIED_NAME = new KeywordField("modelEntityQualifiedName", "modelEntityQualifiedName");

    /** Business expiration date for the asset. */
    NumericField MODEL_EXPIRED_AT_BUSINESS_DATE =
            new NumericField("modelExpiredAtBusinessDate", "modelExpiredAtBusinessDate");

    /** System expiration date for the asset. */
    NumericField MODEL_EXPIRED_AT_SYSTEM_DATE =
            new NumericField("modelExpiredAtSystemDate", "modelExpiredAtSystemDate");
    ...
    KeywordTextField MODEL_NAMESPACE =
            new KeywordTextField("modelNamespace", "modelNamespace.keyword", "modelNamespace");

    /** Unique name of the model in which this asset exists, or empty if it is itself a data model. */
    KeywordField MODEL_QUALIFIED_NAME = new KeywordField("modelQualifiedName", "modelQualifiedName");

    /** System date for the asset. */
    NumericField MODEL_SYSTEM_DATE = new NumericField("modelSystemDate", "modelSystemDate");
