...
public interface IDatabricksExternalLocationPath {

    public static final String TYPE_NAME = "DatabricksExternalLocationPath";

    /** External location that contains the paths. */
    RelationField DATABRICKS_EXTERNAL_LOCATION = new RelationField("databricksExternalLocation");

    /** Name of the parent external location. */
    KeywordField DATABRICKS_PARENT_NAME = new KeywordField("databricksParentName", "databricksParentName");

    /** Qualified name of the parent external location. */
    KeywordField DATABRICKS_PARENT_QUALIFIED_NAME =
            new KeywordField("databricksParentQualifiedName", "databricksParentQualifiedName");

    /** Path of data at the external location. */
    KeywordField DATABRICKS_PATH = new KeywordField("databricksPath", "databricksPath");
    ...
    /** External location that contains the paths. */
    IDatabricksExternalLocation getDatabricksExternalLocation();

    /** Name of the parent external location. */
    String getDatabricksParentName();

    /** Qualified name of the parent external location. */
    String getDatabricksParentQualifiedName();

    /** Path of data at the external location. */
    String getDatabricksPath();
