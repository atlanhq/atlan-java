...
public class DataProduct extends Asset implements IDataProduct, IDataMesh, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all DataProduct assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DataProduct assets will be included.
     *
     * @return an asset filter that includes all DataProduct assets
    ...
    /**
     * Retrieves a DataProduct by its GUID, complete with all of its relationships.
     *
     * @param guid of the DataProduct to retrieve
     * @return the requested full DataProduct, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DataProduct does not exist or the provided GUID is not a DataProduct
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DataProduct retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DataProduct retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DataProduct by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DataProduct to retrieve
     * @return the requested full DataProduct, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DataProduct does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DataProduct retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DataProduct retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
     ...
     */
    public static DataProductBuilder<?, ?> creator(
            String name, String domainQualifiedName, IndexSearchDSL assetSelection) throws InvalidRequestException {
        return creator(Atlan.getDefaultClient(), name, domainQualifiedName, assetSelection);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static DataProduct updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DataProduct replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a DataProduct.
     *
     * @param qualifiedName of the DataProduct
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DataProduct
     ...
     * Add Atlan tags to a DataProduct.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DataProduct
     * @param qualifiedName of the DataProduct
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DataProduct
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
