...
public interface IPartial {
    ...
    public static final String TYPE_NAME = "Partial";

    /** Unique name of the field's parent asset. */
    KeywordField PARTIAL_PARENT_QUALIFIED_NAME =
            new KeywordField("partialParentQualifiedName", "partialParentQualifiedName");

    /** Type of the field's parent asset. */
    KeywordField PARTIAL_PARENT_TYPE = new KeywordField("partialParentType", "partialParentType");

    /** Atlan-mapped type name of this partial asset. */
    KeywordField PARTIAL_RESOLVED_TYPE_NAME = new KeywordField("partialResolvedTypeName", "partialResolvedTypeName");

    /** Complete JSON structure of this partial asset, as a string. */
    KeywordField PARTIAL_STRUCTURE_JSON = new KeywordField("partialStructureJSON", "partialStructureJSON");

    /** Hash ID of the unknown attributes for this partial asset. */
    KeywordField PARTIAL_UNKNOWN_ATTRIBUTES_HASH_ID =
            new KeywordField("partialUnknownAttributesHashId", "partialUnknownAttributesHashId");
    ...
    /** Unique name of the field's parent asset. */
    String getPartialParentQualifiedName();

    /** Type of the field's parent asset. */
    String getPartialParentType();

    /** Atlan-mapped type name of this partial asset. */
    String getPartialResolvedTypeName();

    /** Complete JSON structure of this partial asset, as a string. */
    String getPartialStructureJSON();

    /** Hash ID of the unknown attributes for this partial asset. */
    String getPartialUnknownAttributesHashId();
