...
public class DomoDataset extends Asset implements IDomoDataset, IDomo, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all DomoDataset assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DomoDataset assets will be included.
     *
     * @return an asset filter that includes all DomoDataset assets
     ...
     */
    @JsonIgnore
    public static DomoDataset get(AtlanClient client, String id, boolean includeRelationships) throws AtlanException {
        if (id == null) {
    ...
    /**
     * Retrieves a DomoDataset by its GUID, complete with all of its relationships.
     *
     * @param guid of the DomoDataset to retrieve
     * @return the requested full DomoDataset, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DomoDataset does not exist or the provided GUID is not a DomoDataset
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DomoDataset retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DomoDataset retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DomoDataset by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DomoDataset to retrieve
     * @return the requested full DomoDataset, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DomoDataset does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DomoDataset retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DomoDataset retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    public DomoDatasetBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "DomoDataset", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a DomoDataset.
     *
     * @param qualifiedName of the DomoDataset
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DomoDataset
     ...
     * Add Atlan tags to a DomoDataset.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DomoDataset
     * @param qualifiedName of the DomoDataset
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DomoDataset
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
