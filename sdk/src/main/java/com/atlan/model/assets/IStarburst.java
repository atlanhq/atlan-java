...
public interface IStarburst {

    public static final String TYPE_NAME = "Starburst";

    /** Name of the Starburst Data Product that contains this asset. */
    KeywordField STARBURST_DATA_PRODUCT_NAME = new KeywordField("starburstDataProductName", "starburstDataProductName");

    /** Simple name of the Starburst Dataset that contains this asset, or this asset's own name if it is a Dataset. */
    KeywordField STARBURST_DATASET_NAME = new KeywordField("starburstDatasetName", "starburstDatasetName");

    /** Unique name of the Starburst Dataset that contains this asset, or this asset's own qualified name if it is a Dataset. */
    KeywordField STARBURST_DATASET_QUALIFIED_NAME =
            new KeywordField("starburstDatasetQualifiedName", "starburstDatasetQualifiedName");
