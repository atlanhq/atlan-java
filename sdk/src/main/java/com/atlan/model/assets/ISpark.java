...
public interface ISpark {
    ...
    public static final String TYPE_NAME = "Spark";

    /** Airflow assets that execute this spark asset. */
    RelationField SPARK_ORCHESTRATED_BY_AIRFLOW_ASSETS = new RelationField("sparkOrchestratedByAirflowAssets");

    /** End time of the Spark Job eg. 1695673598218 */
    NumericField SPARK_RUN_END_TIME = new NumericField("sparkRunEndTime", "sparkRunEndTime");

    /** OpenLineage state of the Spark Job run eg. COMPLETE */
    KeywordField SPARK_RUN_OPEN_LINEAGE_STATE =
            new KeywordField("sparkRunOpenLineageState", "sparkRunOpenLineageState");

    /** OpenLineage Version of the Spark Job run eg. 1.1.0 */
    KeywordField SPARK_RUN_OPEN_LINEAGE_VERSION =
            new KeywordField("sparkRunOpenLineageVersion", "sparkRunOpenLineageVersion");

    /** Start time of the Spark Job eg. 1695673598218 */
    NumericField SPARK_RUN_START_TIME = new NumericField("sparkRunStartTime", "sparkRunStartTime");

    /** Spark Version for the Spark Job run eg. 3.4.1 */
    KeywordField SPARK_RUN_VERSION = new KeywordField("sparkRunVersion", "sparkRunVersion");
    ...
    /** Airflow assets that execute this spark asset. */
    SortedSet<IAirflow> getSparkOrchestratedByAirflowAssets();

    /** End time of the Spark Job eg. 1695673598218 */
    Long getSparkRunEndTime();

    /** OpenLineage state of the Spark Job run eg. COMPLETE */
    OpenLineageRunState getSparkRunOpenLineageState();

    /** OpenLineage Version of the Spark Job run eg. 1.1.0 */
    String getSparkRunOpenLineageVersion();

    /** Start time of the Spark Job eg. 1695673598218 */
    Long getSparkRunStartTime();

    /** Spark Version for the Spark Job run eg. 3.4.1 */
    String getSparkRunVersion();
