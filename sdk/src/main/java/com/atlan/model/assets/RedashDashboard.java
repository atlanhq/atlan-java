...
public class RedashDashboard extends Asset implements IRedashDashboard, IRedash, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Builds the minimal object necessary to create a relationship to a RedashDashboard, from a potentially
     * more-complete RedashDashboard object.
     *
     * @return the minimal object necessary to relate to the RedashDashboard
     * @throws InvalidRequestException if any of the minimal set of required properties for a RedashDashboard relationship are not found in the initial object
     */
    @Override
    ...
    /**
     * Reference to a RedashDashboard by GUID. Use this to create a relationship to this RedashDashboard,
     ...
     * @return reference to a RedashDashboard that can be used for defining a relationship to a RedashDashboard
     */
    public static RedashDashboard refByGuid(String guid, Reference.SaveSemantic semantic) {
        return RedashDashboard._internal().guid(guid).semantic(semantic).build();
    }

    /**
     * Reference to a RedashDashboard by qualifiedName. Use this to create a relationship to this RedashDashboard,
     * where the relationship should be replaced.
     *
     ...
     * @return reference to a RedashDashboard that can be used for defining a relationship to a RedashDashboard
     */
    public static RedashDashboard refByQualifiedName(String qualifiedName, Reference.SaveSemantic semantic) {
    ...
    /**
     * Retrieves a RedashDashboard by one of its identifiers, optionally complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the RedashDashboard to retrieve, either its GUID or its full qualifiedName
     * @param includeAllRelationships if true, all the asset's relationships will also be retrieved; if false, no relationships will be retrieved
     * @return the requested full RedashDashboard, optionally complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the RedashDashboard does not exist or the provided GUID is not a RedashDashboard
     */
    @JsonIgnore
    ...
    /**
     * Retrieves a RedashDashboard by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the RedashDashboard to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the RedashDashboard, including any relationships
     * @return the requested RedashDashboard, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the RedashDashboard does not exist or the provided GUID is not a RedashDashboard
     */
    @JsonIgnore
     ...
     * @param id of the RedashDashboard to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the RedashDashboard, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the RedashDashboard
     * @return the requested RedashDashboard, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the RedashDashboard does not exist or the provided GUID is not a RedashDashboard
     */
    @JsonIgnore
    public static RedashDashboard get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = RedashDashboard.select(client)
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof RedashDashboard) {
                return (RedashDashboard) asset.get();
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
