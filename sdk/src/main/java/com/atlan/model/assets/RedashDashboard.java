...
public class RedashDashboard extends Asset implements IRedashDashboard, IRedash, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all RedashDashboard assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) RedashDashboard assets will be included.
     *
     * @return an asset filter that includes all RedashDashboard assets
     ...
     */
    @JsonIgnore
    public static RedashDashboard get(AtlanClient client, String id, boolean includeRelationships)
