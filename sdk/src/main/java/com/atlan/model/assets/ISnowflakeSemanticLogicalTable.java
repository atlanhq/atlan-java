...
public interface ISnowflakeSemanticLogicalTable {
    ...
    RelationField SNOWFLAKE_BASE_TABLE = new RelationField("snowflakeBaseTable");

    /** Dimensions contained in the logical table. */
    RelationField SNOWFLAKE_SEMANTIC_DIMENSIONS = new RelationField("snowflakeSemanticDimensions");
    ...
    KeywordField SNOWFLAKE_SEMANTIC_TABLE_DISTINCT_RANGES =
            new KeywordField("snowflakeSemanticTableDistinctRanges", "snowflakeSemanticTableDistinctRanges");

    /** Comma separated list of primary key columns for the logical table. */
    KeywordField SNOWFLAKE_SEMANTIC_TABLE_PRIMARY_KEYS =
            new KeywordField("snowflakeSemanticTablePrimaryKeys", "snowflakeSemanticTablePrimaryKeys");

    /** Unique key columns for the logical table. */
    KeywordField SNOWFLAKE_SEMANTIC_TABLE_UNIQUE_KEYS =
            new KeywordField("snowflakeSemanticTableUniqueKeys", "snowflakeSemanticTableUniqueKeys");

    /** Semantic view containing the logical table. */
    RelationField SNOWFLAKE_SEMANTIC_VIEW = new RelationField("snowflakeSemanticView");

    /** Simple name of the semantic view in which this logical table exists. */
    KeywordField SNOWFLAKE_SEMANTIC_VIEW_NAME =
            new KeywordField("snowflakeSemanticViewName", "snowflakeSemanticViewName");

    /** Unique name of the semantic view in which this logical table exists. */
    KeywordField SNOWFLAKE_SEMANTIC_VIEW_QUALIFIED_NAME =
            new KeywordField("snowflakeSemanticViewQualifiedName", "snowflakeSemanticViewQualifiedName");
    ...
    String getSemanticAccessModifier();

    /** Data type of the semantic field. */
    String getSemanticDataType();
    ...
    SortedSet<String> getSemanticSynonyms();

    /** Detailed type of the semantic field (e.g., type of measure, type of dimension, or type of entity). */
    String getSemanticType();

    /** Base physical table or view referenced by this logical table. */
    ISQL getSnowflakeBaseTable();

    /** Dimensions contained in the logical table. */
    SortedSet<ISnowflakeSemanticDimension> getSnowflakeSemanticDimensions();

    /** Facts contained in the logical table. */
    SortedSet<ISnowflakeSemanticFact> getSnowflakeSemanticFacts();

    /** Logical tables that join to this logical table. */
    SortedSet<ISnowflakeSemanticLogicalTable> getSnowflakeSemanticLogicalTableJoins();

    /** Metrics contained in the logical table. */
    SortedSet<ISnowflakeSemanticMetric> getSnowflakeSemanticMetrics();

    /** Distinct ranges defined for the logical table. */
    SortedSet<String> getSnowflakeSemanticTableDistinctRanges();

    /** Comma separated list of primary key columns for the logical table. */
    SortedSet<String> getSnowflakeSemanticTablePrimaryKeys();

    /** Unique key columns for the logical table. */
    SortedSet<String> getSnowflakeSemanticTableUniqueKeys();

    /** Semantic view containing the logical table. */
    ISnowflakeSemanticView getSnowflakeSemanticView();

    /** Simple name of the semantic view in which this logical table exists. */
    String getSnowflakeSemanticViewName();

    /** Unique name of the semantic view in which this logical table exists. */
    String getSnowflakeSemanticViewQualifiedName();
