...
public interface IDremioFolder {

    public static final String TYPE_NAME = "DremioFolder";

    /** Type of top level asset that contains this folder. */
    KeywordField DREMIO_PARENT_ASSET_TYPE = new KeywordField("dremioParentAssetType", "dremioParentAssetType");

    /** Parent Dremio Folder containing the sub-folders. */
    RelationField DREMIO_PARENT_FOLDER = new RelationField("dremioParentFolder");
    ...
    RelationField DREMIO_SOURCE = new RelationField("dremioSource");

    /** Dremio Space that contains the folders. */
    RelationField DREMIO_SPACE = new RelationField("dremioSpace");

    /** Child folders nested within the parent Dremio Folder. */
    RelationField DREMIO_SUB_FOLDERS = new RelationField("dremioSubFolders");

    /** Virtual datasets (views) contained within the Dremio Folder. */
    RelationField DREMIO_VIRTUAL_DATASETS = new RelationField("dremioVirtualDatasets");
    ...
    /** Type of top level asset that contains this folder. */
    DremioParentAssetType getDremioParentAssetType();

    /** Parent Dremio Folder containing the sub-folders. */
    IDremioFolder getDremioParentFolder();
    ...
    /** Child folders nested within the parent Dremio Folder. */
    SortedSet<IDremioFolder> getDremioSubFolders();

    /** Virtual datasets (views) contained within the Dremio Folder. */
    SortedSet<IDremioVirtualDataset> getDremioVirtualDatasets();
