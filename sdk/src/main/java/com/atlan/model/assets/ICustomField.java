...
public interface ICustomField {
    ...
    RelationField CUSTOM_TABLE = new RelationField("customTable");

    /** Temperature of the CustomTable asset. */
    KeywordField CUSTOM_TEMPERATURE = new KeywordField("customTemperature", "customTemperature");
    ...
    /** CustomTable asset containing this CustomField. */
    ICustomTable getCustomTable();

    /** Temperature of the CustomTable asset. */
    CustomTemperatureType getCustomTemperature();
