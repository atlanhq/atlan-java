...
public interface ICustomEntity {
    ...
    /** Custom entities contained within the parent entity. */
    default SortedSet<ICustomEntity> getCustomChildEntities() {
        return null;
    }
    ...
    /** Custom entity in which the child entities are contained. */
    default ICustomEntity getCustomParentEntity() {
        return null;
    }

    /** Source custom entity indicating where the relationship originates. */
    default SortedSet<ICustomEntity> getCustomRelatedFromEntities() {
        return null;
    }

    /** Target custom entity indicating where the relationship is directed. */
    default SortedSet<ICustomEntity> getCustomRelatedToEntities() {
        return null;
    }
