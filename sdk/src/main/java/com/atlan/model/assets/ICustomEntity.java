...
public interface ICustomEntity {
    ...
    RelationField CUSTOM_RELATED_FROM_ENTITIES = new RelationField("customRelatedFromEntities");

    /** Target custom entity indicating where the relationship is directed. */
    RelationField CUSTOM_RELATED_TO_ENTITIES = new RelationField("customRelatedToEntities");
    ...
    /** Source custom entity indicating where the relationship originates. */
    SortedSet<ICustomEntity> getCustomRelatedFromEntities();

    /** Target custom entity indicating where the relationship is directed. */
    SortedSet<ICustomEntity> getCustomRelatedToEntities();
