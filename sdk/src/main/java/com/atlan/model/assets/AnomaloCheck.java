...
public class AnomaloCheck extends Asset
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
