...
public class AnomaloCheck extends Asset
     ...
     */
    @JsonIgnore
    public static AnomaloCheck get(AtlanClient client, String id, boolean includeAllRelationships)
    ...
    /**
     * Retrieves a AnomaloCheck by one of its identifiers, with only the requested attributes (and relationships).
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the AnomaloCheck to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the AnomaloCheck, including any relationships
     * @return the requested AnomaloCheck, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the AnomaloCheck does not exist or the provided GUID is not a AnomaloCheck
     */
    @JsonIgnore
    public static AnomaloCheck get(AtlanClient client, String id, Collection<AtlanField> attributes)
            throws AtlanException {
     ...
     * @param id of the AnomaloCheck to retrieve, either its GUID or its full qualifiedName
     * @param attributes to retrieve for the AnomaloCheck, including any relationships
     * @param attributesOnRelated to retrieve on each relationship retrieved for the AnomaloCheck
     * @return the requested AnomaloCheck, with only its minimal information and the requested attributes (and relationships)
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the AnomaloCheck does not exist or the provided GUID is not a AnomaloCheck
     */
    @JsonIgnore
    public static AnomaloCheck get(
            AtlanClient client,
            String id,
        ...
        if (id == null) {
            ...
            Optional<Asset> asset = AnomaloCheck.select(client)
                    .where(AnomaloCheck.GUID.eq(id))
            ...
            if (!asset.isPresent()) {
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_GUID, id);
            } else if (asset.get() instanceof AnomaloCheck) {
            ...
            Optional<Asset> asset = AnomaloCheck.select(client)
                    .where(AnomaloCheck.QUALIFIED_NAME.eq(id))
                    .includesOnResults(attributes)
                    .includesOnRelations(attributesOnRelated)
                    .pageSize(1)
                    .stream()
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck removeDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck removeOwners(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck updateCertificate(
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck removeCertificate(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck updateAnnouncement(
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck removeAnnouncement(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static AnomaloCheck replaceTerms(
    ...
    public static AnomaloCheck appendAtlanTags(
            ...
            throws AtlanException {
        return (AnomaloCheck) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
