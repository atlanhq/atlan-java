...
public interface IFabric {
    ...
    public static final String TYPE_NAME = "Fabric";

    /** Number of columns in this asset. */
    NumericField FABRIC_COLUMN_COUNT = new NumericField("fabricColumnCount", "fabricColumnCount");

    /** Data type of this asset. */
    KeywordField FABRIC_DATA_TYPE = new KeywordField("fabricDataType", "fabricDataType");

    /** Order/position of this asset within its parent. */
    NumericField FABRIC_ORDINAL = new NumericField("fabricOrdinal", "fabricOrdinal");
