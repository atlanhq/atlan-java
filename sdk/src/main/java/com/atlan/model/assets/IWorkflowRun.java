...
public interface IWorkflowRun {
    ...
    NumericField WORKFLOW_RUN_DELETED_AT = new NumericField("workflowRunDeletedAt", "workflowRunDeletedAt");

    /** Time at which this run will expire. */
    NumericField WORKFLOW_RUN_EXPIRES_AT = new NumericField("workflowRunExpiresAt", "workflowRunExpiresAt");

    /** The asset for which this run was created. */
    KeywordField WORKFLOW_RUN_ON_ASSET_GUID = new KeywordField("workflowRunOnAssetGuid", "workflowRunOnAssetGuid");

    /** Status of the run. */
    KeywordField WORKFLOW_RUN_STATUS = new KeywordField("workflowRunStatus", "workflowRunStatus");

    /** Type of the workflow from which this run was created. */
    KeywordField WORKFLOW_RUN_TYPE = new KeywordField("workflowRunType", "workflowRunType");

    /** Username of the user who updated this workflow run. */
    KeywordField WORKFLOW_RUN_UPDATED_BY = new KeywordField("workflowRunUpdatedBy", "workflowRunUpdatedBy");

    /** GUID of the workflow from which this run was created. */
    KeywordField WORKFLOW_RUN_WORKFLOW_GUID = new KeywordField("workflowRunWorkflowGuid", "workflowRunWorkflowGuid");
    ...
    String getWorkflowCreatedBy();

    /** Deletion time of this workflow. */
    Long getWorkflowDeletedAt();
    ...
    /** Details of the approval workflow run. */
    String getWorkflowRunConfig();

    /** Username of the user who created this workflow run. */
    String getWorkflowRunCreatedBy();

    /** Deletion time of this workflow run. */
    Long getWorkflowRunDeletedAt();

    /** Time at which this run will expire. */
    Long getWorkflowRunExpiresAt();

    /** Time duration after which a run of this workflow will expire. */
    String getWorkflowRunExpiresIn();

    /** The asset for which this run was created. */
    String getWorkflowRunOnAssetGuid();

    /** Status of the run. */
    WorkflowRunStatus getWorkflowRunStatus();

    /** Type of the workflow from which this run was created. */
    WorkflowRunType getWorkflowRunType();

    /** Username of the user who updated this workflow run. */
    String getWorkflowRunUpdatedBy();

    /** GUID of the workflow from which this run was created. */
    String getWorkflowRunWorkflowGuid();

    /** Status of the workflow. */
    WorkflowStatus getWorkflowStatus();

    /** GUID of the workflow template from which this workflow was created. */
    String getWorkflowTemplateGuid();
