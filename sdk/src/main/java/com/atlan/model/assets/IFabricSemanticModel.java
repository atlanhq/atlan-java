...
public interface IFabricSemanticModel {

    public static final String TYPE_NAME = "FabricSemanticModel";

    /** Individual semantic model tables contained in the semantic model. */
    RelationField FABRIC_SEMANTIC_MODEL_TABLES = new RelationField("fabricSemanticModelTables");
    ...
    /** Individual semantic model tables contained in the semantic model. */
    SortedSet<IFabricSemanticModelTable> getFabricSemanticModelTables();
