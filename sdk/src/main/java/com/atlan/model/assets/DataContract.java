...
@Slf4j
public class DataContract extends Asset implements IDataContract, IDataMesh, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all DataContract assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) DataContract assets will be included.
     *
     * @return an asset filter that includes all DataContract assets
    ...
    /**
     * Reference to a DataContract by GUID.
     *
    ...
    public static DataContract refByGuid(String guid) {
        return DataContract._internal().guid(guid).build();
    }

    /**
     * Reference to a DataContract by qualifiedName.
     *
    ...
    /**
     * Retrieves a DataContract by its GUID, complete with all of its relationships.
     *
     * @param guid of the DataContract to retrieve
     * @return the requested full DataContract, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DataContract does not exist or the provided GUID is not a DataContract
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DataContract retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static DataContract retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a DataContract by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the DataContract to retrieve
     * @return the requested full DataContract, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the DataContract does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static DataContract retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static DataContract retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    public DataContractBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "DataContract", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static DataContract updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static DataContract replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a DataContract.
     *
     * @param qualifiedName of the DataContract
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DataContract
     ...
     * Add Atlan tags to a DataContract.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the DataContract
     * @param qualifiedName of the DataContract
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the DataContract
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
