...
public interface IBigqueryTag {

    public static final String TYPE_NAME = "BigqueryTag";

    /** List of top-level upstream nested bigquery tags. */
    KeywordField BIGQUERY_TAG_HIERARCHY = new KeywordField("bigqueryTagHierarchy", "bigqueryTagHierarchy");

    /** Properties of the bigquery tag taxonomy attribute. */
    KeywordField BIGQUERY_TAG_TAXONOMY_PROPERTIES =
            new KeywordField("bigqueryTagTaxonomyProperties", "bigqueryTagTaxonomyProperties");
    ...
    KeywordField BIGQUERY_TAG_TYPE = new KeywordField("bigqueryTagType", "bigqueryTagType");
    ...
    SortedSet<String> getTagAllowedValues();
