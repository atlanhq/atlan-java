...
public interface ISageMakerUnifiedStudioAssetSchema {
    ...
    RelationField SMUS_ASSET = new RelationField("smusAsset");

    /** Simple name of the Atlan SageMaker Unified Studio published/subscribed asset that contains this schema. */
    KeywordField SMUS_ASSET_NAME = new KeywordField("smusAssetName", "smusAssetName");

    /** Unique name of the Atlan SageMaker Unified Studio published/subscribed asset that contains this schema. */
    KeywordField SMUS_ASSET_QUALIFIED_NAME = new KeywordField("smusAssetQualifiedName", "smusAssetQualifiedName");

    /** Data type of the schema/column. */
    KeywordField SMUS_DATA_TYPE = new KeywordField("smusDataType", "smusDataType");
    ...
    /** Asset in which this schema exists. The asset can be a published or subscribed asset. */
    ISageMakerUnifiedStudioAsset getSmusAsset();
