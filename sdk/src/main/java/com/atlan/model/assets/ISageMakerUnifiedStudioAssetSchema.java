...
public interface ISageMakerUnifiedStudioAssetSchema {
    ...
    KeywordTextField SMUS_ASSET_NAME = new KeywordTextField("smusAssetName", "smusAssetName.keyword", "smusAssetName");

    /** Unique name of the Atlan AWS SMUS Published/Subscribed Asset that contains this schema */
    KeywordTextField SMUS_ASSET_QUALIFIED_NAME =
            new KeywordTextField("smusAssetQualifiedName", "smusAssetQualifiedName.keyword", "smusAssetQualifiedName");

    /** Data Type of the Schema/Column */
    KeywordTextField SMUS_DATA_TYPE = new KeywordTextField("smusDataType", "smusDataType.keyword", "smusDataType");
    ...
    RelationField SMUS_SUBSCRIBED_ASSET = new RelationField("smusSubscribedAsset");
    ...
    /** Name of the Atlan AWS SMUS Published/Subscribed Asset that contains this schema */
    String getSmusAssetName();

    /** Unique name of the Atlan AWS SMUS Published/Subscribed Asset that contains this schema */
    String getSmusAssetQualifiedName();

    /** Data Type of the Schema/Column */
    String getSmusDataType();
    ...
    /** Subscribed Asset in which this schema exists. */
    ISageMakerUnifiedStudioSubscribedAsset getSmusSubscribedAsset();
