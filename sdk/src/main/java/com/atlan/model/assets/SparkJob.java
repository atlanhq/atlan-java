...
public class SparkJob extends Asset implements ISparkJob, ISpark, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all SparkJob assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SparkJob assets will be included.
     *
     * @return an asset filter that includes all SparkJob assets
    ...
    /**
     * Retrieves a SparkJob by its GUID, complete with all of its relationships.
     *
     * @param guid of the SparkJob to retrieve
     * @return the requested full SparkJob, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SparkJob does not exist or the provided GUID is not a SparkJob
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SparkJob retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static SparkJob retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a SparkJob by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the SparkJob to retrieve
     * @return the requested full SparkJob, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SparkJob does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SparkJob retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static SparkJob retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
    ...
    public SparkJobBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "SparkJob", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a SparkJob.
     *
     * @param qualifiedName of the SparkJob
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SparkJob
     ...
     * Add Atlan tags to a SparkJob.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the SparkJob
     * @param qualifiedName of the SparkJob
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SparkJob
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
