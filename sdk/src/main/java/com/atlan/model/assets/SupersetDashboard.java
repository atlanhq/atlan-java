...
public class SupersetDashboard extends Asset
    ...
    /**
     * Start an asset filter that will return all SupersetDashboard assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SupersetDashboard assets will be included.
     *
     * @return an asset filter that includes all SupersetDashboard assets
     ...
     */
    @JsonIgnore
    public static SupersetDashboard get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a SupersetDashboard by its GUID, complete with all of its relationships.
     *
     * @param guid of the SupersetDashboard to retrieve
     * @return the requested full SupersetDashboard, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SupersetDashboard does not exist or the provided GUID is not a SupersetDashboard
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SupersetDashboard retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static SupersetDashboard retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a SupersetDashboard by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the SupersetDashboard to retrieve
     * @return the requested full SupersetDashboard, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SupersetDashboard does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SupersetDashboard retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static SupersetDashboard retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SupersetDashboard replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static SupersetDashboard appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a SupersetDashboard.
     *
     * @param qualifiedName of the SupersetDashboard
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SupersetDashboard
     ...
     * Add Atlan tags to a SupersetDashboard.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the SupersetDashboard
     * @param qualifiedName of the SupersetDashboard
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SupersetDashboard
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
