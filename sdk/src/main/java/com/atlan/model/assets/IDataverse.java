...
public interface IDataverse {
    ...
    public static final String TYPE_NAME = "Dataverse";

    /** Indicator if DataverseEntity has auditing enabled. */
    BooleanField DATAVERSE_IS_AUDIT_ENABLED = new BooleanField("dataverseIsAuditEnabled", "dataverseIsAuditEnabled");

    /** Indicator if DataverseEntity is custom built. */
    BooleanField DATAVERSE_IS_CUSTOM = new BooleanField("dataverseIsCustom", "dataverseIsCustom");

    /** Indicator if DataverseEntity is customizable. */
    BooleanField DATAVERSE_IS_CUSTOMIZABLE = new BooleanField("dataverseIsCustomizable", "dataverseIsCustomizable");
