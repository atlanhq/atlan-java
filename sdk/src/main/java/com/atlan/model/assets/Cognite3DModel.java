...
public class Cognite3DModel extends Asset
    ...
    /**
     * Builds the minimal object necessary to create a relationship to a Cognite3DModel, from a potentially
     * more-complete Cognite3DModel object.
     *
     * @return the minimal object necessary to relate to the Cognite3DModel
     * @throws InvalidRequestException if any of the minimal set of required properties for a Cognite3DModel relationship are not found in the initial object
     */
    @Override
    public Cognite3DModel trimToReference() throws InvalidRequestException {
    ...
    /**
     * Start an asset filter that will return all Cognite3DModel assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) Cognite3DModel assets will be included.
     *
     * @return an asset filter that includes all Cognite3DModel assets
    ...
    /**
     * Reference to a Cognite3DModel by GUID. Use this to create a relationship to this Cognite3DModel,
     * where the relationship should be replaced.
     *
     * @param guid the GUID of the Cognite3DModel to reference
     * @return reference to a Cognite3DModel that can be used for defining a relationship to a Cognite3DModel
     */
    public static Cognite3DModel refByGuid(String guid) {
     ...
     * @return reference to a Cognite3DModel that can be used for defining a relationship to a Cognite3DModel
     */
    public static Cognite3DModel refByGuid(String guid, Reference.SaveSemantic semantic) {
        return Cognite3DModel._internal().guid(guid).semantic(semantic).build();
    }

    /**
     * Reference to a Cognite3DModel by qualifiedName. Use this to create a relationship to this Cognite3DModel,
     * where the relationship should be replaced.
     *
     * @param qualifiedName the qualifiedName of the Cognite3DModel to reference
     * @return reference to a Cognite3DModel that can be used for defining a relationship to a Cognite3DModel
     */
    public static Cognite3DModel refByQualifiedName(String qualifiedName) {
     ...
     * @return reference to a Cognite3DModel that can be used for defining a relationship to a Cognite3DModel
     */
    public static Cognite3DModel refByQualifiedName(String qualifiedName, Reference.SaveSemantic semantic) {
        return Cognite3DModel._internal()
                .uniqueAttributes(
    ...
    /**
     * Retrieves a Cognite3DModel by one of its identifiers, optionally complete with all of its relationships.
     *
     * @param client connectivity to the Atlan tenant from which to retrieve the asset
     * @param id of the Cognite3DModel to retrieve, either its GUID or its full qualifiedName
     * @param includeRelationships if true, all of the asset's relationships will also be retrieved; if false, no relationships will be retrieved
     * @return the requested full Cognite3DModel, optionally complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Cognite3DModel does not exist or the provided GUID is not a Cognite3DModel
     */
    @JsonIgnore
    public static Cognite3DModel get(AtlanClient client, String id, boolean includeRelationships)
        ...
        if (id == null) {
            ...
            } else if (asset instanceof Cognite3DModel) {
                return (Cognite3DModel) asset;
            } else {
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, TYPE_NAME);
            }
        } else {
            Asset asset = Asset.get(client, TYPE_NAME, id, includeRelationships);
            if (asset instanceof Cognite3DModel) {
                return (Cognite3DModel) asset;
            } else {
    ...
    /**
     * Retrieves a Cognite3DModel by its GUID, complete with all of its relationships.
     *
     * @param guid of the Cognite3DModel to retrieve
     * @return the requested full Cognite3DModel, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Cognite3DModel does not exist or the provided GUID is not a Cognite3DModel
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static Cognite3DModel retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static Cognite3DModel retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a Cognite3DModel by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the Cognite3DModel to retrieve
     * @return the requested full Cognite3DModel, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the Cognite3DModel does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static Cognite3DModel retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static Cognite3DModel retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    /**
     * Builds the minimal object necessary to update a Cognite3DModel.
     *
     * @param qualifiedName of the Cognite3DModel
     * @param name of the Cognite3DModel
     * @return the minimal request necessary to update the Cognite3DModel, as a builder
     */
    public static Cognite3DModelBuilder<?, ?> updater(String qualifiedName, String name) {
        return Cognite3DModel._internal()
    ...
    public Cognite3DModelBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "Cognite3DModel", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static Cognite3DModel removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
        return (Cognite3DModel) Asset.removeUserDescription(client, updater(qualifiedName, name));
    }
     ...
     * Update the certificate on a Cognite3DModel.
     *
     * @param client connectivity to the Atlan tenant on which to update the Cognite3DModel's certificate
     * @param qualifiedName of the Cognite3DModel
     * @param certificate to use
     * @param message (optional) message, or null if no message
     * @return the updated Cognite3DModel, or null if the update failed
     ...
     * Update the announcement on a Cognite3DModel.
     *
     * @param client connectivity to the Atlan tenant on which to update the Cognite3DModel's announcement
     * @param qualifiedName of the Cognite3DModel
     * @param type type of announcement to set
     * @param title (optional) title of the announcement to set (or null for no title)
     * @param message (optional) message of the announcement to set (or null for no message)
     ...
     * Replace the terms linked to the Cognite3DModel.
     *
     * @param client connectivity to the Atlan tenant on which to replace the Cognite3DModel's assigned terms
     * @param qualifiedName for the Cognite3DModel
     * @param name human-readable name of the Cognite3DModel
     * @param terms the list of terms to replace on the Cognite3DModel, or null to remove all terms from the Cognite3DModel
     * @return the Cognite3DModel that was updated (note that it will NOT contain details of the replaced terms)
     ...
     * and a second to append the new terms.
     *
     * @param client connectivity to the Atlan tenant on which to append terms to the Cognite3DModel
     * @param qualifiedName for the Cognite3DModel
     * @param terms the list of terms to append to the Cognite3DModel
     * @return the Cognite3DModel that was updated  (note that it will NOT contain details of the appended terms)
     * @throws AtlanException on any API problems
     */
    public static Cognite3DModel appendTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
        return (Cognite3DModel) Asset.appendTerms(client, TYPE_NAME, qualifiedName, terms);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static Cognite3DModel removeTerms(AtlanClient client, String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
        return (Cognite3DModel) Asset.removeTerms(client, TYPE_NAME, qualifiedName, terms);
    }
    ...
    public static Cognite3DModel appendAtlanTags(
            ...
            boolean restrictLineagePropagation)
            throws AtlanException {
        return (Cognite3DModel) Asset.appendAtlanTags(
                client,
                TYPE_NAME,
                qualifiedName,
                atlanTagNames,
    ...
    /**
     * Add Atlan tags to a Cognite3DModel.
     *
     * @param qualifiedName of the Cognite3DModel
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the Cognite3DModel
     ...
     * Add Atlan tags to a Cognite3DModel.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the Cognite3DModel
     * @param qualifiedName of the Cognite3DModel
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the Cognite3DModel
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
     ...
     * Remove an Atlan tag from a Cognite3DModel.
     *
     * @param client connectivity to the Atlan tenant from which to remove an Atlan tag from a Cognite3DModel
     * @param qualifiedName of the Cognite3DModel
     * @param atlanTagName human-readable name of the Atlan tag to remove
     * @throws AtlanException on any API problems, or if the Atlan tag does not exist on the Cognite3DModel
     */
