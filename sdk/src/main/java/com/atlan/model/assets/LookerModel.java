...
public class LookerModel extends Asset implements ILookerModel, ILooker, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all LookerModel assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) LookerModel assets will be included.
     *
     * @return an asset filter that includes all LookerModel assets
     ...
     */
    @JsonIgnore
    public static LookerModel get(AtlanClient client, String id, boolean includeRelationships) throws AtlanException {
        if (id == null) {
     ...
     */
    @Deprecated
    public static LookerModel retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static LookerModel retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
     ...
     * Add Atlan tags to a LookerModel.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the LookerModel
     * @param qualifiedName of the LookerModel
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the LookerModel
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
