...
public interface IModelDataModel {

    public static final String TYPE_NAME = "ModelDataModel";

    /** Tool used to create this data model. */
    KeywordField MODEL_TOOL = new KeywordField("modelTool", "modelTool");

    /** Number of versions of the data model. */
    NumericField MODEL_VERSION_COUNT = new NumericField("modelVersionCount", "modelVersionCount");
