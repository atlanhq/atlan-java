...
public interface ISSRSFolder {

    public static final String TYPE_NAME = "SSRSFolder";

    /** Parent folder containing this folder. */
    RelationField SSRS_PARENT_FOLDER = new RelationField("ssrsParentFolder");

    /** Reports contained in the folder. */
    RelationField SSRS_REPORTS = new RelationField("ssrsReports");

    /** Subfolders contained in the folder. */
    RelationField SSRS_SUB_FOLDERS = new RelationField("ssrsSubFolders");
    ...
    /** Parent folder containing this folder. */
    default ISSRSFolder getSsrsParentFolder() {
        return null;
    }
    ...
    /** Reports contained in the folder. */
    default SortedSet<ISSRSReport> getSsrsReports() {
        return null;
    }
    ...
    /** Subfolders contained in the folder. */
    default SortedSet<ISSRSFolder> getSsrsSubFolders() {
        return null;
    }
