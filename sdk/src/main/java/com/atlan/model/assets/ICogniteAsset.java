...
public interface ICogniteAsset {

    public static final String TYPE_NAME = "CogniteAsset";

    /** 3D models that exist within this asset. */
    RelationField COGNITE3DMODELS = new RelationField("cognite3dmodels");

    /** Events that exist within this asset. */
    RelationField COGNITE_EVENTS = new RelationField("cogniteEvents");

    /** Files that exist within this asset. */
    RelationField COGNITE_FILES = new RelationField("cogniteFiles");

    /** Sequences that exist within this asset. */
    RelationField COGNITE_SEQUENCES = new RelationField("cogniteSequences");

    /** Time series that exist within this asset. */
    RelationField COGNITE_TIMESERIES = new RelationField("cogniteTimeseries");
    ...
    /** 3D models that exist within this asset. */
    SortedSet<ICognite3DModel> getCognite3dmodels();

    /** Events that exist within this asset. */
    SortedSet<ICogniteEvent> getCogniteEvents();

    /** Files that exist within this asset. */
    SortedSet<ICogniteFile> getCogniteFiles();

    /** Sequences that exist within this asset. */
    SortedSet<ICogniteSequence> getCogniteSequences();

    /** Time series that exist within this asset. */
    SortedSet<ICogniteTimeSeries> getCogniteTimeseries();
