...
public interface ISageMakerModelGroup {

    public static final String TYPE_NAME = "SageMakerModelGroup";

    /** Current status of the Model Package Group. */
    KeywordField SAGE_MAKER_MODEL_GROUP_STATUS =
            new KeywordField("sageMakerModelGroupStatus", "sageMakerModelGroupStatus");

    /** Models that are grouped within the SageMaker Model Group. */
    RelationField SAGE_MAKER_MODELS = new RelationField("sageMakerModels");
    ...
    /** Current status of the Model Package Group. */
    String getSageMakerModelGroupStatus();

    /** Models that are grouped within the SageMaker Model Group. */
    default SortedSet<ISageMakerModel> getSageMakerModels() {
        return null;
    }
