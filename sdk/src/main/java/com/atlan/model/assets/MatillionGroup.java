...
public class MatillionGroup extends Asset implements IMatillionGroup, IMatillion, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all MatillionGroup assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) MatillionGroup assets will be included.
     *
     * @return an asset filter that includes all MatillionGroup assets
     ...
     */
    @JsonIgnore
    public static MatillionGroup get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a MatillionGroup by its GUID, complete with all of its relationships.
     *
     * @param guid of the MatillionGroup to retrieve
     * @return the requested full MatillionGroup, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MatillionGroup does not exist or the provided GUID is not a MatillionGroup
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static MatillionGroup retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static MatillionGroup retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a MatillionGroup by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the MatillionGroup to retrieve
     * @return the requested full MatillionGroup, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the MatillionGroup does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static MatillionGroup retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static MatillionGroup retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public MatillionGroupBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "MatillionGroup", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a MatillionGroup.
     *
     * @param qualifiedName of the MatillionGroup
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the MatillionGroup
     ...
     * Add Atlan tags to a MatillionGroup.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the MatillionGroup
     * @param qualifiedName of the MatillionGroup
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the MatillionGroup
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
