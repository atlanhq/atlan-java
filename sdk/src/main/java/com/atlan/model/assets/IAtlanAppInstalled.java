...
public interface IAtlanAppInstalled {

    public static final String TYPE_NAME = "AtlanAppInstalled";

    /** Current version identifier for the atlan application. */
    NumericField ATLAN_APP_CURRENT_VERSION_ID =
            new NumericField("atlanAppCurrentVersionId", "atlanAppCurrentVersionId");
    ...
    /** Current version identifier for the atlan application. */
    Integer getAtlanAppCurrentVersionId();
