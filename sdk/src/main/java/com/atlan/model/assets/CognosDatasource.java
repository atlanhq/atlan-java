...
public class CognosDatasource extends Asset
    ...
    /**
     * Start an asset filter that will return all CognosDatasource assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) CognosDatasource assets will be included.
     *
     * @return an asset filter that includes all CognosDatasource assets
     ...
     */
    @JsonIgnore
    public static CognosDatasource get(String id) throws AtlanException {
     ...
     */
    @JsonIgnore
    public static CognosDatasource get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a CognosDatasource by its GUID, complete with all of its relationships.
     *
     * @param guid of the CognosDatasource to retrieve
     * @return the requested full CognosDatasource, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosDatasource does not exist or the provided GUID is not a CognosDatasource
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosDatasource retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosDatasource retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a CognosDatasource by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the CognosDatasource to retrieve
     * @return the requested full CognosDatasource, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the CognosDatasource does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static CognosDatasource retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static CognosDatasource retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosDatasource removeDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosDatasource removeUserDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosDatasource removeOwners(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosDatasource removeCertificate(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosDatasource removeAnnouncement(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosDatasource replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosDatasource appendTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static CognosDatasource removeTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     */
    public static CognosDatasource appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a CognosDatasource.
     *
     * @param qualifiedName of the CognosDatasource
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosDatasource
     ...
     * Add Atlan tags to a CognosDatasource.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the CognosDatasource
     * @param qualifiedName of the CognosDatasource
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the CognosDatasource
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
