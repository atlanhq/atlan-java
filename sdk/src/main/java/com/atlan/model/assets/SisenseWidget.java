...
public class SisenseWidget extends Asset implements ISisenseWidget, ISisense, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all SisenseWidget assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SisenseWidget assets will be included.
     *
     * @return an asset filter that includes all SisenseWidget assets
    ...
    /**
     * Reference to a SisenseWidget by GUID.
     *
    ...
    public static SisenseWidget refByGuid(String guid) {
        return SisenseWidget._internal().guid(guid).build();
    }

    /**
     * Reference to a SisenseWidget by qualifiedName.
     *
     ...
     */
    @JsonIgnore
    public static SisenseWidget get(String id) throws AtlanException {
     ...
     */
    @JsonIgnore
    public static SisenseWidget get(AtlanClient client, String id, boolean includeRelationships) throws AtlanException {
        if (id == null) {
    ...
    /**
     * Retrieves a SisenseWidget by its GUID, complete with all of its relationships.
     *
     * @param guid of the SisenseWidget to retrieve
     * @return the requested full SisenseWidget, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SisenseWidget does not exist or the provided GUID is not a SisenseWidget
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SisenseWidget retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static SisenseWidget retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a SisenseWidget by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the SisenseWidget to retrieve
     * @return the requested full SisenseWidget, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SisenseWidget does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SisenseWidget retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static SisenseWidget retrieveByQualifiedName(AtlanClient client, String qualifiedName)
    ...
    public SisenseWidgetBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "SisenseWidget", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseWidget removeDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseWidget removeUserDescription(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseWidget removeOwners(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseWidget updateCertificate(String qualifiedName, CertificateStatus certificate, String message)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseWidget removeCertificate(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseWidget removeAnnouncement(String qualifiedName, String name) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseWidget replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseWidget appendTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseWidget removeTerms(String qualifiedName, List<IGlossaryTerm> terms) throws AtlanException {
     ...
     */
    public static SisenseWidget appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a SisenseWidget.
     *
     * @param qualifiedName of the SisenseWidget
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SisenseWidget
     ...
     * Add Atlan tags to a SisenseWidget.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the SisenseWidget
     * @param qualifiedName of the SisenseWidget
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SisenseWidget
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
