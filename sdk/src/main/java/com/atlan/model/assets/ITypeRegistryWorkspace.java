...
public interface ITypeRegistryWorkspace {
    ...
    RelationField TYPE_REGISTRY_TYPES = new RelationField("typeRegistryTypes");
    ...
    /** Unpublished types that are contained in this workspace. */
    SortedSet<ITypeRegistryWorkspaced> getTypeRegistryTypes();
