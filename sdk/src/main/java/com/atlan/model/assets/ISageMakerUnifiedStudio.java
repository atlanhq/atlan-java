...
public interface ISageMakerUnifiedStudio {

    public static final String TYPE_NAME = "SageMakerUnifiedStudio";

    /** AWS SMUS Domain ID */
    KeywordTextField SMUS_DOMAIN_ID = new KeywordTextField("smusDomainId", "smusDomainId.keyword", "smusDomainId");

    /** AWS SMUS Domain Name */
    KeywordField SMUS_DOMAIN_NAME = new KeywordField("smusDomainName", "smusDomainName");

    /** AWS SMUS Domain Unit ID */
    KeywordTextField SMUS_DOMAIN_UNIT_ID =
            new KeywordTextField("smusDomainUnitId", "smusDomainUnitId.keyword", "smusDomainUnitId");

    /** AWS SMUS Domain Unit Name */
    KeywordTextField SMUS_DOMAIN_UNIT_NAME =
            new KeywordTextField("smusDomainUnitName", "smusDomainUnitName.keyword", "smusDomainUnitName");

    /** Unique ID of the AWS SMUS Project which owns an Asset */
    KeywordTextField SMUS_OWNING_PROJECT_ID =
            new KeywordTextField("smusOwningProjectId", "smusOwningProjectId.keyword", "smusOwningProjectId");

    /** Unique ID of the AWS SMUS Project */
    KeywordTextField SMUS_PROJECT_ID = new KeywordTextField("smusProjectId", "smusProjectId.keyword", "smusProjectId");
