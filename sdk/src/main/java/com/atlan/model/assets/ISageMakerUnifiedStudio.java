...
public interface ISageMakerUnifiedStudio {
    ...
    KeywordField SMUS_DOMAIN_ID = new KeywordField("smusDomainId", "smusDomainId");
    ...
    KeywordField SMUS_DOMAIN_UNIT_ID = new KeywordField("smusDomainUnitId", "smusDomainUnitId");

    /** Name of the SageMaker Unified Studio domain unit. */
    KeywordField SMUS_DOMAIN_UNIT_NAME = new KeywordField("smusDomainUnitName", "smusDomainUnitName");

    /** Unique identifier of the SageMaker Unified Studio project which owns the asset. */
    KeywordField SMUS_OWNING_PROJECT_ID = new KeywordField("smusOwningProjectId", "smusOwningProjectId");

    /** Unique identifier of the SageMaker Unified Studio project. */
    KeywordField SMUS_PROJECT_ID = new KeywordField("smusProjectId", "smusProjectId");
