...
public class BusinessPolicyIncident extends Asset
    ...
    /**
     * Start an asset filter that will return all BusinessPolicyIncident assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) BusinessPolicyIncident assets will be included.
     *
     * @return an asset filter that includes all BusinessPolicyIncident assets
    ...
    /**
     * Retrieves a BusinessPolicyIncident by its GUID, complete with all of its relationships.
     *
     * @param guid of the BusinessPolicyIncident to retrieve
     * @return the requested full BusinessPolicyIncident, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the BusinessPolicyIncident does not exist or the provided GUID is not a BusinessPolicyIncident
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static BusinessPolicyIncident retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static BusinessPolicyIncident retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a BusinessPolicyIncident by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the BusinessPolicyIncident to retrieve
     * @return the requested full BusinessPolicyIncident, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the BusinessPolicyIncident does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static BusinessPolicyIncident retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static BusinessPolicyIncident retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a BusinessPolicyIncident.
     *
     * @param qualifiedName of the BusinessPolicyIncident
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the BusinessPolicyIncident
     ...
     * Add Atlan tags to a BusinessPolicyIncident.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the BusinessPolicyIncident
     * @param qualifiedName of the BusinessPolicyIncident
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the BusinessPolicyIncident
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
