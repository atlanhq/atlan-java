...
public interface IPowerBIApp {

    public static final String TYPE_NAME = "PowerBIApp";

    /** List of groups and their permission access for a PowerBI App. */
    KeywordField POWER_BI_APP_GROUPS = new KeywordField("powerBIAppGroups", "powerBIAppGroups");

    /** Unique ID of the PowerBI App in the PowerBI Assets Ecosystem. */
    KeywordField POWER_BI_APP_ID = new KeywordField("powerBIAppId", "powerBIAppId");

    /** List of users and their permission access for a PowerBI App. */
    KeywordField POWER_BI_APP_USERS = new KeywordField("powerBIAppUsers", "powerBIAppUsers");

    /** PowerBI Dashboards that associates with this PowerBI App. */
    RelationField POWER_BI_DASHBOARDS = new RelationField("powerBIDashboards");

    /** PowerBI Reports that associates with this PowerBI App. */
    RelationField POWER_BI_REPORTS = new RelationField("powerBIReports");
    ...
    /** PowerBI Dashboards that associates with this PowerBI App. */
    SortedSet<IPowerBIDashboard> getPowerBIDashboards();
    ...
    /** PowerBI Reports that associates with this PowerBI App. */
    SortedSet<IPowerBIReport> getPowerBIReports();
