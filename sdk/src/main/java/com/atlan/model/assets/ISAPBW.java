...
public interface ISAPBW {

    public static final String TYPE_NAME = "SAPBW";

    /** Simple name of the SAP BW InfoObject asset related to this asset. */
    KeywordField SAP_BW_INFO_OBJECT_NAME = new KeywordField("sapBwInfoObjectName", "sapBwInfoObjectName");

    /** Unique name of the SAP BW InfoObject asset related to this asset. */
    KeywordField SAP_BW_INFO_OBJECT_QUALIFIED_NAME =
            new KeywordField("sapBwInfoObjectQualifiedName", "sapBwInfoObjectQualifiedName");

    /** Length of the field in characters or bytes (e.g. RSDSSEGFD.LENG, RSKSFIELDNEW.LENG). */
    NumericField SAP_BW_LENGTH = new NumericField("sapBwLength", "sapBwLength");

    /** Lifecycle status of the object in SAP BW such as active, inactive, or modified (e.g. RSDAREA.OBJSTAT, RSKSNEW.OBJSTAT). */
    KeywordField SAP_BW_OBJECT_STATUS = new KeywordField("sapBwObjectStatus", "sapBwObjectStatus");

    /** Simple name of the SAP BW parent asset in which this asset exists. */
    KeywordField SAP_BW_PARENT_NAME = new KeywordField("sapBwParentName", "sapBwParentName");

    /** Unique name of the SAP BW parent asset in which this asset exists. */
    KeywordField SAP_BW_PARENT_QUALIFIED_NAME =
            new KeywordField("sapBwParentQualifiedName", "sapBwParentQualifiedName");
