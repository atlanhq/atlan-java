...
public interface IKafkaCluster {
    ...
    KeywordTextField KAFKA_AUTHENTICATION_TYPE = new KeywordTextField(
            "kafkaAuthenticationType", "kafkaAuthenticationType.keyword", "kafkaAuthenticationType");

    /** Bootstrap server addresses for this cluster. */
    KeywordField KAFKA_BOOTSTRAP_SERVERS = new KeywordField("kafkaBootstrapServers", "kafkaBootstrapServers");

    /** Total number of brokers in this cluster. */
    NumericField KAFKA_BROKER_COUNT = new NumericField("kafkaBrokerCount", "kafkaBrokerCount");

    /** Distribution type of this Kafka cluster, for example: Apache, Confluent, MSK, Aiven, Redpanda. */
    KeywordTextField KAFKA_CLUSTER_TYPE =
            new KeywordTextField("kafkaClusterType", "kafkaClusterType.keyword", "kafkaClusterType");

    /** Environment classification of this Kafka cluster, for example: DEV, STAGING, PROD. */
    KeywordTextField KAFKA_ENVIRONMENT =
            new KeywordTextField("kafkaEnvironment", "kafkaEnvironment.keyword", "kafkaEnvironment");

    /** Total number of partitions across all topics in this cluster. */
    NumericField KAFKA_PARTITION_COUNT = new NumericField("kafkaPartitionCount", "kafkaPartitionCount");

    /** URL of the schema registry associated with this cluster. */
    KeywordField KAFKA_SCHEMA_REGISTRY_URL = new KeywordField("kafkaSchemaRegistryUrl", "kafkaSchemaRegistryUrl");

    /** Number of topics in this cluster. */
    NumericField KAFKA_TOPIC_COUNT = new NumericField("kafkaTopicCount", "kafkaTopicCount");
    ...
    /** Authentication type used to connect to this Kafka cluster, for example: SASL_PLAIN, SASL_SCRAM, TLS, IAM. */
    String getKafkaAuthenticationType();

    /** Bootstrap server addresses for this cluster. */
    SortedSet<String> getKafkaBootstrapServers();

    /** Total number of brokers in this cluster. */
    Long getKafkaBrokerCount();

    /** Distribution type of this Kafka cluster, for example: Apache, Confluent, MSK, Aiven, Redpanda. */
    String getKafkaClusterType();

    /** Environment classification of this Kafka cluster, for example: DEV, STAGING, PROD. */
    String getKafkaEnvironment();

    /** Total number of partitions across all topics in this cluster. */
    Long getKafkaPartitionCount();

    /** URL of the schema registry associated with this cluster. */
    String getKafkaSchemaRegistryUrl();

    /** Number of topics in this cluster. */
    Long getKafkaTopicCount();

    /** Topics contained within this Kafka cluster. */
    default SortedSet<IKafkaTopic> getKafkaTopics() {
        return null;
    }
