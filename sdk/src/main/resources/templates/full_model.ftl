...
This area contains a full reference of the different metadata in Atlan. For every [type](../concepts/review.md#type-definitions), a full list of attributes and relationships is provided.
