...
!!! warning "Complete reference"
    This is a complete reference for the `${originalName}` struct in Atlan, showing all of its embedded properties. For an introduction, you probably want to start with:
