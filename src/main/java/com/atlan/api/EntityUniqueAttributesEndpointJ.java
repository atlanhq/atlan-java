...
import com.atlan.model.core.SingleEntityRequestJ;
...
@Slf4j
public class EntityUniqueAttributesEndpointJ {
     ...
     */
    public static EntityResponseJ retrieve(
        ...
        String url = String.format(
                ...
                String.format(
                        ...
                        endpoint,
                        ApiResourceJ.urlEncodeId(typeName),
                        ApiResourceJ.urlEncodeId(qualifiedName),
                        ignoreRelationships,
                        minExtInfo));
     ...
     */
    public static EntityMutationResponseJ updateAttributes(String typeName, String qualifiedName, EntityJ value)
            throws AtlanException {
        String url = String.format(
                "%s%s",
                Atlan.getBaseUrl(),
                String.format("%s%s?attr:qualifiedName=%s", endpoint, typeName, ApiResourceJ.urlEncode(qualifiedName)));
        SingleEntityRequestJ seq = SingleEntityRequestJ.builder().entity(value).build();
        return ApiResourceJ.request(ApiResourceJ.RequestMethod.PUT, url, seq, EntityMutationResponseJ.class, null);
    }
    ...
    public static void addClassifications(
            ...
            throws AtlanException {
        List<ClassificationJ> classifications = new ArrayList<>();
        for (String classificationName : classificationNames) {
            ...
            classifications.add(ClassificationJ.builder()
        ...
        String url = String.format(
                ...
                String.format(
                        ...
                        endpoint, typeName, ApiResourceJ.urlEncode(qualifiedName)));
        ApiResourceJ.request(ApiResourceJ.RequestMethod.POST, url, new ClassificationList(classifications), null, null);
    }
    ...
    public static void removeClassification(
        ...
        String classificationId = ClassificationCacheJ.getIdForName(classificationName);
        if (classificationId != null) {
            String url = String.format(
                    ...
                    String.format(
                            ...
                            endpoint, typeName, classificationId, ApiResourceJ.urlEncode(qualifiedName)));
            try {
    ...
    public static class ClassificationList extends AtlanObjectJ {
        private final List<ClassificationJ> classifications;

        public ClassificationList(List<ClassificationJ> classifications) {
        ...
        public String toJson() {
            try {
                return ApiResourceJ.mapper.writeValueAsString(classifications);
