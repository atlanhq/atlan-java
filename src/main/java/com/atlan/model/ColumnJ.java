...
public class ColumnJ extends SQLJ {
     ...
     */
    public static ColumnJBuilder<?, ?> creator(
            String name,
        ...
        ColumnJBuilder<?, ?> builder = ColumnJ.builder()
                .name(name)
     ...
     */
    public static ColumnJBuilder<?, ?> updater(String qualifiedName, String name) {
        return ColumnJ.builder().qualifiedName(qualifiedName).name(name);
    }
     ...
     */
    @Override
    protected ColumnJBuilder<?, ?> trimToRequired() {
