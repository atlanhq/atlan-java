...
public class AssetX extends EntityX {
     ...
     */
    @Attribute String qualifiedName;
     ...
     */
    @Attribute String userDescription;

    /** Name of the Atlan workspace in which the asset exists. */
    @Attribute String tenantId;

    /** Status of the asset's certification. */
    @Attribute AtlanCertificateStatus certificateStatus;

    /**
     * Human-readable descriptive message that can optionally be submitted when the
     * `certificateStatus` is changed.
     */
    @Attribute String certificateStatusMessage;

    /** Name of the user who last updated the `certificateStatus`. */
    @Attribute final String certificateUpdatedBy;

    /** Time (epoch) at which the `certificateStatus` was last updated, in milliseconds. */
    @Attribute final Long certificateUpdatedAt;

    /**
     * Brief title for the announcement on this asset. Required when `announcementType` is specified.
     */
    @Attribute String announcementTitle;

    /** Detailed message to include in the announcement on this asset. */
    @Attribute String announcementMessage;

    /** Time (epoch) at which the announcement was last updated, in milliseconds. */
    @Attribute final Long announcementUpdatedAt;

    /** User who last updated the announcement. */
    @Attribute final String announcementUpdatedBy;

    /** Type of announcement on the asset. */
    @Attribute AtlanAnnouncementType announcementType;

    /** List of users who own the asset. */
    @Singular
    @Attribute List<String> ownerUsers;

    /** List of groups who own the asset. */
    @Singular
    @Attribute List<String> ownerGroups;

    /** List of users who administer the asset. (This is only used for Connection assets.) */
    @Singular
    @Attribute List<String> adminUsers;

    /** List of groups who administer the asset. (This is only used for Connection assets.) */
    @Singular
    @Attribute List<String> adminGroups;

    /** Unused. */
    @Singular
    @Attribute List<String> viewerUsers;

    /** Unused. */
    @Singular
    @Attribute List<String> viewerGroups;

    /** Name of the connector through which this asset is accessible. */
    @Attribute String connectorName;

    /** Unused. */
    @Attribute String connectionName;

    /** Unique name of the connection through which this asset is accessible. */
    @Attribute String connectionQualifiedName;

    /** Unused. */
    @Attribute Boolean isDiscoverable;

    /** Unused. */
    @Attribute Boolean isEditable;

    /** Unused. */
    @Attribute Object subType;

    /** Unused. */
    @Attribute Number viewScore;

    /** Unused. */
    @Attribute Number popularityScore;

    /** Unused. */
    @Attribute String sourceOwners;

    /** URL to the resource within the source application. */
    @Attribute String sourceURL;

    /** Name of the crawler that last synchronized this asset. */
    @Attribute String lastSyncWorkflowName;

    /** Time (epoch) at which the asset was last crawled, in milliseconds. */
    @Attribute Long lastSyncRunAt;

    /** Name of the last run of the crawler that last synchronized this asset. */
    @Attribute String lastSyncRun;

    /** Who created the asset. */
    @Attribute final String sourceCreatedBy;

    /** Time (epoch) at which the asset was created, in milliseconds. */
    @Attribute final Long sourceCreatedAt;

    /** Time (epoch) at which the asset was last updated, in milliseconds. */
    @Attribute final Long sourceUpdatedAt;

    /** Who last updated the asset. */
    @Attribute final String sourceUpdatedBy;

    /** Resources that are linked to this asset. */
    @Singular
    @Attribute List<Reference> links;

    /** Readme that is linked to this asset. */
    @Attribute Reference readme;

    /** Terms that are linked to this asset. */
    @Singular
    @Attribute List<Reference> meanings;
