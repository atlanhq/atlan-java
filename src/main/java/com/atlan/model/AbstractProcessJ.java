...
public abstract class AbstractProcessJ extends AssetJ {
     ...
     */
    private static void appendRelationships(StringBuilder sb, List<ReferenceJ> relationships) {
        for (ReferenceJ relationship : relationships) {
     ...
     */
    private static void appendRelationship(StringBuilder sb, ReferenceJ relationship) {
