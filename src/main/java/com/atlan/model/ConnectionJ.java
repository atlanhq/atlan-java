...
public class ConnectionJ extends AssetJ {
     ...
     */
    public static ConnectionJBuilder<?, ?> creator(
            String name,
            AtlanConnectionCategory category,
        ...
        ConnectionJBuilder<?, ?> builder = ConnectionJ.builder()
                .name(name)
     ...
     */
    public static ConnectionJBuilder<?, ?> updater(String qualifiedName, String name) {
        return ConnectionJ.builder().qualifiedName(qualifiedName).name(name);
    }
     ...
     */
    @Override
    protected ConnectionJBuilder<?, ?> trimToRequired() {
