...
public class PackagesJ {

    public static WorkflowJ getConnectionDelete(String qualifiedName, boolean purge) {
        ...
        return WorkflowJ.builder()
                .metadata(WorkflowMetadataJ.builder()
                        .labels(labels)
                        .annotations(annotations)
                        .name(runName)
                        .namespace("default")
                        .build())
                .spec(WorkflowSpecJ.builder()
                        .templates(Collections.singletonList(WorkflowTemplateJ.builder()
                                .name("main")
                                .dag(WorkflowDAGJ.builder()
                                        .task(WorkflowTaskJ.builder()
                                                .name("run")
                                                .arguments(WorkflowTaskArgumentsJ.builder()
                                                        .parameter(NameValuePairJ.builder()
                                                        ...
                                                        .parameter(NameValuePairJ.builder()
                                                                ...
                                                                .build())
                                                        .build())
                                                .templateRef(WorkflowTemplateRefJ.builder()
