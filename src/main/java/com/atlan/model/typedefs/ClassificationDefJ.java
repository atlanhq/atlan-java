...
public class ClassificationDefJ extends TypeDefJ {
    ...
    ClassificationOptionsJ options;
     ...
     */
    public static ClassificationDefJ toCreate(String displayName, AtlanClassificationColor color) {
        return ClassificationDefJ.builder()
                .name(displayName)
                .displayName(displayName)
                .options(ClassificationOptionsJ.of(color))
                .build();
    }
     ...
     */
    public ClassificationDefJ create() throws AtlanException {
    ...
    public static void purge(String displayName) throws AtlanException {
        String internalName = ClassificationCacheJ.getIdForName(displayName);
