...
public class S3BucketJ extends S3J {
     ...
     */
    public static S3BucketJ updateCertificate(String qualifiedName, AtlanCertificateStatus certificate, String message)
            throws AtlanException {
        return (S3BucketJ) AssetJ.updateCertificate(builder(), TYPE_NAME, qualifiedName, certificate, message);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static S3BucketJ removeCertificate(String qualifiedName, String name) throws AtlanException {
        return (S3BucketJ)
                AssetJ.removeCertificate(builder().qualifiedName(qualifiedName).name(name));
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static S3BucketJ updateAnnouncement(
            String qualifiedName, AtlanAnnouncementType type, String title, String message) throws AtlanException {
        return (S3BucketJ) AssetJ.updateAnnouncement(builder(), TYPE_NAME, qualifiedName, type, title, message);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static S3BucketJ removeAnnouncement(String qualifiedName, String name) throws AtlanException {
        return (S3BucketJ)
                AssetJ.removeAnnouncement(builder().qualifiedName(qualifiedName).name(name));
    }
     ...
     */
    public static S3BucketJBuilder<?, ?> creator(String name, String connectionQualifiedName, String awsArn) {
        return S3BucketJ.builder()
     ...
     */
    public static S3BucketJBuilder<?, ?> updater(String qualifiedName, String name) {
        return S3BucketJ.builder().qualifiedName(qualifiedName).name(name);
    }
     ...
     */
    @Override
    protected S3BucketJBuilder<?, ?> trimToRequired() {
