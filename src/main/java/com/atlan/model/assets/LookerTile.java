...
public class LookerTile extends Looker {
    ...
    public LookerTileBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    "Required field for updating LookerTile is missing.",
                    String.join(",", missing),
    ...
    public static LookerTile retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof LookerTile) {
            return (LookerTile) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a LookerTile.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
