...
public class LookerTile extends Looker {
    ...
    public static LookerTile removeDescription(String qualifiedName, String name) throws AtlanException {
        return (LookerTile) Asset.removeDescription(updater(qualifiedName, name));
    }
    ...
    public static LookerTile removeUserDescription(String qualifiedName, String name) throws AtlanException {
        return (LookerTile) Asset.removeUserDescription(updater(qualifiedName, name));
    }
    ...
    public static LookerTile removeOwners(String qualifiedName, String name) throws AtlanException {
        return (LookerTile) Asset.removeOwners(updater(qualifiedName, name));
    }
    ...
    public static LookerTile removeCertificate(String qualifiedName, String name) throws AtlanException {
        return (LookerTile) Asset.removeCertificate(updater(qualifiedName, name));
    }
    ...
    public static LookerTile updateAnnouncement(
        ...
        return (LookerTile) Asset.updateAnnouncement(builder(), TYPE_NAME, qualifiedName, type, title, message);
    }
    ...
    public static LookerTile removeAnnouncement(String qualifiedName, String name) throws AtlanException {
        return (LookerTile) Asset.removeAnnouncement(updater(qualifiedName, name));
    }
    ...
    /**
     * Add classifications to a LookerTile, without replacing existing classifications linked to the LookerTile.
     * Note: this operation must make two API calls — one to retrieve the LookerTile's existing classifications,
     ...
     */
    public static LookerTile appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (LookerTile) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated LookerTile
     */
    public static LookerTile appendClassifications(
            ...
            throws AtlanException {
        return (LookerTile) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
    ...
    /**
     * Add classifications to a LookerTile.
     *
     * @param qualifiedName of the LookerTile
     * @param classificationNames human-readable names of the classifications to add
     * @throws AtlanException on any API problems, or if any of the classifications already exist on the LookerTile
    ...
    /**
     * Remove a classification from a LookerTile.
     *
     * @param qualifiedName of the LookerTile
     * @param classificationName human-readable name of the classification to remove
     * @throws AtlanException on any API problems, or if the classification does not exist on the LookerTile
     */
