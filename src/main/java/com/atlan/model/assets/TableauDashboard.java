...
public class TableauDashboard extends Tableau {
    ...
    /**
     * Add classifications to a TableauDashboard, without replacing existing classifications linked to the TableauDashboard.
     * Note: this operation must make two API calls — one to retrieve the TableauDashboard's existing classifications,
     ...
     */
    public static TableauDashboard appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (TableauDashboard) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated TableauDashboard
     */
    public static TableauDashboard appendClassifications(
            ...
            throws AtlanException {
        return (TableauDashboard) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
