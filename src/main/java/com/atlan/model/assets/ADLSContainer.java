...
public class ADLSContainer extends ADLS {
    ...
    /**
     * Add classifications to a ADLSContainer, without replacing existing classifications linked to the ADLSContainer.
     * Note: this operation must make two API calls — one to retrieve the ADLSContainer's existing classifications,
     ...
     */
    public static ADLSContainer appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (ADLSContainer) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated ADLSContainer
     */
    public static ADLSContainer appendClassifications(
            ...
            throws AtlanException {
        return (ADLSContainer) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
