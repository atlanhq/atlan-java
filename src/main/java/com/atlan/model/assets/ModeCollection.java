...
public class ModeCollection extends Mode {
    ...
    /**
     * Add classifications to a ModeCollection, without replacing existing classifications linked to the ModeCollection.
     * Note: this operation must make two API calls — one to retrieve the ModeCollection's existing classifications,
     ...
     */
    public static ModeCollection appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (ModeCollection) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated ModeCollection
     */
    public static ModeCollection appendClassifications(
            ...
            throws AtlanException {
        return (ModeCollection) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
