...
public class PresetDataset extends Preset {
    ...
    public PresetDatasetBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    "Required field for updating PresetDataset is missing.",
                    String.join(",", missing),
    ...
    public static PresetDataset retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof PresetDataset) {
            return (PresetDataset) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a PresetDataset.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
    ...
    public static PresetDataset retrieveByQualifiedName(String qualifiedName) throws AtlanException {
        ...
        if (entity instanceof PresetDataset) {
            ...
            throw new NotFoundException(
                    "No PresetDataset found with qualifiedName: " + qualifiedName,
