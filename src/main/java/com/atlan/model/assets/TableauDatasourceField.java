...
public class TableauDatasourceField extends Tableau {
    ...
    /**
     * Add classifications to a TableauDatasourceField, without replacing existing classifications linked to the TableauDatasourceField.
     * Note: this operation must make two API calls — one to retrieve the TableauDatasourceField's existing classifications,
     ...
     */
    public static TableauDatasourceField appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (TableauDatasourceField) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated TableauDatasourceField
     */
    public static TableauDatasourceField appendClassifications(
            ...
            throws AtlanException {
        return (TableauDatasourceField) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
