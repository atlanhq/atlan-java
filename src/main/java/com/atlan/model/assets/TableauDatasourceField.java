...
public class TableauDatasourceField extends Asset
    ...
    public static TableauDatasourceField get(AtlanClient client, String id, boolean includeRelationships)
        ...
        if (id == null) {
            ...
            if (asset == null) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, "TableauDatasourceField");
            }
        } else {
            ...
            if (asset instanceof TableauDatasourceField) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_QN, id, "TableauDatasourceField");
            }
        }
    }
    ...
    public static TableauDatasourceFieldBuilder<?, ?> updater(String qualifiedName, String name) {
        return TableauDatasourceField._internal().qualifiedName(qualifiedName).name(name);
    }
