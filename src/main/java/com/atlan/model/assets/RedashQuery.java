...
public class RedashQuery extends Redash {
    ...
    /**
     * Add classifications to a RedashQuery, without replacing existing classifications linked to the RedashQuery.
     * Note: this operation must make two API calls — one to retrieve the RedashQuery's existing classifications,
     ...
     */
    public static RedashQuery appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (RedashQuery) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated RedashQuery
     */
    public static RedashQuery appendClassifications(
            ...
            throws AtlanException {
        return (RedashQuery) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
    ...
    /**
     * Add classifications to a RedashQuery.
     *
     * @param qualifiedName of the RedashQuery
     * @param classificationNames human-readable names of the classifications to add
     * @throws AtlanException on any API problems, or if any of the classifications already exist on the RedashQuery
    ...
    /**
     * Remove a classification from a RedashQuery.
     *
     * @param qualifiedName of the RedashQuery
     * @param classificationName human-readable name of the classification to remove
     * @throws AtlanException on any API problems, or if the classification does not exist on the RedashQuery
     */
