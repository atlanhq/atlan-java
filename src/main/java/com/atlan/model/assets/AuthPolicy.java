...
public class AuthPolicy extends Asset {
    ...
    /**
     * Add classifications to a AuthPolicy, without replacing existing classifications linked to the AuthPolicy.
     * Note: this operation must make two API calls — one to retrieve the AuthPolicy's existing classifications,
     ...
     */
    public static AuthPolicy appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (AuthPolicy) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated AuthPolicy
     */
    public static AuthPolicy appendClassifications(
            ...
            throws AtlanException {
        return (AuthPolicy) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
    ...
    /**
     * Add classifications to a AuthPolicy.
     *
     * @param qualifiedName of the AuthPolicy
     * @param classificationNames human-readable names of the classifications to add
     * @throws AtlanException on any API problems, or if any of the classifications already exist on the AuthPolicy
    ...
    /**
     * Remove a classification from a AuthPolicy.
     *
     * @param qualifiedName of the AuthPolicy
     * @param classificationName human-readable name of the classification to remove
     * @throws AtlanException on any API problems, or if the classification does not exist on the AuthPolicy
     */
