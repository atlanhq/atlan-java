...
public class MetabaseQuestion extends Metabase {
    ...
    /**
     * Add classifications to a MetabaseQuestion, without replacing existing classifications linked to the MetabaseQuestion.
     * Note: this operation must make two API calls — one to retrieve the MetabaseQuestion's existing classifications,
     ...
     */
    public static MetabaseQuestion appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (MetabaseQuestion) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated MetabaseQuestion
     */
    public static MetabaseQuestion appendClassifications(
            ...
            throws AtlanException {
        return (MetabaseQuestion) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
