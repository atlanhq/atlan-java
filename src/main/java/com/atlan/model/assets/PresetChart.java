...
public class PresetChart extends Preset {
    ...
    /**
     * Add classifications to a PresetChart, without replacing existing classifications linked to the PresetChart.
     * Note: this operation must make two API calls — one to retrieve the PresetChart's existing classifications,
     ...
     */
    public static PresetChart appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (PresetChart) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated PresetChart
     */
    public static PresetChart appendClassifications(
            ...
            throws AtlanException {
        return (PresetChart) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
