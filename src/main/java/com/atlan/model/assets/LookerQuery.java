...
public class LookerQuery extends Looker {
    ...
    /**
     * Add classifications to a LookerQuery, without replacing existing classifications linked to the LookerQuery.
     * Note: this operation must make two API calls — one to retrieve the LookerQuery's existing classifications,
     ...
     */
    public static LookerQuery appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (LookerQuery) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated LookerQuery
     */
    public static LookerQuery appendClassifications(
            ...
            throws AtlanException {
        return (LookerQuery) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
