...
public class PowerBIWorkspace extends PowerBI {
    ...
    /**
     * Add classifications to a PowerBIWorkspace, without replacing existing classifications linked to the PowerBIWorkspace.
     * Note: this operation must make two API calls — one to retrieve the PowerBIWorkspace's existing classifications,
     ...
     */
    public static PowerBIWorkspace appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (PowerBIWorkspace) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated PowerBIWorkspace
     */
    public static PowerBIWorkspace appendClassifications(
            ...
            throws AtlanException {
        return (PowerBIWorkspace) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
