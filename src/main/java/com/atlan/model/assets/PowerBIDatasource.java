...
public class PowerBIDatasource extends PowerBI {
    ...
    /**
     * Add classifications to a PowerBIDatasource, without replacing existing classifications linked to the PowerBIDatasource.
     * Note: this operation must make two API calls — one to retrieve the PowerBIDatasource's existing classifications,
     ...
     */
    public static PowerBIDatasource appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (PowerBIDatasource) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated PowerBIDatasource
     */
    public static PowerBIDatasource appendClassifications(
            ...
            throws AtlanException {
        return (PowerBIDatasource) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
