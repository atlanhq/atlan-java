...
public class Database extends SQL {
    ...
    /**
     * Add classifications to a Database, without replacing existing classifications linked to the Database.
     * Note: this operation must make two API calls — one to retrieve the Database's existing classifications,
     ...
     */
    public static Database appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (Database) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated Database
     */
    public static Database appendClassifications(
            ...
            throws AtlanException {
        return (Database) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
