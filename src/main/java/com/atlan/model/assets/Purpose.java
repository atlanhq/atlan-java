...
public class Purpose extends AccessControl {
    ...
    @Attribute
    @Singular
    SortedSet<String> purposeClassifications;
    ...
    /**
     * Add classifications to a Purpose, without replacing existing classifications linked to the Purpose.
     * Note: this operation must make two API calls — one to retrieve the Purpose's existing classifications,
     ...
     */
    public static Purpose appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (Purpose) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated Purpose
     */
    public static Purpose appendClassifications(
            ...
            throws AtlanException {
        return (Purpose) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
    ...
    /**
     * Add classifications to a Purpose.
     *
     * @param qualifiedName of the Purpose
     * @param classificationNames human-readable names of the classifications to add
     * @throws AtlanException on any API problems, or if any of the classifications already exist on the Purpose
    ...
    /**
     * Remove a classification from a Purpose.
     *
     * @param qualifiedName of the Purpose
     * @param classificationName human-readable name of the classification to remove
     * @throws AtlanException on any API problems, or if the classification does not exist on the Purpose
     */
