...
public class DbtColumnProcess extends ColumnProcess {
    ...
    /**
     * Add classifications to a DbtColumnProcess, without replacing existing classifications linked to the DbtColumnProcess.
     * Note: this operation must make two API calls — one to retrieve the DbtColumnProcess's existing classifications,
     ...
     */
    public static DbtColumnProcess appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (DbtColumnProcess) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated DbtColumnProcess
     */
    public static DbtColumnProcess appendClassifications(
            ...
            throws AtlanException {
        return (DbtColumnProcess) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
