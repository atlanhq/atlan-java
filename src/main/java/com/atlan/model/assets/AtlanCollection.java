...
public class AtlanCollection extends Namespace {
    ...
    public AtlanCollectionBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    "Required field for updating AtlanCollection is missing.",
                    String.join(",", missing),
    ...
    public static AtlanCollection retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof AtlanCollection) {
            return (AtlanCollection) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a AtlanCollection.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
    ...
    public static AtlanCollection retrieveByQualifiedName(String qualifiedName) throws AtlanException {
        ...
        if (entity instanceof AtlanCollection) {
            ...
            throw new NotFoundException(
                    "No AtlanCollection found with qualifiedName: " + qualifiedName,
