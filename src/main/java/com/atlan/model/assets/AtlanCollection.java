...
public class AtlanCollection extends Namespace {
    ...
    /**
     * Add classifications to a AtlanCollection, without replacing existing classifications linked to the AtlanCollection.
     * Note: this operation must make two API calls — one to retrieve the AtlanCollection's existing classifications,
     ...
     */
    public static AtlanCollection appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (AtlanCollection) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated AtlanCollection
     */
    public static AtlanCollection appendClassifications(
            ...
            throws AtlanException {
        return (AtlanCollection) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
