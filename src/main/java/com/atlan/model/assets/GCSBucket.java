...
public class GCSBucket extends GCS {
    ...
    /**
     * Add classifications to a GCSBucket, without replacing existing classifications linked to the GCSBucket.
     * Note: this operation must make two API calls — one to retrieve the GCSBucket's existing classifications,
     ...
     */
    public static GCSBucket appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (GCSBucket) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated GCSBucket
     */
    public static GCSBucket appendClassifications(
            ...
            throws AtlanException {
        return (GCSBucket) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
