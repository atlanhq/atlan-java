...
public class SalesforceOrganization extends Salesforce {
    ...
    /**
     * Add classifications to a SalesforceOrganization, without replacing existing classifications linked to the SalesforceOrganization.
     * Note: this operation must make two API calls — one to retrieve the SalesforceOrganization's existing classifications,
     ...
     */
    public static SalesforceOrganization appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SalesforceOrganization) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SalesforceOrganization
     */
    public static SalesforceOrganization appendClassifications(
            ...
            throws AtlanException {
        return (SalesforceOrganization) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
