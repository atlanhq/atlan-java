...
public class MaterializedView extends SQL {
    ...
    /**
     * Add classifications to a MaterializedView, without replacing existing classifications linked to the MaterializedView.
     * Note: this operation must make two API calls — one to retrieve the MaterializedView's existing classifications,
     ...
     */
    public static MaterializedView appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (MaterializedView) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated MaterializedView
     */
    public static MaterializedView appendClassifications(
            ...
            throws AtlanException {
        return (MaterializedView) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
