...
public class GlossaryTerm extends Asset {
    ...
    /**
     * Add classifications to a GlossaryTerm, without replacing existing classifications linked to the GlossaryTerm.
     * Note: this operation must make two API calls — one to retrieve the GlossaryTerm's existing classifications,
     ...
     */
    public static GlossaryTerm appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (GlossaryTerm) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated GlossaryTerm
     */
    public static GlossaryTerm appendClassifications(
            String qualifiedName,
            ...
            throws AtlanException {
        return (GlossaryTerm) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
