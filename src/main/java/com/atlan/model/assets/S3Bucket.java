...
public class S3Bucket extends S3 {
    ...
    /**
     * Add classifications to a S3Bucket, without replacing existing classifications linked to the S3Bucket.
     * Note: this operation must make two API calls — one to retrieve the S3Bucket's existing classifications,
     ...
     */
    public static S3Bucket appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (S3Bucket) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated S3Bucket
     */
    public static S3Bucket appendClassifications(
            ...
            throws AtlanException {
        return (S3Bucket) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
