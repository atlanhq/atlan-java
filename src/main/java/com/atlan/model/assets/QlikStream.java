...
public class QlikStream extends QlikSpace {
    ...
    /**
     * Add classifications to a QlikStream, without replacing existing classifications linked to the QlikStream.
     * Note: this operation must make two API calls — one to retrieve the QlikStream's existing classifications,
     ...
     */
    public static QlikStream appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (QlikStream) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated QlikStream
     */
    public static QlikStream appendClassifications(
            ...
            throws AtlanException {
        return (QlikStream) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
