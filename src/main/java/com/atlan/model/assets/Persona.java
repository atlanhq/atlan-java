...
public class Persona extends AccessControl {
    ...
    /**
     * Add classifications to a Persona, without replacing existing classifications linked to the Persona.
     * Note: this operation must make two API calls — one to retrieve the Persona's existing classifications,
     ...
     */
    public static Persona appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (Persona) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated Persona
     */
    public static Persona appendClassifications(
            ...
            throws AtlanException {
        return (Persona) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
    ...
    /**
     * Add classifications to a Persona.
     *
     * @param qualifiedName of the Persona
     * @param classificationNames human-readable names of the classifications to add
     * @throws AtlanException on any API problems, or if any of the classifications already exist on the Persona
    ...
    /**
     * Remove a classification from a Persona.
     *
     * @param qualifiedName of the Persona
     * @param classificationName human-readable name of the classification to remove
     * @throws AtlanException on any API problems, or if the classification does not exist on the Persona
     */
