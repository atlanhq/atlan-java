...
public class Procedure extends SQL {
    ...
    /**
     * Add classifications to a Procedure, without replacing existing classifications linked to the Procedure.
     * Note: this operation must make two API calls — one to retrieve the Procedure's existing classifications,
     ...
     */
    public static Procedure appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (Procedure) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated Procedure
     */
    public static Procedure appendClassifications(
            ...
            throws AtlanException {
        return (Procedure) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
