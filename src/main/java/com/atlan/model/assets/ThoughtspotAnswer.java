...
/**
 * Atlan Thoughtspot Answer Asset
 */
...
public class ThoughtspotAnswer extends Asset
    ...
    /**
     * Start an asset filter that will return all ThoughtspotAnswer assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) ThoughtspotAnswer assets will be included.
     *
     * @return an asset filter that includes all ThoughtspotAnswer assets
     */
    ...
    public static ThoughtspotAnswer refByGuid(String guid) {
        return ThoughtspotAnswer._internal().guid(guid).build();
    }
    ...
    public static ThoughtspotAnswerBuilder<?, ?> updater(String qualifiedName, String name) {
        return ThoughtspotAnswer._internal().qualifiedName(qualifiedName).name(name);
    }
     ...
     */
    public static ThoughtspotAnswer appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a ThoughtspotAnswer.
     *
     * @param qualifiedName of the ThoughtspotAnswer
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the ThoughtspotAnswer
     ...
     * Add Atlan tags to a ThoughtspotAnswer.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the ThoughtspotAnswer
     * @param qualifiedName of the ThoughtspotAnswer
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the ThoughtspotAnswer
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
