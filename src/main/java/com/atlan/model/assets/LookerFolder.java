...
public class LookerFolder extends Looker {
    ...
    /**
     * Add classifications to a LookerFolder, without replacing existing classifications linked to the LookerFolder.
     * Note: this operation must make two API calls — one to retrieve the LookerFolder's existing classifications,
     ...
     */
    public static LookerFolder appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (LookerFolder) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated LookerFolder
     */
    public static LookerFolder appendClassifications(
            ...
            throws AtlanException {
        return (LookerFolder) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
