...
public class QuickSightDatasetField extends QuickSight {
    ...
    /**
     * Add classifications to a QuickSightDatasetField, without replacing existing classifications linked to the QuickSightDatasetField.
     * Note: this operation must make two API calls — one to retrieve the QuickSightDatasetField's existing classifications,
     ...
     */
    public static QuickSightDatasetField appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (QuickSightDatasetField) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated QuickSightDatasetField
     */
    public static QuickSightDatasetField appendClassifications(
            ...
            throws AtlanException {
        return (QuickSightDatasetField) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
