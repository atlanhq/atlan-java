...
public class TableauWorkbook extends Tableau {
    ...
    public static TableauWorkbook retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof TableauWorkbook) {
            return (TableauWorkbook) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a TableauWorkbook.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
     ...
     * @return the TableauWorkbook that was restored
     * @throws AtlanException on any API problems
     */
    public static TableauWorkbook restore(String qualifiedName) throws AtlanException {
        return (TableauWorkbook) Asset.restore(TYPE_NAME, qualifiedName);
    }
