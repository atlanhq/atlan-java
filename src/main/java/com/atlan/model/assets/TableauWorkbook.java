...
public class TableauWorkbook extends Asset
    ...
    /**
     * Start an asset filter that will return all TableauWorkbook assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) TableauWorkbook assets will be included.
     *
     * @return an asset filter that includes all TableauWorkbook assets
     */
     ...
     */
    @JsonIgnore
    public static TableauWorkbook get(AtlanClient client, String id, boolean includeRelationships)
        ...
        if (id == null) {
            ...
            if (asset == null) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, "TableauWorkbook");
            }
        } else {
            ...
            if (asset instanceof TableauWorkbook) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_QN, id, "TableauWorkbook");
            }
        }
    }
     ...
     */
    @Deprecated
    public static TableauWorkbook retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
     ...
     * Add Atlan tags to a TableauWorkbook.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the TableauWorkbook
     * @param qualifiedName of the TableauWorkbook
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the TableauWorkbook
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
