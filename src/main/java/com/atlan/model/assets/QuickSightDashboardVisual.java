...
public class QuickSightDashboardVisual extends QuickSight {
    ...
    /**
     * Add classifications to a QuickSightDashboardVisual, without replacing existing classifications linked to the QuickSightDashboardVisual.
     * Note: this operation must make two API calls — one to retrieve the QuickSightDashboardVisual's existing classifications,
     ...
     */
    public static QuickSightDashboardVisual appendClassifications(
            String qualifiedName, List<String> classificationNames) throws AtlanException {
        return (QuickSightDashboardVisual) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
    ...
    public static QuickSightDashboardVisual appendClassifications(
            ...
            throws AtlanException {
        return (QuickSightDashboardVisual) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
