...
public class SnowflakePipe extends SQL {
    ...
    /**
     * Add classifications to a SnowflakePipe, without replacing existing classifications linked to the SnowflakePipe.
     * Note: this operation must make two API calls — one to retrieve the SnowflakePipe's existing classifications,
     ...
     */
    public static SnowflakePipe appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SnowflakePipe) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SnowflakePipe
     */
    public static SnowflakePipe appendClassifications(
            ...
            throws AtlanException {
        return (SnowflakePipe) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
