...
public class SnowflakePipe extends SQL {
     ...
     */
    @Override
    protected SnowflakePipeBuilder<?, ?> trimToRequired() {
    ...
    public static SnowflakePipe retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof SnowflakePipe) {
            return (SnowflakePipe) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a SnowflakePipe.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
    ...
    public static SnowflakePipe retrieveByQualifiedName(String qualifiedName) throws AtlanException {
        ...
        if (entity instanceof SnowflakePipe) {
            return (SnowflakePipe) entity;
        } else {
            throw new NotFoundException(
