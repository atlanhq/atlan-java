...
public class LookerLook extends Looker {
    ...
    /**
     * Add classifications to a LookerLook, without replacing existing classifications linked to the LookerLook.
     * Note: this operation must make two API calls — one to retrieve the LookerLook's existing classifications,
     ...
     */
    public static LookerLook appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (LookerLook) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated LookerLook
     */
    public static LookerLook appendClassifications(
            ...
            throws AtlanException {
        return (LookerLook) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
