...
public class SalesforceField extends Salesforce {
    ...
    /**
     * Add classifications to a SalesforceField, without replacing existing classifications linked to the SalesforceField.
     * Note: this operation must make two API calls — one to retrieve the SalesforceField's existing classifications,
     ...
     */
    public static SalesforceField appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SalesforceField) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SalesforceField
     */
    public static SalesforceField appendClassifications(
            ...
            throws AtlanException {
        return (SalesforceField) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
