...
public class SalesforceField extends Salesforce {
     ...
     * @return the SalesforceField that was restored
     * @throws AtlanException on any API problems
     */
    public static SalesforceField restore(String qualifiedName) throws AtlanException {
        return (SalesforceField) Asset.restore(TYPE_NAME, qualifiedName);
    }
