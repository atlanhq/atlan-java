...
public class TableauDatasource extends Tableau {
    ...
    /**
     * Add classifications to a TableauDatasource, without replacing existing classifications linked to the TableauDatasource.
     * Note: this operation must make two API calls — one to retrieve the TableauDatasource's existing classifications,
     ...
     */
    public static TableauDatasource appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (TableauDatasource) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated TableauDatasource
     */
    public static TableauDatasource appendClassifications(
            ...
            throws AtlanException {
        return (TableauDatasource) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
