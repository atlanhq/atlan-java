...
public class ModeReport extends Mode {
    ...
    public ModeReportBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    "Required field for updating ModeReport is missing.",
                    String.join(",", missing),
    ...
    public static ModeReport retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof ModeReport) {
            return (ModeReport) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a ModeReport.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
