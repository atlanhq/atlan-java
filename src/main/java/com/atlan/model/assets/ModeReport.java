...
public class ModeReport extends Mode {
    ...
    /**
     * Add classifications to a ModeReport, without replacing existing classifications linked to the ModeReport.
     * Note: this operation must make two API calls — one to retrieve the ModeReport's existing classifications,
     ...
     */
    public static ModeReport appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (ModeReport) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated ModeReport
     */
    public static ModeReport appendClassifications(
            ...
            throws AtlanException {
        return (ModeReport) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
