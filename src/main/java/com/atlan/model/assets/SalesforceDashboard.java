...
public class SalesforceDashboard extends Salesforce {
    ...
    /**
     * Add classifications to a SalesforceDashboard, without replacing existing classifications linked to the SalesforceDashboard.
     * Note: this operation must make two API calls — one to retrieve the SalesforceDashboard's existing classifications,
     ...
     */
    public static SalesforceDashboard appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SalesforceDashboard) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SalesforceDashboard
     */
    public static SalesforceDashboard appendClassifications(
            ...
            throws AtlanException {
        return (SalesforceDashboard) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
