...
public class ADLSObject extends ADLS {
    ...
    /**
     * Add classifications to a ADLSObject, without replacing existing classifications linked to the ADLSObject.
     * Note: this operation must make two API calls — one to retrieve the ADLSObject's existing classifications,
     ...
     */
    public static ADLSObject appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (ADLSObject) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated ADLSObject
     */
    public static ADLSObject appendClassifications(
            ...
            throws AtlanException {
        return (ADLSObject) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
