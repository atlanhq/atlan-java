...
public class LookerModel extends Looker {
    ...
    /**
     * Add classifications to a LookerModel, without replacing existing classifications linked to the LookerModel.
     * Note: this operation must make two API calls — one to retrieve the LookerModel's existing classifications,
     ...
     */
    public static LookerModel appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (LookerModel) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated LookerModel
     */
    public static LookerModel appendClassifications(
            ...
            throws AtlanException {
        return (LookerModel) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
