...
public class AtlanQuery extends SQL {
    ...
    /**
     * Add classifications to a AtlanQuery, without replacing existing classifications linked to the AtlanQuery.
     * Note: this operation must make two API calls — one to retrieve the AtlanQuery's existing classifications,
     ...
     */
    public static AtlanQuery appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (AtlanQuery) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated AtlanQuery
     */
    public static AtlanQuery appendClassifications(
            ...
            throws AtlanException {
        return (AtlanQuery) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
