...
public class LookerDashboard extends Looker {
    ...
    public LookerDashboardBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    "Required field for updating LookerDashboard is missing.",
                    String.join(",", missing),
    ...
    public static LookerDashboard retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof LookerDashboard) {
            return (LookerDashboard) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a LookerDashboard.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
    ...
    public static LookerDashboard retrieveByQualifiedName(String qualifiedName) throws AtlanException {
        ...
        if (entity instanceof LookerDashboard) {
            ...
            throw new NotFoundException(
                    "No LookerDashboard found with qualifiedName: " + qualifiedName,
