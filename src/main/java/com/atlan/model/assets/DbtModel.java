...
public class DbtModel extends Dbt {
    ...
    /**
     * Add classifications to a DbtModel, without replacing existing classifications linked to the DbtModel.
     * Note: this operation must make two API calls — one to retrieve the DbtModel's existing classifications,
     ...
     */
    public static DbtModel appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (DbtModel) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated DbtModel
     */
    public static DbtModel appendClassifications(
            ...
            throws AtlanException {
        return (DbtModel) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
