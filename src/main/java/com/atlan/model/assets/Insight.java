...
public class Insight extends Catalog {
    ...
    /**
     * Add classifications to a Insight, without replacing existing classifications linked to the Insight.
     * Note: this operation must make two API calls — one to retrieve the Insight's existing classifications,
     ...
     */
    public static Insight appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (Insight) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated Insight
     */
    public static Insight appendClassifications(
            ...
            throws AtlanException {
        return (Insight) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
