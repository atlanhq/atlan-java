...
public class QuickSightAnalysisVisual extends QuickSight {
    ...
    /**
     * Add classifications to a QuickSightAnalysisVisual, without replacing existing classifications linked to the QuickSightAnalysisVisual.
     * Note: this operation must make two API calls — one to retrieve the QuickSightAnalysisVisual's existing classifications,
     ...
     */
    public static QuickSightAnalysisVisual appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (QuickSightAnalysisVisual) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated QuickSightAnalysisVisual
     */
    public static QuickSightAnalysisVisual appendClassifications(
            ...
            throws AtlanException {
        return (QuickSightAnalysisVisual) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
