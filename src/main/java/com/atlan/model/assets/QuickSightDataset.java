...
public class QuickSightDataset extends QuickSight {
    ...
    /**
     * Add classifications to a QuickSightDataset, without replacing existing classifications linked to the QuickSightDataset.
     * Note: this operation must make two API calls — one to retrieve the QuickSightDataset's existing classifications,
     ...
     */
    public static QuickSightDataset appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (QuickSightDataset) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated QuickSightDataset
     */
    public static QuickSightDataset appendClassifications(
            ...
            throws AtlanException {
        return (QuickSightDataset) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
