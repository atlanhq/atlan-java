...
public class ModeWorkspace extends Mode {
    ...
    public static ModeWorkspace retrieveByGuid(String guid) throws AtlanException {
        ...
        if (asset == null) {
            ...
            throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, guid, "ModeWorkspace");
        }
    }
    ...
    public static ModeWorkspace retrieveByQualifiedName(String qualifiedName) throws AtlanException {
        ...
        if (asset instanceof ModeWorkspace) {
            ...
            throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_QN, qualifiedName, "ModeWorkspace");
        }
    }
    ...
    /**
     * Add classifications to a ModeWorkspace, without replacing existing classifications linked to the ModeWorkspace.
     * Note: this operation must make two API calls — one to retrieve the ModeWorkspace's existing classifications,
     ...
     */
    public static ModeWorkspace appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (ModeWorkspace) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated ModeWorkspace
     */
    public static ModeWorkspace appendClassifications(
            ...
            throws AtlanException {
        return (ModeWorkspace) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
