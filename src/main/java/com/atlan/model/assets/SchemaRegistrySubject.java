...
public class SchemaRegistrySubject extends Asset
    ...
    /**
     * Start an asset filter that will return all SchemaRegistrySubject assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SchemaRegistrySubject assets will be included.
     *
     * @return an asset filter that includes all SchemaRegistrySubject assets
     */
    ...
    /**
     * Reference to a SchemaRegistrySubject by GUID.
     *
    ...
    public static SchemaRegistrySubject refByGuid(String guid) {
        return SchemaRegistrySubject._internal().guid(guid).build();
    }

    /**
     * Reference to a SchemaRegistrySubject by qualifiedName.
     *
    ...
    /**
     * Retrieves a SchemaRegistrySubject by its GUID, complete with all of its relationships.
     *
     * @param guid of the SchemaRegistrySubject to retrieve
     * @return the requested full SchemaRegistrySubject, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SchemaRegistrySubject does not exist or the provided GUID is not a SchemaRegistrySubject
    ...
    /**
     * Retrieves a SchemaRegistrySubject by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the SchemaRegistrySubject to retrieve
     * @return the requested full SchemaRegistrySubject, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SchemaRegistrySubject does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
     ...
     */
    @Deprecated
    public static SchemaRegistrySubject retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public static SchemaRegistrySubjectBuilder<?, ?> updater(String qualifiedName, String name) {
        return SchemaRegistrySubject._internal().qualifiedName(qualifiedName).name(name);
    }
    ...
    public SchemaRegistrySubjectBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "SchemaRegistrySubject", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a SchemaRegistrySubject.
     *
     * @param qualifiedName of the SchemaRegistrySubject
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SchemaRegistrySubject
     ...
     * Add Atlan tags to a SchemaRegistrySubject.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the SchemaRegistrySubject
     * @param qualifiedName of the SchemaRegistrySubject
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SchemaRegistrySubject
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
