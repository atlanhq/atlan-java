...
public class ThoughtspotDashlet extends Thoughtspot {
    ...
    /**
     * Add classifications to a ThoughtspotDashlet, without replacing existing classifications linked to the ThoughtspotDashlet.
     * Note: this operation must make two API calls — one to retrieve the ThoughtspotDashlet's existing classifications,
     ...
     */
    public static ThoughtspotDashlet appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (ThoughtspotDashlet) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated ThoughtspotDashlet
     */
    public static ThoughtspotDashlet appendClassifications(
            ...
            throws AtlanException {
        return (ThoughtspotDashlet) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
    ...
    /**
     * Add classifications to a ThoughtspotDashlet.
     *
     * @param qualifiedName of the ThoughtspotDashlet
     * @param classificationNames human-readable names of the classifications to add
     * @throws AtlanException on any API problems, or if any of the classifications already exist on the ThoughtspotDashlet
    ...
    /**
     * Remove a classification from a ThoughtspotDashlet.
     *
     * @param qualifiedName of the ThoughtspotDashlet
     * @param classificationName human-readable name of the classification to remove
     * @throws AtlanException on any API problems, or if the classification does not exist on the ThoughtspotDashlet
     */
