...
public class QlikDataset extends Qlik {
    ...
    /**
     * Add classifications to a QlikDataset, without replacing existing classifications linked to the QlikDataset.
     * Note: this operation must make two API calls — one to retrieve the QlikDataset's existing classifications,
     ...
     */
    public static QlikDataset appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (QlikDataset) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated QlikDataset
     */
    public static QlikDataset appendClassifications(
            ...
            throws AtlanException {
        return (QlikDataset) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
