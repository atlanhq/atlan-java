...
public class BIProcess extends AbstractProcess {
    ...
    public static BIProcess retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof BIProcess) {
            return (BIProcess) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a BIProcess.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
    ...
    public static BIProcess retrieveByQualifiedName(String qualifiedName) throws AtlanException {
        ...
        if (entity instanceof BIProcess) {
            ...
            throw new NotFoundException(
                    "No BIProcess found with qualifiedName: " + qualifiedName, "ATLAN_JAVA_CLIENT-404-003", 404, null);
        }
    }
