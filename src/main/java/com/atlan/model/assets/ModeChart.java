...
public class ModeChart extends Mode {
    ...
    /**
     * Add classifications to a ModeChart, without replacing existing classifications linked to the ModeChart.
     * Note: this operation must make two API calls — one to retrieve the ModeChart's existing classifications,
     ...
     */
    public static ModeChart appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (ModeChart) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated ModeChart
     */
    public static ModeChart appendClassifications(
            ...
            throws AtlanException {
        return (ModeChart) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
