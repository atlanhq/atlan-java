...
public class DataStudioAsset extends Google {
    ...
    /**
     * Add classifications to a DataStudioAsset, without replacing existing classifications linked to the DataStudioAsset.
     * Note: this operation must make two API calls — one to retrieve the DataStudioAsset's existing classifications,
     ...
     */
    public static DataStudioAsset appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (DataStudioAsset) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated DataStudioAsset
     */
    public static DataStudioAsset appendClassifications(
            ...
            throws AtlanException {
        return (DataStudioAsset) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
