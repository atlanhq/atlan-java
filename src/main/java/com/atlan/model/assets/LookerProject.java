...
public class LookerProject extends Looker {
    ...
    public LookerProjectBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    "Required field for updating LookerProject is missing.",
                    String.join(",", missing),
    ...
    public static LookerProject retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof LookerProject) {
            return (LookerProject) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a LookerProject.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
    ...
    public static LookerProject retrieveByQualifiedName(String qualifiedName) throws AtlanException {
        ...
        if (entity instanceof LookerProject) {
            ...
            throw new NotFoundException(
                    "No LookerProject found with qualifiedName: " + qualifiedName,
