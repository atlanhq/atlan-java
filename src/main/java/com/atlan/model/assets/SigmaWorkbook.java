...
public class SigmaWorkbook extends Sigma {
    ...
    /**
     * Add classifications to a SigmaWorkbook, without replacing existing classifications linked to the SigmaWorkbook.
     * Note: this operation must make two API calls — one to retrieve the SigmaWorkbook's existing classifications,
     ...
     */
    public static SigmaWorkbook appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SigmaWorkbook) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SigmaWorkbook
     */
    public static SigmaWorkbook appendClassifications(
            ...
            throws AtlanException {
        return (SigmaWorkbook) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
