...
public class PowerBIDataflow extends PowerBI {
    ...
    /**
     * Add classifications to a PowerBIDataflow, without replacing existing classifications linked to the PowerBIDataflow.
     * Note: this operation must make two API calls — one to retrieve the PowerBIDataflow's existing classifications,
     ...
     */
    public static PowerBIDataflow appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (PowerBIDataflow) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated PowerBIDataflow
     */
    public static PowerBIDataflow appendClassifications(
            ...
            throws AtlanException {
        return (PowerBIDataflow) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
