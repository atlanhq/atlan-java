...
public class PowerBIDataset extends PowerBI {
    ...
    /**
     * Add classifications to a PowerBIDataset, without replacing existing classifications linked to the PowerBIDataset.
     * Note: this operation must make two API calls — one to retrieve the PowerBIDataset's existing classifications,
     ...
     */
    public static PowerBIDataset appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (PowerBIDataset) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated PowerBIDataset
     */
    public static PowerBIDataset appendClassifications(
            ...
            throws AtlanException {
        return (PowerBIDataset) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
