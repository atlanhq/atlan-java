...
public class PowerBIDataset extends Asset implements IPowerBIDataset, IPowerBI, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all PowerBIDataset assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) PowerBIDataset assets will be included.
     *
     * @return an asset filter that includes all PowerBIDataset assets
     */
     ...
     */
    @JsonIgnore
    public static PowerBIDataset get(AtlanClient client, String id, boolean includeRelationships)
        ...
        if (id == null) {
            ...
            if (asset == null) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, "PowerBIDataset");
            }
        } else {
            ...
            if (asset instanceof PowerBIDataset) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_QN, id, "PowerBIDataset");
            }
        }
    }
     ...
     */
    @Deprecated
    public static PowerBIDataset retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static PowerBIDataset retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public static PowerBIDatasetBuilder<?, ?> updater(String qualifiedName, String name) {
        return PowerBIDataset._internal().qualifiedName(qualifiedName).name(name);
    }
     ...
     * @throws AtlanException on any API problems
     */
    public static PowerBIDataset removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * Add Atlan tags to a PowerBIDataset.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the PowerBIDataset
     * @param qualifiedName of the PowerBIDataset
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the PowerBIDataset
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
