...
public class Folder extends Namespace {
    ...
    /**
     * Add classifications to a Folder, without replacing existing classifications linked to the Folder.
     * Note: this operation must make two API calls — one to retrieve the Folder's existing classifications,
     ...
     */
    public static Folder appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (Folder) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated Folder
     */
    public static Folder appendClassifications(
            ...
            throws AtlanException {
        return (Folder) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
