...
public class Folder extends Asset implements IFolder, INamespace, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all Folder assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) Folder assets will be included.
     *
     * @return an asset filter that includes all Folder assets
     */
     ...
     * Add Atlan tags to a Folder.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the Folder
     * @param qualifiedName of the Folder
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the Folder
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
