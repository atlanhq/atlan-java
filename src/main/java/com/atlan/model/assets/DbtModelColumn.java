...
public class DbtModelColumn extends Dbt {
    ...
    /**
     * Add classifications to a DbtModelColumn, without replacing existing classifications linked to the DbtModelColumn.
     * Note: this operation must make two API calls — one to retrieve the DbtModelColumn's existing classifications,
     ...
     */
    public static DbtModelColumn appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (DbtModelColumn) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated DbtModelColumn
     */
    public static DbtModelColumn appendClassifications(
            ...
            throws AtlanException {
        return (DbtModelColumn) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
