...
public class PowerBITile extends PowerBI {
    ...
    /**
     * Add classifications to a PowerBITile, without replacing existing classifications linked to the PowerBITile.
     * Note: this operation must make two API calls — one to retrieve the PowerBITile's existing classifications,
     ...
     */
    public static PowerBITile appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (PowerBITile) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated PowerBITile
     */
    public static PowerBITile appendClassifications(
            ...
            throws AtlanException {
        return (PowerBITile) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
