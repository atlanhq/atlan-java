...
public class TablePartition extends SQL {
    ...
    /**
     * Add classifications to a TablePartition, without replacing existing classifications linked to the TablePartition.
     * Note: this operation must make two API calls — one to retrieve the TablePartition's existing classifications,
     ...
     */
    public static TablePartition appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (TablePartition) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated TablePartition
     */
    public static TablePartition appendClassifications(
            ...
            throws AtlanException {
        return (TablePartition) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
