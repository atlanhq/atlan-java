...
public class SnowflakeStream extends SQL {
    ...
    /**
     * Add classifications to a SnowflakeStream, without replacing existing classifications linked to the SnowflakeStream.
     * Note: this operation must make two API calls — one to retrieve the SnowflakeStream's existing classifications,
     ...
     */
    public static SnowflakeStream appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SnowflakeStream) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SnowflakeStream
     */
    public static SnowflakeStream appendClassifications(
            ...
            throws AtlanException {
        return (SnowflakeStream) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
