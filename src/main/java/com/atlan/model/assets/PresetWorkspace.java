...
public class PresetWorkspace extends Preset {
    ...
    /**
     * Add classifications to a PresetWorkspace, without replacing existing classifications linked to the PresetWorkspace.
     * Note: this operation must make two API calls — one to retrieve the PresetWorkspace's existing classifications,
     ...
     */
    public static PresetWorkspace appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (PresetWorkspace) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated PresetWorkspace
     */
    public static PresetWorkspace appendClassifications(
            ...
            throws AtlanException {
        return (PresetWorkspace) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
