...
public class Column extends SQL {
    ...
    /**
     * Add classifications to a Column, without replacing existing classifications linked to the Column.
     * Note: this operation must make two API calls — one to retrieve the Column's existing classifications,
     ...
     */
    public static Column appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (Column) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated Column
     */
    public static Column appendClassifications(
            ...
            throws AtlanException {
        return (Column) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
