...
public class LookerExplore extends Asset implements ILookerExplore, ILooker, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all LookerExplore assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) LookerExplore assets will be included.
     *
     * @return an asset filter that includes all LookerExplore assets
     */
    ...
    public static LookerExplore refByGuid(String guid) {
        return LookerExplore._internal().guid(guid).build();
    }
    ...
    public static LookerExplore get(AtlanClient client, String id) throws AtlanException {
        if (id == null) {
            ...
            if (asset instanceof LookerExplore) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_QN, id, "LookerExplore");
            }
        }
    }
    ...
    public static LookerExploreBuilder<?, ?> updater(String qualifiedName, String name) {
        return LookerExplore._internal().qualifiedName(qualifiedName).name(name);
    }
     ...
     * Add Atlan tags to a LookerExplore.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the LookerExplore
     * @param qualifiedName of the LookerExplore
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the LookerExplore
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
