...
public class PowerBIDashboard extends PowerBI {
    ...
    public PowerBIDashboardBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    "Required field for updating PowerBIDashboard is missing.",
                    String.join(",", missing),
    ...
    public static PowerBIDashboard retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof PowerBIDashboard) {
            return (PowerBIDashboard) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a PowerBIDashboard.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
    ...
    public static PowerBIDashboard retrieveByQualifiedName(String qualifiedName) throws AtlanException {
        ...
        if (entity instanceof PowerBIDashboard) {
            ...
            throw new NotFoundException(
                    "No PowerBIDashboard found with qualifiedName: " + qualifiedName,
