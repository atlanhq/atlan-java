    ...
    public static PowerBIPage get(AtlanClient client, String id) throws AtlanException {
        if (id == null) {
            ...
            if (asset instanceof PowerBIPage) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_QN, id, "PowerBIPage");
            }
        } else {
            ...
            if (asset == null) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, "PowerBIPage");
            }
        }
    }
