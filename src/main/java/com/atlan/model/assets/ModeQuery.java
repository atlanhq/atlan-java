...
public class ModeQuery extends Mode {
    ...
    /**
     * Add classifications to a ModeQuery, without replacing existing classifications linked to the ModeQuery.
     * Note: this operation must make two API calls — one to retrieve the ModeQuery's existing classifications,
     ...
     */
    public static ModeQuery appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (ModeQuery) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated ModeQuery
     */
    public static ModeQuery appendClassifications(
            ...
            throws AtlanException {
        return (ModeQuery) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
