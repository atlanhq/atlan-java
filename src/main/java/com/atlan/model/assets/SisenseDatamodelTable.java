...
public class SisenseDatamodelTable extends Asset
    ...
    /**
     * Start an asset filter that will return all SisenseDatamodelTable assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SisenseDatamodelTable assets will be included.
     *
     * @return an asset filter that includes all SisenseDatamodelTable assets
    ...
    /**
     * Reference to a SisenseDatamodelTable by GUID.
     *
    ...
    public static SisenseDatamodelTable refByGuid(String guid) {
        return SisenseDatamodelTable._internal().guid(guid).build();
    }

    /**
     * Reference to a SisenseDatamodelTable by qualifiedName.
     *
     ...
     */
    @JsonIgnore
    public static SisenseDatamodelTable get(AtlanClient client, String id, boolean includeRelationships)
    ...
    /**
     * Retrieves a SisenseDatamodelTable by its GUID, complete with all of its relationships.
     *
     * @param guid of the SisenseDatamodelTable to retrieve
     * @return the requested full SisenseDatamodelTable, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SisenseDatamodelTable does not exist or the provided GUID is not a SisenseDatamodelTable
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SisenseDatamodelTable retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static SisenseDatamodelTable retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a SisenseDatamodelTable by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the SisenseDatamodelTable to retrieve
     * @return the requested full SisenseDatamodelTable, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the SisenseDatamodelTable does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static SisenseDatamodelTable retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static SisenseDatamodelTable retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    public SisenseDatamodelTableBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "SisenseDatamodelTable", String.join(",", missing));
        }
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseDatamodelTable replaceTerms(String qualifiedName, String name, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseDatamodelTable appendTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static SisenseDatamodelTable removeTerms(String qualifiedName, List<IGlossaryTerm> terms)
            throws AtlanException {
     ...
     */
    public static SisenseDatamodelTable appendAtlanTags(String qualifiedName, List<String> atlanTagNames)
            throws AtlanException {
    ...
    /**
     * Add Atlan tags to a SisenseDatamodelTable.
     *
     * @param qualifiedName of the SisenseDatamodelTable
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SisenseDatamodelTable
     ...
     * Add Atlan tags to a SisenseDatamodelTable.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the SisenseDatamodelTable
     * @param qualifiedName of the SisenseDatamodelTable
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SisenseDatamodelTable
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
