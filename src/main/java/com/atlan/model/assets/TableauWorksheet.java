...
public class TableauWorksheet extends Tableau {
    ...
    /**
     * Add classifications to a TableauWorksheet, without replacing existing classifications linked to the TableauWorksheet.
     * Note: this operation must make two API calls — one to retrieve the TableauWorksheet's existing classifications,
     ...
     */
    public static TableauWorksheet appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (TableauWorksheet) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated TableauWorksheet
     */
    public static TableauWorksheet appendClassifications(
            ...
            throws AtlanException {
        return (TableauWorksheet) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
