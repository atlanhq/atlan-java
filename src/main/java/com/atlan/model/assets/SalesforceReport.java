...
public class SalesforceReport extends Salesforce {
    ...
    /**
     * Add classifications to a SalesforceReport, without replacing existing classifications linked to the SalesforceReport.
     * Note: this operation must make two API calls — one to retrieve the SalesforceReport's existing classifications,
     ...
     */
    public static SalesforceReport appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SalesforceReport) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SalesforceReport
     */
    public static SalesforceReport appendClassifications(
            ...
            throws AtlanException {
        return (SalesforceReport) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
