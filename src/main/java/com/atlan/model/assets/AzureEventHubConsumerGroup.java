...
public class AzureEventHubConsumerGroup extends Asset
    ...
    /**
     * Start an asset filter that will return all AzureEventHubConsumerGroup assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) AzureEventHubConsumerGroup assets will be included.
     *
     * @return an asset filter that includes all AzureEventHubConsumerGroup assets
    ...
    /**
     * Reference to a AzureEventHubConsumerGroup by GUID.
     *
    ...
    public static AzureEventHubConsumerGroup refByGuid(String guid) {
        return AzureEventHubConsumerGroup._internal().guid(guid).build();
    }

    /**
     * Reference to a AzureEventHubConsumerGroup by qualifiedName.
     *
    ...
    /**
     * Retrieves a AzureEventHubConsumerGroup by its GUID, complete with all of its relationships.
     *
     * @param guid of the AzureEventHubConsumerGroup to retrieve
     * @return the requested full AzureEventHubConsumerGroup, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the AzureEventHubConsumerGroup does not exist or the provided GUID is not a AzureEventHubConsumerGroup
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static AzureEventHubConsumerGroup retrieveByGuid(String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static AzureEventHubConsumerGroup retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
        return get(client, guid);
    }

    /**
     * Retrieves a AzureEventHubConsumerGroup by its qualifiedName, complete with all of its relationships.
     *
     * @param qualifiedName of the AzureEventHubConsumerGroup to retrieve
     * @return the requested full AzureEventHubConsumerGroup, complete with all of its relationships
     * @throws AtlanException on any error during the API invocation, such as the {@link NotFoundException} if the AzureEventHubConsumerGroup does not exist
     * @deprecated see {@link #get(String)} instead
     */
    @Deprecated
    public static AzureEventHubConsumerGroup retrieveByQualifiedName(String qualifiedName) throws AtlanException {
     ...
     */
    @Deprecated
    public static AzureEventHubConsumerGroup retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
    ...
    /**
     * Builds the minimal object necessary to apply an update to a AzureEventHubConsumerGroup, from a potentially
     * more-complete AzureEventHubConsumerGroup object.
     *
    ...
    public AzureEventHubConsumerGroupBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    ErrorCode.MISSING_REQUIRED_UPDATE_PARAM, "AzureEventHubConsumerGroup", String.join(",", missing));
        }
    ...
    /**
     * Add Atlan tags to a AzureEventHubConsumerGroup.
     *
     * @param qualifiedName of the AzureEventHubConsumerGroup
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the AzureEventHubConsumerGroup
     ...
     * Add Atlan tags to a AzureEventHubConsumerGroup.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the AzureEventHubConsumerGroup
     * @param qualifiedName of the AzureEventHubConsumerGroup
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the AzureEventHubConsumerGroup
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
