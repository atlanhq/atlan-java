...
public class PresetDashboard extends Preset {
    ...
    /**
     * Add classifications to a PresetDashboard, without replacing existing classifications linked to the PresetDashboard.
     * Note: this operation must make two API calls — one to retrieve the PresetDashboard's existing classifications,
     ...
     */
    public static PresetDashboard appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (PresetDashboard) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated PresetDashboard
     */
    public static PresetDashboard appendClassifications(
            ...
            throws AtlanException {
        return (PresetDashboard) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
