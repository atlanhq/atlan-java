...
public class View extends SQL {
    ...
    public static View retrieveByGuid(String guid) throws AtlanException {
        ...
        if (entity == null) {
            ...
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a View.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
     ...
     * @return the View that was restored
     * @throws AtlanException on any API problems
     */
    public static View restore(String qualifiedName) throws AtlanException {
        return (View) Asset.restore(TYPE_NAME, qualifiedName);
    }
