...
public class LineageProcess extends Asset {
    ...
    /**
     * Add classifications to a LineageProcess, without replacing existing classifications linked to the LineageProcess.
     * Note: this operation must make two API calls — one to retrieve the LineageProcess's existing classifications,
     ...
     */
    public static LineageProcess appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (LineageProcess) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated LineageProcess
     */
    public static LineageProcess appendClassifications(
            ...
            throws AtlanException {
        return (LineageProcess) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
