...
public class SigmaDataset extends Sigma {
    ...
    /**
     * Add classifications to a SigmaDataset, without replacing existing classifications linked to the SigmaDataset.
     * Note: this operation must make two API calls — one to retrieve the SigmaDataset's existing classifications,
     ...
     */
    public static SigmaDataset appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SigmaDataset) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SigmaDataset
     */
    public static SigmaDataset appendClassifications(
            ...
            throws AtlanException {
        return (SigmaDataset) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
