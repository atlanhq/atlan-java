...
public class SigmaDataset extends Asset implements ISigmaDataset, ISigma, IBI, ICatalog, IAsset, IReferenceable {
    ...
    /**
     * Start an asset filter that will return all SigmaDataset assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) SigmaDataset assets will be included.
     *
     * @return an asset filter that includes all SigmaDataset assets
     */
     ...
     */
    @JsonIgnore
    public static SigmaDataset get(String id) throws AtlanException {
     ...
     */
    @JsonIgnore
    public static SigmaDataset get(AtlanClient client, String id, boolean includeRelationships) throws AtlanException {
        if (id == null) {
            ...
            if (asset == null) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, "SigmaDataset");
            }
        } else {
            ...
            if (asset instanceof SigmaDataset) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_QN, id, "SigmaDataset");
            }
        }
    }
     ...
     */
    @Deprecated
    public static SigmaDataset retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static SigmaDataset retrieveByQualifiedName(AtlanClient client, String qualifiedName) throws AtlanException {
     ...
     * Add Atlan tags to a SigmaDataset.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the SigmaDataset
     * @param qualifiedName of the SigmaDataset
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the SigmaDataset
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
