...
public class PowerBITable extends PowerBI {
    ...
    /**
     * Add classifications to a PowerBITable, without replacing existing classifications linked to the PowerBITable.
     * Note: this operation must make two API calls — one to retrieve the PowerBITable's existing classifications,
     ...
     */
    public static PowerBITable appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (PowerBITable) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated PowerBITable
     */
    public static PowerBITable appendClassifications(
            ...
            throws AtlanException {
        return (PowerBITable) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
