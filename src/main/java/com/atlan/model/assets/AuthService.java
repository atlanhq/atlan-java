...
public class AuthService extends Asset {
    ...
    /**
     * Add classifications to a AuthService, without replacing existing classifications linked to the AuthService.
     * Note: this operation must make two API calls — one to retrieve the AuthService's existing classifications,
     ...
     */
    public static AuthService appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (AuthService) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated AuthService
     */
    public static AuthService appendClassifications(
            ...
            throws AtlanException {
        return (AuthService) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
    ...
    /**
     * Add classifications to a AuthService.
     *
     * @param qualifiedName of the AuthService
     * @param classificationNames human-readable names of the classifications to add
     * @throws AtlanException on any API problems, or if any of the classifications already exist on the AuthService
    ...
    /**
     * Remove a classification from a AuthService.
     *
     * @param qualifiedName of the AuthService
     * @param classificationName human-readable name of the classification to remove
     * @throws AtlanException on any API problems, or if the classification does not exist on the AuthService
     */
