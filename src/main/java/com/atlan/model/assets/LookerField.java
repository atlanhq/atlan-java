...
public class LookerField extends Looker {
    ...
    public LookerFieldBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    "Required field for updating LookerField is missing.",
                    String.join(",", missing),
    ...
    public static LookerField retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof LookerField) {
            return (LookerField) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a LookerField.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
    ...
    public static LookerField retrieveByQualifiedName(String qualifiedName) throws AtlanException {
        ...
        if (entity instanceof LookerField) {
            ...
            throw new NotFoundException(
                    "No LookerField found with qualifiedName: " + qualifiedName,
