...
public class LookerField extends Looker {
    ...
    /**
     * Add classifications to a LookerField, without replacing existing classifications linked to the LookerField.
     * Note: this operation must make two API calls — one to retrieve the LookerField's existing classifications,
     ...
     */
    public static LookerField appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (LookerField) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated LookerField
     */
    public static LookerField appendClassifications(
            ...
            throws AtlanException {
        return (LookerField) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
