...
public class MCIncident extends MonteCarlo {
    ...
    /**
     * Add classifications to a MCIncident, without replacing existing classifications linked to the MCIncident.
     * Note: this operation must make two API calls — one to retrieve the MCIncident's existing classifications,
     ...
     */
    public static MCIncident appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (MCIncident) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated MCIncident
     */
    public static MCIncident appendClassifications(
            ...
            throws AtlanException {
        return (MCIncident) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
    ...
    /**
     * Add classifications to a MCIncident.
     *
     * @param qualifiedName of the MCIncident
     * @param classificationNames human-readable names of the classifications to add
     * @throws AtlanException on any API problems, or if any of the classifications already exist on the MCIncident
    ...
    /**
     * Remove a classification from a MCIncident.
     *
     * @param qualifiedName of the MCIncident
     * @param classificationName human-readable name of the classification to remove
     * @throws AtlanException on any API problems, or if the classification does not exist on the MCIncident
     */
