...
public class MetabaseCollection extends Metabase {
    ...
    /**
     * Add classifications to a MetabaseCollection, without replacing existing classifications linked to the MetabaseCollection.
     * Note: this operation must make two API calls — one to retrieve the MetabaseCollection's existing classifications,
     ...
     */
    public static MetabaseCollection appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (MetabaseCollection) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated MetabaseCollection
     */
    public static MetabaseCollection appendClassifications(
            ...
            throws AtlanException {
        return (MetabaseCollection) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
