    ...
    public static MetabaseCollection get(AtlanClient client, String id, boolean includeRelationships)
        ...
        if (id == null) {
            ...
            if (asset == null) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, "MetabaseCollection");
            }
        } else {
            ...
            if (asset instanceof MetabaseCollection) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_QN, id, "MetabaseCollection");
            }
        }
    }
