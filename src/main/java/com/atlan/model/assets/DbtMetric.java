...
public class DbtMetric extends Metric {
    ...
    public DbtMetricBuilder<?, ?> trimToRequired() throws InvalidRequestException {
        ...
        if (!missing.isEmpty()) {
            throw new InvalidRequestException(
                    "Required field for updating DbtMetric is missing.",
                    String.join(",", missing),
    ...
    public static DbtMetric retrieveByGuid(String guid) throws AtlanException {
        ...
        } else if (entity instanceof DbtMetric) {
            return (DbtMetric) entity;
        } else {
            throw new NotFoundException(
                    "Entity with GUID " + guid + " is not a DbtMetric.", "ATLAN_JAVA_CLIENT-404-002", 404, null);
        }
    }
