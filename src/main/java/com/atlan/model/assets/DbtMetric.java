...
public class DbtMetric extends Metric {
    ...
    /**
     * Add classifications to a DbtMetric, without replacing existing classifications linked to the DbtMetric.
     * Note: this operation must make two API calls — one to retrieve the DbtMetric's existing classifications,
     ...
     */
    public static DbtMetric appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (DbtMetric) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated DbtMetric
     */
    public static DbtMetric appendClassifications(
            ...
            throws AtlanException {
        return (DbtMetric) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
