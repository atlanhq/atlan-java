...
public class SigmaDatasetColumn extends Sigma {
    ...
    /**
     * Add classifications to a SigmaDatasetColumn, without replacing existing classifications linked to the SigmaDatasetColumn.
     * Note: this operation must make two API calls — one to retrieve the SigmaDatasetColumn's existing classifications,
     ...
     */
    public static SigmaDatasetColumn appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SigmaDatasetColumn) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SigmaDatasetColumn
     */
    public static SigmaDatasetColumn appendClassifications(
            ...
            throws AtlanException {
        return (SigmaDatasetColumn) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
