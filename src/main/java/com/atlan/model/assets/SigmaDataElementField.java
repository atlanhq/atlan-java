...
public class SigmaDataElementField extends Sigma {
    ...
    /**
     * Add classifications to a SigmaDataElementField, without replacing existing classifications linked to the SigmaDataElementField.
     * Note: this operation must make two API calls — one to retrieve the SigmaDataElementField's existing classifications,
     ...
     */
    public static SigmaDataElementField appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (SigmaDataElementField) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated SigmaDataElementField
     */
    public static SigmaDataElementField appendClassifications(
            ...
            throws AtlanException {
        return (SigmaDataElementField) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
