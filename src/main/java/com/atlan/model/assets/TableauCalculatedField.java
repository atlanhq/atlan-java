...
public class TableauCalculatedField extends Asset
    ...
    /**
     * Start an asset filter that will return all TableauCalculatedField assets.
     * Additional conditions can be chained onto the returned filter before any
     * asset retrieval is attempted, ensuring all conditions are pushed-down for
     * optimal retrieval. Only active (non-archived) TableauCalculatedField assets will be included.
     *
     * @return an asset filter that includes all TableauCalculatedField assets
     */
     ...
     */
    @JsonIgnore
    public static TableauCalculatedField get(AtlanClient client, String id, boolean includeRelationships)
        ...
        if (id == null) {
            ...
            if (asset == null) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_TYPE_REQUESTED, id, "TableauCalculatedField");
            }
        } else {
            ...
            if (asset instanceof TableauCalculatedField) {
                ...
                throw new NotFoundException(ErrorCode.ASSET_NOT_FOUND_BY_QN, id, "TableauCalculatedField");
            }
        }
    }
     ...
     */
    @Deprecated
    public static TableauCalculatedField retrieveByGuid(AtlanClient client, String guid) throws AtlanException {
     ...
     */
    @Deprecated
    public static TableauCalculatedField retrieveByQualifiedName(AtlanClient client, String qualifiedName)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static TableauCalculatedField removeUserDescription(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * @throws AtlanException on any API problems
     */
    public static TableauCalculatedField removeAnnouncement(AtlanClient client, String qualifiedName, String name)
            throws AtlanException {
     ...
     * Add Atlan tags to a TableauCalculatedField.
     *
     * @param client connectivity to the Atlan tenant on which to add Atlan tags to the TableauCalculatedField
     * @param qualifiedName of the TableauCalculatedField
     * @param atlanTagNames human-readable names of the Atlan tags to add
     * @throws AtlanException on any API problems, or if any of the Atlan tags already exist on the TableauCalculatedField
     * @deprecated see {@link #appendAtlanTags(String, List)} instead
