...
public class TableauCalculatedField extends Tableau {
    ...
    /**
     * Add classifications to a TableauCalculatedField, without replacing existing classifications linked to the TableauCalculatedField.
     * Note: this operation must make two API calls — one to retrieve the TableauCalculatedField's existing classifications,
     ...
     */
    public static TableauCalculatedField appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (TableauCalculatedField) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated TableauCalculatedField
     */
    public static TableauCalculatedField appendClassifications(
            ...
            throws AtlanException {
        return (TableauCalculatedField) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
