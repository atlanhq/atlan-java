...
public class KafkaTopic extends Kafka {
    ...
    /**
     * Add classifications to a KafkaTopic, without replacing existing classifications linked to the KafkaTopic.
     * Note: this operation must make two API calls — one to retrieve the KafkaTopic's existing classifications,
     ...
     */
    public static KafkaTopic appendClassifications(String qualifiedName, List<String> classificationNames)
            throws AtlanException {
        return (KafkaTopic) Asset.appendClassifications(TYPE_NAME, qualifiedName, classificationNames);
    }
     ...
     * @return the updated KafkaTopic
     */
    public static KafkaTopic appendClassifications(
            ...
            throws AtlanException {
        return (KafkaTopic) Asset.appendClassifications(
                TYPE_NAME,
                qualifiedName,
                classificationNames,
                propagate,
