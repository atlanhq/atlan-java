...
public abstract class Entity extends AtlanObject {
  ...
  public static EntityMutationResponse create(
      Entity value, boolean replaceClassifications, boolean replaceBusinessAttributes)
      throws AtlanException {
    return create(
        Collections.singletonList(value), replaceClassifications, replaceBusinessAttributes);
  }
  ...
  public static EntityMutationResponse create(
    ...
    return ApiResource.request(
        ApiResource.RequestMethod.POST, url, beq, EntityMutationResponse.class, null);
  }
  ...
  public static EntityResponse retrieve(
      String guid, boolean ignoreRelationships, boolean minExtInfo) throws AtlanException {
    String url =
        String.format(
            "%s%s",
            Atlan.getApiBase(),
  ...
  public static EntityResponse retrieve(String typeName, String qualifiedName)
      throws AtlanException {
  ...
  /** Deletes any entity */
  public static EntityMutationResponse delete(String guid, AtlanDeleteType deleteType)
      throws AtlanException {
    return delete(Collections.singletonList(guid), deleteType);
  }

  /** Deletes any entities */
  public static EntityMutationResponse delete(List<String> guids, AtlanDeleteType deleteType)
      throws AtlanException {
    if (guids != null) {
