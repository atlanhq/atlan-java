...
@Slf4j
public abstract class ApiResourceJ extends AtlanObjectJ implements AtlanResponseInterface {
    public static final Charset CHARSET = StandardCharsets.UTF_8;

    private static AtlanResponseGetterJ atlanResponseGetter = new LiveAtlanResponseGetterJ();

    public static void setAtlanResponseGetter(AtlanResponseGetterJ arg) {
        ApiResourceJ.atlanResponseGetter = arg;
    }
    ...
    public JsonNode getRawJsonObject() {
        ...
        if ((this.rawJsonObject == null) && (this.getLastResponse() != null)) {
            try {
                this.rawJsonObject = mapper.readTree(this.getLastResponse().body());
    ...
    public static <T extends ApiResourceJ> T request(
            ApiResourceJ.RequestMethod method, String url, AtlanObjectJ payload, Class<T> clazz, RequestOptions options)
    ...
    public static <T extends ApiResourceJ> T request(
        ...
        T response = ApiResourceJ.atlanResponseGetter.request(method, url, body, clazz, options);
