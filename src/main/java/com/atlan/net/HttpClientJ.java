...
public abstract class HttpClientJ {
     ...
     */
    public abstract AtlanResponse request(AtlanRequestJ request) throws AtlanException;
     ...
     * @throws AtlanException If the request fails for any reason
     */
    public AtlanResponseStream requestStream(AtlanRequestJ request) throws AtlanException {
    ...
    private interface RequestSendFunction<R> {
        R apply(AtlanRequestJ request) throws AtlanException;
    }

    private <T extends AbstractAtlanResponse<?>> T sendWithTelemetry(AtlanRequestJ request, RequestSendFunction<T> send)
     ...
     * @throws AtlanException If the request fails for any reason
     */
    public AtlanResponse requestWithTelemetry(AtlanRequestJ request) throws AtlanException {
     ...
     * @throws AtlanException If the request fails for any reason
     */
    public AtlanResponseStream requestStreamWithTelemetry(AtlanRequestJ request) throws AtlanException {
        return sendWithTelemetry(request, this::requestStream);
    }

    public <T extends AbstractAtlanResponse<?>> T sendWithRetries(AtlanRequestJ request, RequestSendFunction<T> send)
            throws AtlanException {
     ...
     * @throws AtlanException If the request fails for any reason
     */
    public AtlanResponse requestWithRetries(AtlanRequestJ request) throws AtlanException {
     ...
     * @throws AtlanException If the request fails for any reason
     */
    public AtlanResponseStream requestStreamWithRetries(AtlanRequestJ request) throws AtlanException {
    ...
    protected static String buildXAtlanClientUserAgentString() {
        ...
        try {
            if (Atlan.getAppInfo() != null) {
                propertyMap.put("application", ApiResourceJ.mapper.writeValueAsString(Atlan.getAppInfo()));
            }
            return ApiResourceJ.mapper.writeValueAsString(propertyMap);
    ...
    private <T extends AbstractAtlanResponse<?>> boolean shouldRetry(
            int numRetries, AtlanException exception, AtlanRequestJ request, T response) {
