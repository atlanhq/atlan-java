...
public class HttpURLConnectionClientJ extends HttpClientJ {
    /** Initializes a new instance of the {@link HttpURLConnectionClientJ}. */
    public HttpURLConnectionClientJ() {
        super();
    }
     ...
     */
    @Override
    public AtlanResponseStream requestStream(AtlanRequestJ request) throws ApiConnectionException {
        try {
     ...
     */
    @Override
    public AtlanResponse request(AtlanRequestJ request) throws ApiConnectionException {
    ...
    static HttpHeaders getHeaders(AtlanRequestJ request) {
    ...
    private static HttpURLConnection createAtlanConnection(AtlanRequestJ request)
