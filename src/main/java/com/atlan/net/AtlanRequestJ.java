...
public class AtlanRequestJ {
    /** The HTTP method for the request (GET, POST or DELETE). */
    ApiResourceJ.RequestMethod method;
     ...
     */
    public AtlanRequestJ(ApiResourceJ.RequestMethod method, String url, String body, RequestOptions options)
     ...
     */
    public AtlanRequestJ withAdditionalHeader(String name, String value) {
        return new AtlanRequestJ(
                this.method,
                this.url,
                this.content,
    ...
    private static HttpHeaders buildHeaders(ApiResourceJ.RequestMethod method, RequestOptions options)
        ...
        // Accept-Charset
        headerMap.put("Accept-Charset", Arrays.asList(ApiResourceJ.CHARSET.name()));
        ...
        } else if (method == ApiResourceJ.RequestMethod.POST) {
