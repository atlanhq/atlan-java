...
public class LineageTest extends AtlanLiveTest {
    ...
    void createLineage() {
        ...
        LineageProcess process = LineageProcess.creator(
                        ...
                        Collections.singletonList(GuidReference.to(S3Object.TYPE_NAME, S3AssetTest.s3Object1Guid)),
                        Collections.singletonList(GuidReference.to(S3Object.TYPE_NAME, S3AssetTest.s3Object2Guid)))
                .build();
        try {
