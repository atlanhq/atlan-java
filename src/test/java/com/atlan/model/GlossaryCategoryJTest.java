...
public class GlossaryCategoryJTest {

    private static final GlossaryCategoryJ full = GlossaryCategoryJ.builder()
            .guid("guid")
            ...
            .parentCategory(ReferenceJ.to(GlossaryCategoryJ.TYPE_NAME, "categoryGuid"))
            .term(ReferenceJ.to(GlossaryTerm.TYPE_NAME, "termGuid1"))
            .term(ReferenceJ.to(GlossaryTerm.TYPE_NAME, "termGuid2"))
            .childCategory(ReferenceJ.to(GlossaryCategoryJ.TYPE_NAME, "categoryGuid1"))
            .childCategory(ReferenceJ.to(GlossaryCategoryJ.TYPE_NAME, "categoryGuid2"))
            .build();

    private static GlossaryCategoryJ frodo;
    ...
    void deserialization() throws JsonProcessingException {
        assertNotNull(serialized);
        frodo = ApiResourceJ.mapper.readValue(serialized, GlossaryCategoryJ.class);
        assertNotNull(frodo);
    }
