...
public class DbtColumnProcessTest {
    ...
    private static final DbtColumnProcess full = DbtColumnProcess._internal()
            ...
            .input(KafkaTopic.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .input(KafkaTopic.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .output(KafkaTopic.refByGuid("705d96f4-bdb6-4792-8dfe-8dc4ca3d2c23"))
            .output(KafkaTopic.refByQualifiedName("default/snowflake/1234567890/test/qualifiedName"))
            .sql("String0")
    ...
    void deserialization() throws IOException {
        assertNotNull(serialized);
        frodo = Atlan.getDefaultClient().readValue(serialized, DbtColumnProcess.class);
        assertNotNull(frodo);
    }
