...
public class TableauDatasourceFieldTest {
    ...
    private static final TableauDatasourceField full = TableauDatasourceField.builder()
            ...
            .upstreamTable("key1", "value1")
            .upstreamTable("key2", "value2")
            .tableauDatasourceFieldFormula("String0")
            .tableauDatasourceFieldBinSize("String0")
            .upstreamColumn("key1", "value1")
            .upstreamColumn("key2", "value2")
            .upstreamField("key1", "value1")
            .upstreamField("key2", "value2")
