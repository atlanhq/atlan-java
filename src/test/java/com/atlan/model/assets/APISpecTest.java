...
public class APISpecTest {
    ...
    private static final APISpec full = APISpec.builder()
            .guid("guid")
            ...
            .apiSpecTermsOfServiceURL("apiSpecTermsOfServiceURL")
            .apiSpecContactEmail("apiSpecContactEmail")
            .apiSpecContactName("apiSpecContactName")
            .apiSpecContactURL("apiSpecContactURL")
            .apiSpecLicenseName("apiSpecLicenseName")
