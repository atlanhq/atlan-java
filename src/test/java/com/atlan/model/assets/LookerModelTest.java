...
public class LookerModelTest {

    private static final LookerModel full = LookerModel.builder()
            .guid("guid")
            ...
            .inputToProcesses(Set.of(
                    LineageProcess.refByGuid("c92f82af-ac3c-4ecb-9c9a-420c35f68c2d"),
                    LineageProcess.refByGuid("bb9ff878-9310-4c61-88b0-974faac8a667")))
            .outputFromProcesses(Set.of(
                    LineageProcess.refByGuid("811dd501-dd3b-4374-917a-5d7468c57e7f"),
                    LineageProcess.refByGuid("d52c6c66-2ad0-4189-8a60-d092043e9502")))
            .projectName("projectName")
            .explores(Set.of(
                    LookerExplore.refByGuid("5f87d0a0-a34b-4197-8498-73c2dec52a4f"),
                    LookerExplore.refByGuid("a3494c64-7d9c-499a-9c2e-4384f68189ca")))
            .project(LookerProject.refByGuid("b9e79b0b-3a40-4acf-a11c-20c3b02a2959"))
            .fields(Set.of(
                    LookerField.refByGuid("533efb23-9b57-4878-88f6-b40088385649"),
                    LookerField.refByGuid("66da62ee-aa0d-4572-862a-b615d235aac7")))
            .look(LookerLook.refByGuid("3a2bf4b7-11c5-4c4e-b34a-db09bb9d379b"))
            .queries(Set.of(
                    LookerQuery.refByGuid("95739669-e528-4133-b975-9aa2b5773e74"),
                    LookerQuery.refByGuid("df16b09f-257d-40ee-90c5-4a9f7e051d32")))
            .build();
    private static LookerModel frodo;
    private static String serialized;

    @Test(groups = {"LookerModel.builderEquivalency"})
    void builderEquivalency() {
        assertEquals(full.toBuilder().build(), full);
    }

    @Test(
            groups = {"LookerModel.serialize"},
            dependsOnGroups = {"LookerModel.builderEquivalency"})
    void serialization() {
        assertNotNull(full);
    ...
    @Test(
            groups = {"LookerModel.deserialize"},
            dependsOnGroups = {"LookerModel.serialize"})
    void deserialization() throws JsonProcessingException {
        assertNotNull(serialized);
        frodo = Serde.mapper.readValue(serialized, LookerModel.class);
        assertNotNull(frodo);
    }

    @Test(
            groups = {"LookerModel.equivalency"},
            dependsOnGroups = {"LookerModel.serialize", "LookerModel.deserialize"})
