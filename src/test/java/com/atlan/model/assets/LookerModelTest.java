...
public class LookerModelTest {
    ...
    private static final LookerModel full = LookerModel.builder()
            ...
            .inputToProcesses(Set.of(
                    LineageProcess.refByGuid("8be8a374-abb0-49f6-b9d6-b0f75031b1c5"),
                    LineageProcess.refByGuid("9fff6632-583b-4d75-91ab-d640678689d1")))
            .outputFromProcesses(Set.of(
                    LineageProcess.refByGuid("b571e022-eda9-44de-b231-3650a0945e4d"),
                    LineageProcess.refByGuid("5c15d71f-4437-48b2-95c9-8a5db079e59d")))
            .projectName("projectName")
            .explores(Set.of(
                    LookerExplore.refByGuid("58888d7b-a915-4bef-a8b7-ce4323d5d7d7"),
                    LookerExplore.refByGuid("039fade3-3347-4d5b-906a-0f9117be08a7")))
            .project(LookerProject.refByGuid("2353ba1f-99a8-4a44-90c8-e3fbd3c775de"))
            .fields(Set.of(
                    LookerField.refByGuid("709223ac-ab58-4167-af70-58628d42dcda"),
                    LookerField.refByGuid("362d4fff-4e13-419f-a116-2e54f7f4a81b")))
            .look(LookerLook.refByGuid("4189a182-eb73-4085-9055-d63c867878ba"))
            .queries(Set.of(
                    LookerQuery.refByGuid("a24359cd-ee11-485e-8abd-5ae70ec39b67"),
                    LookerQuery.refByGuid("aff4b860-4491-4137-b65e-6002022301b1")))
            .build();
