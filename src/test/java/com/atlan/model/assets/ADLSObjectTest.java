...
public class ADLSObjectTest {
    ...
    private static final ADLSObject full = ADLSObject.builder()
            ...
            .azureTags(Table.refByGuid("3f9114c1-40a7-49bb-8d4f-91a2872c7039"))
            ...
            .adlsObjectType(Table.refByGuid("bda8cee2-29bf-458f-a3c7-6774141482db"))
            .adlsObjectSize(-4522292454635227782L)
            .adlsObjectAccessTier(Table.refByGuid("9c9e8f3a-49b2-42f5-b63b-25b990a3033b"))
            .adlsObjectAccessTierLastModifiedTime(3541758216269101356L)
            .adlsObjectArchiveStatus(Table.refByGuid("5f9e314d-c4a4-45c9-b7bb-02e8f0cbb443"))
            ...
            .adlsObjectLeaseStatus(Table.refByGuid("2e4c7047-baf3-4983-afad-e95cd70a0c38"))
            .adlsObjectLeaseState(Table.refByGuid("eb1b8ebd-233c-4866-a199-db00bc76aa9b"))
