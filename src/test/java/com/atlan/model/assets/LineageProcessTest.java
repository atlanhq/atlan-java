...
public class LineageProcessTest {
    ...
    private static final LineageProcess full = LineageProcess.builder()
            ...
            .connectorType(AtlanConnectorType.GLUE)
            ...
            .output(View.refByGuid("output2"))
            .columnProcess(ColumnProcess.refByGuid("columnProcess1"))
            .columnProcess(ColumnProcess.refByGuid("columnProcess2"))
            .build();
