...
public class S3BucketJTest {

    private static final S3BucketJ full = S3BucketJ.builder()
            .guid("guid")
            ...
            .awsTag(AWSTagJ.of("awsTagKey1", "awsTagValue1"))
            .awsTag(AWSTagJ.of("awsTagKey2", "awsTagValue2"))
            .s3ETag("s3ETag")
            .s3Encryption("s3Encryption")
            .s3ObjectCount(123456L)
            .s3BucketVersioningEnabled(true)
            .object(ReferenceJ.to(S3Object.TYPE_NAME, "objectGuid1"))
            .object(ReferenceJ.to(S3Object.TYPE_NAME, "objectGuid2"))
            .build();

    private static S3BucketJ frodo;
    ...
    void deserialization() throws JsonProcessingException {
        assertNotNull(serialized);
        frodo = ApiResourceJ.mapper.readValue(serialized, S3BucketJ.class);
        assertNotNull(frodo);
    }
