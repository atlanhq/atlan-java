...
public class IndistinctAssetJTest {

    private static final IndistinctAssetJ full = IndistinctAssetJ.builder()
            .typeName("typeName")
            .guid("guid")
    ...
    private static IndistinctAssetJ frodo;
    ...
    void deserialization() throws JsonProcessingException {
        assertNotNull(serialized);
        frodo = ApiResourceJ.mapper.readValue(serialized, IndistinctAssetJ.class);
        assertNotNull(frodo);
    }
