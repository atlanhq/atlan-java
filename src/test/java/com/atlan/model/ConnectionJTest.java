...
public class ConnectionJTest {

    private static final ConnectionJ full = ConnectionJ.builder()
            .guid("guid")
    ...
    private static ConnectionJ frodo;
    ...
    void deserialization() throws JsonProcessingException {
        assertNotNull(serialized);
        frodo = ApiResourceJ.mapper.readValue(serialized, ConnectionJ.class);
        assertNotNull(frodo);
    }
