...
public class S3ObjectJTest {

    private static final S3ObjectJ full = S3ObjectJ.builder()
            .guid("guid")
            ...
            .awsTag(AWSTagJ.builder()
                    .awsTagKey("awsTagKey1")
                    .awsTagValue("awsTagValue1")
                    .build())
            .awsTag(AWSTagJ.builder()
                    .awsTagKey("awsTagKey2")
                    .awsTagValue("awsTagValue2")
                    .build())
            .s3ETag("s3ETag")
            .s3Encryption("s3Encryption")
            .s3ObjectLastModifiedTime(123456789L)
            .s3BucketName("s3BucketName")
            .s3BucketQualifiedName("s3BucketQualifiedName")
            .s3ObjectSize(123456L)
            ...
            .bucket(ReferenceJ.to(S3BucketJ.TYPE_NAME, "bucketGuid"))
            .build();

    private static S3ObjectJ frodo;
    ...
    void deserialization() throws JsonProcessingException {
        assertNotNull(serialized);
        frodo = ApiResourceJ.mapper.readValue(serialized, S3ObjectJ.class);
        assertNotNull(frodo);
    }
