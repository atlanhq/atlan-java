...
public class ReadmeJTest {

    private static final ReadmeJ full = ReadmeJ.builder()
            .guid("guid")
            ...
            .isGlobal(false)
            .reference("reference")
            .asset(ReferenceJ.to(GlossaryTermJ.TYPE_NAME, "termGuid3"))
            .build();

    private static ReadmeJ frodo;
    ...
    void deserialization() throws JsonProcessingException {
        assertNotNull(serialized);
        frodo = ApiResourceJ.mapper.readValue(serialized, ReadmeJ.class);
        assertNotNull(frodo);
    }
